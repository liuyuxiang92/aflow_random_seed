...
#ifndef _AFLOW_ANRL_A8B_tI18_139_hi_a_CPP
#define _AFLOW_ANRL_A8B_tI18_139_hi_a_CPP
#include "../aflow.h"
...
namespace anrl {
  uint PrototypeANRL_A8B_tI18_139_hi_a(ostream &oss,stringstream &web,xstructure& str,string parameters,string proto_line,uint print_mode,bool LDEBUG) {
