...
// FILE "ANRL/aflow_anrl_A8B_tI18_139_hi_a.cpp"

#ifndef _AFLOW_ANRL_A8B_tI18_139_hi_a_CPP // AFLOW_REMOVE_GREP
#define _AFLOW_ANRL_A8B_tI18_139_hi_a_CPP // AFLOW_REMOVE_GREP
#include "../aflow.h" // AFLOW_REMOVE_GREP

namespace anrl {
  uint WebANRL_A8B_tI18_139_hi_a(stringstream &web,bool LDEBUG);
}

namespace anrl {
  uint PrototypeANRL_A8B_tI18_139_hi_a(stringstream &web,xstructure& str,string parameters,string proto_line,uint print_mode,bool LDEBUG) {
    // system A8B_tI18_139_hi_a

    if(XHOST.vflag_control.flag("WWW")) {
      WebANRL_A8B_tI18_139_hi_a(web,LDEBUG); // PLUG WEB STUFF
#ifdef _ANRL_NOWEB_
      cout << "no web" << endl;
#else
      cout << web.str() << endl;
    ...
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A8B_tI18_139_hi_a: FOUND" << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A8B_tI18_139_hi_a: label=" << label << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A8B_tI18_139_hi_a: nspecies=" << nspecies << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A8B_tI18_139_hi_a: natoms=" << natoms << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A8B_tI18_139_hi_a: spacegroup=" << spacegroup << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A8B_tI18_139_hi_a: nunderscores=" << nunderscores << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A8B_tI18_139_hi_a: nparameters=" <<  nparameters << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A8B_tI18_139_hi_a: Pearson_symbol=" << Pearson_symbol << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A8B_tI18_139_hi_a: params=" << params << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A8B_tI18_139_hi_a: Strukturbericht=" << Strukturbericht << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A8B_tI18_139_hi_a: prototype=" << prototype << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A8B_tI18_139_hi_a: dialect=" << dialect << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A8B_tI18_139_hi_a: vparameters.size()=" << vparameters.size() << endl;}
    ...
    uint i=0;
    double a=vparameters.at(i++);                  if(LDEBUG) { cerr << "anrl::PrototypeANRL_A8B_tI18_139_hi_a: a=" << a << endl;}
    double covera=vparameters.at(i++),c=covera*a;  if(LDEBUG) { cerr << "anrl::PrototypeANRL_A8B_tI18_139_hi_a: c=" << c << " (c/a=" << covera << ")" << endl;}

    double x2=vparameters.at(i++);                 if(LDEBUG) { cerr << "anrl::PrototypeANRL_A8B_tI18_139_hi_a: x2=" << x2 << endl;}
    double x3=vparameters.at(i++);                 if(LDEBUG) { cerr << "anrl::PrototypeANRL_A8B_tI18_139_hi_a: x3=" << x3 << endl;}
...
namespace anrl {
  uint WebANRL_A8B_tI18_139_hi_a(stringstream& web,bool LDEBUG) {
    ...
    if(LDEBUG) {cerr << "anrl:: WebANRL_A8B_tI18_139_hi_a: web.str().size()=" << web.str().size() << endl;}
