...
#ifndef _AFLOW_ANRL_A_mP8_10_2m2n_CPP
#define _AFLOW_ANRL_A_mP8_10_2m2n_CPP
#include "../aflow.h"
...
namespace anrl {
  uint PrototypeANRL_A_mP8_10_2m2n(ostream &oss,stringstream &web,xstructure& str,string parameters,string proto_line,uint print_mode,bool LDEBUG) {
