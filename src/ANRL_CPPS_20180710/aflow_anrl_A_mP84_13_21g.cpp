...
#ifndef _AFLOW_ANRL_A_mP84_13_21g_CPP
#define _AFLOW_ANRL_A_mP84_13_21g_CPP
#include "../aflow.h"
...
namespace anrl {
  uint PrototypeANRL_A_mP84_13_21g(ostream &oss,stringstream &web,xstructure& str,string parameters,string proto_line,uint print_mode,bool LDEBUG) {
