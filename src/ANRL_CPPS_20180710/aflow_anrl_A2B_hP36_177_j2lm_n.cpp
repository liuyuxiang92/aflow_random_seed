...
#ifndef _AFLOW_ANRL_A2B_hP36_177_j2lm_n_CPP
#define _AFLOW_ANRL_A2B_hP36_177_j2lm_n_CPP
#include "../aflow.h"
...
namespace anrl {
  uint PrototypeANRL_A2B_hP36_177_j2lm_n(ostream &oss,stringstream &web,xstructure& str,string parameters,string proto_line,uint print_mode,bool LDEBUG) {
