...
#ifndef _AFLOW_ANRL_AB_hP6_191_f_ad_CPP
#define _AFLOW_ANRL_AB_hP6_191_f_ad_CPP
#include "../aflow.h"
...
namespace anrl {
  uint PrototypeANRL_AB_hP6_191_f_ad(ostream &oss,stringstream &web,xstructure& str,string parameters,string proto_line,uint print_mode,bool LDEBUG) {
