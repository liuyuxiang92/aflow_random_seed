...
// FILE "ANRL/aflow_anrl_A12BC4_cP34_195_2j_ab_2e.cpp"

#ifndef _AFLOW_ANRL_A12BC4_cP34_195_2j_ab_2e_CPP // AFLOW_REMOVE_GREP
#define _AFLOW_ANRL_A12BC4_cP34_195_2j_ab_2e_CPP // AFLOW_REMOVE_GREP
#include "../aflow.h" // AFLOW_REMOVE_GREP

namespace anrl {
  uint WebANRL_A12BC4_cP34_195_2j_ab_2e(stringstream &web,bool LDEBUG);
}

namespace anrl {
  uint PrototypeANRL_A12BC4_cP34_195_2j_ab_2e(stringstream &web,xstructure& str,string parameters,string proto_line,uint print_mode,bool LDEBUG) {
    // system A12BC4_cP34_195_2j_ab_2e

    if(XHOST.vflag_control.flag("WWW")) {
      WebANRL_A12BC4_cP34_195_2j_ab_2e(web,LDEBUG); // PLUG WEB STUFF
      #ifdef _ANRL_NOWEB_
      cout << "no web" << endl;
      #else
      cout << web.str() << endl;
    ...
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A12BC4_cP34_195_2j_ab_2e: FOUND" << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A12BC4_cP34_195_2j_ab_2e: label=" << label << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A12BC4_cP34_195_2j_ab_2e: nspecies=" << nspecies << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A12BC4_cP34_195_2j_ab_2e: natoms=" << natoms << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A12BC4_cP34_195_2j_ab_2e: spacegroup=" << spacegroup << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A12BC4_cP34_195_2j_ab_2e: nunderscores=" << nunderscores << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A12BC4_cP34_195_2j_ab_2e: nparameters=" <<  nparameters << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A12BC4_cP34_195_2j_ab_2e: Pearson_symbol=" << Pearson_symbol << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A12BC4_cP34_195_2j_ab_2e: params=" << params << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A12BC4_cP34_195_2j_ab_2e: Strukturbericht=" << Strukturbericht << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A12BC4_cP34_195_2j_ab_2e: prototype=" << prototype << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A12BC4_cP34_195_2j_ab_2e: dialect=" << dialect << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A12BC4_cP34_195_2j_ab_2e: vparameters.size()=" << vparameters.size() << endl;}
    ...
    uint i=0;
    double a=vparameters.at(i++);                  if(LDEBUG) { cerr << "anrl::PrototypeANRL_A12BC4_cP34_195_2j_ab_2e: a=" << a << endl;}
    
    double x3=vparameters.at(i++);                 if(LDEBUG) { cerr << "anrl::PrototypeANRL_A12BC4_cP34_195_2j_ab_2e: x3=" << x3 << endl;}
    double x4=vparameters.at(i++);                 if(LDEBUG) { cerr << "anrl::PrototypeANRL_A12BC4_cP34_195_2j_ab_2e: x4=" << x4 << endl;}
    double x5=vparameters.at(i++);                 if(LDEBUG) { cerr << "anrl::PrototypeANRL_A12BC4_cP34_195_2j_ab_2e: x5=" << x5 << endl;}
    double y5=vparameters.at(i++);                 if(LDEBUG) { cerr << "anrl::PrototypeANRL_A12BC4_cP34_195_2j_ab_2e: y5=" << y5 << endl;}
    double z5=vparameters.at(i++);                 if(LDEBUG) { cerr << "anrl::PrototypeANRL_A12BC4_cP34_195_2j_ab_2e: z5=" << z5 << endl;}
    double x6=vparameters.at(i++);                 if(LDEBUG) { cerr << "anrl::PrototypeANRL_A12BC4_cP34_195_2j_ab_2e: x6=" << x6 << endl;}
    double y6=vparameters.at(i++);                 if(LDEBUG) { cerr << "anrl::PrototypeANRL_A12BC4_cP34_195_2j_ab_2e: y6=" << y6 << endl;}
    double z6=vparameters.at(i++);                 if(LDEBUG) { cerr << "anrl::PrototypeANRL_A12BC4_cP34_195_2j_ab_2e: z6=" << z6 << endl;}
    ...
    atom.fpos(1)=z5;atom.fpos(2)=x5;atom.fpos(3)=y5;                     // atom B15
    atom.fpos_equation.clear();atom.fpos_equation.push_back("z5");atom.fpos_equation.push_back("x5");atom.fpos_equation.push_back("y5");// atom B15 // symbolic math for atom positions
    ...
    atom.fpos(1)=-z5;atom.fpos(2)=-x5;atom.fpos(3)=y5;                     // atom B17
    atom.fpos_equation.clear();atom.fpos_equation.push_back("-z5");atom.fpos_equation.push_back("-x5");atom.fpos_equation.push_back("y5");// atom B17 // symbolic math for atom positions
    str.comp_each_type.at(atom.type)+=1.0;                            // atom B17 // if we need partial occupation
    str.atoms.push_back(atom);                                        // atom B17
    
    atom.name="A"; atom.type=0;                                       // atom B18
    atom.fpos(1)=-z5;atom.fpos(2)=x5;atom.fpos(3)=-y5;                     // atom B18
    atom.fpos_equation.clear();atom.fpos_equation.push_back("-z5");atom.fpos_equation.push_back("x5");atom.fpos_equation.push_back("-y5");// atom B18 // symbolic math for atom positions
    str.comp_each_type.at(atom.type)+=1.0;                            // atom B18 // if we need partial occupation
    str.atoms.push_back(atom);                                        // atom B18
    
    atom.name="A"; atom.type=0;                                       // atom B19
    atom.fpos(1)=y5;atom.fpos(2)=z5;atom.fpos(3)=x5;                     // atom B19
    atom.fpos_equation.clear();atom.fpos_equation.push_back("y5");atom.fpos_equation.push_back("z5");atom.fpos_equation.push_back("x5");// atom B19 // symbolic math for atom positions
    ...
    atom.fpos(1)=y5;atom.fpos(2)=-z5;atom.fpos(3)=-x5;                     // atom B21
    atom.fpos_equation.clear();atom.fpos_equation.push_back("y5");atom.fpos_equation.push_back("-z5");atom.fpos_equation.push_back("-x5");// atom B21 // symbolic math for atom positions
    str.comp_each_type.at(atom.type)+=1.0;                            // atom B21 // if we need partial occupation
    str.atoms.push_back(atom);                                        // atom B21
    
    atom.name="A"; atom.type=0;                                       // atom B22
    atom.fpos(1)=-y5;atom.fpos(2)=-z5;atom.fpos(3)=x5;                     // atom B22
    atom.fpos_equation.clear();atom.fpos_equation.push_back("-y5");atom.fpos_equation.push_back("-z5");atom.fpos_equation.push_back("x5");// atom B22 // symbolic math for atom positions
    ...
    atom.fpos(1)=z6;atom.fpos(2)=x6;atom.fpos(3)=y6;                     // atom B27
    atom.fpos_equation.clear();atom.fpos_equation.push_back("z6");atom.fpos_equation.push_back("x6");atom.fpos_equation.push_back("y6");// atom B27 // symbolic math for atom positions
    ...
    atom.fpos(1)=z6;atom.fpos(2)=-x6;atom.fpos(3)=-y6;                     // atom B28
    atom.fpos_equation.clear();atom.fpos_equation.push_back("z6");atom.fpos_equation.push_back("-x6");atom.fpos_equation.push_back("-y6");// atom B28 // symbolic math for atom positions
    ...
    atom.fpos(1)=-z6;atom.fpos(2)=-x6;atom.fpos(3)=y6;                     // atom B29
    atom.fpos_equation.clear();atom.fpos_equation.push_back("-z6");atom.fpos_equation.push_back("-x6");atom.fpos_equation.push_back("y6");// atom B29 // symbolic math for atom positions
    ...
    atom.fpos(1)=-z6;atom.fpos(2)=x6;atom.fpos(3)=-y6;                     // atom B30
    atom.fpos_equation.clear();atom.fpos_equation.push_back("-z6");atom.fpos_equation.push_back("x6");atom.fpos_equation.push_back("-y6");// atom B30 // symbolic math for atom positions
    ...
    atom.fpos(1)=y6;atom.fpos(2)=z6;atom.fpos(3)=x6;                     // atom B31
    atom.fpos_equation.clear();atom.fpos_equation.push_back("y6");atom.fpos_equation.push_back("z6");atom.fpos_equation.push_back("x6");// atom B31 // symbolic math for atom positions
    ...
    atom.fpos(1)=-y6;atom.fpos(2)=z6;atom.fpos(3)=-x6;                     // atom B32
    atom.fpos_equation.clear();atom.fpos_equation.push_back("-y6");atom.fpos_equation.push_back("z6");atom.fpos_equation.push_back("-x6");// atom B32 // symbolic math for atom positions
    ...
    atom.fpos(1)=-y6;atom.fpos(2)=-z6;atom.fpos(3)=x6;                     // atom B34
    atom.fpos_equation.clear();atom.fpos_equation.push_back("-y6");atom.fpos_equation.push_back("-z6");atom.fpos_equation.push_back("x6");// atom B34 // symbolic math for atom positions
    ...
    atom.fpos(1)=-x4;atom.fpos(2)=-x4;atom.fpos(3)=x4;                     // atom B8
    atom.fpos_equation.clear();atom.fpos_equation.push_back("-x4");atom.fpos_equation.push_back("-x4");atom.fpos_equation.push_back("x4");// atom B8 // symbolic math for atom positions
...
namespace anrl {
  uint WebANRL_A12BC4_cP34_195_2j_ab_2e(stringstream& web,bool LDEBUG) {
    ...
    if(LDEBUG) {cerr << "anrl:: WebANRL_A12BC4_cP34_195_2j_ab_2e: web.str().size()=" << web.str().size() << endl;}
