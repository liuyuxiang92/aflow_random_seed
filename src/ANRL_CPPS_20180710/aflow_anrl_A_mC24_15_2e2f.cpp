...
#ifndef _AFLOW_ANRL_A_mC24_15_2e2f_CPP
#define _AFLOW_ANRL_A_mC24_15_2e2f_CPP
#include "../aflow.h"
...
namespace anrl {
  uint PrototypeANRL_A_mC24_15_2e2f(ostream &oss,stringstream &web,xstructure& str,string parameters,string proto_line,uint print_mode,bool LDEBUG) {
