...
#ifndef _AFLOW_ANRL_A2B_cF24_227_d_a_CPP
#define _AFLOW_ANRL_A2B_cF24_227_d_a_CPP
#include "../aflow.h"
...
namespace anrl {
  uint PrototypeANRL_A2B_cF24_227_d_a(ostream &oss,stringstream &web,xstructure& str,string parameters,string proto_line,uint print_mode,bool LDEBUG) {
