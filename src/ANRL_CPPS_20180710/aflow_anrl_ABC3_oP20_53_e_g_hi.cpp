...
// FILE "ANRL/aflow_anrl_ABC3_oP20_53_e_g_hi.cpp"

#ifndef _AFLOW_ANRL_ABC3_oP20_53_e_g_hi_CPP // AFLOW_REMOVE_GREP
#define _AFLOW_ANRL_ABC3_oP20_53_e_g_hi_CPP // AFLOW_REMOVE_GREP
#include "../aflow.h" // AFLOW_REMOVE_GREP

namespace anrl {
  uint WebANRL_ABC3_oP20_53_e_g_hi(stringstream &web,bool LDEBUG);
}

namespace anrl {
  uint PrototypeANRL_ABC3_oP20_53_e_g_hi(stringstream &web,xstructure& str,string parameters,string proto_line,uint print_mode,bool LDEBUG) {
    // system ABC3_oP20_53_e_g_hi

    if(XHOST.vflag_control.flag("WWW")) {
      WebANRL_ABC3_oP20_53_e_g_hi(web,LDEBUG); // PLUG WEB STUFF
#ifdef _ANRL_NOWEB_
      cout << "no web" << endl;
#else
      cout << web.str() << endl;
    ...
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_ABC3_oP20_53_e_g_hi: FOUND" << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_ABC3_oP20_53_e_g_hi: label=" << label << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_ABC3_oP20_53_e_g_hi: nspecies=" << nspecies << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_ABC3_oP20_53_e_g_hi: natoms=" << natoms << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_ABC3_oP20_53_e_g_hi: spacegroup=" << spacegroup << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_ABC3_oP20_53_e_g_hi: nunderscores=" << nunderscores << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_ABC3_oP20_53_e_g_hi: nparameters=" <<  nparameters << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_ABC3_oP20_53_e_g_hi: Pearson_symbol=" << Pearson_symbol << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_ABC3_oP20_53_e_g_hi: params=" << params << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_ABC3_oP20_53_e_g_hi: Strukturbericht=" << Strukturbericht << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_ABC3_oP20_53_e_g_hi: prototype=" << prototype << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_ABC3_oP20_53_e_g_hi: dialect=" << dialect << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_ABC3_oP20_53_e_g_hi: vparameters.size()=" << vparameters.size() << endl;}
    ...
    uint i=0;
    double a=vparameters.at(i++);                  if(LDEBUG) { cerr << "anrl::PrototypeANRL_ABC3_oP20_53_e_g_hi: a=" << a << endl;}
    double bovera=vparameters.at(i++),b=bovera*a;  if(LDEBUG) { cerr << "anrl::PrototypeANRL_ABC3_oP20_53_e_g_hi: b=" << b << " (b/a=" << bovera << ")" << endl;}
    double covera=vparameters.at(i++),c=covera*a;  if(LDEBUG) { cerr << "anrl::PrototypeANRL_ABC3_oP20_53_e_g_hi: c=" << c << " (c/a=" << covera << ")" << endl;}

    double x1=vparameters.at(i++);                 if(LDEBUG) { cerr << "anrl::PrototypeANRL_ABC3_oP20_53_e_g_hi: x1=" << x1 << endl;}
    double y2=vparameters.at(i++);                 if(LDEBUG) { cerr << "anrl::PrototypeANRL_ABC3_oP20_53_e_g_hi: y2=" << y2 << endl;}
    double y3=vparameters.at(i++);                 if(LDEBUG) { cerr << "anrl::PrototypeANRL_ABC3_oP20_53_e_g_hi: y3=" << y3 << endl;}
    double z3=vparameters.at(i++);                 if(LDEBUG) { cerr << "anrl::PrototypeANRL_ABC3_oP20_53_e_g_hi: z3=" << z3 << endl;}
    double x4=vparameters.at(i++);                 if(LDEBUG) { cerr << "anrl::PrototypeANRL_ABC3_oP20_53_e_g_hi: x4=" << x4 << endl;}
    double y4=vparameters.at(i++);                 if(LDEBUG) { cerr << "anrl::PrototypeANRL_ABC3_oP20_53_e_g_hi: y4=" << y4 << endl;}
    double z4=vparameters.at(i++);                 if(LDEBUG) { cerr << "anrl::PrototypeANRL_ABC3_oP20_53_e_g_hi: z4=" << z4 << endl;}
    ...
    atom.fpos(1)=((1.0/2.0)+x4);atom.fpos(2)=-y4;atom.fpos(3)=((1.0/2.0)+z4);                     // atom B19
    atom.fpos_equation.clear();atom.fpos_equation.push_back("((1.0/2.0)+x4)");atom.fpos_equation.push_back("-y4");atom.fpos_equation.push_back("((1.0/2.0)+z4)");// atom B19 // symbolic math for atom positions
    str.comp_each_type.at(atom.type)+=1.0;                            // atom B19 // if we need partial occupation
    str.atoms.push_back(atom);                                        // atom B19

    atom.name="C"; atom.type=2;                                       // atom B20
    atom.fpos(1)=-x4;atom.fpos(2)=y4;atom.fpos(3)=z4;                     // atom B20
    atom.fpos_equation.clear();atom.fpos_equation.push_back("-x4");atom.fpos_equation.push_back("y4");atom.fpos_equation.push_back("z4");// atom B20 // symbolic math for atom positions
...
namespace anrl {
  uint WebANRL_ABC3_oP20_53_e_g_hi(stringstream& web,bool LDEBUG) {
    ...
    if(LDEBUG) {cerr << "anrl:: WebANRL_ABC3_oP20_53_e_g_hi: web.str().size()=" << web.str().size() << endl;}
