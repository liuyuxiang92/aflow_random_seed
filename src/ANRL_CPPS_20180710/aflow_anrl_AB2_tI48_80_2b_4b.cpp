...
#ifndef _AFLOW_ANRL_AB2_tI48_80_2b_4b_CPP // AFLOW_REMOVE_GREP
#define _AFLOW_ANRL_AB2_tI48_80_2b_4b_CPP // AFLOW_REMOVE_GREP
...
namespace anrl {
  uint PrototypeANRL_AB2_tI48_80_2b_4b(stringstream &web,xstructure& str,string parameters,string proto_line,uint print_mode,bool LDEBUG) {
