...
// FILE "ANRL/aflow_anrl_A2B13C4_hP57_168_d_c6d_2d.cpp"

#ifndef _AFLOW_ANRL_A2B13C4_hP57_168_d_c6d_2d_CPP // AFLOW_REMOVE_GREP
#define _AFLOW_ANRL_A2B13C4_hP57_168_d_c6d_2d_CPP // AFLOW_REMOVE_GREP
#include "../aflow.h" // AFLOW_REMOVE_GREP

namespace anrl {
  uint WebANRL_A2B13C4_hP57_168_d_c6d_2d(stringstream &web,bool LDEBUG);
}

namespace anrl {
  uint PrototypeANRL_A2B13C4_hP57_168_d_c6d_2d(stringstream &web,xstructure& str,string parameters,string proto_line,uint print_mode,bool LDEBUG) {
    // system A2B13C4_hP57_168_d_c6d_2d

    if(XHOST.vflag_control.flag("WWW")) {
      WebANRL_A2B13C4_hP57_168_d_c6d_2d(web,LDEBUG); // PLUG WEB STUFF
#ifdef _ANRL_NOWEB_
      cout << "no web" << endl;
#else
      cout << web.str() << endl;
    ...
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2B13C4_hP57_168_d_c6d_2d: FOUND" << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2B13C4_hP57_168_d_c6d_2d: label=" << label << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2B13C4_hP57_168_d_c6d_2d: nspecies=" << nspecies << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2B13C4_hP57_168_d_c6d_2d: natoms=" << natoms << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2B13C4_hP57_168_d_c6d_2d: spacegroup=" << spacegroup << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2B13C4_hP57_168_d_c6d_2d: nunderscores=" << nunderscores << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2B13C4_hP57_168_d_c6d_2d: nparameters=" <<  nparameters << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2B13C4_hP57_168_d_c6d_2d: Pearson_symbol=" << Pearson_symbol << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2B13C4_hP57_168_d_c6d_2d: params=" << params << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2B13C4_hP57_168_d_c6d_2d: Strukturbericht=" << Strukturbericht << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2B13C4_hP57_168_d_c6d_2d: prototype=" << prototype << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2B13C4_hP57_168_d_c6d_2d: dialect=" << dialect << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2B13C4_hP57_168_d_c6d_2d: vparameters.size()=" << vparameters.size() << endl;}
    ...
    uint i=0;
    double a=vparameters.at(i++);                  if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2B13C4_hP57_168_d_c6d_2d: a=" << a << endl;}
    double covera=vparameters.at(i++),c=covera*a;  if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2B13C4_hP57_168_d_c6d_2d: c=" << c << " (c/a=" << covera << ")" << endl;}

    double z1=vparameters.at(i++);                 if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2B13C4_hP57_168_d_c6d_2d: z1=" << z1 << endl;}
    double x2=vparameters.at(i++);                 if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2B13C4_hP57_168_d_c6d_2d: x2=" << x2 << endl;}
    double y2=vparameters.at(i++);                 if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2B13C4_hP57_168_d_c6d_2d: y2=" << y2 << endl;}
    double z2=vparameters.at(i++);                 if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2B13C4_hP57_168_d_c6d_2d: z2=" << z2 << endl;}
    double x3=vparameters.at(i++);                 if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2B13C4_hP57_168_d_c6d_2d: x3=" << x3 << endl;}
    double y3=vparameters.at(i++);                 if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2B13C4_hP57_168_d_c6d_2d: y3=" << y3 << endl;}
    double z3=vparameters.at(i++);                 if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2B13C4_hP57_168_d_c6d_2d: z3=" << z3 << endl;}
    double x4=vparameters.at(i++);                 if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2B13C4_hP57_168_d_c6d_2d: x4=" << x4 << endl;}
    double y4=vparameters.at(i++);                 if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2B13C4_hP57_168_d_c6d_2d: y4=" << y4 << endl;}
    double z4=vparameters.at(i++);                 if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2B13C4_hP57_168_d_c6d_2d: z4=" << z4 << endl;}
    double x5=vparameters.at(i++);                 if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2B13C4_hP57_168_d_c6d_2d: x5=" << x5 << endl;}
    double y5=vparameters.at(i++);                 if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2B13C4_hP57_168_d_c6d_2d: y5=" << y5 << endl;}
    double z5=vparameters.at(i++);                 if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2B13C4_hP57_168_d_c6d_2d: z5=" << z5 << endl;}
    double x6=vparameters.at(i++);                 if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2B13C4_hP57_168_d_c6d_2d: x6=" << x6 << endl;}
    double y6=vparameters.at(i++);                 if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2B13C4_hP57_168_d_c6d_2d: y6=" << y6 << endl;}
    double z6=vparameters.at(i++);                 if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2B13C4_hP57_168_d_c6d_2d: z6=" << z6 << endl;}
    double x7=vparameters.at(i++);                 if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2B13C4_hP57_168_d_c6d_2d: x7=" << x7 << endl;}
    double y7=vparameters.at(i++);                 if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2B13C4_hP57_168_d_c6d_2d: y7=" << y7 << endl;}
    double z7=vparameters.at(i++);                 if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2B13C4_hP57_168_d_c6d_2d: z7=" << z7 << endl;}
    double x8=vparameters.at(i++);                 if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2B13C4_hP57_168_d_c6d_2d: x8=" << x8 << endl;}
    double y8=vparameters.at(i++);                 if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2B13C4_hP57_168_d_c6d_2d: y8=" << y8 << endl;}
    double z8=vparameters.at(i++);                 if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2B13C4_hP57_168_d_c6d_2d: z8=" << z8 << endl;}
    double x9=vparameters.at(i++);                 if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2B13C4_hP57_168_d_c6d_2d: x9=" << x9 << endl;}
    double y9=vparameters.at(i++);                 if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2B13C4_hP57_168_d_c6d_2d: y9=" << y9 << endl;}
    double z9=vparameters.at(i++);                 if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2B13C4_hP57_168_d_c6d_2d: z9=" << z9 << endl;}
    double x10=vparameters.at(i++);                 if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2B13C4_hP57_168_d_c6d_2d: x10=" << x10 << endl;}
    double y10=vparameters.at(i++);                 if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2B13C4_hP57_168_d_c6d_2d: y10=" << y10 << endl;}
    double z10=vparameters.at(i++);                 if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2B13C4_hP57_168_d_c6d_2d: z10=" << z10 << endl;}
    ...
    atom.fpos(1)=-y2;atom.fpos(2)=(x2-y2);atom.fpos(3)=z2;                     // atom B5
    atom.fpos_equation.clear();atom.fpos_equation.push_back("-y2");atom.fpos_equation.push_back("(x2-y2)");atom.fpos_equation.push_back("z2");// atom B5 // symbolic math for atom positions
    str.comp_each_type.at(atom.type)+=1.0;                            // atom B5 // if we need partial occupation
    str.atoms.push_back(atom);                                        // atom B5

    atom.name="A"; atom.type=0;                                       // atom B6
    atom.fpos(1)=(-x2+y2);atom.fpos(2)=-x2;atom.fpos(3)=z2;                     // atom B6
    atom.fpos_equation.clear();atom.fpos_equation.push_back("(-x2+y2)");atom.fpos_equation.push_back("-x2");atom.fpos_equation.push_back("z2");// atom B6 // symbolic math for atom positions
    ...
    atom.fpos(1)=(1.0/2.0);atom.fpos(2)=0.0;atom.fpos(3)=z1;                     // atom B1
    atom.fpos_equation.clear();atom.fpos_equation.push_back("(1.0/2.0)");atom.fpos_equation.push_back("0.0");atom.fpos_equation.push_back("z1");// atom B1 // symbolic math for atom positions
    str.comp_each_type.at(atom.type)+=1.0;                            // atom B1 // if we need partial occupation
    str.atoms.push_back(atom);                                        // atom B1

    atom.name="B"; atom.type=1;                                       // atom B2
    atom.fpos(1)=0.0;atom.fpos(2)=(1.0/2.0);atom.fpos(3)=z1;                     // atom B2
    atom.fpos_equation.clear();atom.fpos_equation.push_back("0.0");atom.fpos_equation.push_back("(1.0/2.0)");atom.fpos_equation.push_back("z1");// atom B2 // symbolic math for atom positions
    str.comp_each_type.at(atom.type)+=1.0;                            // atom B2 // if we need partial occupation
    str.atoms.push_back(atom);                                        // atom B2

    atom.name="B"; atom.type=1;                                       // atom B3
    atom.fpos(1)=(1.0/2.0);atom.fpos(2)=(1.0/2.0);atom.fpos(3)=z1;                     // atom B3
    atom.fpos_equation.clear();atom.fpos_equation.push_back("(1.0/2.0)");atom.fpos_equation.push_back("(1.0/2.0)");atom.fpos_equation.push_back("z1");// atom B3 // symbolic math for atom positions
    ...
    atom.fpos(1)=-y3;atom.fpos(2)=(x3-y3);atom.fpos(3)=z3;                     // atom B11
    atom.fpos_equation.clear();atom.fpos_equation.push_back("-y3");atom.fpos_equation.push_back("(x3-y3)");atom.fpos_equation.push_back("z3");// atom B11 // symbolic math for atom positions
    str.comp_each_type.at(atom.type)+=1.0;                            // atom B11 // if we need partial occupation
    str.atoms.push_back(atom);                                        // atom B11

    atom.name="B"; atom.type=1;                                       // atom B12
    atom.fpos(1)=(-x3+y3);atom.fpos(2)=-x3;atom.fpos(3)=z3;                     // atom B12
    atom.fpos_equation.clear();atom.fpos_equation.push_back("(-x3+y3)");atom.fpos_equation.push_back("-x3");atom.fpos_equation.push_back("z3");// atom B12 // symbolic math for atom positions
    ...
    atom.fpos(1)=-y4;atom.fpos(2)=(x4-y4);atom.fpos(3)=z4;                     // atom B17
    atom.fpos_equation.clear();atom.fpos_equation.push_back("-y4");atom.fpos_equation.push_back("(x4-y4)");atom.fpos_equation.push_back("z4");// atom B17 // symbolic math for atom positions
    str.comp_each_type.at(atom.type)+=1.0;                            // atom B17 // if we need partial occupation
    str.atoms.push_back(atom);                                        // atom B17

    atom.name="B"; atom.type=1;                                       // atom B18
    atom.fpos(1)=(-x4+y4);atom.fpos(2)=-x4;atom.fpos(3)=z4;                     // atom B18
    atom.fpos_equation.clear();atom.fpos_equation.push_back("(-x4+y4)");atom.fpos_equation.push_back("-x4");atom.fpos_equation.push_back("z4");// atom B18 // symbolic math for atom positions
    ...
    atom.fpos(1)=-y5;atom.fpos(2)=(x5-y5);atom.fpos(3)=z5;                     // atom B23
    atom.fpos_equation.clear();atom.fpos_equation.push_back("-y5");atom.fpos_equation.push_back("(x5-y5)");atom.fpos_equation.push_back("z5");// atom B23 // symbolic math for atom positions
    str.comp_each_type.at(atom.type)+=1.0;                            // atom B23 // if we need partial occupation
    str.atoms.push_back(atom);                                        // atom B23

    atom.name="B"; atom.type=1;                                       // atom B24
    atom.fpos(1)=(-x5+y5);atom.fpos(2)=-x5;atom.fpos(3)=z5;                     // atom B24
    atom.fpos_equation.clear();atom.fpos_equation.push_back("(-x5+y5)");atom.fpos_equation.push_back("-x5");atom.fpos_equation.push_back("z5");// atom B24 // symbolic math for atom positions
    ...
    atom.fpos(1)=-y6;atom.fpos(2)=(x6-y6);atom.fpos(3)=z6;                     // atom B29
    atom.fpos_equation.clear();atom.fpos_equation.push_back("-y6");atom.fpos_equation.push_back("(x6-y6)");atom.fpos_equation.push_back("z6");// atom B29 // symbolic math for atom positions
    ...
    atom.fpos(1)=(-x6+y6);atom.fpos(2)=-x6;atom.fpos(3)=z6;                     // atom B30
    atom.fpos_equation.clear();atom.fpos_equation.push_back("(-x6+y6)");atom.fpos_equation.push_back("-x6");atom.fpos_equation.push_back("z6");// atom B30 // symbolic math for atom positions
    ...
    atom.fpos(1)=-y7;atom.fpos(2)=(x7-y7);atom.fpos(3)=z7;                     // atom B35
    atom.fpos_equation.clear();atom.fpos_equation.push_back("-y7");atom.fpos_equation.push_back("(x7-y7)");atom.fpos_equation.push_back("z7");// atom B35 // symbolic math for atom positions
    ...
    atom.fpos(1)=(-x7+y7);atom.fpos(2)=-x7;atom.fpos(3)=z7;                     // atom B36
    atom.fpos_equation.clear();atom.fpos_equation.push_back("(-x7+y7)");atom.fpos_equation.push_back("-x7");atom.fpos_equation.push_back("z7");// atom B36 // symbolic math for atom positions
    ...
    atom.fpos(1)=-y8;atom.fpos(2)=(x8-y8);atom.fpos(3)=z8;                     // atom B41
    atom.fpos_equation.clear();atom.fpos_equation.push_back("-y8");atom.fpos_equation.push_back("(x8-y8)");atom.fpos_equation.push_back("z8");// atom B41 // symbolic math for atom positions
    ...
    atom.fpos(1)=(-x8+y8);atom.fpos(2)=-x8;atom.fpos(3)=z8;                     // atom B42
    atom.fpos_equation.clear();atom.fpos_equation.push_back("(-x8+y8)");atom.fpos_equation.push_back("-x8");atom.fpos_equation.push_back("z8");// atom B42 // symbolic math for atom positions
    ...
    atom.fpos(1)=x9;atom.fpos(2)=y9;atom.fpos(3)=z9;                     // atom B46
    atom.fpos_equation.clear();atom.fpos_equation.push_back("x9");atom.fpos_equation.push_back("y9");atom.fpos_equation.push_back("z9");// atom B46 // symbolic math for atom positions
    ...
    atom.fpos(1)=-y9;atom.fpos(2)=(x9-y9);atom.fpos(3)=z9;                     // atom B47
    atom.fpos_equation.clear();atom.fpos_equation.push_back("-y9");atom.fpos_equation.push_back("(x9-y9)");atom.fpos_equation.push_back("z9");// atom B47 // symbolic math for atom positions
    ...
    atom.fpos(1)=(-x9+y9);atom.fpos(2)=-x9;atom.fpos(3)=z9;                     // atom B48
    atom.fpos_equation.clear();atom.fpos_equation.push_back("(-x9+y9)");atom.fpos_equation.push_back("-x9");atom.fpos_equation.push_back("z9");// atom B48 // symbolic math for atom positions
    ...
    atom.fpos(1)=x10;atom.fpos(2)=y10;atom.fpos(3)=z10;                     // atom B52
    atom.fpos_equation.clear();atom.fpos_equation.push_back("x10");atom.fpos_equation.push_back("y10");atom.fpos_equation.push_back("z10");// atom B52 // symbolic math for atom positions
    ...
    atom.fpos(1)=-y10;atom.fpos(2)=(x10-y10);atom.fpos(3)=z10;                     // atom B53
    atom.fpos_equation.clear();atom.fpos_equation.push_back("-y10");atom.fpos_equation.push_back("(x10-y10)");atom.fpos_equation.push_back("z10");// atom B53 // symbolic math for atom positions
    ...
    atom.fpos(1)=(-x10+y10);atom.fpos(2)=-x10;atom.fpos(3)=z10;                     // atom B54
    atom.fpos_equation.clear();atom.fpos_equation.push_back("(-x10+y10)");atom.fpos_equation.push_back("-x10");atom.fpos_equation.push_back("z10");// atom B54 // symbolic math for atom positions
...
namespace anrl {
  uint WebANRL_A2B13C4_hP57_168_d_c6d_2d(stringstream& web,bool LDEBUG) {
    ...
    if(LDEBUG) {cerr << "anrl:: WebANRL_A2B13C4_hP57_168_d_c6d_2d: web.str().size()=" << web.str().size() << endl;}
