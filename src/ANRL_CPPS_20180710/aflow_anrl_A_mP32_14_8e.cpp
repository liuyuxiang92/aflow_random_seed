...
#ifndef _AFLOW_ANRL_A_mP32_14_8e_CPP
#define _AFLOW_ANRL_A_mP32_14_8e_CPP
#include "../aflow.h"
...
namespace anrl {
  uint PrototypeANRL_A_mP32_14_8e(ostream &oss,stringstream &web,xstructure& str,string parameters,string proto_line,uint print_mode,bool LDEBUG) {
    // system A_mP32_14_8e
