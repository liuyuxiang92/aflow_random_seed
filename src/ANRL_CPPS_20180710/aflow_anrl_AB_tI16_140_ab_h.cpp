...
#ifndef _AFLOW_ANRL_AB_tI16_140_ab_h_CPP
#define _AFLOW_ANRL_AB_tI16_140_ab_h_CPP
#include "../aflow.h"
...
namespace anrl {
  uint PrototypeANRL_AB_tI16_140_ab_h(ostream &oss,stringstream &web,xstructure& str,string parameters,string proto_line,uint print_mode,bool LDEBUG) {
