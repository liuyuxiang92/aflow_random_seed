...
#ifndef _AFLOW_ANRL_A6B2C_cF36_225_e_c_a_CPP
#define _AFLOW_ANRL_A6B2C_cF36_225_e_c_a_CPP
#include "../aflow.h"
...
namespace anrl {
  uint PrototypeANRL_A6B2C_cF36_225_e_c_a(ostream &oss,stringstream &web,xstructure& str,string parameters,string proto_line,uint print_mode,bool LDEBUG) {
