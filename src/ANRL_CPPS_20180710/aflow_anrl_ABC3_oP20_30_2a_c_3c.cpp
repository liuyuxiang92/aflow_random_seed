...
#ifndef _AFLOW_ANRL_ABC3_oP20_30_2a_c_3c_CPP
#define _AFLOW_ANRL_ABC3_oP20_30_2a_c_3c_CPP
#include "../aflow.h"
...
namespace anrl {
  uint PrototypeANRL_ABC3_oP20_30_2a_c_3c(ostream &oss,stringstream &web,xstructure& str,string parameters,string proto_line,uint print_mode,bool LDEBUG) {
