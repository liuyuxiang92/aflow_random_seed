...
// FILE "ANRL/aflow_anrl_A3B_cI8_229_b_a.cpp"

#ifndef _AFLOW_ANRL_A3B_cI8_229_b_a_CPP // AFLOW_REMOVE_GREP
#define _AFLOW_ANRL_A3B_cI8_229_b_a_CPP // AFLOW_REMOVE_GREP
#include "../aflow.h" // AFLOW_REMOVE_GREP

namespace anrl {
  uint WebANRL_A3B_cI8_229_b_a(stringstream &web,bool LDEBUG);
}

namespace anrl {
  uint PrototypeANRL_A3B_cI8_229_b_a(stringstream &web,xstructure& str,string parameters,string proto_line,uint print_mode,bool LDEBUG) {
    // system A3B_cI8_229_b_a

    if(XHOST.vflag_control.flag("WWW")) {
      WebANRL_A3B_cI8_229_b_a(web,LDEBUG); // PLUG WEB STUFF
      #ifdef _ANRL_NOWEB_
      cout << "no web" << endl;
      #else
      cout << web.str() << endl;
    ...
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A3B_cI8_229_b_a: FOUND" << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A3B_cI8_229_b_a: label=" << label << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A3B_cI8_229_b_a: nspecies=" << nspecies << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A3B_cI8_229_b_a: natoms=" << natoms << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A3B_cI8_229_b_a: spacegroup=" << spacegroup << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A3B_cI8_229_b_a: nunderscores=" << nunderscores << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A3B_cI8_229_b_a: nparameters=" <<  nparameters << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A3B_cI8_229_b_a: Pearson_symbol=" << Pearson_symbol << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A3B_cI8_229_b_a: params=" << params << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A3B_cI8_229_b_a: Strukturbericht=" << Strukturbericht << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A3B_cI8_229_b_a: prototype=" << prototype << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A3B_cI8_229_b_a: dialect=" << dialect << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A3B_cI8_229_b_a: vparameters.size()=" << vparameters.size() << endl;}
    ...
    uint i=0;
    double a=vparameters.at(i++);                  if(LDEBUG) { cerr << "anrl::PrototypeANRL_A3B_cI8_229_b_a: a=" << a << endl;}
...
namespace anrl {
  uint WebANRL_A3B_cI8_229_b_a(stringstream& web,bool LDEBUG) {
    ...
    if(LDEBUG) {cerr << "anrl:: WebANRL_A3B_cI8_229_b_a: web.str().size()=" << web.str().size() << endl;}
