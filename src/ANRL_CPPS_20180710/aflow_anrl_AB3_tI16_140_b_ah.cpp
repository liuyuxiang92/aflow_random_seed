...
#ifndef _AFLOW_ANRL_AB3_tI16_140_b_ah_CPP
#define _AFLOW_ANRL_AB3_tI16_140_b_ah_CPP
#include "../aflow.h"
...
namespace anrl {
  uint PrototypeANRL_AB3_tI16_140_b_ah(ostream &oss,stringstream &web,xstructure& str,string parameters,string proto_line,uint print_mode,bool LDEBUG) {
