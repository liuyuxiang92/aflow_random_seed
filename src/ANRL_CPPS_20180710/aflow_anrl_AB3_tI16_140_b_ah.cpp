...
// FILE "ANRL/aflow_anrl_AB3_tI16_140_b_ah.cpp"

#ifndef _AFLOW_ANRL_AB3_tI16_140_b_ah_CPP // AFLOW_REMOVE_GREP
#define _AFLOW_ANRL_AB3_tI16_140_b_ah_CPP // AFLOW_REMOVE_GREP
#include "../aflow.h" // AFLOW_REMOVE_GREP

namespace anrl {
  uint WebANRL_AB3_tI16_140_b_ah(stringstream &web,bool LDEBUG);
}

namespace anrl {
  uint PrototypeANRL_AB3_tI16_140_b_ah(stringstream &web,xstructure& str,string parameters,string proto_line,uint print_mode,bool LDEBUG) {
    // system AB3_tI16_140_b_ah

    if(XHOST.vflag_control.flag("WWW")) {
      WebANRL_AB3_tI16_140_b_ah(web,LDEBUG); // PLUG WEB STUFF
#ifdef _ANRL_NOWEB_
      web << "no web";
      cout << web.str() << endl;
#else
    ...
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB3_tI16_140_b_ah: FOUND" << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB3_tI16_140_b_ah: label=" << label << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB3_tI16_140_b_ah: nspecies=" << nspecies << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB3_tI16_140_b_ah: natoms=" << natoms << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB3_tI16_140_b_ah: spacegroup=" << spacegroup << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB3_tI16_140_b_ah: nunderscores=" << nunderscores << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB3_tI16_140_b_ah: nparameters=" <<  nparameters << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB3_tI16_140_b_ah: Pearson_symbol=" << Pearson_symbol << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB3_tI16_140_b_ah: params=" << params << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB3_tI16_140_b_ah: Strukturbericht=" << Strukturbericht << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB3_tI16_140_b_ah: prototype=" << prototype << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB3_tI16_140_b_ah: dialect=" << dialect << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB3_tI16_140_b_ah: vparameters.size()=" << vparameters.size() << endl;}
    ...
    uint i=0;
    double a=vparameters.at(i++);                  if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB3_tI16_140_b_ah: a=" << a << endl;}
    double covera=vparameters.at(i++),c=covera*a;  if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB3_tI16_140_b_ah: c=" << c << " (c/a=" << covera << ")" << endl;}

    double x3=vparameters.at(i++);                 if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB3_tI16_140_b_ah: x3=" << x3 << endl;}
...
namespace anrl {
  uint WebANRL_AB3_tI16_140_b_ah(stringstream& web,bool LDEBUG) {
    ...
    if(LDEBUG) {cerr << "anrl:: WebANRL_AB3_tI16_140_b_ah: web.str().size()=" << web.str().size() << endl;}
