...
// FILE "ANRL/aflow_anrl_AB3C4_cP8_221_a_c_bd.cpp"

#ifndef _AFLOW_ANRL_AB3C4_cP8_221_a_c_bd_CPP // AFLOW_REMOVE_GREP
#define _AFLOW_ANRL_AB3C4_cP8_221_a_c_bd_CPP // AFLOW_REMOVE_GREP
#include "../aflow.h" // AFLOW_REMOVE_GREP

namespace anrl {
  uint WebANRL_AB3C4_cP8_221_a_c_bd(stringstream &web,bool LDEBUG);
}

namespace anrl {
  uint PrototypeANRL_AB3C4_cP8_221_a_c_bd(stringstream &web,xstructure& str,string parameters,string proto_line,uint print_mode,bool LDEBUG) {
    // system AB3C4_cP8_221_a_c_bd

    if(XHOST.vflag_control.flag("WWW")) {
      WebANRL_AB3C4_cP8_221_a_c_bd(web,LDEBUG); // PLUG WEB STUFF
#ifdef _ANRL_NOWEB_
      cout << "no web" << endl;
#else
      cout << web.str() << endl;
    ...
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB3C4_cP8_221_a_c_bd: FOUND" << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB3C4_cP8_221_a_c_bd: label=" << label << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB3C4_cP8_221_a_c_bd: nspecies=" << nspecies << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB3C4_cP8_221_a_c_bd: natoms=" << natoms << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB3C4_cP8_221_a_c_bd: spacegroup=" << spacegroup << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB3C4_cP8_221_a_c_bd: nunderscores=" << nunderscores << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB3C4_cP8_221_a_c_bd: nparameters=" <<  nparameters << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB3C4_cP8_221_a_c_bd: Pearson_symbol=" << Pearson_symbol << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB3C4_cP8_221_a_c_bd: params=" << params << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB3C4_cP8_221_a_c_bd: Strukturbericht=" << Strukturbericht << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB3C4_cP8_221_a_c_bd: prototype=" << prototype << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB3C4_cP8_221_a_c_bd: dialect=" << dialect << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB3C4_cP8_221_a_c_bd: vparameters.size()=" << vparameters.size() << endl;}
    ...
    uint i=0;
    double a=vparameters.at(i++);                  if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB3C4_cP8_221_a_c_bd: a=" << a << endl;}
...
namespace anrl {
  uint WebANRL_AB3C4_cP8_221_a_c_bd(stringstream& web,bool LDEBUG) {
    ...
    if(LDEBUG) {cerr << "anrl:: WebANRL_AB3C4_cP8_221_a_c_bd: web.str().size()=" << web.str().size() << endl;}
