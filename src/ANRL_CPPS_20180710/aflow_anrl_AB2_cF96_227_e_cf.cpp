...
#ifndef _AFLOW_ANRL_AB2_cF96_227_e_cf_CPP
#define _AFLOW_ANRL_AB2_cF96_227_e_cf_CPP
#include "../aflow.h"
...
namespace anrl {
  uint PrototypeANRL_AB2_cF96_227_e_cf(ostream &oss,stringstream &web,xstructure& str,string parameters,string proto_line,uint print_mode,bool LDEBUG) {
