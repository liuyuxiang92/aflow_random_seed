...
#ifndef _AFLOW_ANRL_AB3C3_cF112_227_c_de_f_CPP
#define _AFLOW_ANRL_AB3C3_cF112_227_c_de_f_CPP
#include "../aflow.h"
...
namespace anrl {
  uint PrototypeANRL_AB3C3_cF112_227_c_de_f(ostream &oss,stringstream &web,xstructure& str,string parameters,string proto_line,uint print_mode,bool LDEBUG) {
