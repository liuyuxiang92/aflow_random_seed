...
#ifndef _AFLOW_ANRL_AB3C2_cI96_206_c_e_ad_CPP
#define _AFLOW_ANRL_AB3C2_cI96_206_c_e_ad_CPP
#include "../aflow.h"
...
namespace anrl {
  uint PrototypeANRL_AB3C2_cI96_206_c_e_ad(ostream &oss,stringstream &web,xstructure& str,string parameters,string proto_line,uint print_mode,bool LDEBUG) {
