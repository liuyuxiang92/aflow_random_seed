...
#ifndef _AFLOW_ANRL_A3B_oP32_60_3d_d_CPP
#define _AFLOW_ANRL_A3B_oP32_60_3d_d_CPP
#include "../aflow.h"
...
namespace anrl {
  uint PrototypeANRL_A3B_oP32_60_3d_d(ostream &oss,stringstream &web,xstructure& str,string parameters,string proto_line,uint print_mode,bool LDEBUG) {
