...
#ifndef _AFLOW_ANRL_A2B2C_oC80_64_efg_efg_df_CPP
#define _AFLOW_ANRL_A2B2C_oC80_64_efg_efg_df_CPP
#include "../aflow.h"
...
namespace anrl {
  uint PrototypeANRL_A2B2C_oC80_64_efg_efg_df(ostream &oss,stringstream &web,xstructure& str,string parameters,string proto_line,uint print_mode,bool LDEBUG) {
