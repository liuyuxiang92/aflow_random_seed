...
#ifndef _AFLOW_ANRL_AB_hR10_160_5a_5a_CPP
#define _AFLOW_ANRL_AB_hR10_160_5a_5a_CPP
#include "../aflow.h"
...
namespace anrl {
  uint PrototypeANRL_AB_hR10_160_5a_5a(ostream &oss,stringstream &web,xstructure& str,string parameters,string proto_line,uint print_mode,bool LDEBUG) {
