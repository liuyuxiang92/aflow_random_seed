...
#ifndef _AFLOW_ANRL_A3B_hP24_151_3c_2a_CPP
#define _AFLOW_ANRL_A3B_hP24_151_3c_2a_CPP
#include "../aflow.h"
...
namespace anrl {
  uint PrototypeANRL_A3B_hP24_151_3c_2a(ostream &oss,stringstream &web,xstructure& str,string parameters,string proto_line,uint print_mode,bool LDEBUG) {
