...
#ifndef _AFLOW_ANRL_A_cP240_205_10d_CPP
#define _AFLOW_ANRL_A_cP240_205_10d_CPP
#include "../aflow.h"
...
namespace anrl {
  uint PrototypeANRL_A_cP240_205_10d(ostream &oss,stringstream &web,xstructure& str,string parameters,string proto_line,uint print_mode,bool LDEBUG) {
