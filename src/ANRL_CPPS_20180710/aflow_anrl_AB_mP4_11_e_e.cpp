...
#ifndef _AFLOW_ANRL_AB_mP4_11_e_e_CPP // AFLOW_REMOVE_GREP
#define _AFLOW_ANRL_AB_mP4_11_e_e_CPP // AFLOW_REMOVE_GREP
...
namespace anrl {
  uint PrototypeANRL_AB_mP4_11_e_e(stringstream &web,xstructure& str,string parameters,string proto_line,uint print_mode,bool LDEBUG) {
