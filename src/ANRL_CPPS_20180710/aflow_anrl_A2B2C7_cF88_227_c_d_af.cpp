...
#ifndef _AFLOW_ANRL_A2B2C7_cF88_227_c_d_af_CPP
#define _AFLOW_ANRL_A2B2C7_cF88_227_c_d_af_CPP
#include "../aflow.h"
...
namespace anrl {
  uint PrototypeANRL_A2B2C7_cF88_227_c_d_af(ostream &oss,stringstream &web,xstructure& str,string parameters,string proto_line,uint print_mode,bool LDEBUG) {
