...
#ifndef _AFLOW_ANRL_AB2_oC24_41_2a_2b_CPP
#define _AFLOW_ANRL_AB2_oC24_41_2a_2b_CPP
#include "../aflow.h"
...
namespace anrl {
  uint PrototypeANRL_AB2_oC24_41_2a_2b(ostream &oss,stringstream &web,xstructure& str,string parameters,string proto_line,uint print_mode,bool LDEBUG) {
