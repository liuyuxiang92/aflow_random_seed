...
// FILE "ANRL/aflow_anrl_A4B_cI10_229_c_a.cpp"

#ifndef _AFLOW_ANRL_A4B_cI10_229_c_a_CPP // AFLOW_REMOVE_GREP
#define _AFLOW_ANRL_A4B_cI10_229_c_a_CPP // AFLOW_REMOVE_GREP
#include "../aflow.h" // AFLOW_REMOVE_GREP

namespace anrl {
  uint WebANRL_A4B_cI10_229_c_a(stringstream &web,bool LDEBUG);
}

namespace anrl {
  uint PrototypeANRL_A4B_cI10_229_c_a(stringstream &web,xstructure& str,string parameters,string proto_line,uint print_mode,bool LDEBUG) {
    // system A4B_cI10_229_c_a

    if(XHOST.vflag_control.flag("WWW")) {
      WebANRL_A4B_cI10_229_c_a(web,LDEBUG); // PLUG WEB STUFF
      #ifdef _ANRL_NOWEB_
      cout << "no web" << endl;
      #else
      cout << web.str() << endl;
    ...
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A4B_cI10_229_c_a: FOUND" << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A4B_cI10_229_c_a: label=" << label << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A4B_cI10_229_c_a: nspecies=" << nspecies << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A4B_cI10_229_c_a: natoms=" << natoms << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A4B_cI10_229_c_a: spacegroup=" << spacegroup << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A4B_cI10_229_c_a: nunderscores=" << nunderscores << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A4B_cI10_229_c_a: nparameters=" <<  nparameters << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A4B_cI10_229_c_a: Pearson_symbol=" << Pearson_symbol << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A4B_cI10_229_c_a: params=" << params << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A4B_cI10_229_c_a: Strukturbericht=" << Strukturbericht << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A4B_cI10_229_c_a: prototype=" << prototype << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A4B_cI10_229_c_a: dialect=" << dialect << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A4B_cI10_229_c_a: vparameters.size()=" << vparameters.size() << endl;}
    ...
    uint i=0;
    double a=vparameters.at(i++);                  if(LDEBUG) { cerr << "anrl::PrototypeANRL_A4B_cI10_229_c_a: a=" << a << endl;}
...
namespace anrl {
  uint WebANRL_A4B_cI10_229_c_a(stringstream& web,bool LDEBUG) {
    ...
    if(LDEBUG) {cerr << "anrl:: WebANRL_A4B_cI10_229_c_a: web.str().size()=" << web.str().size() << endl;}
