...
#ifndef _AFLOW_ANRL_A4B_cI10_229_c_a_CPP
#define _AFLOW_ANRL_A4B_cI10_229_c_a_CPP
#include "../aflow.h"
...
namespace anrl {
  uint PrototypeANRL_A4B_cI10_229_c_a(ostream &oss,stringstream &web,xstructure& str,string parameters,string proto_line,uint print_mode,bool LDEBUG) {
