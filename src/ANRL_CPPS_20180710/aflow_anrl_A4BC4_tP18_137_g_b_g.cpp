...
#ifndef _AFLOW_ANRL_A4BC4_tP18_137_g_b_g_CPP
#define _AFLOW_ANRL_A4BC4_tP18_137_g_b_g_CPP
#include "../aflow.h"
...
namespace anrl {
  uint PrototypeANRL_A4BC4_tP18_137_g_b_g(ostream &oss,stringstream &web,xstructure& str,string parameters,string proto_line,uint print_mode,bool LDEBUG) {
