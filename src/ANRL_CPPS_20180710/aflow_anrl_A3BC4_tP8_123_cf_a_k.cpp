...
#ifndef _AFLOW_ANRL_A3BC4_tP8_123_cf_a_k_CPP
#define _AFLOW_ANRL_A3BC4_tP8_123_cf_a_k_CPP
#include "../aflow.h"
...
namespace anrl {
  uint PrototypeANRL_A3BC4_tP8_123_cf_a_k(ostream &oss,stringstream &web,xstructure& str,string parameters,string proto_line,uint print_mode,bool LDEBUG) {
