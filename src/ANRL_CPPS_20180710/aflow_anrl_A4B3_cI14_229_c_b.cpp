...
// FILE "ANRL/aflow_anrl_A4B3_cI14_229_c_b.cpp"

#ifndef _AFLOW_ANRL_A4B3_cI14_229_c_b_CPP // AFLOW_REMOVE_GREP
#define _AFLOW_ANRL_A4B3_cI14_229_c_b_CPP // AFLOW_REMOVE_GREP
#include "../aflow.h" // AFLOW_REMOVE_GREP

namespace anrl {
  uint WebANRL_A4B3_cI14_229_c_b(stringstream &web,bool LDEBUG);
}

namespace anrl {
  uint PrototypeANRL_A4B3_cI14_229_c_b(stringstream &web,xstructure& str,string parameters,string proto_line,uint print_mode,bool LDEBUG) {
    // system A4B3_cI14_229_c_b

    if(XHOST.vflag_control.flag("WWW")) {
      WebANRL_A4B3_cI14_229_c_b(web,LDEBUG); // PLUG WEB STUFF
#ifdef _ANRL_NOWEB_
      cout << "no web" << endl;
#else
      cout << web.str() << endl;
    ...
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A4B3_cI14_229_c_b: FOUND" << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A4B3_cI14_229_c_b: label=" << label << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A4B3_cI14_229_c_b: nspecies=" << nspecies << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A4B3_cI14_229_c_b: natoms=" << natoms << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A4B3_cI14_229_c_b: spacegroup=" << spacegroup << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A4B3_cI14_229_c_b: nunderscores=" << nunderscores << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A4B3_cI14_229_c_b: nparameters=" <<  nparameters << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A4B3_cI14_229_c_b: Pearson_symbol=" << Pearson_symbol << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A4B3_cI14_229_c_b: params=" << params << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A4B3_cI14_229_c_b: Strukturbericht=" << Strukturbericht << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A4B3_cI14_229_c_b: prototype=" << prototype << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A4B3_cI14_229_c_b: dialect=" << dialect << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A4B3_cI14_229_c_b: vparameters.size()=" << vparameters.size() << endl;}
    ...
    uint i=0;
    double a=vparameters.at(i++);                  if(LDEBUG) { cerr << "anrl::PrototypeANRL_A4B3_cI14_229_c_b: a=" << a << endl;}
    ...
    atom.fpos(1)=0.0;atom.fpos(2)=0.0;atom.fpos(3)=(1.0/2.0);                     // atom B5
    atom.fpos_equation.clear();atom.fpos_equation.push_back("0.0");atom.fpos_equation.push_back("0.0");atom.fpos_equation.push_back("(1.0/2.0)");// atom B5 // symbolic math for atom positions
...
namespace anrl {
  uint WebANRL_A4B3_cI14_229_c_b(stringstream& web,bool LDEBUG) {
    ...
    if(LDEBUG) {cerr << "anrl:: WebANRL_A4B3_cI14_229_c_b: web.str().size()=" << web.str().size() << endl;}
