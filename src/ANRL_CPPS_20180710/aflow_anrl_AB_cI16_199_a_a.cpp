...
// FILE "ANRL/aflow_anrl_AB_cI16_199_a_a.cpp"

#ifndef _AFLOW_ANRL_AB_cI16_199_a_a_CPP // AFLOW_REMOVE_GREP
#define _AFLOW_ANRL_AB_cI16_199_a_a_CPP // AFLOW_REMOVE_GREP
#include "../aflow.h" // AFLOW_REMOVE_GREP

namespace anrl {
  uint WebANRL_AB_cI16_199_a_a(stringstream &web,bool LDEBUG);
}

namespace anrl {
  uint PrototypeANRL_AB_cI16_199_a_a(stringstream &web,xstructure& str,string parameters,string proto_line,uint print_mode,bool LDEBUG) {
    // system AB_cI16_199_a_a

    if(XHOST.vflag_control.flag("WWW")) {
      WebANRL_AB_cI16_199_a_a(web,LDEBUG); // PLUG WEB STUFF
#ifdef _ANRL_NOWEB_
      cout << "no web" << endl;
#else
      cout << web.str() << endl;
    ...
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB_cI16_199_a_a: FOUND" << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB_cI16_199_a_a: label=" << label << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB_cI16_199_a_a: nspecies=" << nspecies << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB_cI16_199_a_a: natoms=" << natoms << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB_cI16_199_a_a: spacegroup=" << spacegroup << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB_cI16_199_a_a: nunderscores=" << nunderscores << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB_cI16_199_a_a: nparameters=" <<  nparameters << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB_cI16_199_a_a: Pearson_symbol=" << Pearson_symbol << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB_cI16_199_a_a: params=" << params << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB_cI16_199_a_a: Strukturbericht=" << Strukturbericht << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB_cI16_199_a_a: prototype=" << prototype << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB_cI16_199_a_a: dialect=" << dialect << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB_cI16_199_a_a: vparameters.size()=" << vparameters.size() << endl;}
    ...
    uint i=0;
    double a=vparameters.at(i++);                  if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB_cI16_199_a_a: a=" << a << endl;}

    double x1=vparameters.at(i++);                 if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB_cI16_199_a_a: x1=" << x1 << endl;}
    double x2=vparameters.at(i++);                 if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB_cI16_199_a_a: x2=" << x2 << endl;}
...
namespace anrl {
  uint WebANRL_AB_cI16_199_a_a(stringstream& web,bool LDEBUG) {
    ...
    if(LDEBUG) {cerr << "anrl:: WebANRL_AB_cI16_199_a_a: web.str().size()=" << web.str().size() << endl;}
