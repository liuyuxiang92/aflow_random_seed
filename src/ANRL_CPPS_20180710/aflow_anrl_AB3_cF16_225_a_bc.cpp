...
#ifndef _AFLOW_ANRL_AB3_cF16_225_a_bc_CPP
#define _AFLOW_ANRL_AB3_cF16_225_a_bc_CPP
#include "../aflow.h"
...
namespace anrl {
  uint PrototypeANRL_AB3_cF16_225_a_bc(ostream &oss,stringstream &web,xstructure& str,string parameters,string proto_line,uint print_mode,bool LDEBUG) {
