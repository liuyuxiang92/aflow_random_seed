...
#ifndef _AFLOW_ANRL_A3B_mP16_7_6a_2a_CPP
#define _AFLOW_ANRL_A3B_mP16_7_6a_2a_CPP
#include "../aflow.h"
...
namespace anrl {
  uint PrototypeANRL_A3B_mP16_7_6a_2a(ostream &oss,stringstream &web,xstructure& str,string parameters,string proto_line,uint print_mode,bool LDEBUG) {
