...
// FILE "ANRL/aflow_anrl_AB32C48_cI162_204_a_2efg_2gh.cpp"

#ifndef _AFLOW_ANRL_AB32C48_cI162_204_a_2efg_2gh_CPP // AFLOW_REMOVE_GREP
#define _AFLOW_ANRL_AB32C48_cI162_204_a_2efg_2gh_CPP // AFLOW_REMOVE_GREP
...
namespace anrl {
  uint PrototypeANRL_AB32C48_cI162_204_a_2efg_2gh(stringstream &web,xstructure& str,string parameters,string proto_line,uint print_mode,bool LDEBUG) {
    ...
    atom.fpos_equation.clear();atom.fpos_equation.push_back("(1.0/2.0)");atom.fpos_equation.push_back("((1.0/2.0)+x2)");atom.fpos_equation.push_back("x2");// atom B2 // symbolic math for atom positions
    str.comp_each_type.at(atom.type)+=1.0;                            // atom B2 // if we need partial occupation
    str.atoms.push_back(atom);                                        // atom B2

    atom.name="B"; atom.type=1;                                       // atom B3
    atom.fpos(1)=(1.0/2.0);atom.fpos(2)=((1.0/2.0)-x2);atom.fpos(3)=-x2;                     // atom B3
    atom.fpos_equation.clear();atom.fpos_equation.push_back("(1.0/2.0)");atom.fpos_equation.push_back("((1.0/2.0)-x2)");atom.fpos_equation.push_back("-x2");// atom B3 // symbolic math for atom positions
    str.comp_each_type.at(atom.type)+=1.0;                            // atom B3 // if we need partial occupation
    str.atoms.push_back(atom);                                        // atom B3

    atom.name="B"; atom.type=1;                                       // atom B4
    atom.fpos(1)=x2;atom.fpos(2)=(1.0/2.0);atom.fpos(3)=((1.0/2.0)+x2);                     // atom B4
    atom.fpos_equation.clear();atom.fpos_equation.push_back("x2");atom.fpos_equation.push_back("(1.0/2.0)");atom.fpos_equation.push_back("((1.0/2.0)+x2)");// atom B4 // symbolic math for atom positions
    str.comp_each_type.at(atom.type)+=1.0;                            // atom B4 // if we need partial occupation
    str.atoms.push_back(atom);                                        // atom B4

    atom.name="B"; atom.type=1;                                       // atom B5
    atom.fpos(1)=-x2;atom.fpos(2)=(1.0/2.0);atom.fpos(3)=((1.0/2.0)-x2);                     // atom B5
    atom.fpos_equation.clear();atom.fpos_equation.push_back("-x2");atom.fpos_equation.push_back("(1.0/2.0)");atom.fpos_equation.push_back("((1.0/2.0)-x2)");// atom B5 // symbolic math for atom positions
    str.comp_each_type.at(atom.type)+=1.0;                            // atom B5 // if we need partial occupation
    str.atoms.push_back(atom);                                        // atom B5

    atom.name="B"; atom.type=1;                                       // atom B6
    atom.fpos(1)=((1.0/2.0)+x2);atom.fpos(2)=x2;atom.fpos(3)=(1.0/2.0);                     // atom B6
    atom.fpos_equation.clear();atom.fpos_equation.push_back("((1.0/2.0)+x2)");atom.fpos_equation.push_back("x2");atom.fpos_equation.push_back("(1.0/2.0)");// atom B6 // symbolic math for atom positions
    str.comp_each_type.at(atom.type)+=1.0;                            // atom B6 // if we need partial occupation
    str.atoms.push_back(atom);                                        // atom B6

    atom.name="B"; atom.type=1;                                       // atom B7
    atom.fpos(1)=((1.0/2.0)-x2);atom.fpos(2)=-x2;atom.fpos(3)=(1.0/2.0);                     // atom B7
    atom.fpos_equation.clear();atom.fpos_equation.push_back("((1.0/2.0)-x2)");atom.fpos_equation.push_back("-x2");atom.fpos_equation.push_back("(1.0/2.0)");// atom B7 // symbolic math for atom positions
    str.comp_each_type.at(atom.type)+=1.0;                            // atom B7 // if we need partial occupation
    str.atoms.push_back(atom);                                        // atom B7

    atom.name="B"; atom.type=1;                                       // atom B8
    atom.fpos(1)=(1.0/2.0);atom.fpos(2)=((1.0/2.0)+x3);atom.fpos(3)=x3;                     // atom B8
    atom.fpos_equation.clear();atom.fpos_equation.push_back("(1.0/2.0)");atom.fpos_equation.push_back("((1.0/2.0)+x3)");atom.fpos_equation.push_back("x3");// atom B8 // symbolic math for atom positions
    str.comp_each_type.at(atom.type)+=1.0;                            // atom B8 // if we need partial occupation
    str.atoms.push_back(atom);                                        // atom B8

    atom.name="B"; atom.type=1;                                       // atom B9
    atom.fpos(1)=(1.0/2.0);atom.fpos(2)=((1.0/2.0)-x3);atom.fpos(3)=-x3;                     // atom B9
    atom.fpos_equation.clear();atom.fpos_equation.push_back("(1.0/2.0)");atom.fpos_equation.push_back("((1.0/2.0)-x3)");atom.fpos_equation.push_back("-x3");// atom B9 // symbolic math for atom positions
    str.comp_each_type.at(atom.type)+=1.0;                            // atom B9 // if we need partial occupation
    str.atoms.push_back(atom);                                        // atom B9

    atom.name="B"; atom.type=1;                                       // atom B10
    atom.fpos(1)=x3;atom.fpos(2)=(1.0/2.0);atom.fpos(3)=((1.0/2.0)+x3);                     // atom B10
    atom.fpos_equation.clear();atom.fpos_equation.push_back("x3");atom.fpos_equation.push_back("(1.0/2.0)");atom.fpos_equation.push_back("((1.0/2.0)+x3)");// atom B10 // symbolic math for atom positions
    str.comp_each_type.at(atom.type)+=1.0;                            // atom B10 // if we need partial occupation
    str.atoms.push_back(atom);                                        // atom B10

    atom.name="B"; atom.type=1;                                       // atom B11
    atom.fpos(1)=-x3;atom.fpos(2)=(1.0/2.0);atom.fpos(3)=((1.0/2.0)-x3);                     // atom B11
    atom.fpos_equation.clear();atom.fpos_equation.push_back("-x3");atom.fpos_equation.push_back("(1.0/2.0)");atom.fpos_equation.push_back("((1.0/2.0)-x3)");// atom B11 // symbolic math for atom positions
    str.comp_each_type.at(atom.type)+=1.0;                            // atom B11 // if we need partial occupation
    str.atoms.push_back(atom);                                        // atom B11

    atom.name="B"; atom.type=1;                                       // atom B12
    atom.fpos(1)=((1.0/2.0)+x3);atom.fpos(2)=x3;atom.fpos(3)=(1.0/2.0);                     // atom B12
    atom.fpos_equation.clear();atom.fpos_equation.push_back("((1.0/2.0)+x3)");atom.fpos_equation.push_back("x3");atom.fpos_equation.push_back("(1.0/2.0)");// atom B12 // symbolic math for atom positions
    str.comp_each_type.at(atom.type)+=1.0;                            // atom B12 // if we need partial occupation
    str.atoms.push_back(atom);                                        // atom B12

    atom.name="B"; atom.type=1;                                       // atom B13
    atom.fpos(1)=((1.0/2.0)-x3);atom.fpos(2)=-x3;atom.fpos(3)=(1.0/2.0);                     // atom B13
    atom.fpos_equation.clear();atom.fpos_equation.push_back("((1.0/2.0)-x3)");atom.fpos_equation.push_back("-x3");atom.fpos_equation.push_back("(1.0/2.0)");// atom B13 // symbolic math for atom positions
    str.comp_each_type.at(atom.type)+=1.0;                            // atom B13 // if we need partial occupation
    str.atoms.push_back(atom);                                        // atom B13

    atom.name="B"; atom.type=1;                                       // atom B14
    atom.fpos(1)=2.0*x4;atom.fpos(2)=2.0*x4;atom.fpos(3)=2.0*x4;                     // atom B14
    atom.fpos_equation.clear();atom.fpos_equation.push_back("2.0*x4");atom.fpos_equation.push_back("2.0*x4");atom.fpos_equation.push_back("2.0*x4");// atom B14 // symbolic math for atom positions
    str.comp_each_type.at(atom.type)+=1.0;                            // atom B14 // if we need partial occupation
    str.atoms.push_back(atom);                                        // atom B14

    atom.name="B"; atom.type=1;                                       // atom B15
    atom.fpos(1)=2.0*x4;atom.fpos(2)=0.0;atom.fpos(3)=0.0;                     // atom B15
    atom.fpos_equation.clear();atom.fpos_equation.push_back("2.0*x4");atom.fpos_equation.push_back("0.0");atom.fpos_equation.push_back("0.0");// atom B15 // symbolic math for atom positions
    str.comp_each_type.at(atom.type)+=1.0;                            // atom B15 // if we need partial occupation
    str.atoms.push_back(atom);                                        // atom B15

    atom.name="B"; atom.type=1;                                       // atom B16
    atom.fpos(1)=0.0;atom.fpos(2)=2.0*x4;atom.fpos(3)=0.0;                     // atom B16
    atom.fpos_equation.clear();atom.fpos_equation.push_back("0.0");atom.fpos_equation.push_back("2.0*x4");atom.fpos_equation.push_back("0.0");// atom B16 // symbolic math for atom positions
    str.comp_each_type.at(atom.type)+=1.0;                            // atom B16 // if we need partial occupation
    str.atoms.push_back(atom);                                        // atom B16

    atom.name="B"; atom.type=1;                                       // atom B17
    atom.fpos(1)=0.0;atom.fpos(2)=0.0;atom.fpos(3)=2.0*x4;                     // atom B17
    atom.fpos_equation.clear();atom.fpos_equation.push_back("0.0");atom.fpos_equation.push_back("0.0");atom.fpos_equation.push_back("2.0*x4");// atom B17 // symbolic math for atom positions
    str.comp_each_type.at(atom.type)+=1.0;                            // atom B17 // if we need partial occupation
    str.atoms.push_back(atom);                                        // atom B17

    atom.name="B"; atom.type=1;                                       // atom B18
    atom.fpos(1)=-2.0*x4;atom.fpos(2)=-2.0*x4;atom.fpos(3)=-2.0*x4;                     // atom B18
    atom.fpos_equation.clear();atom.fpos_equation.push_back("-2.0*x4");atom.fpos_equation.push_back("-2.0*x4");atom.fpos_equation.push_back("-2.0*x4");// atom B18 // symbolic math for atom positions
    str.comp_each_type.at(atom.type)+=1.0;                            // atom B18 // if we need partial occupation
    str.atoms.push_back(atom);                                        // atom B18

    atom.name="B"; atom.type=1;                                       // atom B19
    atom.fpos(1)=-2.0*x4;atom.fpos(2)=0.0;atom.fpos(3)=0.0;                     // atom B19
    atom.fpos_equation.clear();atom.fpos_equation.push_back("-2.0*x4");atom.fpos_equation.push_back("0.0");atom.fpos_equation.push_back("0.0");// atom B19 // symbolic math for atom positions
    str.comp_each_type.at(atom.type)+=1.0;                            // atom B19 // if we need partial occupation
    str.atoms.push_back(atom);                                        // atom B19

    atom.name="B"; atom.type=1;                                       // atom B20
    atom.fpos(1)=0.0;atom.fpos(2)=-2.0*x4;atom.fpos(3)=0.0;                     // atom B20
    atom.fpos_equation.clear();atom.fpos_equation.push_back("0.0");atom.fpos_equation.push_back("-2.0*x4");atom.fpos_equation.push_back("0.0");// atom B20 // symbolic math for atom positions
    str.comp_each_type.at(atom.type)+=1.0;                            // atom B20 // if we need partial occupation
    str.atoms.push_back(atom);                                        // atom B20

    atom.name="B"; atom.type=1;                                       // atom B21
    atom.fpos(1)=0.0;atom.fpos(2)=0.0;atom.fpos(3)=-2.0*x4;                     // atom B21
    atom.fpos_equation.clear();atom.fpos_equation.push_back("0.0");atom.fpos_equation.push_back("0.0");atom.fpos_equation.push_back("-2.0*x4");// atom B21 // symbolic math for atom positions
    str.comp_each_type.at(atom.type)+=1.0;                            // atom B21 // if we need partial occupation
    str.atoms.push_back(atom);                                        // atom B21

    atom.name="B"; atom.type=1;                                       // atom B22
    atom.fpos(1)=(y5+z5);atom.fpos(2)=z5;atom.fpos(3)=y5;                     // atom B22
    atom.fpos_equation.clear();atom.fpos_equation.push_back("(y5+z5)");atom.fpos_equation.push_back("z5");atom.fpos_equation.push_back("y5");// atom B22 // symbolic math for atom positions
    str.comp_each_type.at(atom.type)+=1.0;                            // atom B22 // if we need partial occupation
    str.atoms.push_back(atom);                                        // atom B22

    atom.name="B"; atom.type=1;                                       // atom B23
    atom.fpos(1)=(z5-y5);atom.fpos(2)=z5;atom.fpos(3)=-y5;                     // atom B23
    atom.fpos_equation.clear();atom.fpos_equation.push_back("(z5-y5)");atom.fpos_equation.push_back("z5");atom.fpos_equation.push_back("-y5");// atom B23 // symbolic math for atom positions
    str.comp_each_type.at(atom.type)+=1.0;                            // atom B23 // if we need partial occupation
    str.atoms.push_back(atom);                                        // atom B23

    atom.name="B"; atom.type=1;                                       // atom B24
    atom.fpos(1)=(y5-z5);atom.fpos(2)=-z5;atom.fpos(3)=y5;                     // atom B24
    atom.fpos_equation.clear();atom.fpos_equation.push_back("(y5-z5)");atom.fpos_equation.push_back("-z5");atom.fpos_equation.push_back("y5");// atom B24 // symbolic math for atom positions
    str.comp_each_type.at(atom.type)+=1.0;                            // atom B24 // if we need partial occupation
    str.atoms.push_back(atom);                                        // atom B24

    atom.name="B"; atom.type=1;                                       // atom B25
    atom.fpos(1)=-(y5+z5);atom.fpos(2)=-z5;atom.fpos(3)=-y5;                     // atom B25
    atom.fpos_equation.clear();atom.fpos_equation.push_back("-(y5+z5)");atom.fpos_equation.push_back("-z5");atom.fpos_equation.push_back("-y5");// atom B25 // symbolic math for atom positions
    str.comp_each_type.at(atom.type)+=1.0;                            // atom B25 // if we need partial occupation
    str.atoms.push_back(atom);                                        // atom B25

    atom.name="B"; atom.type=1;                                       // atom B26
    atom.fpos(1)=y5;atom.fpos(2)=(y5+z5);atom.fpos(3)=z5;                     // atom B26
    atom.fpos_equation.clear();atom.fpos_equation.push_back("y5");atom.fpos_equation.push_back("(y5+z5)");atom.fpos_equation.push_back("z5");// atom B26 // symbolic math for atom positions
    str.comp_each_type.at(atom.type)+=1.0;                            // atom B26 // if we need partial occupation
    str.atoms.push_back(atom);                                        // atom B26

    atom.name="B"; atom.type=1;                                       // atom B27
    atom.fpos(1)=y5;atom.fpos(2)=(y5-z5);atom.fpos(3)=-z5;                     // atom B27
    atom.fpos_equation.clear();atom.fpos_equation.push_back("y5");atom.fpos_equation.push_back("(y5-z5)");atom.fpos_equation.push_back("-z5");// atom B27 // symbolic math for atom positions
    ...
    atom.fpos_equation.clear();atom.fpos_equation.push_back("-y5");atom.fpos_equation.push_back("(z5-y5)");atom.fpos_equation.push_back("z5");// atom B28 // symbolic math for atom positions
    ...
    atom.fpos_equation.clear();atom.fpos_equation.push_back("-y5");atom.fpos_equation.push_back("-(y5+z5)");atom.fpos_equation.push_back("-z5");// atom B29 // symbolic math for atom positions
    ...
    atom.fpos_equation.clear();atom.fpos_equation.push_back("z5");atom.fpos_equation.push_back("y5");atom.fpos_equation.push_back("(y5+z5)");// atom B30 // symbolic math for atom positions
    ...
    atom.fpos_equation.clear();atom.fpos_equation.push_back("z5");atom.fpos_equation.push_back("-y5");atom.fpos_equation.push_back("(z5-y5)");// atom B31 // symbolic math for atom positions
    ...
    atom.fpos_equation.clear();atom.fpos_equation.push_back("-z5");atom.fpos_equation.push_back("y5");atom.fpos_equation.push_back("(y5-z5)");// atom B32 // symbolic math for atom positions
    ...
    atom.fpos_equation.clear();atom.fpos_equation.push_back("-z5");atom.fpos_equation.push_back("-y5");atom.fpos_equation.push_back("-(y5+z5)");// atom B33 // symbolic math for atom positions
    ...
    atom.fpos_equation.clear();atom.fpos_equation.push_back("(y6+z6)");atom.fpos_equation.push_back("z6");atom.fpos_equation.push_back("y6");// atom B34 // symbolic math for atom positions
    ...
    atom.fpos_equation.clear();atom.fpos_equation.push_back("(z6-y6)");atom.fpos_equation.push_back("z6");atom.fpos_equation.push_back("-y6");// atom B35 // symbolic math for atom positions
    ...
    atom.fpos_equation.clear();atom.fpos_equation.push_back("(y6-z6)");atom.fpos_equation.push_back("-z6");atom.fpos_equation.push_back("y6");// atom B36 // symbolic math for atom positions
    ...
    atom.fpos_equation.clear();atom.fpos_equation.push_back("-(y6+z6)");atom.fpos_equation.push_back("-z6");atom.fpos_equation.push_back("-y6");// atom B37 // symbolic math for atom positions
    ...
    atom.fpos_equation.clear();atom.fpos_equation.push_back("y6");atom.fpos_equation.push_back("(y6+z6)");atom.fpos_equation.push_back("z6");// atom B38 // symbolic math for atom positions
    ...
    atom.fpos_equation.clear();atom.fpos_equation.push_back("y6");atom.fpos_equation.push_back("(y6-z6)");atom.fpos_equation.push_back("-z6");// atom B39 // symbolic math for atom positions
    ...
    atom.fpos_equation.clear();atom.fpos_equation.push_back("-y6");atom.fpos_equation.push_back("(z6-y6)");atom.fpos_equation.push_back("z6");// atom B40 // symbolic math for atom positions
    ...
    atom.fpos_equation.clear();atom.fpos_equation.push_back("-y6");atom.fpos_equation.push_back("-(y6+z6)");atom.fpos_equation.push_back("-z6");// atom B41 // symbolic math for atom positions
    ...
    atom.fpos_equation.clear();atom.fpos_equation.push_back("z6");atom.fpos_equation.push_back("y6");atom.fpos_equation.push_back("(y6+z6)");// atom B42 // symbolic math for atom positions
    ...
    atom.fpos_equation.clear();atom.fpos_equation.push_back("z6");atom.fpos_equation.push_back("-y6");atom.fpos_equation.push_back("(z6-y6)");// atom B43 // symbolic math for atom positions
    ...
    atom.fpos_equation.clear();atom.fpos_equation.push_back("-z6");atom.fpos_equation.push_back("y6");atom.fpos_equation.push_back("(y6-z6)");// atom B44 // symbolic math for atom positions
    ...
    atom.fpos_equation.clear();atom.fpos_equation.push_back("-z6");atom.fpos_equation.push_back("-y6");atom.fpos_equation.push_back("-(y6+z6)");// atom B45 // symbolic math for atom positions
    ...
    atom.fpos_equation.clear();atom.fpos_equation.push_back("(y7+z7)");atom.fpos_equation.push_back("z7");atom.fpos_equation.push_back("y7");// atom B46 // symbolic math for atom positions
    ...
    atom.fpos_equation.clear();atom.fpos_equation.push_back("(z7-y7)");atom.fpos_equation.push_back("z7");atom.fpos_equation.push_back("-y7");// atom B47 // symbolic math for atom positions
    ...
    atom.fpos_equation.clear();atom.fpos_equation.push_back("(y7-z7)");atom.fpos_equation.push_back("-z7");atom.fpos_equation.push_back("y7");// atom B48 // symbolic math for atom positions
    ...
    atom.fpos_equation.clear();atom.fpos_equation.push_back("-(y7+z7)");atom.fpos_equation.push_back("-z7");atom.fpos_equation.push_back("-y7");// atom B49 // symbolic math for atom positions
    ...
    atom.fpos_equation.clear();atom.fpos_equation.push_back("y7");atom.fpos_equation.push_back("(y7+z7)");atom.fpos_equation.push_back("z7");// atom B50 // symbolic math for atom positions
    ...
    atom.fpos_equation.clear();atom.fpos_equation.push_back("y7");atom.fpos_equation.push_back("(y7-z7)");atom.fpos_equation.push_back("-z7");// atom B51 // symbolic math for atom positions
    ...
    atom.fpos_equation.clear();atom.fpos_equation.push_back("-y7");atom.fpos_equation.push_back("(z7-y7)");atom.fpos_equation.push_back("z7");// atom B52 // symbolic math for atom positions
    ...
    atom.fpos_equation.clear();atom.fpos_equation.push_back("-y7");atom.fpos_equation.push_back("-(y7+z7)");atom.fpos_equation.push_back("-z7");// atom B53 // symbolic math for atom positions
    ...
    atom.fpos_equation.clear();atom.fpos_equation.push_back("z7");atom.fpos_equation.push_back("y7");atom.fpos_equation.push_back("(y7+z7)");// atom B54 // symbolic math for atom positions
    ...
    atom.fpos_equation.clear();atom.fpos_equation.push_back("z7");atom.fpos_equation.push_back("-y7");atom.fpos_equation.push_back("(z7-y7)");// atom B55 // symbolic math for atom positions
    ...
    atom.fpos_equation.clear();atom.fpos_equation.push_back("-z7");atom.fpos_equation.push_back("y7");atom.fpos_equation.push_back("(y7-z7)");// atom B56 // symbolic math for atom positions
    ...
    atom.fpos_equation.clear();atom.fpos_equation.push_back("-z7");atom.fpos_equation.push_back("-y7");atom.fpos_equation.push_back("-(y7+z7)");// atom B57 // symbolic math for atom positions
    ...
    atom.fpos_equation.clear();atom.fpos_equation.push_back("(y8+z8)");atom.fpos_equation.push_back("(z8+x8)");atom.fpos_equation.push_back("(x8+y8)");// atom B58 // symbolic math for atom positions
    ...
    atom.fpos_equation.clear();atom.fpos_equation.push_back("(z8-y8)");atom.fpos_equation.push_back("(z8-x8)");atom.fpos_equation.push_back("-(x8+y8)");// atom B59 // symbolic math for atom positions
    ...
    atom.fpos_equation.clear();atom.fpos_equation.push_back("(y8-z8)");atom.fpos_equation.push_back("-(z8+x8)");atom.fpos_equation.push_back("(y8-x8)");// atom B60 // symbolic math for atom positions
    ...
    atom.fpos_equation.clear();atom.fpos_equation.push_back("-(y8+z8)");atom.fpos_equation.push_back("(x8-z8)");atom.fpos_equation.push_back("(x8-y8)");// atom B61 // symbolic math for atom positions
    ...
    atom.fpos_equation.clear();atom.fpos_equation.push_back("-(y8+z8)");atom.fpos_equation.push_back("-(z8+x8)");atom.fpos_equation.push_back("-(x8+y8)");// atom B62 // symbolic math for atom positions
    ...
    atom.fpos_equation.clear();atom.fpos_equation.push_back("(y8-z8)");atom.fpos_equation.push_back("(x8-z8)");atom.fpos_equation.push_back("(x8+y8)");// atom B63 // symbolic math for atom positions
    ...
    atom.fpos_equation.clear();atom.fpos_equation.push_back("(z8-y8)");atom.fpos_equation.push_back("(z8+x8)");atom.fpos_equation.push_back("(x8-y8)");// atom B64 // symbolic math for atom positions
    ...
    atom.fpos_equation.clear();atom.fpos_equation.push_back("(y8+z8)");atom.fpos_equation.push_back("(z8-x8)");atom.fpos_equation.push_back("(y8-x8)");// atom B65 // symbolic math for atom positions
    ...
    atom.fpos_equation.clear();atom.fpos_equation.push_back("(x8+y8)");atom.fpos_equation.push_back("(y8+z8)");atom.fpos_equation.push_back("(z8+x8)");// atom B66 // symbolic math for atom positions
    ...
    atom.fpos_equation.clear();atom.fpos_equation.push_back("(y8-x8)");atom.fpos_equation.push_back("(y8-z8)");atom.fpos_equation.push_back("-(z8+x8)");// atom B67 // symbolic math for atom positions
    ...
    atom.fpos_equation.clear();atom.fpos_equation.push_back("(x8-y8)");atom.fpos_equation.push_back("-(y8+z8)");atom.fpos_equation.push_back("(x8-z8)");// atom B68 // symbolic math for atom positions
    ...
    atom.fpos_equation.clear();atom.fpos_equation.push_back("-(x8+y8)");atom.fpos_equation.push_back("(z8-y8)");atom.fpos_equation.push_back("(z8-x8)");// atom B69 // symbolic math for atom positions
    ...
    atom.fpos_equation.clear();atom.fpos_equation.push_back("-(x8+y8)");atom.fpos_equation.push_back("-(y8+z8)");atom.fpos_equation.push_back("-(z8+x8)");// atom B70 // symbolic math for atom positions
    ...
    atom.fpos_equation.clear();atom.fpos_equation.push_back("(x8-y8)");atom.fpos_equation.push_back("(z8-y8)");atom.fpos_equation.push_back("(z8+x8)");// atom B71 // symbolic math for atom positions
    ...
    atom.fpos_equation.clear();atom.fpos_equation.push_back("(y8-x8)");atom.fpos_equation.push_back("(y8+z8)");atom.fpos_equation.push_back("(z8-x8)");// atom B72 // symbolic math for atom positions
    ...
    atom.fpos_equation.clear();atom.fpos_equation.push_back("(x8+y8)");atom.fpos_equation.push_back("(y8-z8)");atom.fpos_equation.push_back("(x8-z8)");// atom B73 // symbolic math for atom positions
    ...
    atom.fpos_equation.clear();atom.fpos_equation.push_back("(z8+x8)");atom.fpos_equation.push_back("(x8+y8)");atom.fpos_equation.push_back("(y8+z8)");// atom B74 // symbolic math for atom positions
    ...
    atom.fpos_equation.clear();atom.fpos_equation.push_back("(x8-z8)");atom.fpos_equation.push_back("(x8-y8)");atom.fpos_equation.push_back("-(y8+z8)");// atom B75 // symbolic math for atom positions
    ...
    atom.fpos_equation.clear();atom.fpos_equation.push_back("(z8-x8)");atom.fpos_equation.push_back("-(x8+y8)");atom.fpos_equation.push_back("(z8-y8)");// atom B76 // symbolic math for atom positions
    ...
    atom.fpos_equation.clear();atom.fpos_equation.push_back("-(z8+x8)");atom.fpos_equation.push_back("(y8-x8)");atom.fpos_equation.push_back("(y8-z8)");// atom B77 // symbolic math for atom positions
    ...
    atom.fpos_equation.clear();atom.fpos_equation.push_back("-(z8+x8)");atom.fpos_equation.push_back("-(x8+y8)");atom.fpos_equation.push_back("-(y8+z8)");// atom B78 // symbolic math for atom positions
    ...
    atom.fpos_equation.clear();atom.fpos_equation.push_back("(z8-x8)");atom.fpos_equation.push_back("(y8-x8)");atom.fpos_equation.push_back("(y8+z8)");// atom B79 // symbolic math for atom positions
    ...
    atom.fpos_equation.clear();atom.fpos_equation.push_back("(x8-z8)");atom.fpos_equation.push_back("(x8+y8)");atom.fpos_equation.push_back("(y8-z8)");// atom B80 // symbolic math for atom positions
    ...
    atom.fpos_equation.clear();atom.fpos_equation.push_back("(z8+x8)");atom.fpos_equation.push_back("(x8-y8)");atom.fpos_equation.push_back("(z8-y8)");// atom B81 // symbolic math for atom positions
