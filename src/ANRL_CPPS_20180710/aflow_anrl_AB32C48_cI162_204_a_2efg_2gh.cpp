...
namespace anrl {
  uint PrototypeANRL_AB32C48_cI162_204_a_2efg_2gh(ostream &oss,stringstream &web,xstructure& str,string parameters,string proto_line,uint print_mode,bool LDEBUG) {
