...
#ifndef _AFLOW_ANRL_AB_hP8_186_ab_ab_CPP
#define _AFLOW_ANRL_AB_hP8_186_ab_ab_CPP
#include "../aflow.h"
...
namespace anrl {
  uint PrototypeANRL_AB_hP8_186_ab_ab(ostream &oss,stringstream &web,xstructure& str,string parameters,string proto_line,uint print_mode,bool LDEBUG) {
