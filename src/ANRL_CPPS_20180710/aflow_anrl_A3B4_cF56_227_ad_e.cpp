...
#ifndef _AFLOW_ANRL_A3B4_cF56_227_ad_e_CPP
#define _AFLOW_ANRL_A3B4_cF56_227_ad_e_CPP
#include "../aflow.h"
...
namespace anrl {
  uint PrototypeANRL_A3B4_cF56_227_ad_e(ostream &oss,stringstream &web,xstructure& str,string parameters,string proto_line,uint print_mode,bool LDEBUG) {
