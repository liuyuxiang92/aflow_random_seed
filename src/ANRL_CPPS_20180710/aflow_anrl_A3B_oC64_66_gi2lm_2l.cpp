...
// FILE "ANRL/aflow_anrl_A3B_oC64_66_gi2lm_2l.cpp"

#ifndef _AFLOW_ANRL_A3B_oC64_66_gi2lm_2l_CPP // AFLOW_REMOVE_GREP
#define _AFLOW_ANRL_A3B_oC64_66_gi2lm_2l_CPP // AFLOW_REMOVE_GREP
...
namespace anrl {
  uint PrototypeANRL_A3B_oC64_66_gi2lm_2l(stringstream &web,xstructure& str,string parameters,string proto_line,uint print_mode,bool LDEBUG) {
    // system A3B_oC64_66_gi2lm_2l
    ...
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A3B_oC64_66_gi2lm_2l: FOUND" << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A3B_oC64_66_gi2lm_2l: label=" << label << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A3B_oC64_66_gi2lm_2l: nspecies=" << nspecies << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A3B_oC64_66_gi2lm_2l: natoms=" << natoms << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A3B_oC64_66_gi2lm_2l: spacegroup=" << spacegroup << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A3B_oC64_66_gi2lm_2l: nunderscores=" << nunderscores << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A3B_oC64_66_gi2lm_2l: nparameters=" <<  nparameters << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A3B_oC64_66_gi2lm_2l: Pearson_symbol=" << Pearson_symbol << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A3B_oC64_66_gi2lm_2l: params=" << params << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A3B_oC64_66_gi2lm_2l: Strukturbericht=" << Strukturbericht << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A3B_oC64_66_gi2lm_2l: prototype=" << prototype << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A3B_oC64_66_gi2lm_2l: dialect=" << dialect << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A3B_oC64_66_gi2lm_2l: vparameters.size()=" << vparameters.size() << endl;}
    ...
    double y3=vparameters.at(i++);                 if(LDEBUG) { cerr << "anrl::PrototypeANRL_A3B_oC64_66_gi2lm_2l: y3=" << y3 << endl;}
    double x4=vparameters.at(i++);                 if(LDEBUG) { cerr << "anrl::PrototypeANRL_A3B_oC64_66_gi2lm_2l: x4=" << x4 << endl;}
    double y4=vparameters.at(i++);                 if(LDEBUG) { cerr << "anrl::PrototypeANRL_A3B_oC64_66_gi2lm_2l: y4=" << y4 << endl;}
    double x5=vparameters.at(i++);                 if(LDEBUG) { cerr << "anrl::PrototypeANRL_A3B_oC64_66_gi2lm_2l: x5=" << x5 << endl;}
    double y5=vparameters.at(i++);                 if(LDEBUG) { cerr << "anrl::PrototypeANRL_A3B_oC64_66_gi2lm_2l: y5=" << y5 << endl;}
    double x6=vparameters.at(i++);                 if(LDEBUG) { cerr << "anrl::PrototypeANRL_A3B_oC64_66_gi2lm_2l: x6=" << x6 << endl;}
    double y6=vparameters.at(i++);                 if(LDEBUG) { cerr << "anrl::PrototypeANRL_A3B_oC64_66_gi2lm_2l: y6=" << y6 << endl;}
