...
#ifndef _AFLOW_ANRL_A_cF136_227_aeg_CPP // AFLOW_REMOVE_GREP
#define _AFLOW_ANRL_A_cF136_227_aeg_CPP // AFLOW_REMOVE_GREP
...
namespace anrl {
  uint PrototypeANRL_A_cF136_227_aeg(stringstream &web,xstructure& str,string parameters,string proto_line,uint print_mode,bool LDEBUG) {
