...
#ifndef _AFLOW_ANRL_AB3_mC8_12_a_di_CPP
#define _AFLOW_ANRL_AB3_mC8_12_a_di_CPP
#include "../aflow.h"
...
namespace anrl {
  uint PrototypeANRL_AB3_mC8_12_a_di(ostream &oss,stringstream &web,xstructure& str,string parameters,string proto_line,uint print_mode,bool LDEBUG) {
