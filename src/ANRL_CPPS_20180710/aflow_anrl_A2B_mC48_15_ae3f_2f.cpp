...
// FILE "ANRL/aflow_anrl_A2B_mC48_15_ae3f_2f.cpp"

#ifndef _AFLOW_ANRL_A2B_mC48_15_ae3f_2f_CPP // AFLOW_REMOVE_GREP
#define _AFLOW_ANRL_A2B_mC48_15_ae3f_2f_CPP // AFLOW_REMOVE_GREP
#include "../aflow.h" // AFLOW_REMOVE_GREP

namespace anrl {
  uint WebANRL_A2B_mC48_15_ae3f_2f(stringstream &web,bool LDEBUG);
}

namespace anrl {
  uint PrototypeANRL_A2B_mC48_15_ae3f_2f(stringstream &web,xstructure& str,string parameters,string proto_line,uint print_mode,bool LDEBUG) {
    // system A2B_mC48_15_ae3f_2f

    if(XHOST.vflag_control.flag("WWW")) {
      WebANRL_A2B_mC48_15_ae3f_2f(web,LDEBUG); // PLUG WEB STUFF
      #ifdef _ANRL_NOWEB_
      cout << "no web" << endl;
      #else
      cout << web.str() << endl;
    ...
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2B_mC48_15_ae3f_2f: FOUND" << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2B_mC48_15_ae3f_2f: label=" << label << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2B_mC48_15_ae3f_2f: nspecies=" << nspecies << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2B_mC48_15_ae3f_2f: natoms=" << natoms << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2B_mC48_15_ae3f_2f: spacegroup=" << spacegroup << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2B_mC48_15_ae3f_2f: nunderscores=" << nunderscores << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2B_mC48_15_ae3f_2f: nparameters=" <<  nparameters << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2B_mC48_15_ae3f_2f: Pearson_symbol=" << Pearson_symbol << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2B_mC48_15_ae3f_2f: params=" << params << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2B_mC48_15_ae3f_2f: Strukturbericht=" << Strukturbericht << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2B_mC48_15_ae3f_2f: prototype=" << prototype << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2B_mC48_15_ae3f_2f: dialect=" << dialect << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2B_mC48_15_ae3f_2f: vparameters.size()=" << vparameters.size() << endl;}
    ...
    uint i=0;
    double a=vparameters.at(i++);                  if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2B_mC48_15_ae3f_2f: a=" << a << endl;}
    double bovera=vparameters.at(i++),b=bovera*a;  if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2B_mC48_15_ae3f_2f: b=" << b << " (b/a=" << bovera << ")" << endl;}
    double covera=vparameters.at(i++),c=covera*a;  if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2B_mC48_15_ae3f_2f: c=" << c << " (c/a=" << covera << ")" << endl;}
    double beta=vparameters.at(i++);               if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2B_mC48_15_ae3f_2f: beta=" << beta << endl;}
    
    double y2=vparameters.at(i++);                 if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2B_mC48_15_ae3f_2f: y2=" << y2 << endl;}
    double x3=vparameters.at(i++);                 if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2B_mC48_15_ae3f_2f: x3=" << x3 << endl;}
    double y3=vparameters.at(i++);                 if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2B_mC48_15_ae3f_2f: y3=" << y3 << endl;}
    double z3=vparameters.at(i++);                 if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2B_mC48_15_ae3f_2f: z3=" << z3 << endl;}
    double x4=vparameters.at(i++);                 if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2B_mC48_15_ae3f_2f: x4=" << x4 << endl;}
    double y4=vparameters.at(i++);                 if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2B_mC48_15_ae3f_2f: y4=" << y4 << endl;}
    double z4=vparameters.at(i++);                 if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2B_mC48_15_ae3f_2f: z4=" << z4 << endl;}
    double x5=vparameters.at(i++);                 if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2B_mC48_15_ae3f_2f: x5=" << x5 << endl;}
    double y5=vparameters.at(i++);                 if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2B_mC48_15_ae3f_2f: y5=" << y5 << endl;}
    double z5=vparameters.at(i++);                 if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2B_mC48_15_ae3f_2f: z5=" << z5 << endl;}
    double x6=vparameters.at(i++);                 if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2B_mC48_15_ae3f_2f: x6=" << x6 << endl;}
    double y6=vparameters.at(i++);                 if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2B_mC48_15_ae3f_2f: y6=" << y6 << endl;}
    double z6=vparameters.at(i++);                 if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2B_mC48_15_ae3f_2f: z6=" << z6 << endl;}
    double x7=vparameters.at(i++);                 if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2B_mC48_15_ae3f_2f: x7=" << x7 << endl;}
    double y7=vparameters.at(i++);                 if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2B_mC48_15_ae3f_2f: y7=" << y7 << endl;}
    double z7=vparameters.at(i++);                 if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2B_mC48_15_ae3f_2f: z7=" << z7 << endl;}
        
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2B_mC48_15_ae3f_2f: cos(beta)=" << cos(deg2rad*beta)  << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2B_mC48_15_ae3f_2f: sin(beta)=" << sin(deg2rad*beta)  << endl;}
    ...
    atom.fpos(1)=-(x7+y7);atom.fpos(2)=(y7-x7);atom.fpos(3)=((1.0/2.0)-z7);                     // atom B22
    atom.fpos_equation.clear();atom.fpos_equation.push_back("-(x7+y7)");atom.fpos_equation.push_back("(y7-x7)");atom.fpos_equation.push_back("((1.0/2.0)-z7)");// atom B22 // symbolic math for atom positions
    str.comp_each_type.at(atom.type)+=1.0;                            // atom B22 // if we need partial occupation
    str.atoms.push_back(atom);                                        // atom B22
    
    atom.name="B"; atom.type=1;                                       // atom B23
    atom.fpos(1)=(y7-x7);atom.fpos(2)=-(x7+y7);atom.fpos(3)=-z7;                     // atom B23
    atom.fpos_equation.clear();atom.fpos_equation.push_back("(y7-x7)");atom.fpos_equation.push_back("-(x7+y7)");atom.fpos_equation.push_back("-z7");// atom B23 // symbolic math for atom positions
...
namespace anrl {
  uint WebANRL_A2B_mC48_15_ae3f_2f(stringstream& web,bool LDEBUG) {
    ...
    if(LDEBUG) {cerr << "anrl:: WebANRL_A2B_mC48_15_ae3f_2f: web.str().size()=" << web.str().size() << endl;}
