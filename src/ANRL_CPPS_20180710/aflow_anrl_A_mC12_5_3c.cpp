...
#ifndef _AFLOW_ANRL_A_mC12_5_3c_CPP
#define _AFLOW_ANRL_A_mC12_5_3c_CPP
#include "../aflow.h"
...
namespace anrl {
  uint PrototypeANRL_A_mC12_5_3c(ostream &oss,stringstream &web,xstructure& str,string parameters,string proto_line,uint print_mode,bool LDEBUG) {
    // system A_mC12_5_3c
