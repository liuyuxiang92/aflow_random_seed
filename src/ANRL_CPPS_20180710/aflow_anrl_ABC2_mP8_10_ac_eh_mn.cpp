...
#ifndef _AFLOW_ANRL_ABC2_mP8_10_ac_eh_mn_CPP
#define _AFLOW_ANRL_ABC2_mP8_10_ac_eh_mn_CPP
#include "../aflow.h"
...
namespace anrl {
  uint PrototypeANRL_ABC2_mP8_10_ac_eh_mn(ostream &oss,stringstream &web,xstructure& str,string parameters,string proto_line,uint print_mode,bool LDEBUG) {
