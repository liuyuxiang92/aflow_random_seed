...
#ifndef _AFLOW_ANRL_AB3C16_cF160_203_b_ad_eg_CPP
#define _AFLOW_ANRL_AB3C16_cF160_203_b_ad_eg_CPP
#include "../aflow.h"
...
namespace anrl {
  uint PrototypeANRL_AB3C16_cF160_203_b_ad_eg(ostream &oss,stringstream &web,xstructure& str,string parameters,string proto_line,uint print_mode,bool LDEBUG) {
