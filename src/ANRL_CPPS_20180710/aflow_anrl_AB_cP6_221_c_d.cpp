...
// FILE "ANRL/aflow_anrl_AB_cP6_221_c_d.cpp"

#ifndef _AFLOW_ANRL_AB_cP6_221_c_d_CPP // AFLOW_REMOVE_GREP
#define _AFLOW_ANRL_AB_cP6_221_c_d_CPP // AFLOW_REMOVE_GREP
#include "../aflow.h" // AFLOW_REMOVE_GREP

namespace anrl {
  uint WebANRL_AB_cP6_221_c_d(stringstream &web,bool LDEBUG);
}

namespace anrl {
  uint PrototypeANRL_AB_cP6_221_c_d(stringstream &web,xstructure& str,string parameters,string proto_line,uint print_mode,bool LDEBUG) {
    // system AB_cP6_221_c_d

    if(XHOST.vflag_control.flag("WWW")) {
      WebANRL_AB_cP6_221_c_d(web,LDEBUG); // PLUG WEB STUFF
#ifdef _ANRL_NOWEB_
      cout << "no web" << endl;
#else
      cout << web.str() << endl;
    ...
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB_cP6_221_c_d: FOUND" << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB_cP6_221_c_d: label=" << label << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB_cP6_221_c_d: nspecies=" << nspecies << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB_cP6_221_c_d: natoms=" << natoms << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB_cP6_221_c_d: spacegroup=" << spacegroup << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB_cP6_221_c_d: nunderscores=" << nunderscores << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB_cP6_221_c_d: nparameters=" <<  nparameters << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB_cP6_221_c_d: Pearson_symbol=" << Pearson_symbol << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB_cP6_221_c_d: params=" << params << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB_cP6_221_c_d: Strukturbericht=" << Strukturbericht << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB_cP6_221_c_d: prototype=" << prototype << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB_cP6_221_c_d: dialect=" << dialect << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB_cP6_221_c_d: vparameters.size()=" << vparameters.size() << endl;}
    ...
    uint i=0;
    double a=vparameters.at(i++);                  if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB_cP6_221_c_d: a=" << a << endl;}
...
namespace anrl {
  uint WebANRL_AB_cP6_221_c_d(stringstream& web,bool LDEBUG) {
    ...
    if(LDEBUG) {cerr << "anrl:: WebANRL_AB_cP6_221_c_d: web.str().size()=" << web.str().size() << endl;}
