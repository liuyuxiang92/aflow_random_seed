...
// FILE "ANRL/aflow_anrl_A5B2_hR7_166_a2c_c.cpp"

#ifndef _AFLOW_ANRL_A5B2_hR7_166_a2c_c_CPP // AFLOW_REMOVE_GREP
#define _AFLOW_ANRL_A5B2_hR7_166_a2c_c_CPP // AFLOW_REMOVE_GREP
#include "../aflow.h" // AFLOW_REMOVE_GREP

namespace anrl {
  uint WebANRL_A5B2_hR7_166_a2c_c(stringstream &web,bool LDEBUG);
}

namespace anrl {
  uint PrototypeANRL_A5B2_hR7_166_a2c_c(stringstream &web,xstructure& str,string parameters,string proto_line,uint print_mode,bool LDEBUG) {
    // system A5B2_hR7_166_a2c_c

    if(XHOST.vflag_control.flag("WWW")) {
      WebANRL_A5B2_hR7_166_a2c_c(web,LDEBUG); // PLUG WEB STUFF
#ifdef _ANRL_NOWEB_
      cout << "no web" << endl;
#else
      cout << web.str() << endl;
    ...
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A5B2_hR7_166_a2c_c: FOUND" << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A5B2_hR7_166_a2c_c: label=" << label << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A5B2_hR7_166_a2c_c: nspecies=" << nspecies << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A5B2_hR7_166_a2c_c: natoms=" << natoms << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A5B2_hR7_166_a2c_c: spacegroup=" << spacegroup << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A5B2_hR7_166_a2c_c: nunderscores=" << nunderscores << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A5B2_hR7_166_a2c_c: nparameters=" <<  nparameters << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A5B2_hR7_166_a2c_c: Pearson_symbol=" << Pearson_symbol << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A5B2_hR7_166_a2c_c: params=" << params << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A5B2_hR7_166_a2c_c: Strukturbericht=" << Strukturbericht << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A5B2_hR7_166_a2c_c: prototype=" << prototype << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A5B2_hR7_166_a2c_c: dialect=" << dialect << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A5B2_hR7_166_a2c_c: vparameters.size()=" << vparameters.size() << endl;}
    ...
    uint i=0;
    double a=vparameters.at(i++);                  if(LDEBUG) { cerr << "anrl::PrototypeANRL_A5B2_hR7_166_a2c_c: a=" << a << endl;}
    double covera=vparameters.at(i++),c=covera*a;  if(LDEBUG) { cerr << "anrl::PrototypeANRL_A5B2_hR7_166_a2c_c: c=" << c << " (c/a=" << covera << ")" << endl;}

    double x2=vparameters.at(i++);                 if(LDEBUG) { cerr << "anrl::PrototypeANRL_A5B2_hR7_166_a2c_c: x2=" << x2 << endl;}
    double x3=vparameters.at(i++);                 if(LDEBUG) { cerr << "anrl::PrototypeANRL_A5B2_hR7_166_a2c_c: x3=" << x3 << endl;}
    double x4=vparameters.at(i++);                 if(LDEBUG) { cerr << "anrl::PrototypeANRL_A5B2_hR7_166_a2c_c: x4=" << x4 << endl;}
...
namespace anrl {
  uint WebANRL_A5B2_hR7_166_a2c_c(stringstream& web,bool LDEBUG) {
    ...
    if(LDEBUG) {cerr << "anrl:: WebANRL_A5B2_hR7_166_a2c_c: web.str().size()=" << web.str().size() << endl;}
