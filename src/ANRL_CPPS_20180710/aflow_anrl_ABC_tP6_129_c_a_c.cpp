...
#ifndef _AFLOW_ANRL_ABC_tP6_129_c_a_c_CPP
#define _AFLOW_ANRL_ABC_tP6_129_c_a_c_CPP
#include "../aflow.h"
...
namespace anrl {
  uint PrototypeANRL_ABC_tP6_129_c_a_c(ostream &oss,stringstream &web,xstructure& str,string parameters,string proto_line,uint print_mode,bool LDEBUG) {
