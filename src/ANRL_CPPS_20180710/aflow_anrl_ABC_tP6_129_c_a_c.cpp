...
// FILE "ANRL/aflow_anrl_ABC_tP6_129_c_a_c.cpp"

#ifndef _AFLOW_ANRL_ABC_tP6_129_c_a_c_CPP // AFLOW_REMOVE_GREP
#define _AFLOW_ANRL_ABC_tP6_129_c_a_c_CPP // AFLOW_REMOVE_GREP
#include "../aflow.h" // AFLOW_REMOVE_GREP

namespace anrl {
  uint WebANRL_ABC_tP6_129_c_a_c(stringstream &web,bool LDEBUG);
}

namespace anrl {
  uint PrototypeANRL_ABC_tP6_129_c_a_c(stringstream &web,xstructure& str,string parameters,string proto_line,uint print_mode,bool LDEBUG) {
    // system ABC_tP6_129_c_a_c

    if(XHOST.vflag_control.flag("WWW")) {
      WebANRL_ABC_tP6_129_c_a_c(web,LDEBUG); // PLUG WEB STUFF
      #ifdef _ANRL_NOWEB_
      cout << "no web" << endl;
      #else
      cout << web.str() << endl;
    ...
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_ABC_tP6_129_c_a_c: FOUND" << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_ABC_tP6_129_c_a_c: label=" << label << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_ABC_tP6_129_c_a_c: nspecies=" << nspecies << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_ABC_tP6_129_c_a_c: natoms=" << natoms << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_ABC_tP6_129_c_a_c: spacegroup=" << spacegroup << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_ABC_tP6_129_c_a_c: nunderscores=" << nunderscores << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_ABC_tP6_129_c_a_c: nparameters=" <<  nparameters << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_ABC_tP6_129_c_a_c: Pearson_symbol=" << Pearson_symbol << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_ABC_tP6_129_c_a_c: params=" << params << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_ABC_tP6_129_c_a_c: Strukturbericht=" << Strukturbericht << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_ABC_tP6_129_c_a_c: prototype=" << prototype << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_ABC_tP6_129_c_a_c: dialect=" << dialect << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_ABC_tP6_129_c_a_c: vparameters.size()=" << vparameters.size() << endl;}
    ...
    uint i=0;
    double a=vparameters.at(i++);                  if(LDEBUG) { cerr << "anrl::PrototypeANRL_ABC_tP6_129_c_a_c: a=" << a << endl;}
    double covera=vparameters.at(i++),c=covera*a;  if(LDEBUG) { cerr << "anrl::PrototypeANRL_ABC_tP6_129_c_a_c: c=" << c << " (c/a=" << covera << ")" << endl;}
    
    double z2=vparameters.at(i++);                 if(LDEBUG) { cerr << "anrl::PrototypeANRL_ABC_tP6_129_c_a_c: z2=" << z2 << endl;}
    double z3=vparameters.at(i++);                 if(LDEBUG) { cerr << "anrl::PrototypeANRL_ABC_tP6_129_c_a_c: z3=" << z3 << endl;}
...
namespace anrl {
  uint WebANRL_ABC_tP6_129_c_a_c(stringstream& web,bool LDEBUG) {
    ...
    if(LDEBUG) {cerr << "anrl:: WebANRL_ABC_tP6_129_c_a_c: web.str().size()=" << web.str().size() << endl;}
