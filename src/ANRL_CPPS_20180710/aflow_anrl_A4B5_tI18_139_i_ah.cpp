...
#ifndef _AFLOW_ANRL_A4B5_tI18_139_i_ah_CPP
#define _AFLOW_ANRL_A4B5_tI18_139_i_ah_CPP
#include "../aflow.h"
...
namespace anrl {
  uint PrototypeANRL_A4B5_tI18_139_i_ah(ostream &oss,stringstream &web,xstructure& str,string parameters,string proto_line,uint print_mode,bool LDEBUG) {
