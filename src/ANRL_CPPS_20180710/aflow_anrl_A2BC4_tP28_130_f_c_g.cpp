...
#ifndef _AFLOW_ANRL_A2BC4_tP28_130_f_c_g_CPP
#define _AFLOW_ANRL_A2BC4_tP28_130_f_c_g_CPP
#include "../aflow.h"
...
namespace anrl {
  uint PrototypeANRL_A2BC4_tP28_130_f_c_g(ostream &oss,stringstream &web,xstructure& str,string parameters,string proto_line,uint print_mode,bool LDEBUG) {
