...
#ifndef _AFLOW_ANRL_A6B2CD6E_cP64_208_m_ad_b_m_c_CPP
#define _AFLOW_ANRL_A6B2CD6E_cP64_208_m_ad_b_m_c_CPP
#include "../aflow.h"
...
namespace anrl {
  uint PrototypeANRL_A6B2CD6E_cP64_208_m_ad_b_m_c(ostream &oss,stringstream &web,xstructure& str,string parameters,string proto_line,uint print_mode,bool LDEBUG) {
