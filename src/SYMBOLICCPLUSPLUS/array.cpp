...
#ifndef SYMBOLIC_CPLUSPLUS_ARRAY_DEFINE //DX20200824 - added for proper compilation
#define SYMBOLIC_CPLUSPLUS_ARRAY_DEFINE //DX20200824 - added for proper compilation
