...
#ifndef SYMBOLIC_CPLUSPLUS_VERYLONG_DEFINE //DX20200824 - added for proper compilation
#define SYMBOLIC_CPLUSPLUS_VERYLONG_DEFINE //DX20200824 - added for proper compilation
...
Verylong sqrt(const Verylong &v)
{
   ...
   sum = z = Verylong(int(std::sqrt(double(digitsum)))); //DX20200825 - added std namespace
