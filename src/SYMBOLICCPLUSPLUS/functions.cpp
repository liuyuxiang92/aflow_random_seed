...
Cloning *Sin::clone() const { return Cloning::clone(*this); } //DX20200825 - moved from h file and added Sin class to *clone()
...
Cloning *Cos::clone() const { return Cloning::clone(*this); } //DX20200825 - moved from h file and added Cos class to *clone()
...
Cloning *Sinh::clone() const { return Cloning::clone(*this); } //DX20200825 - moved from h file and added Sinh class to *clone()
...
Cloning *Cosh::clone() const { return Cloning::clone(*this); } //DX20200825 - moved from h file and added Cosh class to *clone()
...
Cloning *Log::clone() const { return Cloning::clone(*this); } //DX20200825 - moved from h file and added Log class to *clone()
...
Cloning *Power::clone() const { return Cloning::clone(*this); } //DX20200825 - moved from h file and added Power class to *clone()
...
Cloning *Derivative::clone() const { return Cloning::clone(*this); } //DX20200825 - moved from h file and added Derivative class to *clone()
...
Cloning *Integral::clone() const { return Cloning::clone(*this); } //DX20200825 - moved from h file and added Integral class to *clone()
...
Cloning *Rows::clone() const { return Cloning::clone(*this); } //DX20200825 - moved from h file and added Rows class to *clone()
...
Cloning *Columns::clone() const { return Cloning::clone(*this); } //DX20200825 - moved from h file and added Columns class to *clone()
...
Cloning *Row::clone() const { return Cloning::clone(*this); } //DX20200825 - moved from h file and added Row class to *clone()
...
Cloning *Column::clone() const { return Cloning::clone(*this); } //DX20200825 - moved from h file and added Column class to *clone()
...
Cloning *Transpose::clone() const { return Cloning::clone(*this); } //DX20200825 - moved from h file and added Transpose class to *clone()
...
Cloning *Trace::clone() const { return Cloning::clone(*this); } //DX20200825 - moved from h file and added Trace class to *clone()
...
Cloning *Determinant::clone() const { return Cloning::clone(*this); } //DX20200825 - moved from h file and added Determinant class to *clone()
...
Cloning *Vec::clone() const { return Cloning::clone(*this); } //DX20200825 - moved from h file and added Vec class to *clone()
...
Cloning *Kronecker::clone() const { return Cloning::clone(*this); } //DX20200825 - moved from h file and added Kronecker class to *clone()
...
Cloning *DirectSum::clone() const { return Cloning::clone(*this); } //DX20200825 - moved from h file and added DirectSum class to *clone()
...
Cloning *Hadamard::clone() const { return Cloning::clone(*this); } //DX20200825 - moved from h file and added Hadamard class to *clone()
...
Cloning *Gamma::clone() const { return Cloning::clone(*this); } //DX20200825 - moved from h file and added Gamma class to *clone()
} //namespace symbolic //DX20200625
