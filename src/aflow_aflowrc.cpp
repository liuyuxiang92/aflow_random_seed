...
#define AFLOWRC_DEFAULT_AFLOW_PGROUP_PATTERSON_OUT      string("aflow.pgroup_Patterson.out") //DX 20200129
#define         DEFAULT_AFLOW_PGROUP_PATTERSON_OUT      XHOST.adefault.getattachedscheme("DEFAULT_AFLOW_PGROUP_PATTERSON_OUT") //DX 20200129
#define AFLOWRC_DEFAULT_AFLOW_PGROUP_PATTERSON_JSON     string("aflow.pgroup_Patterson.json") //DX 20200129
#define         DEFAULT_AFLOW_PGROUP_PATTERSON_JSON     XHOST.adefault.getattachedscheme("DEFAULT_AFLOW_PGROUP_Patterson_JSON") //DX 20200129
...
#define AFLOWRC_DEFAULT_AAPL_THERMALGRID                      string("21x21x21")  // ME200110 - 21x21x21 more than enough for tetrahedron method
...
namespace aflowrc {
  bool read(std::ostream& oss,bool AFLOWRC_VERBOSE) {
    ...
    aflowrc::load_default("DEFAULT_AFLOW_PGROUP_PATTERSON_OUT",AFLOWRC_DEFAULT_AFLOW_PGROUP_PATTERSON_OUT); //DX 20200129
    aflowrc::load_default("DEFAULT_AFLOW_PGROUP_PATTERSON_JSON",AFLOWRC_DEFAULT_AFLOW_PGROUP_PATTERSON_JSON); //DX 20200129
...
namespace aflowrc {
  bool write_default(std::ostream& oss,bool AFLOWRC_VERBOSE) {
    ...
    aflowrc << "DEFAULT_AFLOW_PGROUP_PATTERSON_OUT=\"" << AFLOWRC_DEFAULT_AFLOW_PGROUP_PATTERSON_OUT << "\"" << endl; //DX 20200129
    aflowrc << "DEFAULT_AFLOW_PGROUP_PATTERSON_JSON=\"" << AFLOWRC_DEFAULT_AFLOW_PGROUP_PATTERSON_JSON << "\"" << endl; //DX 20200129
...
namespace aflowrc {
  bool print_aflowrc(std::ostream& oss,bool AFLOWRC_VERBOSE) {
    ...
    if(LDEBUG) oss << "XHOST.adefault.getattachedscheme(\"DEFAULT_AFLOW_PGROUP_PATTERSON_OUT\")=\"" << DEFAULT_AFLOW_PGROUP_PATTERSON_OUT << "\"" << endl; //DX 20200129
    if(LDEBUG) oss << "XHOST.adefault.getattachedscheme(\"DEFAULT_AFLOW_PGROUP_PATTERSON_JSON\")=\"" << DEFAULT_AFLOW_PGROUP_PATTERSON_JSON << "\"" << endl; //DX 20200129
