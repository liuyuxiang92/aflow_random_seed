...
namespace aflowlib {
  ...
  bool LIB2RAW_Calculate_FormationEnthalpy(const string& directory_LIB,aflowlib::_aflowlib_entry& data,const xstructure& xstr,const string& MESSAGE); //CO20200731
