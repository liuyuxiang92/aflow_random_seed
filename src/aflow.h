...
#define _VASP_POSCAR_MODE_EXPLICIT_START_P_ "[VASP_POSCAR_MODE_EXPLICIT]START."  //CO20200624
#define _VASP_POSCAR_MODE_EXPLICIT_STOP_P_ "[VASP_POSCAR_MODE_EXPLICIT]STOP."  //CO20200624
