...
_vflags::_vflags() {
  ...
  // ISMEAR_STATIC_BANDS  //CO20181128
  KBIN_VASP_FORCE_OPTION_ISMEAR_STATIC_BANDS_EQUAL.clear(); //CO20181128
  KBIN_VASP_FORCE_OPTION_ISMEAR_STATIC_BANDS_EQUAL.push(aurostd::utype2string(DEFAULT_VASP_FORCE_OPTION_ISMEAR_STATIC_BANDS_SCHEME));  //default //CO20181128
  // SIGMA_STATIC_BANDS  //CO20181128
  KBIN_VASP_FORCE_OPTION_SIGMA_STATIC_BANDS_EQUAL.clear(); //CO20181128
  KBIN_VASP_FORCE_OPTION_SIGMA_STATIC_BANDS_EQUAL.push(aurostd::utype2string(DEFAULT_VASP_FORCE_OPTION_SIGMA_STATIC_BANDS));  //default //CO20181128
  // RWIGS
...
void _vflags::copy(const _vflags& b) {
  ...
  // ISMEAR_STATIC_BANDS
  KBIN_VASP_FORCE_OPTION_ISMEAR_STATIC_BANDS_EQUAL               = b.KBIN_VASP_FORCE_OPTION_ISMEAR_STATIC_BANDS_EQUAL; //CO20181128
  // SIGMA_STATIC_BANDS
  KBIN_VASP_FORCE_OPTION_SIGMA_STATIC_BANDS_EQUAL                = b.KBIN_VASP_FORCE_OPTION_SIGMA_STATIC_BANDS_EQUAL; //CO20181128
  // RWIGS
