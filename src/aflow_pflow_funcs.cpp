...
namespace pflow {
  void GetXrayData(const xstructure& str,
    ...
    vector<double> v(5);
    // aurostd::matrix<double> ids(tlen,v);  //CO20200404 aurostd->pflow
...
namespace pflow {
  void GetXray(const xstructure& str, vector<double>& dist,vector<double>& sf,
    ...
    //  aurostd::matrix<double> fpos=GetFpos(sstr);  //CO20200404 aurostd->pflow
...
namespace pflow {
  void GetRDF(xstructure str, const double& rmax,
      const int& nbins, aurostd::matrix<double>& rdf_all) {  //CO20200404 aurostd->pflow
    int natoms=str.atoms.size();
    std::deque<int> num_each_type=str.num_each_type;
    int ntyp=num_each_type.size();
    rdf_all=aurostd::matrix<double> ((ntyp+1)*natoms,nbins); //CO20200404 aurostd->pflow
...
namespace pflow {
  void GetRDFShells(const xstructure& str,const double& rmax,const int& nbins,
      const int& smooth_width,const aurostd::matrix<double>& rdf,  //CO20200404 aurostd->pflow
      aurostd::matrix<double>& rdfsh,aurostd::matrix<double>& rdfsh_loc) { //CO20200404 aurostd->pflow
    ...
    rdfsh = aurostd::matrix<double>  (_rdi,0); pflow::VVset(rdfsh,0);  //CO20200404 aurostd->pflow
    rdfsh_loc =  aurostd::matrix<double> (_rdi,0);  pflow::VVset(rdfsh_loc,0); //CO20200404 aurostd->pflow
...
namespace pflow {
  double RdfSh_RMS(const int iaA, const int iaB, const int nsh_max,const int nt,
      ...
      ,const aurostd::matrix<double>& rdfsh_all_B) { //CO20200404 aurostd->pflow
    double rms=0;
    int cnt=0;
...
namespace pflow {
  void CmpRDFShells(const xstructure& str_A, const xstructure& str_B,
    ...
    // Get rms_mat
    rms_mat = aurostd::matrix<double> (nat,nat); pflow::VVset(rms_mat,-1.0); //CO20200404 aurostd->pflow
...
namespace pflow {
  aurostd::matrix<double> GetSmoothRDF(const aurostd::matrix<double>& rdf, //CO20200404 aurostd->pflow
      const double& sigma) {
    aurostd::matrix<double> rdf_sm=rdf;  //CO20200404 aurostd->pflow
...
namespace pflow {
  void CmpStrDist(xstructure str1, xstructure str2,const double& cutoff,
      ...
      aurostd::matrix<double>& dist_diff,aurostd::matrix<double>& dist_diff_n) { //CO20200404 aurostd->pflow
    ...
    dist1=aurostd::matrix<double> (nprs1,tmpvec);  //CO20200404 aurostd->pflow
    dist2=aurostd::matrix<double> (nprs2,tmpvec);  //CO20200404 aurostd->pflow
    ...
    dist_diff = aurostd::matrix<double> (nprs_min,tmpvec); //CO20200404 aurostd->pflow
    dist_diff_n = aurostd::matrix<double> (nprs_min,tmpvec); //CO20200404 aurostd->pflow
...
namespace pflow {
  ...
  rtparams::rtparams() {
    ...
    lightcenter = aurostd::matrix<double> (1,center);  //CO20200404 aurostd->pflow
    lightrad = vector<double> (1,0.001);
    vector<double> color (3,0.0);
    lightcolor = aurostd::matrix<double> (1,color);  //CO20200404 aurostd->pflow
    ...
    shading = "fullshade";
    outfile = "POSCAR_RT";
    sc=aurostd::matrix<double> (3,3); pflow::VVset(sc,0.0);  //CO20200404 aurostd->pflow
    sc[0][0]=1;
    sc[1][1]=1;
    sc[2][2]=1;
    sc_s=0;
...
// Dane Morgan style
namespace pflow {
  void GetDatFromOutcar(vector<aurostd::matrix<double> >& lat_vec, //CO20200404 aurostd->pflow
    ...
    while (outcar_inf >> a[2]) {
      ...
      if(key=="reciprocal lattice vectors") {
        aurostd::matrix<double> lat(3,3);  //CO20200404 aurostd->pflow
...
namespace pflow {
  void GetDatFromXdatcar(vector<aurostd::matrix<double> >& fpos_vec, //CO20200404 aurostd->pflow
      ifstream& xdatcar_inf)
  {
    fpos_vec.clear();
    string s;
    aurostd::matrix<double> dpmat(0);  //CO20200404 aurostd->pflow
    ...
    while (keep_reading) {
      ...
      dpmat=aurostd::matrix<double> (0); //CO20200404 aurostd->pflow
    }
  }
}
...
namespace pflow {
  vector<xstructure> GetStrVecFromOUTCAR_XDATCAR(ifstream& outcar_inf, ifstream& xdatcar_inf) {
    vector<aurostd::matrix<double> > fpos_vec; //CO20200404 aurostd->pflow
    vector<aurostd::matrix<double> > lat_vec;  //CO20200404 aurostd->pflow
    ...
    if(lat_vec.size()<fpos_vec.size()) {
      aurostd::matrix<double> tlat=lat_vec[lat_vec.size()-1];  //CO20200404 aurostd->pflow
...
namespace pflow {
  void JoinStrVec(vector<xstructure> vstr1,
    ...
    for(int is=0;is<size1;is++) {
      ...
      aurostd::matrix<double> lat1=pflow::GetLat(str1);  //CO20200404 aurostd->pflow
      xmatrix<double> xlat1(3,3);xlat1=str1.lattice;
      aurostd::matrix<double> cpos2=pflow::GetCpos(str2);  //CO20200404 aurostd->pflow
...
namespace pflow {
  void SetStrFromRTParams(xstructure& str, pflow::rtparams& rtp) {
    ...
    if(rtp.sc_s) {
      ...
      _supercell=aurostd::matrix2xmatrix(rtp.sc);  //CO20200404 aurostd->pflow
...
namespace pflow {
  void SuperCellStrVec(vector<xstructure>& vstr, const aurostd::matrix<double>& sc) {  //CO20200404 aurostd->pflow
    if(vstr.size()==0) return;
    for(int is=0;is<(int)vstr.size();is++) {
      xmatrix<double> _supercell(3,3);
      _supercell=aurostd::matrix2xmatrix(sc);  //CO20200404 aurostd->pflow
...
namespace pflow {
  void SetRTParams(xstructure& str, pflow::rtparams& rtp) {
    ...
    str=ReScale(str,1.0);
    aurostd::matrix<double> lat=pflow::GetLat(str);  //CO20200404 aurostd->pflow
    aurostd::matrix<double> cpos=pflow::GetCpos(str);  //CO20200404 aurostd->pflow
    int nat=cpos.size();
    ...
    if(rtp.first_set) {
      ...
      aurostd::matrix<double> tmp; //CO20200404 aurostd->pflow
      int size;
      // Set sphtex_tex
      size=rtp.sphtex_tex_def.size();
      tmp=aurostd::matrix<double> (ntypes,rtp.sphtex_tex_def); //CO20200404 aurostd->pflow
      ...
      tmp=aurostd::matrix<double> (ntypes,rtp.sphtex_color_def); //CO20200404 aurostd->pflow
      ...
      tmp=aurostd::matrix<double> (ntypes,rtp.sphtex_phong_def); //CO20200404 aurostd->pflow
...
namespace pflow {
  aurostd::matrix<double> GetRotationMatrix(const vector<double>& angles) {  //CO20200404 aurostd->pflow
    // Sin and cos.
    ...
    aurostd::matrix<double> xm(3,3);pflow::VVset(xm,0.0);  //CO20200404 aurostd->pflow
    aurostd::matrix<double> ym(3,3);pflow::VVset(ym,0.0);  //CO20200404 aurostd->pflow
    aurostd::matrix<double> zm(3,3);pflow::VVset(zm,0.0);  //CO20200404 aurostd->pflow
    ...
    aurostd::matrix<double> rm;  //CO20200404 aurostd->pflow
...
namespace pflow {
  void RotateStrVec(vector<xstructure>& vstr, const vector<double>& rot) {
    ...
    aurostd::matrix<double> irm=GetRotationMatrix(angles); //CO20200404 aurostd->pflow
    ...
    aurostd::matrix<double> prm=GetRotationMatrix(angles); //CO20200404 aurostd->pflow
    aurostd::matrix<double> rm=irm;  //CO20200404 aurostd->pflow
    xmatrix<double> xprm(3,3); xprm=aurostd::matrix2xmatrix(prm);  //CO20200404 aurostd->pflow
    xmatrix<double> xrm(3,3);  xrm=aurostd::matrix2xmatrix(rm);  //CO20200404 aurostd->pflow
    for(int is=0;is<(int)vstr.size();is++) {
      //    xrm=aurostd::matrix2xmatrix(rm); //CO20200404 aurostd->pflow
      //   vstr[is]=Rotate(vstr[is],xrm);
      vstr[is]=Rotate(vstr[is],aurostd::matrix2xmatrix(rm)); //CO20200404 aurostd->pflow
...
namespace pflow {
  void ReadInProj(projdata& pd) {
    ...
    pd.wfermi_u = aurostd::matrix<double> (pd.nbands,pd.nkpts,0.0);  //CO20200404 aurostd->pflow
    ...
    // Projections
    aurostd::matrix<std::complex<double> > m(pd.nbands,pd.nlm,0.0);  //CO20200404 aurostd->pflow
    aurostd::matrix<aurostd::matrix<std::complex<double> > > mm(pd.nkpts,pd.nions,m);  //CO20200404 aurostd->pflow
    pd.pdat_u=vector<aurostd::matrix<aurostd::matrix<std::complex<double> > > > (pd.ntypes,mm);  //CO20200404 aurostd->pflow
    ...
    pd.kpts = aurostd::matrix<double> (pd.nkpts,3,0.0);  //CO20200404 aurostd->pflow
    pd.ener_k_b_u = aurostd::matrix<double> (pd.nkpts,pd.nbands,0.0);  //CO20200404 aurostd->pflow
    ...
    if(aurostd::RemoveSpaces(s)=="PROOUT") {
      ...
      // Fermi weights (kpts (inner loop) and bands (outer loop)).
      pd.wfermi_d = aurostd::matrix<double> (pd.nbands,pd.nkpts,0.0);  //CO20200404 aurostd->pflow
      for(int ib=0;ib<pd.nbands;ib++) {
        for(int ik=0;ik<pd.nkpts;ik++) {
      ...
      aurostd::matrix<std::complex<double> > m(pd.nbands,pd.nlm,0.0);  //CO20200404 aurostd->pflow
      aurostd::matrix<aurostd::matrix<std::complex<double> > > mm(pd.nkpts,pd.nions,m);  //CO20200404 aurostd->pflow
      pd.pdat_d=vector<aurostd::matrix<aurostd::matrix<std::complex<double> > > > (pd.ntypes,mm);  //CO20200404 aurostd->pflow
      vector<double> rval(pd.nlm);
      vector<double> ival(pd.nlm);
      for(int it=0;it<pd.ntypes;it++) {
        for(int ik=0;ik<pd.nkpts;ik++) {
      ...
      // Kpt weights and values and energy vs. kpt,bnd
      pd.ener_k_b_d = aurostd::matrix<double> (pd.nkpts,pd.nbands,0.0);  //CO20200404 aurostd->pflow
      getline(infile,s); // Gets line "# of k-points: ..."
      for(int ik=0;ik<pd.nkpts;ik++) {
        getline(infile,s); // Gets blank line.
        infile >>sdum>>sdum>>sdum>>pd.kpts[ik][0]>>pd.kpts[ik][1]>>pd.kpts[ik][2]>>sdum>>sdum>>pd.wkpt[ik];
...
namespace pflow {
  void CalcNeatProj(projdata& pd, int only_occ) {
    ...
    aurostd::matrix<double> m1 (pd.nbands,pd.nlm_max,0.0); //CO20200404 aurostd->pflow
    aurostd::matrix<double> m2 (pd.nkpts,pd.nlm_max,0.0);  //CO20200404 aurostd->pflow
    aurostd::matrix<double> m3 (pd.nbands,pd.nlm_max,0.0); //CO20200404 aurostd->pflow
    pd.occ_vs_ion_kpt_bnd_lm_u = aurostd::matrix<aurostd::matrix<double> > (pd.nions,pd.nkpts,m1); //CO20200404 aurostd->pflow
    pd.occ_vs_ion_kpt_lm_u = vector<aurostd::matrix<double> > (pd.nions,m2); //CO20200404 aurostd->pflow
    pd.occ_vs_ion_bnd_lm_u = vector<aurostd::matrix<double> > (pd.nions,m3); //CO20200404 aurostd->pflow
    pd.occ_vs_ion_lm_u = aurostd::matrix<double> (pd.nions,pd.nlm_max,0.0);  //CO20200404 aurostd->pflow
    if(pd.sp) {
      pd.occ_vs_ion_kpt_bnd_lm_d = aurostd::matrix<aurostd::matrix<double> > (pd.nions,pd.nkpts,m1); //CO20200404 aurostd->pflow
      pd.occ_vs_ion_kpt_lm_d = vector<aurostd::matrix<double> > (pd.nions,m2); //CO20200404 aurostd->pflow
      pd.occ_vs_ion_bnd_lm_d = vector<aurostd::matrix<double> > (pd.nions,m3); //CO20200404 aurostd->pflow
      pd.occ_vs_ion_lm_d = aurostd::matrix<double> (pd.nions,pd.nlm_max,0.0);  //CO20200404 aurostd->pflow
    }
    ioncnt=-1;
    for(int it=0;it<pd.ntypes;it++) {
      for(int iat=0;iat<pd.num_each_type.at(it);iat++) {
    ...
    aurostd::matrix<double> n1 (pd.nbands,pd.nl_max+1,0.0);  //CO20200404 aurostd->pflow
    aurostd::matrix<double> n2 (pd.nkpts,pd.nl_max+1,0.0); //CO20200404 aurostd->pflow
    aurostd::matrix<double> n3 (pd.nbands,pd.nl_max+1,0.0);  //CO20200404 aurostd->pflow
    pd.occ_vs_ion_kpt_bnd_l_u = aurostd::matrix<aurostd::matrix<double> > (pd.nions,pd.nkpts,n1);  //CO20200404 aurostd->pflow
    pd.occ_vs_ion_kpt_l_u = vector<aurostd::matrix<double> > (pd.nions,n2);  //CO20200404 aurostd->pflow
    pd.occ_vs_ion_bnd_l_u = vector<aurostd::matrix<double> > (pd.nions,n3);  //CO20200404 aurostd->pflow
    pd.occ_vs_ion_l_u = aurostd::matrix<double> (pd.nions,pd.nl_max+1,0.0);  //CO20200404 aurostd->pflow
    if(pd.sp) {
      pd.occ_vs_ion_kpt_bnd_l_d = aurostd::matrix<aurostd::matrix<double> > (pd.nions,pd.nkpts,n1);  //CO20200404 aurostd->pflow
      pd.occ_vs_ion_kpt_l_d = vector<aurostd::matrix<double> > (pd.nions,n2);  //CO20200404 aurostd->pflow
      pd.occ_vs_ion_bnd_l_d = vector<aurostd::matrix<double> > (pd.nions,n3);  //CO20200404 aurostd->pflow
      pd.occ_vs_ion_l_d = aurostd::matrix<double> (pd.nions,pd.nl_max+1,0.0);  //CO20200404 aurostd->pflow
    }
    ...
    m1 = aurostd::matrix<double> (pd.nbands,pd.nlmtot,0.0);  //CO20200404 aurostd->pflow
    pd.occ_vs_ion_kpt_bnd_lmtot_u = aurostd::matrix<aurostd::matrix<double> > (pd.nions,pd.nkpts,m1);  //CO20200404 aurostd->pflow
    if(pd.sp) pd.occ_vs_ion_kpt_bnd_lmtot_d = aurostd::matrix<aurostd::matrix<double> > (pd.nions,pd.nkpts,m1);  //CO20200404 aurostd->pflow
...
namespace pflow {
  void CalcPDOS(const projdata& prd, pdosdata& pdd) {
    ...
    int sp_size=1;
    if(prd.sp) sp_size=3;
    pdd.pdos = aurostd::matrix<double> (pdd.nbins,2*sp_size+1,0.0);  //CO20200404 aurostd->pflow
...
namespace pflow {
  void ReadInPDOSData(aurostd::matrix<aurostd::matrix<double> >& allpdos, pflow::pdosdata& pdd,  //CO20200404 aurostd->pflow
      ifstream& infile) {
    string sdum;
    // Get natoms
    infile >> pdd.natoms;
    ...
    aurostd::matrix<double> tmp(pdd.nlm+1,pdd.nbins);  //CO20200404 aurostd->pflow
    allpdos = aurostd::matrix<aurostd::matrix<double> > (pdd.natoms,pdd.spin,tmp); //CO20200404 aurostd->pflow
    // tpx
...
namespace pflow {
  void SumPDOS(const aurostd::matrix<aurostd::matrix<double> >& allpdos, pflow::pdosdata& pdd) { //CO20200404 aurostd->pflow
    if(pdd.spin==1) {
      pdd.pdos = aurostd::matrix<double> (pdd.nbins,3);  //CO20200404 aurostd->pflow
    }
    else {
      pdd.pdos = aurostd::matrix<double> (pdd.nbins,7);  //CO20200404 aurostd->pflow
    }
    // Set energies
    for(int ib=0;ib<pdd.nbins;ib++) {
...
namespace pflow {
  double TotalAtomDist(xstructure str, xstructure str00, const string& path_flag) {
    ...
    aurostd::matrix<double> cpos=pflow::GetCpos(str);  //CO20200404 aurostd->pflow
    aurostd::matrix<double> cpos00=pflow::GetCpos(str00);  //CO20200404 aurostd->pflow
    aurostd::matrix<double> lat=pflow::GetLat(str);  //CO20200404 aurostd->pflow
...
namespace pflow {
  vector<double> GetRBDistCum(const vector<xstructure>& vstr, const string& path_flag) {
    ...
    xstructure diffstr;
    aurostd::matrix<double> cm;  //CO20200404 aurostd->pflow
...
namespace pflow {
  void RBPoscarDisp(const xstructure& str1in, const xstructure& str2in,
      xstructure& diffstr, double& totdist, aurostd::matrix<double>& cm, //CO20200404 aurostd->pflow
      const string& path_flag) {
    diffstr=str1in;
    ...
    str1=ReScale(str1,1);
    str2=ReScale(str2,1);
    aurostd::matrix<double> cpos1=pflow::GetCpos(str1);  //CO20200404 aurostd->pflow
    aurostd::matrix<double> cpos2=pflow::GetCpos(str2);  //CO20200404 aurostd->pflow
    aurostd::matrix<double> lat1=pflow::GetLat(str1);  //CO20200404 aurostd->pflow
    aurostd::matrix<double> lat2=pflow::GetLat(str1);  //CO20200404 aurostd->pflow
    aurostd::matrix<double> latdiff(3,3);  //CO20200404 aurostd->pflow
    cm = aurostd::matrix<double> (2);  //CO20200404 aurostd->pflow
    int nat=min(cpos1.size(),cpos2.size());
    aurostd::matrix<double> cposdiff(nat,3); //CO20200404 aurostd->pflow
    totdist=0;
    for(int ic=0;ic<3;ic++) {
...
namespace pflow {
  void GetChgInt(vector<aurostd::matrix<double> >& rad_chg_int, aurostd::matrix<double>& vor_chg_int) {  //CO20200404 aurostd->pflow
    // Read in CHGCAR
    ...
    aurostd::matrix<double> dum_mat(NRBIN,5,0.0);  //CO20200404 aurostd->pflow
    rad_chg_int = vector<aurostd::matrix<double> > (natoms,dum_mat); //CO20200404 aurostd->pflow
    vector<int> ig(3);
    ...
    // Atom loop
    aurostd::matrix<double> at_fpos=pflow::GetFpos(str); //CO20200404 aurostd->pflow
    ...
    vor_chg_int = aurostd::matrix<double> (natoms,4,0.0);  //CO20200404 aurostd->pflow
...
namespace pflow {
  void GetChgInt(vector<aurostd::matrix<double> >& rad_chg_int,  //CO20200404 aurostd->pflow
...
namespace pflow {
  ...
  void ReadPlaneDensParams(const xstructure& str, pd_params& pdp, istream& infile) {
    ...
    string s;
    double TOL=1e-7;
    pdp.pts = aurostd::matrix<double> (3,3); //CO20200404 aurostd->pflow
    pdp.dpts = aurostd::matrix<double> (3,3);  //CO20200404 aurostd->pflow
    infile >> pdp.type;
    getline(infile,s);
    infile >> pdp.scale;
    getline(infile,s);
...
namespace pflow {
  void Ewald(const xstructure& in_str,double& epoint,double& ereal,
    ...
    str=PutInCell(str);
    aurostd::matrix<double> lat = pflow::GetScaledLat(str);  //CO20200404 aurostd->pflow
    aurostd::matrix<double> rlat = pflow::RecipLat(lat); //CO20200404 aurostd->pflow
    int natoms=pflow::GetNumAtoms(str);
    double vol=pflow::GetVol(lat);
    aurostd::matrix<double> atfpos=pflow::GetFpos(str);  //CO20200404 aurostd->pflow
...
namespace pflow {
  double GetRecipEner(const double& eta,const vector<double>& atchg,
      const double& vol,const aurostd::matrix<double>& rlat, //CO20200404 aurostd->pflow
      const aurostd::matrix<double>& atfpos,const double& SUMTOL) {  //CO20200404 aurostd->pflow
    double TOL=1e-16;
...
namespace pflow {
  double GetRealEner(const double& eta,const vector<double>& atchg,
      const double& vol,const aurostd::matrix<double>& lat,  //CO20200404 aurostd->pflow
      const aurostd::matrix<double>& atfpos,const double& SUMTOL) {  //CO20200404 aurostd->pflow
