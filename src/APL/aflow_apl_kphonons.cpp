...
namespace KBIN {
  ...
  bool relaxStructureAPL_VASP(int start_relax,
    ...
    l << "Relaxations will be performed on a " << aurostd::joinWDelimiter(kpts_pc, "x") << " k-point grid." << apl::endl;

    // Create k-points file
    stringstream kpts_file;
    kpts_file << "k-points automatically generated by APL,"
              << " supercell = " << aurostd::joinWDelimiter(scell_dims, "x") << ","
              << " kppra = " << kppra_phonons << " (k = " << aurostd::joinWDelimiter(kpts_sc, "x")  << ")" << std::endl;
  ...
  void RunPhonons_APL_181216(_xinput& xinput,
    ...
    if (!aurostd::EFileExist(phposcar_file) && USER_RELAX) {
      ...
      if (xinput.AFLOW_MODE_VASP) {
        ...
        Krun = relaxStructureAPL_VASP(START_RELAX, AflowIn, supercell_opts, scell_dims,
            xinput.xvasp, aflags, kflags, xflags.vflags, messageFile);
      }
      if (!Krun) {
    ...
    //ME20200102 - Moved into apl::Supercell
      ...
      //[OBSOLETE]  // ME 181026 - Added default case: if there are no supercell entries,
      ...
      //[OBSOLETE]   bool USER_WANTS_FULL_SHELL = false;  // ME 181026
