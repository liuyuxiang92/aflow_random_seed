...
bool relaxStructureAPL_VASP(int start_relax,
  ...
  KPPRA(kpts_sc[1], kpts_sc[2], kpts_sc[3], scell.getSupercellStructure().lattice, kppra_phonons);
  ...
  kpts_file << "k-points automaticall generated by APL, "
  ...
  // would lead to inconsistencies between the supercell creation
  ...
  if (scell_dims != scell_dims_new) {
    ...
    string message = "Supercell dimensions of input and relaxed structure do not agree."
                     " This is likely due to different symmetries in these structures. Use"
                     " an input structure that is closer to the fully relaxed one, remove"
                     " the CONTCAR.relax_apl* files, and run APL again.";
    throw aurostd::xerror(_AFLOW_FILE_NAME_, function, message, _RUNTIME_ERROR_);
  }
  xvector<int> kpts_sc_new(3);
  scell.build(scell_dims_new, false);
  KPPRA(kpts_sc_new[1], kpts_sc_new[2], kpts_sc_new[3], scell.getSupercellStructure().lattice, kppra_phonons);
  if (kpts_sc != kpts_sc_new) {
    string function = "KBIN::relaxStructureAPL_VASP()";
    string message = "k-point grids  of the supercells of the input and relaxed structure do not agree."
                     " This is likely due to different symmetries in these structures. Use"
                     " an input structure that is closer to the fully relaxed one, remove"
                     " the CONTCAR.relax_apl* files, and run APL again.";
    throw aurostd::xerror(_AFLOW_FILE_NAME_, function, message, _RUNTIME_ERROR_);
...
//[OBSOLETE]    //apl::Supercell supercell_test = supercell;    //CO  // OBSOLETE ME191223 - not used
//[OBSOLETE]
...
//[OBSOLETE]    }
//[OBSOLETE]
//[OBSOLETE]    //      cerr << "USER_WANTS_FULL_SHELL=" << USER_WANTS_FULL_SHELL << endl;
//[OBSOLETE]    //    for(int i=2;i<20;i+=2) cerr << "try " << i << ": " << supercell_test.buildSuitableForShell(i,USER_WANTS_FULL_SHELL,FALSE) << endl;
//[OBSOLETE]
//[OBSOLETE]    if (USER_SUPERCELL.empty() && kflags.KBIN_MODULE_OPTIONS.supercell_method[2]) {  // Not documented - ME181026
...
//[OBSOLETE]        supercell.setupShellRestrictions(USER_MAXSHELL);
//[OBSOLETE]//    } else {  OBSOLETE ME181026
