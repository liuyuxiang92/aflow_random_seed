...
bool APENNSY_Parameters::LoadLibrary(_aflags &aflags) {
  ...
  if(in_file_pointer_TMELTING==NULL) {
    throw aurostd::xerror(_AFLOW_FILE_NAME_,__AFLOW_FUNC__,"file not found [M]: "+MELTING_FILE,_FILE_CORRUPT_); //CO20200624
  }
  ...
  { //CO20200106 - patching for auto-indenting
    ...
    if(!strstr(string_line_TMELTING,alloys.at(nalloy))) {
      throw aurostd::xerror(_AFLOW_FILE_NAME_,__AFLOW_FUNC__,"string "+alloys.at(nalloy)+" not found in "+string_line_TMELTING,_FILE_CORRUPT_); //CO20200624
    }
    ...
    for(uint i=0;i<vaflowlib.size();i++) { // i in vaflowlib.size()
      ...
      if(ishole==FALSE) {
        ...
        //    throw aurostd::xerror(_AFLOW_FILE_NAME_,__AFLOW_FUNC__,"struct_proprts.vstr.size()="+aurostd::utype2string(struct_proprts.vstr.size()),_INDEX_MISMATCH_); //CO20200624
        //	}
        xstructure xstr;
        if(XHOST.APENNSY_USE_SERVER) {
          string aurl;	
          ...
          if(!aurostd::FileExist(aurl+"/POSCAR.relax1") && !aurostd::FileExist(aurl+"/POSCAR.orig")) {
            throw aurostd::xerror(_AFLOW_FILE_NAME_,__AFLOW_FUNC__,"aurl=\""+aurl+"\" needed POSCAR.orig/POSCAR.relax1",_FILE_CORRUPT_); //CO20200624
          }
          ...
          if(!aurostd::FileExist(aurl+"/CONTCAR.relax1") && !aurostd::FileExist(aurl+"/POSCAR.relax2")) {
            throw aurostd::xerror(_AFLOW_FILE_NAME_,__AFLOW_FUNC__,"aurl=\""+aurl+"\" needed POSCAR.relax2/CONTCAR.relax1",_FILE_CORRUPT_); //CO20200624
          }
          ...
          if(!aurostd::FileExist(aurl+"/CONTCAR.relax") && !aurostd::FileExist(aurl+"/CONTCAR.relax2")) {
            throw aurostd::xerror(_AFLOW_FILE_NAME_,__AFLOW_FUNC__,"aurl=\""+aurl+"\" needed CONTCAR.relax/CONTCAR.relax2",_FILE_CORRUPT_); //CO20200624
          }
        ...
        if(XHOST.APENNSY_SERVER_AFLOWLIB_ORG) { 	  // load files
          ...
          if(!aurostd::substring2bool(vaflowlib.at(i).vfiles,"POSCAR.relax1") && !aurostd::substring2bool(vaflowlib.at(i).vfiles,"POSCAR.orig")) {
            throw aurostd::xerror(_AFLOW_FILE_NAME_,__AFLOW_FUNC__,"vaflowlibentry_url.at(i)=\""+vaflowlibentry_url.at(i)+"\" needed POSCAR.orig/POSCAR.relax1",_FILE_CORRUPT_); //CO20200624
          }
          ...
          if(!aurostd::substring2bool(vaflowlib.at(i).vfiles,"CONTCAR.relax1") && !aurostd::substring2bool(vaflowlib.at(i).vfiles,"POSCAR.relax2")) {
            throw aurostd::xerror(_AFLOW_FILE_NAME_,__AFLOW_FUNC__,"vaflowlibentry_url.at(i)=\""+vaflowlibentry_url.at(i)+"\" needed POSCAR.relax2/CONTCAR.relax1",_FILE_CORRUPT_); //CO20200624
          }
          ...
          if(!aurostd::substring2bool(vaflowlib.at(i).vfiles,"CONTCAR.relax") && !aurostd::substring2bool(vaflowlib.at(i).vfiles,"CONTCAR.relax2")) {
            throw aurostd::xerror(_AFLOW_FILE_NAME_,__AFLOW_FUNC__,"vaflowlibentry_url.at(i)=\""+vaflowlibentry_url.at(i)+"\" needed CONTCAR.relax/CONTCAR.relax2",_FILE_CORRUPT_); //CO20200624
          }
        ...
        //  throw aurostd::xerror(_AFLOW_FILE_NAME_,__AFLOW_FUNC__,message,_INPUT_NUMBER_); //CO20200624
        // }
