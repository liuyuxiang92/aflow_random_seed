...
namespace pflow {
  ...
  void PrintChgInt(vector<aurostd::matrix<double> >& rad_chg_int,aurostd::matrix<double>& vor_chg_int,ostream& oss=cout);  //CO20200404 aurostd->pflow
...
void PrintRDF(const xstructure& str,const double& rmax,const int& nbins,const int& smooth_width,const aurostd::matrix<double>& rdf_all,
    aurostd::matrix<double>& rdfsh_all,aurostd::matrix<double>& rdfsh_loc,ostream& oss=cout);  //CO20200404 aurostd->pflow
void PrintRDFCmp(const xstructure& str_A,const xstructure& str_B,const double& rmax,const int nbins,
    ...
    const aurostd::matrix<double>& rms_mat,ostream& oss=cout); //CO20200404 aurostd->pflow
...
namespace pflow {
  ...
  void GetXrayData(const xstructure& str,vector<double>& dist,vector<double>& sf,
      ...
      vector<vector<double> >& ids,aurostd::matrix<double>& data,double lambda=XRAY_RADIATION_COPPER_Kalpha);  //CO20190409  //CO20190620 - intmax can be grabbed later  //CO20200404 aurostd->pflow
  void GetRDF(xstructure str,const double& rmax,const int& nbins,aurostd::matrix<double>& rdf_all);  //CO20200404 aurostd->pflow
  void GetRDFShells(const xstructure& str,const double& rmax,const int& nbins,const int& smooth_width,
      const aurostd::matrix<double>& rdf,aurostd::matrix<double>& rdfsh,aurostd::matrix<double>& rdfsh_loc); //CO20200404 aurostd->pflow
  double RdfSh_RMS(const int iaA,const int iaB,const int nsh_max,const int nt,
      const aurostd::matrix<double>& rdfsh_all_A,const aurostd::matrix<double>& rdfsh_all_B);  //CO20200404 aurostd->pflow
  ...
  aurostd::matrix<double> GetSmoothRDF(const aurostd::matrix<double>& rdf,const double& sigma);  //CO20200404 aurostd->pflow
...
namespace pflow {
  class pdosdata
  {
    public:
      ...
      // variables
      string PDOSinfile;
      aurostd::matrix<int> pdos_at;  //CO20200404 aurostd->pflow
      aurostd::matrix<int> pdos_k;   //CO20200404 aurostd->pflow
      aurostd::matrix<int> pdos_b;   //CO20200404 aurostd->pflow
      aurostd::matrix<int> pdos_lm;  //CO20200404 aurostd->pflow
      aurostd::matrix<double> pdos;  //CO20200404 aurostd->pflow
      double emin;
      double emax;
      double efermi;
      double smooth_sigma;
...
namespace pflow {
  class rtparams
  {
    public:
      ...
      aurostd::matrix<double> lightcenter; //CO20200404 aurostd->pflow
      vector<double> lightrad;
      aurostd::matrix<double> lightcolor;  //CO20200404 aurostd->pflow
      // Sphere texture variables (ambient, diffuse, specular, opacity)
      aurostd::matrix<double> sphtex_tex;  //CO20200404 aurostd->pflow
      vector<double> sphtex_tex_def;
      aurostd::matrix<double> sphtex_color;  //CO20200404 aurostd->pflow
      vector<double> sphtex_color_def;
      aurostd::matrix<double> sphtex_phong;  //CO20200404 aurostd->pflow
      ...
      string shading;
      string outfile;
      aurostd::matrix<double> sc;  //CO20200404 aurostd->pflow
      int sc_s;
      int calc_type;
  ...
  void GetDatFromOutcar(vector<aurostd::matrix<double> >& lat_vec, deque<int>& num_each_type, ifstream& outcar_inf); //CO20200404 aurostd->pflow
  void GetDatFromXdatcar(vector<aurostd::matrix<double> >& fpos_vec, ifstream& xdatcar_inf); //CO20200404 aurostd->pflow
  vector<xstructure> GetStrVecFromOUTCAR_XDATCAR(ifstream& outcar_inf, ifstream& xdatcar_inf);
  ...
  void SuperCellStrVec(vector<xstructure>& str_vec, const aurostd::matrix<double>& sc);  //CO20200404 aurostd->pflow
...
namespace pflow {
  class projdata
  {
    public:
      ...
      aurostd::matrix<double> wfermi_u;  //CO20200404 aurostd->pflow
      aurostd::matrix<double> wfermi_d;  //CO20200404 aurostd->pflow
      vector<double> wkpt;
      vector<aurostd::matrix<aurostd::matrix<std::complex<double> > > > pdat_u;  //CO20200404 aurostd->pflow
      vector<aurostd::matrix<aurostd::matrix<std::complex<double> > > > pdat_d;  //CO20200404 aurostd->pflow
      aurostd::matrix<aurostd::matrix<double> > occ_vs_ion_kpt_bnd_lm_u; //CO20200404 aurostd->pflow
      aurostd::matrix<aurostd::matrix<double> > occ_vs_ion_kpt_bnd_lm_d; //CO20200404 aurostd->pflow
      aurostd::matrix<aurostd::matrix<double> > occ_vs_ion_kpt_bnd_l_u;  //CO20200404 aurostd->pflow
      aurostd::matrix<aurostd::matrix<double> > occ_vs_ion_kpt_bnd_l_d;  //CO20200404 aurostd->pflow
      aurostd::matrix<aurostd::matrix<double> > occ_vs_ion_kpt_bnd_lmtot_u;  //CO20200404 aurostd->pflow
      aurostd::matrix<aurostd::matrix<double> > occ_vs_ion_kpt_bnd_lmtot_d;  //CO20200404 aurostd->pflow
      vector<aurostd::matrix<double> > occ_vs_ion_kpt_lm_u;  //CO20200404 aurostd->pflow
      vector<aurostd::matrix<double> > occ_vs_ion_kpt_lm_d;  //CO20200404 aurostd->pflow
      vector<aurostd::matrix<double> > occ_vs_ion_kpt_l_u; //CO20200404 aurostd->pflow
      vector<aurostd::matrix<double> > occ_vs_ion_kpt_l_d; //CO20200404 aurostd->pflow
      vector<aurostd::matrix<double> > occ_vs_ion_bnd_lm_u;  //CO20200404 aurostd->pflow
      vector<aurostd::matrix<double> > occ_vs_ion_bnd_lm_d;  //CO20200404 aurostd->pflow
      vector<aurostd::matrix<double> > occ_vs_ion_bnd_l_u; //CO20200404 aurostd->pflow
      vector<aurostd::matrix<double> > occ_vs_ion_bnd_l_d; //CO20200404 aurostd->pflow
      aurostd::matrix<double> occ_vs_ion_lm_u; //CO20200404 aurostd->pflow
      aurostd::matrix<double> occ_vs_ion_lm_d; //CO20200404 aurostd->pflow
      aurostd::matrix<double> occ_vs_ion_l_u;  //CO20200404 aurostd->pflow
      aurostd::matrix<double> occ_vs_ion_l_d;  //CO20200404 aurostd->pflow
      aurostd::matrix<double> ener_k_b_u;  //CO20200404 aurostd->pflow
      aurostd::matrix<double> ener_k_b_d;  //CO20200404 aurostd->pflow
      int sp;
      int rspin;
      aurostd::matrix<double> kpts;  //CO20200404 aurostd->pflow
      vector<string> LMnames;
      vector<string> Lnames;
      vector<string> LLMnames;
      string PROOUTinfile;
      aurostd::matrix<double> lat; //CO20200404 aurostd->pflow
  };
}
...
namespace pflow {
  ...
  void ReadInPDOSData(aurostd::matrix<aurostd::matrix<double> >& allpdos, pflow::pdosdata& pdd,ifstream& infile);  //CO20200404 aurostd->pflow
...
namespace pflow {
  ...
  void RBPoscarDisp(const xstructure& str1in, const xstructure& str2in,xstructure& diffstr, double& totdist, aurostd::matrix<double>& cm,const string& path_flag); //CO20200404 aurostd->pflow
}

// in aflow_pflow_print.cpp
void PrintRBAnal(const int& nim, const string& path_flag, ostream& outf);
void PrintRBPoscarDisp(const xstructure& diffstr, double& totdist, aurostd::matrix<double>& cm, const string& path_flag, ostream& outf); //CO20200404 aurostd->pflow
...
namespace pflow {
  class pd_params {
    public:
      string type;
      double scale;
      aurostd::matrix<double> pts; //CO20200404 aurostd->pflow
      aurostd::matrix<double> dpts;  //CO20200404 aurostd->pflow
      int Nx,Ny;
      string orig_loc;
      string ortho;
...
namespace pflow {
  ...
  double GetRecipEner(const double& eta,const vector<double>& atchg,const double& vol,
      const aurostd::matrix<double>& rlat,const aurostd::matrix<double>& fpos,const double& SUMTOL); //CO20200404 aurostd->pflow
  double GetRealEner(const double& eta,const vector<double>& atchg,const double& vol,
      const aurostd::matrix<double>& lat,const aurostd::matrix<double>& fpos,const double& SUMTOL);  //CO20200404 aurostd->pflow
