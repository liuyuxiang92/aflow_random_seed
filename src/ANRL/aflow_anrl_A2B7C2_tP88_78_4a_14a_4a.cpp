...
namespace anrl {
  uint PrototypeANRL_A2B7C2_tP88_78_4a_14a_4a(ostream &oss,stringstream &web,xstructure& str,string parameters,string proto_line,uint print_mode,bool LDEBUG) {
