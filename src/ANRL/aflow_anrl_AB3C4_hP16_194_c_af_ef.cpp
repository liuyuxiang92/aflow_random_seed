...
#ifndef _AFLOW_ANRL_AB3C4_hP16_194_c_af_ef_CPP
#define _AFLOW_ANRL_AB3C4_hP16_194_c_af_ef_CPP
#include "../aflow.h"
...
namespace anrl {
  uint PrototypeANRL_AB3C4_hP16_194_c_af_ef(ostream &oss,stringstream &web,xstructure& str,string parameters,string proto_line,uint print_mode,bool LDEBUG) {
