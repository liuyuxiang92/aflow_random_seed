...
// FILE "ANRL/aflow_anrl_A2BC_oC8_38_e_a_b.cpp"

#ifndef _AFLOW_ANRL_A2BC_oC8_38_e_a_b_CPP
#define _AFLOW_ANRL_A2BC_oC8_38_e_a_b_CPP
#include "../aflow.h"
...
namespace anrl {
  uint PrototypeANRL_A2BC_oC8_38_e_a_b(ostream &oss,stringstream &web,xstructure& str,string parameters,string proto_line,uint print_mode,bool LDEBUG) {
    // system A2BC_oC8_38_e_a_b
    ...
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2BC_oC8_38_e_a_b: nspecies=" << nspecies << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2BC_oC8_38_e_a_b: natoms=" << natoms << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2BC_oC8_38_e_a_b: spacegroup=" << spacegroup << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2BC_oC8_38_e_a_b: nunderscores=" << nunderscores << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2BC_oC8_38_e_a_b: nparameters=" <<  nparameters << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2BC_oC8_38_e_a_b: Pearson_symbol=" << Pearson_symbol << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2BC_oC8_38_e_a_b: params=" << params << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2BC_oC8_38_e_a_b: Strukturbericht=" << Strukturbericht << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2BC_oC8_38_e_a_b: prototype=" << prototype << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2BC_oC8_38_e_a_b: dialect=" << dialect << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A2BC_oC8_38_e_a_b: vparameters.size()=" << vparameters.size() << endl;}
