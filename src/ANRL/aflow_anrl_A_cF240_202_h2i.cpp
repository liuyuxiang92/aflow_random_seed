...
#ifndef _AFLOW_ANRL_A_cF240_202_h2i_CPP
#define _AFLOW_ANRL_A_cF240_202_h2i_CPP
#include "../aflow.h"
...
namespace anrl {
  uint PrototypeANRL_A_cF240_202_h2i(ostream &oss,stringstream &web,xstructure& str,string parameters,string proto_line,uint print_mode,bool LDEBUG) {
