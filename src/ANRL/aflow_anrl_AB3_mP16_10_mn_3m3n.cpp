...
#ifndef _AFLOW_ANRL_AB3_mP16_10_mn_3m3n_CPP
#define _AFLOW_ANRL_AB3_mP16_10_mn_3m3n_CPP
#include "../aflow.h"
...
namespace anrl {
  uint PrototypeANRL_AB3_mP16_10_mn_3m3n(ostream &oss,stringstream &web,xstructure& str,string parameters,string proto_line,uint print_mode,bool LDEBUG) {
