...
#ifndef _AFLOW_ANRL_A3B2_tP10_83_adk_j_CPP
#define _AFLOW_ANRL_A3B2_tP10_83_adk_j_CPP
#include "../aflow.h"
...
namespace anrl {
  uint PrototypeANRL_A3B2_tP10_83_adk_j(ostream &oss,stringstream &web,xstructure& str,string parameters,string proto_line,uint print_mode,bool LDEBUG) {
