...
#ifndef _AFLOW_ANRL_A6B23_cF116_225_e_acfh_CPP
#define _AFLOW_ANRL_A6B23_cF116_225_e_acfh_CPP
#include "../aflow.h"
...
namespace anrl {
  uint PrototypeANRL_A6B23_cF116_225_e_acfh(ostream &oss,stringstream &web,xstructure& str,string parameters,string proto_line,uint print_mode,bool LDEBUG) {
