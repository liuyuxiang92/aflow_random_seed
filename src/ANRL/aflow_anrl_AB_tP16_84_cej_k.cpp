...
#ifndef _AFLOW_ANRL_AB_tP16_84_cej_k_CPP
#define _AFLOW_ANRL_AB_tP16_84_cej_k_CPP
#include "../aflow.h"
...
namespace anrl {
  uint PrototypeANRL_AB_tP16_84_cej_k(ostream &oss,stringstream &web,xstructure& str,string parameters,string proto_line,uint print_mode,bool LDEBUG) {
