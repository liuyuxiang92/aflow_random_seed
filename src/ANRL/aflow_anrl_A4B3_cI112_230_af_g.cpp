...
#ifndef _AFLOW_ANRL_A4B3_cI112_230_af_g_CPP
#define _AFLOW_ANRL_A4B3_cI112_230_af_g_CPP
#include "../aflow.h"
...
namespace anrl {
  uint PrototypeANRL_A4B3_cI112_230_af_g(ostream &oss,stringstream &web,xstructure& str,string parameters,string proto_line,uint print_mode,bool LDEBUG) {
