...
#ifndef _AFLOW_ANRL_AB3_mC16_15_e_cf_CPP
#define _AFLOW_ANRL_AB3_mC16_15_e_cf_CPP
#include "../aflow.h"
...
namespace anrl {
  uint PrototypeANRL_AB3_mC16_15_e_cf(ostream &oss,stringstream &web,xstructure& str,string parameters,string proto_line,uint print_mode,bool LDEBUG) {
