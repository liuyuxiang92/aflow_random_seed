...
#ifndef _AFLOW_ANRL_A_cI16_206_c_CPP
#define _AFLOW_ANRL_A_cI16_206_c_CPP
#include "../aflow.h"
...
namespace anrl {
  uint PrototypeANRL_A_cI16_206_c(ostream &oss,stringstream &web,xstructure& str,string parameters,string proto_line,uint print_mode,bool LDEBUG) {
    // system A_cI16_206_c
