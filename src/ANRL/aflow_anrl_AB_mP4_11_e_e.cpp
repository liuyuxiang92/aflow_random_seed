...
// FILE "ANRL/aflow_anrl_AB_mP4_11_e_e.cpp"

#ifndef _AFLOW_ANRL_AB_mP4_11_e_e_CPP
#define _AFLOW_ANRL_AB_mP4_11_e_e_CPP
#include "../aflow.h"
...
namespace anrl {
  uint PrototypeANRL_AB_mP4_11_e_e(ostream &oss,stringstream &web,xstructure& str,string parameters,string proto_line,uint print_mode,bool LDEBUG) {
    // system AB_mP4_11_e_e
    ...
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB_mP4_11_e_e: FOUND" << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB_mP4_11_e_e: label=" << label << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB_mP4_11_e_e: nspecies=" << nspecies << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB_mP4_11_e_e: natoms=" << natoms << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB_mP4_11_e_e: spacegroup=" << spacegroup << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB_mP4_11_e_e: nunderscores=" << nunderscores << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB_mP4_11_e_e: nparameters=" <<  nparameters << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB_mP4_11_e_e: Pearson_symbol=" << Pearson_symbol << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB_mP4_11_e_e: params=" << params << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB_mP4_11_e_e: Strukturbericht=" << Strukturbericht << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB_mP4_11_e_e: prototype=" << prototype << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB_mP4_11_e_e: dialect=" << dialect << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB_mP4_11_e_e: vparameters.size()=" << vparameters.size() << endl;}
    ...
    uint i=0;
    double a=vparameters.at(i++);                  if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB_mP4_11_e_e: a=" << a << endl;}
