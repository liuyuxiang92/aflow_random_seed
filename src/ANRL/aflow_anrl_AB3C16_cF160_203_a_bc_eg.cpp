...
// FILE "ANRL/aflow_anrl_AB3C16_cF160_203_a_bc_eg.cpp"

#ifndef _AFLOW_ANRL_AB3C16_cF160_203_a_bc_eg_CPP
#define _AFLOW_ANRL_AB3C16_cF160_203_a_bc_eg_CPP
#include "../aflow.h"

namespace anrl {
  uint WebANRL_AB3C16_cF160_203_a_bc_eg(stringstream &web,bool LDEBUG);
}

namespace anrl {
  uint PrototypeANRL_AB3C16_cF160_203_a_bc_eg(ostream &oss,stringstream &web,xstructure& str,string parameters,string proto_line,uint print_mode,bool LDEBUG) {
    // system AB3C16_cF160_203_a_bc_eg

    if(XHOST.vflag_control.flag("WWW")) {
      WebANRL_AB3C16_cF160_203_a_bc_eg(web,LDEBUG); // PLUG WEB STUFF
      #ifdef _ANRL_NOWEB_
      cout << "no web" << endl;
      #else
      cout << web.str() << endl;
    ...
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB3C16_cF160_203_a_bc_eg: FOUND" << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB3C16_cF160_203_a_bc_eg: label=" << label << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB3C16_cF160_203_a_bc_eg: nspecies=" << nspecies << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB3C16_cF160_203_a_bc_eg: natoms=" << natoms << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB3C16_cF160_203_a_bc_eg: spacegroup=" << spacegroup << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB3C16_cF160_203_a_bc_eg: nunderscores=" << nunderscores << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB3C16_cF160_203_a_bc_eg: nparameters=" <<  nparameters << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB3C16_cF160_203_a_bc_eg: Pearson_symbol=" << Pearson_symbol << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB3C16_cF160_203_a_bc_eg: params=" << params << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB3C16_cF160_203_a_bc_eg: Strukturbericht=" << Strukturbericht << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB3C16_cF160_203_a_bc_eg: prototype=" << prototype << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB3C16_cF160_203_a_bc_eg: dialect=" << dialect << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB3C16_cF160_203_a_bc_eg: vparameters.size()=" << vparameters.size() << endl;}
    ...
    uint i=0;
    double a=vparameters.at(i++);                  if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB3C16_cF160_203_a_bc_eg: a=" << a << endl;}
    
    double x4=vparameters.at(i++);                 if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB3C16_cF160_203_a_bc_eg: x4=" << x4 << endl;}
    double x5=vparameters.at(i++);                 if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB3C16_cF160_203_a_bc_eg: x5=" << x5 << endl;}
    double y5=vparameters.at(i++);                 if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB3C16_cF160_203_a_bc_eg: y5=" << y5 << endl;}
    double z5=vparameters.at(i++);                 if(LDEBUG) { cerr << "anrl::PrototypeANRL_AB3C16_cF160_203_a_bc_eg: z5=" << z5 << endl;}
    ...
    atom.fpos(1)=0.0;atom.fpos(2)=0.0;atom.fpos(3)=0.0;                     // atom B5
    atom.fpos_equation.clear();atom.fpos_equation.push_back("0.0");atom.fpos_equation.push_back("0.0");atom.fpos_equation.push_back("0.0");// atom B5 // symbolic math for atom positions
...
namespace anrl {
  uint WebANRL_AB3C16_cF160_203_a_bc_eg(stringstream& web,bool LDEBUG) {
    ...
    if(LDEBUG) {cerr << "anrl:: WebANRL_AB3C16_cF160_203_a_bc_eg: web.str().size()=" << web.str().size() << endl;}
