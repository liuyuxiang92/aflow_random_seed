...
// FILE "ANRL/aflow_anrl_A_cP8_198_2a.cpp"

#ifndef _AFLOW_ANRL_A_cP8_198_2a_CPP
#define _AFLOW_ANRL_A_cP8_198_2a_CPP
#include "../aflow.h"

namespace anrl {
  uint WebANRL_A_cP8_198_2a(stringstream &web,bool LDEBUG);
}

namespace anrl {
  uint PrototypeANRL_A_cP8_198_2a(ostream &oss,stringstream &web,xstructure& str,string parameters,string proto_line,uint print_mode,bool LDEBUG) {
    // system A_cP8_198_2a

    if(XHOST.vflag_control.flag("WWW")) {
      WebANRL_A_cP8_198_2a(web,LDEBUG); // PLUG WEB STUFF
      #ifdef _ANRL_NOWEB_
      cout << "no web" << endl;
      #else
      cout << web.str() << endl;
    ...
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A_cP8_198_2a: FOUND" << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A_cP8_198_2a: label=" << label << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A_cP8_198_2a: nspecies=" << nspecies << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A_cP8_198_2a: natoms=" << natoms << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A_cP8_198_2a: spacegroup=" << spacegroup << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A_cP8_198_2a: nunderscores=" << nunderscores << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A_cP8_198_2a: nparameters=" <<  nparameters << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A_cP8_198_2a: Pearson_symbol=" << Pearson_symbol << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A_cP8_198_2a: params=" << params << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A_cP8_198_2a: Strukturbericht=" << Strukturbericht << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A_cP8_198_2a: prototype=" << prototype << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A_cP8_198_2a: dialect=" << dialect << endl;}
    if(LDEBUG) { cerr << "anrl::PrototypeANRL_A_cP8_198_2a: vparameters.size()=" << vparameters.size() << endl;}
    ...
    uint i=0;
    double a=vparameters.at(i++);                  if(LDEBUG) { cerr << "anrl::PrototypeANRL_A_cP8_198_2a: a=" << a << endl;}
    
    double x1=vparameters.at(i++);                 if(LDEBUG) { cerr << "anrl::PrototypeANRL_A_cP8_198_2a: x1=" << x1 << endl;}
    double x2=vparameters.at(i++);                 if(LDEBUG) { cerr << "anrl::PrototypeANRL_A_cP8_198_2a: x2=" << x2 << endl;}
...
namespace anrl {
  uint WebANRL_A_cP8_198_2a(stringstream& web,bool LDEBUG) {
    ...
    if(LDEBUG) {cerr << "anrl:: WebANRL_A_cP8_198_2a: web.str().size()=" << web.str().size() << endl;}
