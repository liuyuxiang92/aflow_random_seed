...
namespace pflow {
  xstructure SetAllAtomNames(const xstructure& a, const vector<string>& in) {
    ...
    cerr << "Must specity as many names as types/bases: in.size()=" << (int) in.size()  //[CO20200130 - number->basis]
...
namespace pflow {
  xstructure SetNamesWereGiven(const xstructure& a, const vector<int>& in) {
    ...
    cerr << "Must specity as many names as types/bases: in.size()=" << (uint) in.size() //[CO20200130 - number->basis]
