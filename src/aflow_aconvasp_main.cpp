...
uint PflowARGs(vector<string> &argv,vector<string> &cmds,aurostd::xoption &vpflow) {  // vpflow is really XHOST.vflag_pflow
  ...
  // DX [OBSOLETE] - moved further up :  }
  // DX [OBSOLETE] - moved further up : //[CO200106 - close bracket for indenting]}
  // DX [OBSOLETE] - moved further up :  
  ...
  if(vpflow.flag("CHULL::INIT")) {
    ...
    if(vpflow.flag("CHULL::OUTPUT")){
      ...
      for(uint i=0;i<out_forms.size();i++){
        ...
        }//else { //deal with later //[CO200106 - close bracket for indenting]}
      }
  ...
  if(vpflow.flag("COMPARE_MATERIAL") || vpflow.flag("COMPARE_STRUCTURE")) {
    ...
    //DX 20190424 [OBSOLETE]if(vpflow.flag("COMPARE_MATERIAL") || vpflow.flag("COMPARE_STRUCTURE")) { //[CO200106 - close bracket for indenting]}
  ...
  vpflow.flag("CCE_CORRECTION::POSCAR2CCE", aurostd::args2flag(argv,cmds,"--poscar2cce"));
  vpflow.args2addattachedscheme(argv,cmds,"CCE_CORRECTION::PRINT","--print=","OUT");
  vpflow.flag("CCE_CORRECTION::TEST",aurostd::args2flag(argv,cmds,"--cce_test"));
...
namespace pflow {
  ...
  { //CO200106 - patching for auto-indenting
    ...
    //[OBSOLETE CO 180703]  { //CO200106 - patching for auto-indenting
