...
namespace estructure {
  void PLOT_BAND(string options) {
    ...
    fin << "set object 1 rectangle from graph 0,0 to graph 1,1 fc rgb '#E4E4E4' behind fs noborder" << endl;  //CO20170830 - gray background
    fin << "set grid back lt 1 lc rgb 'white' lw 5" << endl; //CO20170830 - white grid
    //fin << "set label 'Generated by AFLOW (Kesong Yang \\& SC Cutarolo)' at screen 0.985, 0.5 font \"Helvetica, 22\" rotate by -90 center " << endl;
    fin << endl;
...
namespace estructure {
  void PLOT_BAND_SPINSPLIT(string options) {
    ...
    if(ISPIN==2) {
      ...
      //finup << "set label 'Generated by AFLOW (Kesong Yang \\& SC Cutarolo)' at screen 0.985, 0.5 font \"Helvetica, 22\" rotate by -90 center " << endl;
      finup << endl;
	...
	finup << "\"" << bandsdatafile << "\"" << " u 1:" << i+1 << " w l lt -1 lw 3, \\" << endl;
      ...
      //findn << "set label 'Generated by AFLOW (Kesong Yang \\& SC Cutarolo)' at screen 0.985, 0.5 font \"Helvetica, 22\" rotate by -90 center " << endl;
      findn << endl;
