...
namespace aurostd {
  ...
  bool LinkLockFile(const string& directory,const string& lockfile,const string& linkfile,bool hard=true); //SD20220208
  bool UnlinkLockFile(const string& directory,const string& linkfile); //SD20220208
  //CO START
