...
namespace aurostd {
  ...
  uint substring2strings(ifstream& input,vector<string> &vstringout,const string& strsub1,const string& strsub2,const int instance=0,bool RemoveWS=false,bool RemoveComments=true); //SD20220520  //CO20230502 - give instance here to speed up aurostd::substring2string(), default instance==0
  uint substring2strings(const string& input,vector<string> &vstringout,const string& strsub1,const string& strsub2,const int instance=0,bool RemoveWS=false,bool RemoveComments=true); //SD20220520 - rewritten  //CO20230502 - give instance here to speed up aurostd::substring2string(), default instance==0
  uint substring2strings(const stringstream& input,vector<string> &vstringout,const string& strsub1,const string& strsub2,const int instance=0,bool RemoveWS=false,bool RemoveComments=true); //SD20220520  //CO20230502 - give instance here to speed up aurostd::substring2string(), default instance==0
