  ...
  template<class utype>
    class xmatrix  {
      public:
        ...
        xvector<utype> best_getvec() const;                                 // return a vector from a 1-d matrix input
        xvector<utype> best_getvec(int lrow,int urow,int lcol,int ucol) const;           // return a vector from a 1-d matrix input
