...
//[CO20180705 - moved to aflow.h for broader access]#define SPECIE_RAW_LIB2U "Ag,Au,Cd,Co,Cr_pv,Cu_pv,Fe_pv,Hf_pv,Hg,Ir,La,Mn_pv,Mo_pv,Nb_sv,Ni_pv,Os_pv,Pd_pv,Pt,Re_pv,Rh_pv,Ru_pv,Sc_sv,Ta_pv,Tc_pv,Ti_sv,V_sv,W_pv,Y_sv,Zn,Zr_sv"

//[CO20180705 - moved to aflow.h for broader access]#define SPECIE_RAW_LIB2 "Ag,Al,As,Au,B_h,Ba_sv,Be_sv,Bi_d,Br,Ca_sv,Cd,Cl,Co,Cr_pv,Cu_pv,Fe_pv,Ga_h,Ge_h,Hf_pv,Hg,In_d,Ir,K_sv,La,Li_sv,Mg_pv,Mn_pv,Mo_pv,Na_pv,Nb_sv,Ni_pv,Os_pv,P,Pb_d,Pd_pv,Pt,Re_pv,Rh_pv,Ru_pv,Sb,Sc_sv,Se,Si,Sn,Sr_sv,Ta_pv,Tc_pv,Te,Ti_sv,Tl_d,V_sv,W_pv,Y_sv,Zn,Zr_sv"

//[CO20180705 - moved to aflow.h for broader access]//#define SPECIE_RAW_LIB3 "Ag,Au,Cd,Co,Cr_pv,Cu_pv,Fe_pv,Hf_pv,Hg,Ir,La,Mn_pv,Mo_pv,Nb_sv,Ni_pv,Os_pv,Pd_pv,Pt,Re_pv,Rh_pv,Ru_pv,Sc_sv,Ta_pv,Tc_pv,Ti_sv,V_sv,W_pv,Y_sv,Zn,Zr_sv"
...
//[CO20180705 - moved to aflow.h for broader access]//#define SPECIE_RAW_LIB3 "Ag,Al,As,Au,B_h,Bi_d,Cd,Co,Cr_pv,Cu_pv,Fe_pv,Ga_h,Ge_h,Hf_pv,Hg,In_d,Ir,La,Mg_pv,Mn_pv,Mo_pv,Nb_sv,Ni_pv,Os_pv,P,Pb_d,Pd_pv,Pt,Re_pv,Rh_pv,Ru_pv,Sb,Sc_sv,Se,Si,Sn,Ta_pv,Te,Tc_pv,Ti_sv,V_sv,W_pv,Y_sv,Zn,Zr_sv"
...
//[CO20181106 - see GetAtomVolume(symbol,clean==TRUE)]
//[CO20181106]double VolumeSpecie(string specie) {
//[CO20181106]  return GetAtomVolume(KBIN::VASP_PseudoPotential_CleanName(specie));
//[CO20181106]}
//[CO20181106 - see GetAtomMass(symbol,clean==TRUE)]
//[CO20181106]double MassSpecie(string specie) {
//[CO20181106]  return GetAtomMass(KBIN::VASP_PseudoPotential_CleanName(specie));
//[CO20181106]}
...
void AVASP_Get_LDAU_Parameters(string _species,bool &LDAU,vector<string>& vLDAUspecies,vector<uint>& vLDAUtype,vector<int>& vLDAUL, vector<double>& vLDAUU, vector<double> &vLDAUJ) {
  ...
  if(species=="U") { // http://cms.mpi.univie.ac.at/vasp-forum/forum_viewtopic.php?3.789
    ...
    LDAU=TRUE;vLDAUspecies.push_back(species);vLDAUtype.push_back(2);vLDAUL.push_back(f);vLDAUU.push_back(4.0);vLDAUJ.push_back(0.0);return; // #U-f orbital,U eff, J parameter
...
string AVASP_Get_PseudoPotential_PAW_PBE_KIN(string species) {
  ...
  if(species=="Be") return "Be"; // Rico suggests Be           [PAW_PBE_KIN]
  if(species=="Bi") return "Bi_d"; //           [PAW_PBE_KIN]
  if(species=="Br") return "Br"; // unique choice...           [PAW_PBE_KIN]
  if(species=="C")  return "C"; // vasp recommends           [PAW_PBE_KIN]
  if(species=="Ca") return "Ca_sv"; //SC           [PAW_PBE_KIN]
  if(species=="Cd") return "Cd"; // unique choice..           [PAW_PBE_KIN]
  if(species=="Ce") return "Ce"; // right on the middle           [PAW_PBE_KIN]
  ...
  if(species=="Os") return "Os_pv"; //SC           [PAW_PBE_KIN]
  ...
  if(species=="Sm") return "Sm"; //  with f-states           [PAW_PBE_KIN]
  ...
  if(species=="Ti") return "Ti_sv"; //            [PAW_PBE_KIN]
  ...
  if(species=="W")  return "W_sv"; //            [PAW_PBE_KIN]
...
string AVASP_Get_PseudoPotential_PAW_PBE(string species) {
  ...
  if(species=="Ac") return "Ac"; // UNTESTED SC of Ac,Ac_s take the hardest one [Wed Nov 23 EST 2011]     [PAW_PBE]
  if(species=="Ag") return "Ag"; // unique choice...     [PAW_PBE]
  if(species=="Al") return "Al"; //SC Al_h has ghost states     [PAW_PBE]
  ...
  if(species=="B")  return "B_h"; //SC     [PAW_PBE]
  ...
  if(species=="Ce") return "Ce"; //WSETYAWAN     [PAW_PBE]
  if(species=="Cl") return "Cl"; //WSETYAWAN     [PAW_PBE]
  if(species=="Co") return "Co"; // unique choice..     [PAW_PBE]
  if(species=="Cr") return "Cr_pv"; //SC     [PAW_PBE]
  if(species=="Cs") return "Cs_sv"; // unique choice..     [PAW_PBE]
  if(species=="Cu") return "Cu_pv"; //SC     [PAW_PBE]
  if(species=="Dy") return "Dy_3"; // unique choice...     [PAW_PBE]
  if(species=="Er") return "Er_3"; //WSETYAWAN, teragrid project     [PAW_PBE]
  //  if(species=="Eu") return "Eu_3"; //WSETYAWAN, frozen f     [PAW_PBE]
  if(species=="Eu") return "Eu"; //WSETYAWAN, with f-states, teragrid project     [PAW_PBE]
  if(species=="F")  return "F"; //WSETYAWAN     [PAW_PBE]
  if(species=="Fe") return "Fe_pv"; //SC     [PAW_PBE]
  if(species=="Ga") return "Ga_h"; //SC     [PAW_PBE]
  if(species=="Ge") return "Ge_h"; //SC     [PAW_PBE]
  // if(species=="Ge") return "Ge_d"; //WSETYAWAN     [PAW_PBE]
  if(species=="Gd") return "Gd"; //WSETYAWAN // LDAU     [PAW_PBE]
  if(species=="H")  return "H"; //WSETYAWAN     [PAW_PBE]
  if(species=="He") return "He"; // unique choice...     [PAW_PBE]
  if(species=="Hf") return "Hf_pv"; //SC     [PAW_PBE]
  ...
  if(species=="In") return "In_d"; //SC     [PAW_PBE]
  ...
  if(species=="Nd") return "Nd"; //WSETYAWAN, with f-states, teragrid project     [PAW_PBE]
  if(species=="Ne") return "Ne"; // unique choice...     [PAW_PBE]
  if(species=="Ni") return "Ni_pv"; //SC     [PAW_PBE]
  if(species=="Np") return "Np_s"; //SC NEVER USED JUST FOR COMPLETENESS     [PAW_PBE]
  if(species=="O")  return "O"; //WSETYAWAN     [PAW_PBE]
  ...
  if(species=="Pt") return "Pt"; //SC     [PAW_PBE]
  //  if(species=="Pr") return "Pr_3"; //WSETYAWAN, frozen f     [PAW_PBE]
  if(species=="Pr") return "Pr";  //WSETYAWAN, with f-states, teragrid project     [PAW_PBE]
  if(species=="Pu") return "Pu_s"; //SC NEVER USED JUST FOR COMPLETENESS     [PAW_PBE]
  if(species=="Rb") return "Rb_sv"; // vasp recommends     [PAW_PBE]
  if(species=="Re") return "Re_pv"; //SC     [PAW_PBE]
  if(species=="Rh") return "Rh_pv"; //SC     [PAW_PBE]
  if(species=="Ru") return "Ru_pv"; //SC     [PAW_PBE]
  if(species=="S")  return "S"; //WSETYAWAN, teragrid project     [PAW_PBE]
  ...
  if(species=="Ta") return "Ta_pv"; //SC     [PAW_PBE]
  if(species=="Tb") return "Tb_3"; //  unique choice...     [PAW_PBE]
  if(species=="Tc") return "Tc_pv"; //SC     [PAW_PBE]
  if(species=="Te") return "Te"; // unique choice...     [PAW_PBE]
  if(species=="Th") return "Th_s"; //SC NEVER USED JUST FOR COMPLETENESS     [PAW_PBE]
  if(species=="Ti") return "Ti_sv"; //SC     [PAW_PBE]
  if(species=="Tl") return "Tl_d"; //SC     [PAW_PBE]
  //  if(species=="Tm") return "Tm_3"; //WSETYAWAN, frozen f     [PAW_PBE]
  if(species=="Tm") return "Tm";  //WSETYAWAN, with f-states, teragrid project     [PAW_PBE]
  if(species=="U") return "U"; // UNTESTED SC of U,U_s take the hardest one [Wed Nov 23 EST 2011]     [PAW_PBE]
  if(species=="V")  return "V_sv"; //SC     [PAW_PBE]
  if(species=="W")  return "W_pv"; //SC     [PAW_PBE]
  ...
  if(species=="Yb") return "Yb";  //WSETYAWAN, with f-states, teragrid project     [PAW_PBE]
...
string AVASP_Get_PseudoPotential_PAW_GGA(string species) {
  ...
  if(species=="Pr") return "Pr"; //"Pr_3";  //WSETYAWAN, teragrid project  // same as potpaw_PBE, compatibility
  if(species=="Lu") return "Lu"; //"Lu_3"; //WSETYAWAN // LDAU  // same as potpaw_PBE, compatibility
  if(species=="Sm") return "Sm_3"; //"Sm_3"; //WSETYAWAN, teragrid project // same as potpaw_PBE, compatibility
  if(species=="Nd") return "Nd"; //"Nd_3"; //WSETYAWAN, teragrid project // same as potpaw_PBE, compatibility
  if(species=="Eu") return "Eu"; //"Eu_2"; //WSETYAWAN, teragrid project // same as potpaw_PBE, compatibility
  if(species=="Pm") return "Pm"; //"Pm_3"; //WSETYAWAN, teragrid project // same as potpaw_PBE, compatibility
...
string AVASP_Get_PseudoPotential_GGA(string species) {
  ...
  if(species=="C")  return "C"; //SC    [GGA]
  if(species=="Ca") return "Ca_pv"; //SC    [GGA]
  ...
  if(species=="Ga") return "Ga_d"; //SC    [GGA]
  if(species=="Ge") return "Ge"; //WSETYAWAN    [GGA]
  if(species=="H")  return "H_soft"; //WSETYAWAN    [GGA]
  if(species=="Hf") return "Hf"; // unique choice...    [GGA]
  if(species=="Hg") return "Hg"; // unique choice...    [GGA]

  if(species=="K")  return "K_pv"; //SC    [GGA]
  if(species=="Kr") return "Kr"; // unique choice...    [GGA]

  if(species=="Li") return "Li_pv"; //SC    [GGA]
  if(species=="Mg") return "Mg_pv"; //SC    [GGA]
  ...
  if(species=="Nb") return "Nb_pv"; //SC    [GGA]
  if(species=="Ne") return "Ne"; // unique choice...    [GGA]
  if(species=="Ni") return "Ni"; // unique choice...    [GGA]
  if(species=="O")  return "O"; //WSETYAWAN    [GGA]
  if(species=="Os") return "Os"; // unique choice...    [GGA]

  if(species=="Pd") return "Pd"; //SC    [GGA]
  if(species=="Pt") return "Pt"; //SC    [GGA]
  if(species=="Rb") return "Rb_pv"; // vasp recommends    [GGA]
  if(species=="Re") return "Re"; //SC    [GGA]
  if(species=="Rh") return "Rh"; //SC    [GGA]
  if(species=="Ru") return "Ru"; //SC    [GGA]
  if(species=="Sc") return "Sc_pv"; // unique choice...    [GGA]
  if(species=="Sm") return "Sm_3"; //   [GGA]
  if(species=="Sr") return "Sr_pv"; // unique choice...    [GGA]
  if(species=="Ta") return "Ta"; //SC    [GGA]
  if(species=="Tc") return "Tc"; //SC    [GGA]
  if(species=="Ti") return "Ti_pv"; //SC    [GGA]
  if(species=="V")  return "V_pv"; //SC    [GGA]
  if(species=="W")  return "W"; //SC    [GGA]
  if(species=="Y")  return "Y_pv"; // unique choice...    [GGA]
  if(species=="Zr") return "Zr_pv"; //SC    [GGA]
...
bool AVASP_populateXVASP(const _aflags& aflags,const _kflags& kflags,const _vflags& vflags,_xvasp& xvasp){
  ...
  if (!kflags.KZIP_BIN.empty()) {xvasp.aopts.push_attached("AFLOWIN_FLAG::KZIP_BIN", kflags.KZIP_BIN);}
  xvasp.aopts.flag("AFLOWIN_FLAG::KBIN_SERIAL_BIN", !kflags.KBIN_SERIAL_BIN.empty()); //CO20181226 //ME20190107
  if (!kflags.KBIN_BIN.empty()) {xvasp.aopts.push_attached("AFLOWIN_FLAG::KBIN_SERIAL_BIN", kflags.KBIN_SERIAL_BIN);} //ME20190107
  xvasp.aopts.flag("AFLOWIN_FLAG::MPI_COMMAND", !kflags.KBIN_MPI_COMMAND.empty()); //CO20181226
  if (!kflags.KBIN_MPI_COMMAND.empty()) {xvasp.aopts.push_attached("AFLOWIN_FLAG::MPI_COMMAND", kflags.KBIN_MPI_COMMAND);}
  xvasp.aopts.flag("AFLOWIN_FLAG::MPI_BIN", !kflags.KBIN_MPI_BIN.empty());
  if (!kflags.KBIN_MPI_BIN.empty()) {xvasp.aopts.push_attached("AFLOWIN_FLAG::MPI_BIN", kflags.KBIN_MPI_BIN);}
  xvasp.aopts.flag("AFLOWIN_FLAG::MPI_NUM_CPUS", !kflags.KBIN_MPI_NCPUS_STRING.empty());
  if (!kflags.KBIN_MPI_NCPUS_STRING.empty()) {xvasp.aopts.push_attached("AFLOWIN_FLAG::MPI_NUM_CPUS", kflags.KBIN_MPI_NCPUS_STRING);}
  ...
  if (vflags.AFLOW_SYSTEM.isentry) {xvasp.aopts.push_attached("AFLOWIN_FLAG::SYSTEM", vflags.AFLOW_SYSTEM.content_string);}

  //[CO20181226 - not sure why it is specified twice]// Potentials
  //[CO20181226 - not sure why it is specified twice]xvasp.AVASP_potential=vflags.KBIN_VASP_FORCE_OPTION_AUTO_PSEUDOPOTENTIALS.xscheme;

  // RELAX
  xvasp.AVASP_flag_GENERATE = (vflags.KBIN_VASP_RUN.flag("GENERATE") || xvasp.AVASP_flag_GENERATE); //CO20190218 
  xvasp.AVASP_flag_RUN_RELAX = (vflags.KBIN_VASP_RUN.flag("RELAX") || xvasp.AVASP_flag_RUN_RELAX); 
  xvasp.AVASP_flag_RUN_RELAX_STATIC = (vflags.KBIN_VASP_RUN.flag("RELAX_STATIC") || xvasp.AVASP_flag_RUN_RELAX_STATIC); 
  xvasp.AVASP_flag_RUN_RELAX_STATIC_BANDS = (vflags.KBIN_VASP_RUN.flag("RELAX_STATIC_BANDS") || xvasp.AVASP_flag_RUN_RELAX_STATIC_BANDS); 
  xvasp.AVASP_flag_RUN_STATIC = (vflags.KBIN_VASP_RUN.flag("STATIC") || xvasp.AVASP_flag_RUN_STATIC); 
  xvasp.AVASP_flag_RUN_STATIC_BANDS = (vflags.KBIN_VASP_RUN.flag("STATIC_BANDS") || xvasp.AVASP_flag_RUN_STATIC_BANDS); //CO20190219 
  //CO20190215 - the order is VERY important, as args2addattachedscheme in aconvasp finds RUN_RELAX RUN_RELAX_STATIC and RUN_RELAX_STATIC_BANDS for --run_relax_static_bands
  //so we proceed in order of longest flag name and with else if's
  if(xvasp.AVASP_flag_GENERATE){
    xvasp.AVASP_flag_GENERATE=TRUE;
  ...
  else if(xvasp.AVASP_flag_RUN_RELAX_STATIC_BANDS){
    xvasp.AVASP_flag_GENERATE=FALSE;
    xvasp.AVASP_flag_RUN_RELAX=FALSE;
    xvasp.AVASP_flag_RUN_RELAX_STATIC=FALSE;
  ...
  else if(xvasp.AVASP_flag_RUN_RELAX_STATIC){
    xvasp.AVASP_flag_GENERATE=FALSE;
    xvasp.AVASP_flag_RUN_RELAX=FALSE;
    xvasp.AVASP_flag_RUN_RELAX_STATIC=TRUE;
    xvasp.AVASP_flag_RUN_RELAX_STATIC_BANDS=FALSE;
    xvasp.AVASP_flag_RUN_STATIC=FALSE;
    xvasp.AVASP_flag_RUN_STATIC_BANDS=FALSE;
  }
  else if(xvasp.AVASP_flag_RUN_STATIC_BANDS){
    xvasp.AVASP_flag_GENERATE=FALSE;
    xvasp.AVASP_flag_RUN_RELAX=FALSE;
    xvasp.AVASP_flag_RUN_RELAX_STATIC=FALSE;
    xvasp.AVASP_flag_RUN_RELAX_STATIC_BANDS=FALSE;
    xvasp.AVASP_flag_RUN_STATIC=FALSE;
    xvasp.AVASP_flag_RUN_STATIC_BANDS=TRUE;
  }
  else if(xvasp.AVASP_flag_RUN_STATIC){
    xvasp.AVASP_flag_GENERATE=FALSE;
    xvasp.AVASP_flag_RUN_RELAX=FALSE;
    xvasp.AVASP_flag_RUN_RELAX_STATIC=FALSE;
    xvasp.AVASP_flag_RUN_RELAX_STATIC_BANDS=FALSE;
  ...
  else if(xvasp.AVASP_flag_RUN_RELAX){  //this is the default, so we put at the end so others can override
    xvasp.AVASP_flag_GENERATE=FALSE;
  ...
  if (vflags.KBIN_VASP_FORCE_OPTION_AUTO_PSEUDOPOTENTIALS.isentry) {xvasp.AVASP_potential = vflags.KBIN_VASP_FORCE_OPTION_AUTO_PSEUDOPOTENTIALS.content_string;}
  else {
    bool found=false;
    vector<string> ppkeywordtokens,pptokens;
    ...
    if(!found && vflags.KBIN_VASP_POTCAR_FILE.flag("KEYWORD")){ //try to search POTCAR_KEYWORDS
      for (uint i = 0; i < ppkeywordtokens.size(); i++) {  // Last vector element is empty  //CO20181226 - better way
        if(!aurostd::RemoveWhiteSpacesFromTheBack(ppkeywordtokens[i]).empty()){  //CO20181226 - better way
          if(!(aurostd::substring2bool(ppkeywordtokens[i],"PREFIX") || aurostd::substring2bool(ppkeywordtokens[i],"SUFFIX") || aurostd::substring2bool(ppkeywordtokens[i],"FILE") || aurostd::substring2bool(ppkeywordtokens[i],"COMMAND"))){ //don't grab from these lines
            aurostd::string2tokens(ppkeywordtokens[i],pptokens,"/");
            if(pptokens.size()==2){xvasp.AVASP_potential=pptokens[0];found=true;}
          }
        }
      }
    }
  }
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.AVASP_potential=" << xvasp.AVASP_potential << endl;}
  ...
  if (vflags.KBIN_VASP_FORCE_OPTION_NBANDS_EQUAL.isentry) {xvasp.aopts.push_attached("AFLOWIN_FLAG::NBANDS_EQUAL", vflags.KBIN_VASP_FORCE_OPTION_NBANDS_EQUAL.content_string);}
  xvasp.aopts.flag("AFLOWIN_FLAG::PSTRESS", vflags.KBIN_VASP_FORCE_OPTION_PSTRESS_EQUAL.isentry);
  if (vflags.KBIN_VASP_FORCE_OPTION_PSTRESS_EQUAL.isentry) {xvasp.aopts.push_attached("AFLOWIN_FLAG::PSTRESS", vflags.KBIN_VASP_FORCE_OPTION_PSTRESS_EQUAL.content_string);} 
  xvasp.aopts.flag("AFLOWIN_FLAG::EDIFFG", vflags.KBIN_VASP_FORCE_OPTION_EDIFFG_EQUAL.isentry);
  if (vflags.KBIN_VASP_FORCE_OPTION_EDIFFG_EQUAL.isentry) {xvasp.aopts.push_attached("AFLOWIN_FLAG::EDIFFG", vflags.KBIN_VASP_FORCE_OPTION_EDIFFG_EQUAL.content_string);} 
  xvasp.aopts.flag("AFLOWIN_FLAG::ENMAX_MULTIPLY", vflags.KBIN_VASP_FORCE_OPTION_ENMAX_MULTIPLY_EQUAL.isentry);
  if (vflags.KBIN_VASP_FORCE_OPTION_ENMAX_MULTIPLY_EQUAL.isentry) {xvasp.aopts.push_attached("AFLOWIN_FLAG::ENMAX_MULTIPLY", vflags.KBIN_VASP_FORCE_OPTION_ENMAX_MULTIPLY_EQUAL.content_string);}
  xvasp.aopts.flag("AFLOWIN_FLAG::POTIM", vflags.KBIN_VASP_FORCE_OPTION_POTIM_EQUAL.isentry);
  if (vflags.KBIN_VASP_FORCE_OPTION_POTIM_EQUAL.isentry) {xvasp.aopts.push_attached("AFLOWIN_FLAG::POTIM", vflags.KBIN_VASP_FORCE_OPTION_POTIM_EQUAL.content_string);}
  xvasp.aopts.flag("AFLOWIN_FLAG::RELAX_TYPE", vflags.KBIN_VASP_FORCE_OPTION_RELAX_TYPE.isentry);
  if (vflags.KBIN_VASP_FORCE_OPTION_RELAX_TYPE.isentry) {xvasp.aopts.push_attached("AFLOWIN_FLAG::RELAX_TYPE", vflags.KBIN_VASP_FORCE_OPTION_RELAX_TYPE.content_string);} 
  xvasp.aopts.flag("AFLOWIN_FLAG::RELAX_MODE", vflags.KBIN_VASP_FORCE_OPTION_RELAX_MODE.isentry);
  if (vflags.KBIN_VASP_FORCE_OPTION_RELAX_MODE.isentry) {xvasp.aopts.push_attached("AFLOWIN_FLAG::RELAX_MODE", vflags.KBIN_VASP_FORCE_OPTION_RELAX_MODE.content_string);} 
  xvasp.aopts.flag("AFLOWIN_FLAG::PRECISION", vflags.KBIN_VASP_FORCE_OPTION_PREC.isentry);
  if (vflags.KBIN_VASP_FORCE_OPTION_PREC.isentry) {xvasp.aopts.push_attached("AFLOWIN_FLAG::PRECISION", vflags.KBIN_VASP_FORCE_OPTION_PREC.content_string);}
  xvasp.aopts.flag("AFLOWIN_FLAG::ALGORITHM", vflags.KBIN_VASP_FORCE_OPTION_ALGO.isentry);
  if (vflags.KBIN_VASP_FORCE_OPTION_ALGO.isentry) {xvasp.aopts.push_attached("AFLOWIN_FLAG::ALGORITHM", vflags.KBIN_VASP_FORCE_OPTION_ALGO.content_string);}
  xvasp.aopts.flag("AFLOWIN_FLAG::METAGGA", vflags.KBIN_VASP_FORCE_OPTION_METAGGA.isentry);
  if (vflags.KBIN_VASP_FORCE_OPTION_METAGGA.isentry) {xvasp.aopts.push_attached("AFLOWIN_FLAG::METAGGA", vflags.KBIN_VASP_FORCE_OPTION_METAGGA.content_string);}
  xvasp.aopts.flag("AFLOWIN_FLAG::IVDW", vflags.KBIN_VASP_FORCE_OPTION_IVDW.isentry);
  if (vflags.KBIN_VASP_FORCE_OPTION_IVDW.isentry) {xvasp.aopts.push_attached("AFLOWIN_FLAG::IVDW", vflags.KBIN_VASP_FORCE_OPTION_IVDW.content_string);}
  xvasp.aopts.flag("FLAG::ABMIX_SET", vflags.KBIN_VASP_FORCE_OPTION_ABMIX.isentry);
  if (vflags.KBIN_VASP_FORCE_OPTION_ABMIX.isentry) {xvasp.AVASP_flag_ABMIX_scheme = vflags.KBIN_VASP_FORCE_OPTION_ABMIX.xscheme;}
  ...
  if (vflags.KBIN_VASP_FORCE_OPTION_TYPE.isentry) {xvasp.aopts.push_attached("AFLOWIN_FLAG::TYPE", vflags.KBIN_VASP_FORCE_OPTION_TYPE.content_string);}
  xvasp.aopts.flag("AFLOWIN_FLAG::CONVERT_UNIT_CELL", vflags.KBIN_VASP_FORCE_OPTION_CONVERT_UNIT_CELL.isentry);
  if (vflags.KBIN_VASP_FORCE_OPTION_CONVERT_UNIT_CELL.isentry) {xvasp.aopts.push_attached("AFLOWIN_FLAG::CONVERT_UNIT_CELL", vflags.KBIN_VASP_FORCE_OPTION_CONVERT_UNIT_CELL.xscheme);}
  ...
  xvasp.aopts.flag("FLAG::AVASP_RECYCLE_SPIN", vflags.KBIN_VASP_FORCE_OPTION_RECYCLE_SPIN); //CO20230826
  ...
  if (vflags.KBIN_VASP_FORCE_OPTION_KPOINTS.isentry) {xvasp.aopts.push_attached("AFLOWIN_FLAG::KPOINTS", vflags.KBIN_VASP_FORCE_OPTION_KPOINTS.content_string);}
  xvasp.aopts.flag("AFLOWIN_FLAG::KSHIFT", vflags.KBIN_VASP_KPOINTS_KSHIFT.isentry);
  if (vflags.KBIN_VASP_KPOINTS_KSHIFT.isentry) {xvasp.aopts.push_attached("AFLOWIN_FLAG::KSHIFT", vflags.KBIN_VASP_KPOINTS_KSHIFT.content_string);}
  xvasp.aopts.flag("AFLOWIN_FLAG::KSHIFT_STATIC", vflags.KBIN_VASP_KPOINTS_STATIC_KSHIFT.isentry);
  if (vflags.KBIN_VASP_KPOINTS_STATIC_KSHIFT.isentry) {xvasp.aopts.push_attached("AFLOWIN_FLAG::KSHIFT_STATIC", vflags.KBIN_VASP_KPOINTS_STATIC_KSHIFT.content_string);}
  xvasp.aopts.flag("AFLOWIN_FLAG::KMODE", vflags.KBIN_VASP_KPOINTS_KMODE.isentry);
  if (vflags.KBIN_VASP_KPOINTS_KMODE.isentry) {xvasp.aopts.push_attached("AFLOWIN_FLAG::KMODE", vflags.KBIN_VASP_KPOINTS_KMODE.content_string);}
  ...
  if (vflags.KBIN_VASP_FORCE_OPTION_CHGCAR_FILE.isentry) xvasp.aopts.push_attached("AFLOWIN_FLAG::CHGCAR_FILE", vflags.KBIN_VASP_FORCE_OPTION_CHGCAR_FILE.content_string);  //ME20191028
  ...
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.AVASP_EXTRA_INCAR=" << endl << xvasp.AVASP_EXTRA_INCAR.str() << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.AVASP_KSCHEME=" << xvasp.AVASP_KSCHEME << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.AVASP_STATIC_KSCHEME=" << xvasp.AVASP_STATIC_KSCHEME << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.AVASP_KPOINTS=" << xvasp.AVASP_KPOINTS << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.AVASP_LDAU_PARAMETERS_STRING=" << xvasp.AVASP_LDAU_PARAMETERS_STRING << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.AVASP_aflowin_only_if_missing=" << xvasp.AVASP_aflowin_only_if_missing << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.AVASP_alpha_fix=" << xvasp.AVASP_alpha_fix << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.AVASP_dirbase=" << xvasp.AVASP_dirbase << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.AVASP_directory_from_library_=" << xvasp.AVASP_directory_from_library_ << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.AVASP_flag_ABMIX_scheme=" << xvasp.AVASP_flag_ABMIX_scheme << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.AVASP_flag_ALGO_scheme=" << xvasp.AVASP_flag_ALGO_scheme << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.AVASP_flag_GENERATE=" << xvasp.AVASP_flag_GENERATE << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.AVASP_flag_MPI=" << xvasp.AVASP_flag_MPI << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.AVASP_flag_PRECISION_scheme=" << xvasp.AVASP_flag_PRECISION_scheme << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.AVASP_flag_RUN_RELAX=" << xvasp.AVASP_flag_RUN_RELAX << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.AVASP_flag_RUN_RELAX_STATIC=" << xvasp.AVASP_flag_RUN_RELAX_STATIC << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.AVASP_flag_RUN_RELAX_STATIC_BANDS=" << xvasp.AVASP_flag_RUN_RELAX_STATIC_BANDS << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.AVASP_flag_RUN_STATIC=" << xvasp.AVASP_flag_RUN_STATIC << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.AVASP_flag_RUN_STATIC_BANDS=" << xvasp.AVASP_flag_RUN_STATIC_BANDS << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.AVASP_flag_TYPE.xscheme=" << xvasp.AVASP_flag_TYPE.xscheme << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.AVASP_label=" << xvasp.AVASP_label << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.AVASP_libbase=" << xvasp.AVASP_libbase << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.AVASP_parameters=" << xvasp.AVASP_parameters << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.AVASP_pocc_parameters=" << xvasp.AVASP_pocc_parameters << endl;}  //CO20181226
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.AVASP_pocc_tol=" << xvasp.AVASP_pocc_tol << endl;}  //CO20181226
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.AVASP_path_BANDS=" << xvasp.AVASP_path_BANDS << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.AVASP_potential=" << xvasp.AVASP_potential << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.AVASP_prototype_from_library_=" << xvasp.AVASP_prototype_from_library_ << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.AVASP_prototype_mode=" << xvasp.AVASP_prototype_mode << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.AVASP_path_BANDS=" << xvasp.AVASP_path_BANDS << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.AVASP_value_BANDS_GRID=" << xvasp.AVASP_value_BANDS_GRID << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.AVASP_value_KPPRA=" << xvasp.AVASP_value_KPPRA << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.AVASP_value_KPPRA_STATIC=" << xvasp.AVASP_value_KPPRA_STATIC << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.AVASP_value_NSW=" << xvasp.AVASP_value_NSW << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.AVASP_volume_in=" << xvasp.AVASP_volume_in << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.Directory=" << xvasp.Directory << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.POTCAR_TYPE_DATE_PRINT_flag=" << xvasp.POTCAR_TYPE_DATE_PRINT_flag << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.POTCAR_TYPE_PRINT_flag=" << xvasp.POTCAR_TYPE_PRINT_flag << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"AFLOWIN_FLAG::ABCCAR\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::ABCCAR") << endl;} //DX20190123 - add ABCCAR
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"AFLOWIN_FLAG::ABINIT\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::ABINIT") << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"AFLOWIN_FLAG::AIMS\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::AIMS") << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"AFLOWIN_FLAG::ALGORITHM\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::ALGORITHM") << endl;}
  ...
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"AFLOWIN_FLAG::EDIFFG\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::EDIFFG") << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"AFLOWIN_FLAG::ENMAX_MULTIPLY\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::ENMAX_MULTIPLY") << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"AFLOWIN_FLAG::ENMAX_MULTYPLY\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::ENMAX_MULTYPLY") << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"AFLOWIN_FLAG::ITC\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::ITC") << endl;} //CO20220613
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"AFLOWIN_FLAG::IVDW\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::IVDW") << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"AFLOWIN_FLAG::KPPRA\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::KPPRA") << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"AFLOWIN_FLAG::KPPRA_STATIC\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::KPPRA_STATIC") << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"AFLOWIN_FLAG::METAGGA\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::METAGGA") << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"AFLOWIN_FLAG::MODULE\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::MODULE") << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"AFLOWIN_FLAG::NBANDS\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::NBANDS") << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"FLAG::VOLUME_PRESERVED\")=" << xvasp.aopts.flag("FLAG::VOLUME_PRESERVED") << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"AFLOWIN_FLAG::PARAMS\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::PARAMS") << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"AFLOWIN_FLAG::POTIM\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::POTIM") << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"AFLOWIN_FLAG::PRECISION\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::PRECISION") << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"AFLOWIN_FLAG::PSTRESS\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::PSTRESS") << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"AFLOWIN_FLAG::QE\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::QE") << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"AFLOWIN_FLAG::RELAX_MODE\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::RELAX_MODE") << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"AFLOWIN_FLAG::RELAX_TYPE\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::RELAX_TYPE") << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"AFLOWIN_FLAG::RELAX_TYPE\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::RELAX_TYPE") << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"AFLOWIN_FLAG::TYPE\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::TYPE") << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"AFLOWIN_FLAG::USE_ANRL_LATTICE_PARAM\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::USE_ANRL_LATTICE_PARAM") << endl;} //DX20190227 - added anrl lattice parameter flag
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"AFLOWIN_FLAG::VASP\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::VASP") << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"AFLOWIN_FLAG::VOLUME_MULTIPLY_EQUAL\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::VOLUME_MULTIPLY_EQUAL") << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"AFLOWIN_FLAG::VOLUME_PLUS_EQUAL\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::VOLUME_PLUS_EQUAL") << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"AVASP_flag_CONVERT_UNIT_CELL_CARTESIAN\")=" << xvasp.aopts.flag("AVASP_flag_CONVERT_UNIT_CELL_CARTESIAN") << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"AVASP_flag_CONVERT_UNIT_CELL_COMPACT\")=" << xvasp.aopts.flag("AVASP_flag_CONVERT_UNIT_CELL_COMPACT") << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"AVASP_flag_CONVERT_UNIT_CELL_FRACTIONAL\")=" << xvasp.aopts.flag("AVASP_flag_CONVERT_UNIT_CELL_FRACTIONAL") << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"AVASP_flag_CONVERT_UNIT_CELL_INCELL\")=" << xvasp.aopts.flag("AVASP_flag_CONVERT_UNIT_CELL_INCELL") << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"AVASP_flag_CONVERT_UNIT_CELL_INCOMPACT\")=" << xvasp.aopts.flag("AVASP_flag_CONVERT_UNIT_CELL_INCOMPACT") << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"AVASP_flag_CONVERT_UNIT_CELL_MINKOWSKI\")=" << xvasp.aopts.flag("AVASP_flag_CONVERT_UNIT_CELL_MINKOWSKI") << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"AVASP_flag_CONVERT_UNIT_CELL_NIGGLI\")=" << xvasp.aopts.flag("AVASP_flag_CONVERT_UNIT_CELL_NIGGLI") << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"AVASP_flag_CONVERT_UNIT_CELL_PRESERVE\")=" << xvasp.aopts.flag("AVASP_flag_CONVERT_UNIT_CELL_PRESERVE") << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"AVASP_flag_CONVERT_UNIT_CELL_STANDARD_CONVENTIONAL\")=" << xvasp.aopts.flag("AVASP_flag_CONVERT_UNIT_CELL_STANDARD_CONVENTIONAL") << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"AVASP_flag_CONVERT_UNIT_CELL_STANDARD_PRIMITIVE\")=" << xvasp.aopts.flag("AVASP_flag_CONVERT_UNIT_CELL_STANDARD_PRIMITIVE") << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"AVASP_flag_CONVERT_UNIT_CELL_WIGNERSEITZ\")=" << xvasp.aopts.flag("AVASP_flag_CONVERT_UNIT_CELL_WIGNERSEITZ") << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"FLAG::ABMIX_SET\")=" << xvasp.aopts.flag("FLAG::ABMIX_SET") << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"FLAG::ALGO_PRESERVED\")=" << xvasp.aopts.flag("FLAG::ALGO_PRESERVED") << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"FLAG::ALGO_SET\")=" << xvasp.aopts.flag("FLAG::ALGO_SET") << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"FLAG::AVASP_AUTO_MAGMOM\")=" << xvasp.aopts.flag("FLAG::AVASP_AUTO_MAGMOM") << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"FLAG::AVASP_AUTO_PSEUDOPOTENTIALS\")=" << xvasp.aopts.flag("FLAG::AVASP_AUTO_PSEUDOPOTENTIALS") << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"FLAG::AVASP_BADER\")=" << xvasp.aopts.flag("FLAG::AVASP_BADER") << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"FLAG::AVASP_CHGCAR\")=" << xvasp.aopts.flag("FLAG::AVASP_CHGCAR") << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"FLAG::AVASP_ELF\")=" << xvasp.aopts.flag("FLAG::AVASP_ELF") << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"FLAG::AVASP_FORCE_NOLDAU\")=" << xvasp.aopts.flag("FLAG::AVASP_FORCE_NOLDAU") << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"FLAG::AVASP_KPPRA\")=" << xvasp.aopts.flag("FLAG::AVASP_KPPRA") << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"FLAG::AVASP_LDAU1\")=" << xvasp.aopts.flag("FLAG::AVASP_LDAU1") << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"FLAG::AVASP_LDAU2\")=" << xvasp.aopts.flag("FLAG::AVASP_LDAU2") << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"FLAG::AVASP_LDAU_ADIABATIC\")=" << xvasp.aopts.flag("FLAG::AVASP_LDAU_ADIABATIC") << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"FLAG::AVASP_LDAU_CUTOFF\")=" << xvasp.aopts.flag("FLAG::AVASP_LDAU_CUTOFF") << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"FLAG::AVASP_LSCOUPLING\")=" << xvasp.aopts.flag("FLAG::AVASP_LSCOUPLING") << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"FLAG::AVASP_RELAX_FORCES\")=" << xvasp.aopts.flag("FLAG::AVASP_RELAX_FORCES") << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"FLAG::AVASP_SKIP_NOMIX\")=" << xvasp.aopts.flag("FLAG::AVASP_SKIP_NOMIX") << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"FLAG::AVASP_SPIN\")=" << xvasp.aopts.flag("FLAG::AVASP_SPIN") << endl;}
  ...
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"FLAG::PRECISION_PRESERVED\")=" << xvasp.aopts.flag("FLAG::PRECISION_PRESERVED") << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"FLAG::PRECISION_SET\")=" << xvasp.aopts.flag("FLAG::PRECISION_SET") << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"FLAG::VOLUME_PRESERVED\")=" << xvasp.aopts.flag("FLAG::VOLUME_PRESERVED") << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"FLAG::AVASP_AAPL=OFF\")=" << xvasp.aopts.flag("FLAG::WRITE_AAPL") << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"FLAG::AVASP_APL=OFF\")=" << xvasp.aopts.flag("FLAG::WRITE_APL") << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"FLAG::AVASP_QHA=OFF\")=" << xvasp.aopts.flag("FLAG::WRITE_QHA") << endl;}
  //DX20210122 [OBSOLETE] if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"FLAG::AVASP_NEIGHBORS=OFF\")=" << xvasp.aopts.flag("FLAG::AVASP_NEIGHBOURS=OFF") << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"FLAG::AVASP_SYMMETRY=OFF\")=" << xvasp.aopts.flag("FLAG::AVASP_SYMMETRY=OFF") << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.str=" << endl << xvasp.str << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.str.bravais_lattice_type=" << xvasp.str.bravais_lattice_type << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.str.bravais_lattice_variation_type=" << xvasp.str.bravais_lattice_variation_type << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.str.comp_each_type=";for(uint i=0;i<xvasp.str.comp_each_type.size();i++){cerr << xvasp.str.comp_each_type[i];} cerr << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.str.num_each_type=";for(uint i=0;i<xvasp.str.num_each_type.size();i++){cerr << xvasp.str.num_each_type[i];} cerr << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.str.spacegroupnumber=" << xvasp.str.spacegroupnumber << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.str.species=";for(uint i=0;i<xvasp.str.species.size();i++){cerr << xvasp.str.species[i];} cerr << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.str.species_mass=";for(uint i=0;i<xvasp.str.species_mass.size();i++){cerr << xvasp.str.species_mass[i];} cerr << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.str.species_pp=";for(uint i=0;i<xvasp.str.species_pp.size();i++){cerr << xvasp.str.species_pp[i];} cerr << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.str.species_pp_ZVAL=";for(uint i=0;i<xvasp.str.species_pp_ZVAL.size();i++){cerr << xvasp.str.species_pp_ZVAL[i];} cerr << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.str.species_pp_type=";for(uint i=0;i<xvasp.str.species_pp_type.size();i++){cerr << xvasp.str.species_pp_type[i];} cerr << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.str.species_pp_vLDAU=";for(uint i=0;i<xvasp.str.species_pp_vLDAU.size();i++){for(uint j=0;j<xvasp.str.species_pp_vLDAU[i].size();j++){cerr << xvasp.str.species_pp_vLDAU[i][j];} cerr << endl;} cerr << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.str.species_pp_version=";for(uint i=0;i<xvasp.str.species_pp_version.size();i++){cerr << xvasp.str.species_pp_version[i];} cerr << endl;}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.str.species_volume=";for(uint i=0;i<xvasp.str.species_volume.size();i++){cerr << xvasp.str.species_volume[i];} cerr << endl;}
...
void AVASP_populateXVASP_ARUN(const _aflags& aflags,const _kflags& kflags,const _vflags& vflags,_xvasp& xvasp) {
  ...
  // xvasp.AVASP_flag_MPI = kflags.KBIN_MPI; OBSOLETE ME20190201 - handled in populate_XVASP already
  ...
  aurostd::StringSubst(xvasp.Directory,"//","/"); //CO20181226
  ...
  if (xvasp.AVASP_arun_mode == "APL" || xvasp.AVASP_arun_mode == "AAPL") {
    ...
    if (xvasp.aopts.flag("APL_FLAG::AVASP_BORN") || xvasp.aopts.flag("APL_FLAG::AVASP_LR")) {
      ...
      if (xvasp.aopts.flag("APL_FLAG::AVASP_BORN")) {
        ...
        //kpts = (5 * kpts)/4;
        xvasp.aopts.pop_attached("AFLOWIN_FLAG::KPPRA_STATIC");xvasp.aopts.push_attached("AFLOWIN_FLAG::KPPRA_STATIC", "10000");  //ME20190207 - modified
      }
    }
...
void AVASP_fix_volumes_masses_XVASP(_xvasp& xvasp,bool skip_volume) { //CO20181226
  if (xvasp.str.species.size() > 0) {
    bool zero_vol = false, zero_mass = false;
    for (uint s = 0; s < xvasp.str.species_volume.size(); s++) {
      if (xvasp.str.species_volume[s] < _ZERO_TOL_) {
        zero_vol = true;
        break;
      }
    }
    for (uint s = 0; s < xvasp.str.species_mass.size(); s++) {
    ...
    if (!skip_volume && zero_vol) { //CO20181226
      ...
      for (uint s = 0; s < xvasp.str.species.size(); s++) {
...
bool AVASP_MakeSingleAFLOWIN(_xvasp& xvasp_in,stringstream &_aflowin,bool flag_WRITE,int pthread,bool flag_PRINT) {
  return AVASP_MakeSingleAFLOWIN_20181226(xvasp_in,_aflowin,flag_WRITE,pthread,flag_PRINT);
}
...
bool AVASP_MakeSingleAFLOWIN_20181226(_xvasp& xvasp_in,stringstream &_aflowin,bool flag_WRITE,int pthread,bool flag_PRINT) {
  ...
  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " " << "[0]" << endl;
  if(LDEBUG && xvasp_in.AVASP_prototype_mode==LIBRARY_MODE_HTQC)       cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp_in.AVASP_prototype_mode==LIBRARY_MODE_HTQC" << endl;
  if(LDEBUG && xvasp_in.AVASP_prototype_mode==LIBRARY_MODE_ICSD)       cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp_in.AVASP_prototype_mode==LIBRARY_MODE_ICSD" << endl;
  if(LDEBUG && xvasp_in.AVASP_prototype_mode==LIBRARY_MODE_HTQC_ICSD)  cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp_in.AVASP_prototype_mode==LIBRARY_MODE_HTQC_ICSD" << endl;
  if(LDEBUG && xvasp_in.AVASP_prototype_mode==LIBRARY_MODE_LIB3)       cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp_in.AVASP_prototype_mode==LIBRARY_MODE_LIB3" << endl;
  if(LDEBUG && xvasp_in.AVASP_prototype_mode==LIBRARY_MODE_PROTOTYPE)  cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp_in.AVASP_prototype_mode==LIBRARY_MODE_PROTOTYPE" << endl;
  if(LDEBUG && xvasp_in.AVASP_prototype_mode==LIBRARY_MODE_XSTRUCTURE) cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp_in.AVASP_prototype_mode==LIBRARY_MODE_XSTRUCTURE" << endl;
  ...
  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"AFLOWIN_FLAG::VASP\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::VASP") << endl;
  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"FLAG::AVASP_FORCE_NOLDAU\")=" << xvasp.aopts.flag("FLAG::AVASP_FORCE_NOLDAU") << endl;
  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"FLAG::AVASP_FORCE_NOLDAU\")=" << xvasp.aopts.flag("FLAG::AVASP_FORCE_NOLDAU") << endl;
  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"AFLOWIN_FLAG::PSTRESS\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::PSTRESS") << endl;
  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp.aopts.getattachedscheme(\"AFLOWIN_FLAG::PSTRESS\")=" << xvasp.aopts.getattachedscheme("AFLOWIN_FLAG::PSTRESS") << endl;
  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"AFLOWIN_FLAG::MODULE\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::MODULE") << endl;  //CO20180214
  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp.aopts.getattachedscheme(\"AFLOWIN_FLAG::MODULE\")=" << xvasp.aopts.getattachedscheme("AFLOWIN_FLAG::MODULE") << endl;  //CO20180214
  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"AFLOWIN_FLAG::APL_SUPERCELL\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::APL_SUPERCELL") << endl;  //CO20180214
  ...
  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp.aopts.getattachedscheme(\"AFLOWIN_FLAG::PRECISION\")=" << xvasp.aopts.getattachedscheme("AFLOWIN_FLAG::PRECISION") << endl;
  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"AFLOWIN_FLAG::ALGORITHM\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::ALGORITHM") << endl;
  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp.aopts.getattachedscheme(\"AFLOWIN_FLAG::ALGORITHM\")=" << xvasp.aopts.getattachedscheme("AFLOWIN_FLAG::ALGORITHM") << endl;
  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"AFLOWIN_FLAG::METAGGA\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::METAGGA") << endl;
  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp.aopts.getattachedscheme(\"AFLOWIN_FLAG::METAGGA\")=" << xvasp.aopts.getattachedscheme("AFLOWIN_FLAG::METAGGA") << endl;
  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"AFLOWIN_FLAG::IVDW\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::IVDW") << endl;
  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp.aopts.getattachedscheme(\"AFLOWIN_FLAG::IVDW\")=" << xvasp.aopts.getattachedscheme("AFLOWIN_FLAG::IVDW") << endl;
  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"AFLOWIN_FLAG::RELAX_TYPE\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::RELAX_TYPE") << endl;  //CO20180214
  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp.aopts.getattachedscheme(\"AFLOWIN_FLAG::RELAX_TYPE\")=" << xvasp.aopts.getattachedscheme("AFLOWIN_FLAG::RELAX_TYPE") << endl;  //CO20180214
  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"AFLOWIN_FLAG::RELAX_MODE\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::RELAX_MODE") << endl;
  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp.aopts.getattachedscheme(\"AFLOWIN_FLAG::RELAX_MODE\")=" << xvasp.aopts.getattachedscheme("AFLOWIN_FLAG::RELAX_MODE") << endl;
  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"AFLOWIN_FLAG::RELAX_COUNT\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::RELAX_COUNT") << endl;
  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp.aopts.getattachedscheme(\"AFLOWIN_FLAG::RELAX_COUNT\")=" << xvasp.aopts.getattachedscheme("AFLOWIN_FLAG::RELAX_COUNT") << endl;
  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"AFLOWIN_FLAG::STATIC\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::STATIC") << endl;
  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"AFLOWIN_FLAG::STATIC_BANDS\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::STATIC_BANDS") << endl;
  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"AFLOWIN_FLAG::TYPE\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::TYPE") << endl;
  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp.aopts.getattachedscheme(\"AFLOWIN_FLAG::TYPE\")=" << xvasp.aopts.getattachedscheme("AFLOWIN_FLAG::TYPE") << endl;
  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"AFLOWIN_FLAG::CONVERT_UNIT_CELL\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::CONVERT_UNIT_CELL") << endl;
  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp.aopts.getattachedscheme(\"AFLOWIN_FLAG::CONVERT_UNIT_CELL\")=" << xvasp.aopts.getattachedscheme("AFLOWIN_FLAG::CONVERT_UNIT_CELL") << endl;
  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"AFLOWIN_FLAG::VOLUME_PLUS_EQUAL\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::VOLUME_PLUS_EQUAL") << endl;
  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp.aopts.getattachedscheme(\"AFLOWIN_FLAG::VOLUME_PLUS_EQUAL\")=" << xvasp.aopts.getattachedscheme("AFLOWIN_FLAG::VOLUME_PLUS_EQUAL") << endl;
  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"AFLOWIN_FLAG::VOLUME_MULTIPLY_EQUAL\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::VOLUME_MULTIPLY_EQUAL") << endl;
  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp.aopts.getattachedscheme(\"AFLOWIN_FLAG::VOLUME_MULTIPLY_EQUAL\")=" << xvasp.aopts.getattachedscheme("AFLOWIN_FLAG::VOLUME_MULTIPLY_EQUAL") << endl;
  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"FLAG::VOLUME_PRESERVED\")=" << xvasp.aopts.flag("FLAG::VOLUME_PRESERVED") << endl;  //CO20180214

  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"AFLOWIN_FLAG::KPPRA\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::KPPRA") << endl;
  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp.aopts.getattachedscheme(\"AFLOWIN_FLAG::KPPRA\")=" << xvasp.aopts.getattachedscheme("AFLOWIN_FLAG::KPPRA") << endl;
  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"AFLOWIN_FLAG::KPPRA_STATIC\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::KPPRA_STATIC") << endl;
  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp.aopts.getattachedscheme(\"AFLOWIN_FLAG::KPPRA_STATIC\")=" << xvasp.aopts.getattachedscheme("AFLOWIN_FLAG::KPPRA_STATIC") << endl;
  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"AFLOWIN_FLAG::BANDS_LATTICE\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::BANDS_LATTICE") << endl;
  ...
  stringstream aflowin_cif; aflowin_cif.clear();aflowin_cif.str(std::string()); //DX20190123 - add CIF
  stringstream aflowin_abccar; aflowin_abccar.clear();aflowin_abccar.str(std::string()); //DX20190123 - add ABCCAR
  // for HTQC
  ...
  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " " << "[2]" << endl;
  ...
  if(LDEBUG) {
    ...
    for(uint i=0;i<xvasp.str.species_volume.size();i++) cerr << xvasp.str.species_volume.at(i) << " "; //CO20181128
    cerr << endl; //CO20181128
    cerr << "xvasp.str.species_mass.size()=" << xvasp.str.species_mass.size() << "   "; //CO20181128
    for(uint i=0;i<xvasp.str.species_mass.size();i++) cerr << xvasp.str.species_mass.at(i) << " "; //CO20181128
    cerr << endl; //CO20181128
  }
  if(xvasp.str.num_each_type.size()!=xvasp.str.species.size()) {
    if(LDEBUG) cerr << __AFLOW_FUNC__ << " WARNING 1 (fixing)" << endl;
  ...
  if(xvasp.str.species_pp.size()!=xvasp.str.species.size()) {
    if(LDEBUG) cerr <<"" << __AFLOW_FUNC__ << " WARNING 2 (fixing)" << endl;
  ...
  if(xvasp.str.species_volume.size()!=xvasp.str.species.size()) {
    if(LDEBUG) cerr <<"" << __AFLOW_FUNC__ << " WARNING 3 (fixing)" << endl;
  ...
  if(xvasp.str.species_mass.size()!=xvasp.str.species.size()) {
    if(LDEBUG) cerr <<"" << __AFLOW_FUNC__ << " WARNING 4 (fixing)" << endl;
  ...
  bool skip_volume=(xvasp_in.AVASP_prototype_mode==LIBRARY_MODE_ICSD || xvasp_in.AVASP_prototype_mode==LIBRARY_MODE_HTQC_ICSD); //CO20181226
  ...
  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " " << "[3]" << endl;
  ...
  if(xvasp.aopts.flag("FLAG::AVASP_AUTO_PSEUDOPOTENTIALS")) {
    if(LDEBUG){cerr << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"FLAG::AVASP_AUTO_PSEUDOPOTENTIALS\")==1" << endl;}
    ...
    if(xvasp.aopts.flag("FLAG::AVASP_AUTO_PSEUDOPOTENTIALS") && (xvasp.AVASP_prototype_mode==LIBRARY_MODE_HTQC || xvasp.AVASP_prototype_mode==LIBRARY_MODE_HTQC_ICSD)) {
      ...
      if(xvasp.AVASP_potential==DEFAULT_VASP_POTCAR_DIR_POTPAW_PBE) {
        for(uint isp=0;isp<xvasp.str.species.size();isp++){
          ...
          if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.str.species_pp.at(" << isp << ")=" << xvasp.str.species_pp.at(isp) << endl;}  //CO20180705
        }
        if(xvasp.str.species.size()==2) {
          ...
          if(KBIN::VASP_PseudoPotential_CleanName(xvasp.str.species.at(0))=="B" && KBIN::VASP_PseudoPotential_CleanName(xvasp.str.species.at(1))=="Sm") {
            ...
            cout << __AFLOW_FUNC__ << " Pseudopotential exception: \"potpaw_PBE\"=>\"potpaw_GGA\"" << endl;
            xvasp.aopts.flag("FLAG::AVASP_AUTO_PSEUDOPOTENTIALS",FALSE);
  ...
  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " " << "[4]" << endl;

  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " [5] xvasp.str.species.size()=" << xvasp.str.species.size() << endl;
  ...
  if((xvasp.AVASP_prototype_mode==LIBRARY_MODE_HTQC || xvasp.AVASP_prototype_mode==LIBRARY_MODE_HTQC_ICSD || xvasp.AVASP_prototype_mode==LIBRARY_MODE_LIB3)) {
    ...
    if(xvasp.AVASP_prototype_from_library_) {
          ...
          if (!XHOST.GENERATE_AFLOWIN_ONLY) { //CO20190116
            if(!KBIN::VASP_Find_FILE_POTCAR(xvasp.AVASP_potential+"/"+xvasp.str.species_pp.at(i),FilePotcar,DataPotcar,AUIDPotcar)) {
              ...
              if(tokens.size()==4) { // no indications of time
                ...
                if(tokens.at(2)=="US" && (aurostd::substring2bool(FilePotcar,"GGA") || aurostd::substring2bool(FilePotcar,"gga")) ) {pottype="GGA";date=DEFAULT_VASP_POTCAR_DATE_POT_GGA;}  //CO20181226 - I think this is a bug - aurostd::substring2bool(FilePotcar,"GGA","gga")
              }
              if(tokens.size()==5) {
                if(LDEBUG){ //CO20191020
                  cerr << __AFLOW_FUNC__ << " xvasp.AVASP_potential=" << xvasp.AVASP_potential << endl;
                  cerr << __AFLOW_FUNC__ << " xvasp.str.species_pp[i=" << i << "]=" << xvasp.str.species_pp.at(i) << endl;
      ...
      if(XHOST.hostname==XHOST.AFLOW_MATERIALS_SERVER || XHOST.hostname==XHOST.AFLOW_WEB_SERVER) {
        if(xvasp.AVASP_libbase.size()==0) {
          if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " [5a.5]" << endl;
          if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " [5a.6] XHOST_LIBRARY_LIB2=" << XHOST_LIBRARY_LIB2 << endl;
          if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " [5a.7] vAFLOW_PROJECTS_DIRECTORIES.size()=" << vAFLOW_PROJECTS_DIRECTORIES.size() << endl;
          if(XHOST_LIBRARY_LIB0!=LIBRARY_NOTHING) label_AFLOWLIB_LIB0=init::AFLOW_Projects_Directories("LIB0")+"/RAW"+label_MIX;  //CO20181216 - in case it doesn't find index
          if(XHOST_LIBRARY_LIB1!=LIBRARY_NOTHING) label_AFLOWLIB_LIB1=init::AFLOW_Projects_Directories("LIB1")+"/RAW"+label_MIX;  //CO20181216 - in case it doesn't find index
          if(XHOST_LIBRARY_LIB2!=LIBRARY_NOTHING) label_AFLOWLIB_LIB2=init::AFLOW_Projects_Directories("LIB2")+"/RAW"+label_MIX;  //CO20181216 - in case it doesn't find index
          if(XHOST_LIBRARY_LIB4!=LIBRARY_NOTHING) label_AFLOWLIB_LIB4=init::AFLOW_Projects_Directories("LIB4")+"/RAW"+label_MIX;  //CO20181216 - in case it doesn't find index
          if(XHOST_LIBRARY_LIB5!=LIBRARY_NOTHING) label_AFLOWLIB_LIB5=init::AFLOW_Projects_Directories("LIB5")+"/RAW"+label_MIX;  //CO20181216 - in case it doesn't find index
          if(XHOST_LIBRARY_LIB6!=LIBRARY_NOTHING) label_AFLOWLIB_LIB6=init::AFLOW_Projects_Directories("LIB6")+"/RAW"+label_MIX;  //CO20181216 - in case it doesn't find index
          if(XHOST_LIBRARY_LIB7!=LIBRARY_NOTHING) label_AFLOWLIB_LIB7=init::AFLOW_Projects_Directories("LIB7")+"/RAW"+label_MIX;  //CO20181216 - in case it doesn't find index
          if(XHOST_LIBRARY_LIB8!=LIBRARY_NOTHING) label_AFLOWLIB_LIB8=init::AFLOW_Projects_Directories("LIB8")+"/RAW"+label_MIX;  //CO20181216 - in case it doesn't find index
          if(XHOST_LIBRARY_LIB9!=LIBRARY_NOTHING) label_AFLOWLIB_LIB9=init::AFLOW_Projects_Directories("LIB9")+"/RAW"+label_MIX;  //CO20181216 - in case it doesn't find index
          if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " [5a.6] label_AFLOWLIB_LIB2=" << label_AFLOWLIB_LIB2 << endl;
          ...
          if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " [5d.02] else CHECK THESE BY HAND" << endl;
          ...
          if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " [5d.02] label_AFLOWLIB_LIB0=" << label_AFLOWLIB_LIB0 << endl;
          if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " [5d.02] label_AFLOWLIB_LIB1=" << label_AFLOWLIB_LIB1 << endl;
          if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " [5d.02] label_AFLOWLIB_LIB2=" << label_AFLOWLIB_LIB2 << endl;
          if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " [5d.02] label_AFLOWLIB_LIB3=" << label_AFLOWLIB_LIB3 << endl;	
          if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " [5d.02] label_AFLOWLIB_LIB4=" << label_AFLOWLIB_LIB4 << endl;
          if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " [5d.02] label_AFLOWLIB_LIB5=" << label_AFLOWLIB_LIB5 << endl;
          if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " [5d.02] label_AFLOWLIB_LIB6=" << label_AFLOWLIB_LIB6 << endl;
          if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " [5d.02] label_AFLOWLIB_LIB7=" << label_AFLOWLIB_LIB7 << endl;
          if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " [5d.02] label_AFLOWLIB_LIB8=" << label_AFLOWLIB_LIB8 << endl;
          if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " [5d.02] label_AFLOWLIB_LIB9=" << label_AFLOWLIB_LIB9 << endl;
        }
        if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " [5d.1]" << endl;
        ...
        if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " [5d.03] no check for MIX in non aflowlib servers " << endl;
      }	
      ...
      if(xvasp.AVASP_aflowin_only_if_missing==TRUE) if(aurostd::FileExist(label_AFLOWLIB_LIB0)) {if(LDEBUG) cerr << label_AFLOWLIB_LIB0 << endl; return TRUE;}  // IN AFLOWLIB
      ...
      // done generate
      if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " [6] xvasp.str.species.size()=" << xvasp.str.species.size() << endl;

      if(xvasp.str.species.size()==1) { // because specie 1 is part of the binary stuff //CO20181226 - cannot be pocc with species.size()==1
        if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " [6a] xvasp.str.species.size()=" << xvasp.str.species.size() << endl;	
      ...
      if(xvasp.str.species.size()>=2) {
        if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " [7]  xvasp.str.species.size()>=2" << endl;
        if(LDEBUG) for(uint i=0;i<xvasp.str.species_pp.size();i++) cerr << "DEBUG - " << __AFLOW_FUNC__ << " [7.0a]: xvasp.str.species_pp.at(i) " << xvasp.str.species_pp.at(i) << endl;
        if(LDEBUG) for(uint i=0;i<xvasp.str.species_pp_type.size();i++) cerr << "DEBUG - " << __AFLOW_FUNC__ << " [7.0b]: xvasp.str.species_pp_type.at(i) " << xvasp.str.species_pp_type.at(i) << endl;
        if(LDEBUG) for(uint i=0;i<xvasp.str.species_pp_version.size();i++) cerr << "DEBUG - " << __AFLOW_FUNC__ << " [7.0c]: xvasp.str.species_pp_version.at(i) " << xvasp.str.species_pp_version.at(i) << endl;
        if(LDEBUG) for(uint i=0;i<xvasp.str.species_pp_ZVAL.size();i++) cerr << "DEBUG - " << __AFLOW_FUNC__ << " [7.0c]: xvasp.str.species_pp_ZVAL.at(i) " << xvasp.str.species_pp_ZVAL.at(i) << endl;
        if(LDEBUG) for(uint i=0;i<xvasp.str.species_pp_vLDAU.size();i++) cerr << "DEBUG - " << __AFLOW_FUNC__ << " [7.0c]: xvasp.str.species_pp_vLDAU.at(i) " << xvasp.str.species_pp_vLDAU.at(i).size() << endl;
        if(LDEBUG) for(uint i=0;i<xvasp.str.species_volume.size();i++) cerr << "DEBUG - " << __AFLOW_FUNC__ << " [7.0d]: xvasp.str.species_volume.at(i) " << xvasp.str.species_volume.at(i) << endl;
        if(LDEBUG) for(uint i=0;i<xvasp.str.species_mass.size();i++) cerr << "DEBUG - " << __AFLOW_FUNC__ << " [7.0e]: xvasp.str.species_mass.at(i) " << xvasp.str.species_mass.at(i) << endl;
        if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " [7.1a1]: xvasp.AVASP_volume_in=" << xvasp.AVASP_volume_in << endl;
        if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " [7.1a2]: xvasp.AVASP_label=" << xvasp.AVASP_label << endl;
        if(LDEBUG) {cerr << "DEBUG - " << __AFLOW_FUNC__ << " [7.1a3]: xvasp.str.species_pp.size()=" << xvasp.str.species_pp.size() << ": "; for(uint i=0;i<xvasp.str.species_pp.size();i++) cerr << " " << xvasp.str.species_pp.at(i); cerr << endl;}
        if(LDEBUG) {cerr << "DEBUG - " << __AFLOW_FUNC__ << " [7.1a3]: xvasp.str.species_volume.size()=" << xvasp.str.species_volume.size() << ": "; for(uint i=0;i<xvasp.str.species_volume.size();i++) cerr << " " << xvasp.str.species_volume.at(i); cerr << endl;}
        ...
        if(pocc){ //CO20190219
          vector<string> species_pp_orig;for(uint i=0;i<xvasp.str.species_pp.size();i++){species_pp_orig.push_back(xvasp.str.species_pp[i]);} //create original
          vector<double> species_volume_orig;for(uint i=0;i<xvasp.str.species_volume.size();i++){species_volume_orig.push_back(xvasp.str.species_volume[i]);} //create original
          uint nspecies=aflowlib::PrototypeLibrariesSpeciesNumber(xvasp.AVASP_label); //find pseudo nspecies for proto
          deque<string> species_pp;for(uint i=0;i<nspecies&&i<xvasp.str.species_pp.size();i++){species_pp.push_back(xvasp.str.species_pp[i]);} //create pseudo species
          deque<double> species_volume;for(uint i=0;i<nspecies&&i<xvasp.str.species_volume.size();i++){species_volume.push_back(xvasp.str.species_volume[i]);} //create pseudo volumes
          xvasp.str=aflowlib::PrototypeLibraries(oaus,xvasp.AVASP_label,xvasp.AVASP_parameters,species_pp,species_volume,xvasp.AVASP_volume_in,xvasp_in.AVASP_prototype_mode); 
        ...
        if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " [7.1b]  xvasp.str.species.size()>=2" << endl;
        if(LDEBUG) cerr << xvasp.str << endl;
        if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " [7.1c]  xvasp.str.species.size()>=2" << endl;
      ...
      if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " [8] xvasp.str.species.size()=" << xvasp.str.species.size() << endl;
    ...
    if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " [9]" << endl;
  ...
  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " " << "[10]" << endl;
  ...
  if(xvasp.AVASP_prototype_mode==LIBRARY_MODE_ICSD) {
    ...
    //  cerr << "DEBUG - " << __AFLOW_FUNC__ << " directory(4)=" << directory << endl;
    //    cerr << directory << endl;
  }
  ...
  if(xvasp.aopts.flag("AFLOWIN_FLAG::PARAMS")==TRUE) {
    //DX [OBSOLETE] string anrl_add_on=""; //":ANRL="+xvasp.AVASP_parameters; //CO20181226 - we ignore this
    string anrl_add_on=":ANRL="+xvasp.AVASP_parameters; //DX20190314 - added back in by default 
    ...
    //DX20190227 [OBSOLETE] if(!aurostd::substring2bool(system,"A3B5_oC32_38_abce_abcdf-001")) {aurostd::StringSubst(system,"A3B5_oC32_38_abce_abcdf","A3B5_oC32_38_abce_abcdf-001");aurostd::StringSubst(directory,"A3B5_oC32_38_abce_abcdf","A3B5_oC32_38_abce_abcdf-001");aurostd::StringSubst(xvasp.AVASP_label,"A3B5_oC32_38_abce_abcdf","A3B5_oC32_38_abce_abcdf-001");} //A3B5_oC32_38_abce_abcdf OL bccSQS
    //DX20190227 [OBSOLETE] if(!aurostd::substring2bool(system,"AB3_mC32_8_4a_12a-001")) {aurostd::StringSubst(system,"AB3_mC32_8_4a_12a","AB3_mC32_8_4a_12a-001");aurostd::StringSubst(directory,"AB3_mC32_8_4a_12a","AB3_mC32_8_4a_12a-001");aurostd::StringSubst(xvasp.AVASP_label,"AB3_mC32_8_4a_12a","AB3_mC32_8_4a_12a-001");} //AB3_mC32_8_4a_12a OL bccSQS
    //DX20190227 [OBSOLETE] if(!aurostd::substring2bool(system,"A5B11_mP16_6_2abc_2a3b3c-001")) {aurostd::StringSubst(system,"A5B11_mP16_6_2abc_2a3b3c","A5B11_mP16_6_2abc_2a3b3c-001");aurostd::StringSubst(directory,"A5B11_mP16_6_2abc_2a3b3c","A5B11_mP16_6_2abc_2a3b3c-001");aurostd::StringSubst(xvasp.AVASP_label,"A5B11_mP16_6_2abc_2a3b3c","A5B11_mP16_6_2abc_2a3b3c-001");} //A5B11_mP16_6_2abc_2a3b3c OL bccSQS
    //DX20190227 [OBSOLETE] if(!aurostd::substring2bool(system,"A3B13_oC32_38_ac_a2bcdef-001")) {aurostd::StringSubst(system,"A3B13_oC32_38_ac_a2bcdef","A3B13_oC32_38_ac_a2bcdef-001");aurostd::StringSubst(directory,"A3B13_oC32_38_ac_a2bcdef","A3B13_oC32_38_ac_a2bcdef-001");aurostd::StringSubst(xvasp.AVASP_label,"A3B13_oC32_38_ac_a2bcdef","A3B13_oC32_38_ac_a2bcdef-001");} //A3B13_oC32_38_ac_a2bcdef OL bccSQS
    //DX20190227 [OBSOLETE] if(!aurostd::substring2bool(system,"AB3_mC32_8_4a_4a4b-001")) {aurostd::StringSubst(system,"AB3_mC32_8_4a_4a4b","AB3_mC32_8_4a_4a4b-001");aurostd::StringSubst(directory,"AB3_mC32_8_4a_4a4b","AB3_mC32_8_4a_4a4b-001");aurostd::StringSubst(xvasp.AVASP_label,"AB3_mC32_8_4a_4a4b","AB3_mC32_8_4a_4a4b-001");} //AB3_mC32_8_4a_4a4b OL bccSQS
    //DX20190227 [OBSOLETE] if(!aurostd::substring2bool(system,"AB_aP16_2_4i_4i-001")) {aurostd::StringSubst(system,"AB_aP16_2_4i_4i","AB_aP16_2_4i_4i-001");aurostd::StringSubst(directory,"AB_aP16_2_4i_4i","AB_aP16_2_4i_4i-001");aurostd::StringSubst(xvasp.AVASP_label,"AB_aP16_2_4i_4i","AB_aP16_2_4i_4i-001");} //AB_aP16_2_4i_4i OL bccSQS
    //DX20190227 [OBSOLETE] if(!aurostd::substring2bool(system,"AB7_hR16_166_c_c2h-001")) {aurostd::StringSubst(system,"AB7_hR16_166_c_c2h","AB7_hR16_166_c_c2h-001");aurostd::StringSubst(directory,"AB7_hR16_166_c_c2h","AB7_hR16_166_c_c2h-001");aurostd::StringSubst(xvasp.AVASP_label,"AB7_hR16_166_c_c2h","AB7_hR16_166_c_c2h-001");} //AB7_hR16_166_c_c2h OL bccSQS
    //DX20190227 [OBSOLETE] if(!aurostd::substring2bool(system,"A2BCD4_tI16_82_ac_b_d_g-001")) {aurostd::StringSubst(system,"A2BCD4_tI16_82_ac_b_d_g","A2BCD4_tI16_82_ac_b_d_g-001");aurostd::StringSubst(directory,"A2BCD4_tI16_82_ac_b_d_g","A2BCD4_tI16_82_ac_b_d_g-001");aurostd::StringSubst(xvasp.AVASP_label,"A2BCD4_tI16_82_ac_b_d_g","A2BCD4_tI16_82_ac_b_d_g-001");} //A2BCD4_tI16_82_ac_b_d_g natalio kesterite
    //DX20190227 [OBSOLETE] if(!aurostd::substring2bool(system,"A_tI4_141_a-001")) {aurostd::StringSubst(system,"A_tI4_141_a","A_tI4_141_a-001");aurostd::StringSubst(directory,"A_tI4_141_a","A_tI4_141_a-001");aurostd::StringSubst(xvasp.AVASP_label,"A_tI4_141_a","A_tI4_141_a-001");} //A_tI4_141_a mike Sn
    //DX20190227 [OBSOLETE] if(!aurostd::substring2bool(system,"A_hP1_191_a-001")) {aurostd::StringSubst(system,"A_hP1_191_a","A_hP1_191_a-001");aurostd::StringSubst(directory,"A_hP1_191_a","A_hP1_191_a-001");aurostd::StringSubst(xvasp.AVASP_label,"A_hP1_191_a","A_hP1_191_a-001");} //A_hP1_191_a mike Sn
    //DX20190227 [OBSOLETE] if(!aurostd::substring2bool(system,"AB2_hP3_191_a_d-001")) {aurostd::StringSubst(system,"AB2_hP3_191_a_d","AB2_hP3_191_a_d-001");aurostd::StringSubst(directory,"AB2_hP3_191_a_d","AB2_hP3_191_a_d-001");aurostd::StringSubst(xvasp.AVASP_label,"AB2_hP3_191_a_d","AB2_hP3_191_a_d-001");} //AB2_hP3_191_a_d pranab 6-metal-boride
  }
  ...
  //DX20190326 - moved up [OBSOLETE]  //DX20180123 - Add ANRL parameters to label - START
  //DX20190326 - moved up [OBSOLETE]  // check for ANRL
  //DX20190326 - moved up [OBSOLETE]  if(xvasp.aopts.flag("AFLOWIN_FLAG::PARAMS")==TRUE) {
  //DX20190326 - moved up [OBSOLETE]    //DX [OBSOLETE] string anrl_add_on=""; //":ANRL="+xvasp.AVASP_parameters; //CO20181226 - we ignore this
  //DX20190326 - moved up [OBSOLETE]    string anrl_add_on=":ANRL="+xvasp.AVASP_parameters; //DX20190314 - added back in by default 
  //DX20190326 - moved up [OBSOLETE]
  //DX20190326 - moved up [OBSOLETE]    //DX20190314 - check if parameter string matches with parameter values from ANRL library - START
  //DX20190326 - moved up [OBSOLETE]    vector<string> parameters; aurostd::string2tokens(xvasp.AVASP_parameters,parameters,",");
  //DX20190326 - moved up [OBSOLETE]    if(aurostd::string2utype<double>(parameters[0])<=0.0){
  //DX20190326 - moved up [OBSOLETE]      string catalog = "anrl";
  //DX20190326 - moved up [OBSOLETE]      vector<string> existing_prototype_labels = pflow::getMatchingPrototypes(xvasp.str,catalog);
  //DX20190326 - moved up [OBSOLETE]      if(existing_prototype_labels.size()){
  //DX20190326 - moved up [OBSOLETE]        //DX20190326 - added if-statement cases - START
  //DX20190326 - moved up [OBSOLETE]        // contains degrees of freedom
  //DX20190326 - moved up [OBSOLETE]        if(aurostd::substring2bool(existing_prototype_labels[0],"-")){ 
  //DX20190326 - moved up [OBSOLETE]          vector<string> tmp_tokens; aurostd::string2tokens(existing_prototype_labels[0],tmp_tokens,"-");
  //DX20190326 - moved up [OBSOLETE]          anrl_add_on = "-" + tmp_tokens[1]; // e.g., 001
  //DX20190326 - moved up [OBSOLETE]        }
  //DX20190326 - moved up [OBSOLETE]        // doesn't contain degree of freedom
  //DX20190326 - moved up [OBSOLETE]        else {
  //DX20190326 - moved up [OBSOLETE]          anrl_add_on = "";
  //DX20190326 - moved up [OBSOLETE]        }
  //DX20190326 - moved up [OBSOLETE]        //DX20190326 - added if-statement cases - END
  //DX20190326 - moved up [OBSOLETE]      }
  //DX20190326 - moved up [OBSOLETE]    }
  //DX20190326 - moved up [OBSOLETE]    //DX20190314 - check if parameter string matches with parameter values from ANRL library - END
  //DX20190326 - moved up [OBSOLETE]    system+=anrl_add_on;directory+=anrl_add_on;xvasp.AVASP_label+=anrl_add_on;
  //DX20190326 - moved up [OBSOLETE]    //CO20181216 - some fudging to adjust for database runs - DX REMOVE WHEN YOU FIX ANRL
  //DX20190326 - moved up [OBSOLETE]    //DX20190227 [OBSOLETE] if(!aurostd::substring2bool(system,"A3B5_oC32_38_abce_abcdf-001")) {aurostd::StringSubst(system,"A3B5_oC32_38_abce_abcdf","A3B5_oC32_38_abce_abcdf-001");aurostd::StringSubst(directory,"A3B5_oC32_38_abce_abcdf","A3B5_oC32_38_abce_abcdf-001");aurostd::StringSubst(xvasp.AVASP_label,"A3B5_oC32_38_abce_abcdf","A3B5_oC32_38_abce_abcdf-001");} //A3B5_oC32_38_abce_abcdf OL bccSQS
  //DX20190326 - moved up [OBSOLETE]    //DX20190227 [OBSOLETE] if(!aurostd::substring2bool(system,"AB3_mC32_8_4a_12a-001")) {aurostd::StringSubst(system,"AB3_mC32_8_4a_12a","AB3_mC32_8_4a_12a-001");aurostd::StringSubst(directory,"AB3_mC32_8_4a_12a","AB3_mC32_8_4a_12a-001");aurostd::StringSubst(xvasp.AVASP_label,"AB3_mC32_8_4a_12a","AB3_mC32_8_4a_12a-001");} //AB3_mC32_8_4a_12a OL bccSQS
  //DX20190326 - moved up [OBSOLETE]    //DX20190227 [OBSOLETE] if(!aurostd::substring2bool(system,"A5B11_mP16_6_2abc_2a3b3c-001")) {aurostd::StringSubst(system,"A5B11_mP16_6_2abc_2a3b3c","A5B11_mP16_6_2abc_2a3b3c-001");aurostd::StringSubst(directory,"A5B11_mP16_6_2abc_2a3b3c","A5B11_mP16_6_2abc_2a3b3c-001");aurostd::StringSubst(xvasp.AVASP_label,"A5B11_mP16_6_2abc_2a3b3c","A5B11_mP16_6_2abc_2a3b3c-001");} //A5B11_mP16_6_2abc_2a3b3c OL bccSQS
  //DX20190326 - moved up [OBSOLETE]    //DX20190227 [OBSOLETE] if(!aurostd::substring2bool(system,"A3B13_oC32_38_ac_a2bcdef-001")) {aurostd::StringSubst(system,"A3B13_oC32_38_ac_a2bcdef","A3B13_oC32_38_ac_a2bcdef-001");aurostd::StringSubst(directory,"A3B13_oC32_38_ac_a2bcdef","A3B13_oC32_38_ac_a2bcdef-001");aurostd::StringSubst(xvasp.AVASP_label,"A3B13_oC32_38_ac_a2bcdef","A3B13_oC32_38_ac_a2bcdef-001");} //A3B13_oC32_38_ac_a2bcdef OL bccSQS
  //DX20190326 - moved up [OBSOLETE]    //DX20190227 [OBSOLETE] if(!aurostd::substring2bool(system,"AB3_mC32_8_4a_4a4b-001")) {aurostd::StringSubst(system,"AB3_mC32_8_4a_4a4b","AB3_mC32_8_4a_4a4b-001");aurostd::StringSubst(directory,"AB3_mC32_8_4a_4a4b","AB3_mC32_8_4a_4a4b-001");aurostd::StringSubst(xvasp.AVASP_label,"AB3_mC32_8_4a_4a4b","AB3_mC32_8_4a_4a4b-001");} //AB3_mC32_8_4a_4a4b OL bccSQS
  //DX20190326 - moved up [OBSOLETE]    //DX20190227 [OBSOLETE] if(!aurostd::substring2bool(system,"AB_aP16_2_4i_4i-001")) {aurostd::StringSubst(system,"AB_aP16_2_4i_4i","AB_aP16_2_4i_4i-001");aurostd::StringSubst(directory,"AB_aP16_2_4i_4i","AB_aP16_2_4i_4i-001");aurostd::StringSubst(xvasp.AVASP_label,"AB_aP16_2_4i_4i","AB_aP16_2_4i_4i-001");} //AB_aP16_2_4i_4i OL bccSQS
  //DX20190326 - moved up [OBSOLETE]    //DX20190227 [OBSOLETE] if(!aurostd::substring2bool(system,"AB7_hR16_166_c_c2h-001")) {aurostd::StringSubst(system,"AB7_hR16_166_c_c2h","AB7_hR16_166_c_c2h-001");aurostd::StringSubst(directory,"AB7_hR16_166_c_c2h","AB7_hR16_166_c_c2h-001");aurostd::StringSubst(xvasp.AVASP_label,"AB7_hR16_166_c_c2h","AB7_hR16_166_c_c2h-001");} //AB7_hR16_166_c_c2h OL bccSQS
  //DX20190326 - moved up [OBSOLETE]    //DX20190227 [OBSOLETE] if(!aurostd::substring2bool(system,"A2BCD4_tI16_82_ac_b_d_g-001")) {aurostd::StringSubst(system,"A2BCD4_tI16_82_ac_b_d_g","A2BCD4_tI16_82_ac_b_d_g-001");aurostd::StringSubst(directory,"A2BCD4_tI16_82_ac_b_d_g","A2BCD4_tI16_82_ac_b_d_g-001");aurostd::StringSubst(xvasp.AVASP_label,"A2BCD4_tI16_82_ac_b_d_g","A2BCD4_tI16_82_ac_b_d_g-001");} //A2BCD4_tI16_82_ac_b_d_g natalio kesterite
  //DX20190326 - moved up [OBSOLETE]    //DX20190227 [OBSOLETE] if(!aurostd::substring2bool(system,"A_tI4_141_a-001")) {aurostd::StringSubst(system,"A_tI4_141_a","A_tI4_141_a-001");aurostd::StringSubst(directory,"A_tI4_141_a","A_tI4_141_a-001");aurostd::StringSubst(xvasp.AVASP_label,"A_tI4_141_a","A_tI4_141_a-001");} //A_tI4_141_a mike Sn
  //DX20190326 - moved up [OBSOLETE]    //DX20190227 [OBSOLETE] if(!aurostd::substring2bool(system,"A_hP1_191_a-001")) {aurostd::StringSubst(system,"A_hP1_191_a","A_hP1_191_a-001");aurostd::StringSubst(directory,"A_hP1_191_a","A_hP1_191_a-001");aurostd::StringSubst(xvasp.AVASP_label,"A_hP1_191_a","A_hP1_191_a-001");} //A_hP1_191_a mike Sn
  //DX20190326 - moved up [OBSOLETE]    //DX20190227 [OBSOLETE] if(!aurostd::substring2bool(system,"AB2_hP3_191_a_d-001")) {aurostd::StringSubst(system,"AB2_hP3_191_a_d","AB2_hP3_191_a_d-001");aurostd::StringSubst(directory,"AB2_hP3_191_a_d","AB2_hP3_191_a_d-001");aurostd::StringSubst(xvasp.AVASP_label,"AB2_hP3_191_a_d","AB2_hP3_191_a_d-001");} //AB2_hP3_191_a_d pranab 6-metal-boride
  //DX20190326 - moved up [OBSOLETE]  }
  //DX20190326 - moved up [OBSOLETE]  //DX20180123 - Add ANRL parameters to label - END
  ...
  if(xvasp.aopts.flag("AFLOWIN_FLAG::PSTRESS")==TRUE) {
    ...
    if(abs(PSTRESS)>0.00001) {
      if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " with pressure " << "[12p]" << endl;
      string pressure_add_on=":P="+aurostd::utype2string(PSTRESS,_AVASP_DOUBLE2STRING_PRECISION_)+"kB";
      if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " with pressure " << "[12p2] pressure_add_on="  << pressure_add_on << endl;
  ...
  if (!xvasp.AVASP_arun) {
    ...
    if(0 && xvasp.aopts.flag("FLAG::AVASP_LDAU1") && !aurostd::substring2bool(system,"_ICSD")) {
      if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " with LDAU1 " << "[12p3]" << endl;
    ...
    if((xvasp.aopts.flag("FLAG::AVASP_LDAU1") || xvasp.aopts.flag("FLAG::AVASP_LDAU2") ) && !aurostd::substring2bool(system,"_ICSD")) {
      if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " with LDAU2 " << "[12p4]" << endl;
    ...
    if (xvasp.AVASP_prototype_mode == LIBRARY_MODE_ARUN) {
      string arun_add_on=":" + ARUN_DIRECTORY_PREFIX + xvasp.AVASP_arun_mode + "_" + xvasp.AVASP_arun_runname; //CO20181226
      system+=arun_add_on;
    }
  }

  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " " << "[12.2]" << endl;
  ...
  aflowin << "[AFLOW] * R. Taylor, C. Calderon, C. Toher, C. Oses, J. J. Plata, D. Hicks, M. Esters,      " << endl;
  aflowin << "[AFLOW] * P. Nath, F. Rose, E. Gossett, E. Perim, R. Chepulskyy, K. Rasch, M. Fornari,      " << endl;
  ...
  if (xvasp.aopts.flag("AFLOWIN_FLAG::KZIP_BIN")) bin = xvasp.aopts.getattachedscheme("AFLOWIN_FLAG::KZIP_BIN");
  aflowin << "[AFLOW_MODE_ZIP=" << bin << "] " << endl;
  bin = DEFAULT_VASP_BIN;
  if (xvasp.aopts.flag("AFLOWIN_FLAG::KBIN_SERIAL_BIN")) bin = xvasp.aopts.getattachedscheme("AFLOWIN_FLAG::KBIN_SERIAL_BIN");
  ...
  if(xvasp.aopts.flag("AFLOWIN_FLAG::MPI_NUM_CPUS")) NCPUS_VAL=xvasp.aopts.getattachedscheme("AFLOWIN_FLAG::MPI_NUM_CPUS");  //ME20181113
  if(XHOST.vflag_control.flag("XPLUG_NUM_THREADS")) NCPUS_VAL=XHOST.vflag_control.getattachedscheme("XPLUG_NUM_THREADS");
  if (!NCPUS_VAL.empty()) aflowin << "[AFLOW_MODE_MPI_MODE]NCPUS=" << NCPUS_VAL << " " << endl;  // Modified - ME20181113
#ifdef MPI_LAM
  aflowin << "[AFLOW_MODE_MPI_MODE]START=\"lamboot\" " << endl;
  aflowin << "[AFLOW_MODE_MPI_MODE]STOP=\"lamhalt\" " << endl;
#endif
  bin = MPI_COMMAND_DEFAULT;
  if (xvasp.aopts.flag("AFLOWIN_FLAG::MPI_COMMAND")) bin = xvasp.aopts.getattachedscheme("AFLOWIN_FLAG::MPI_COMMAND");
  aflowin << "[AFLOW_MODE_MPI_MODE]COMMAND =\"" << bin << "\" " << endl;
  aflowin << "[AFLOW_MODE_MPI_MODE]AUTOTUNE " << endl;
  bin = DEFAULT_VASP_MPI_BIN;
  if (xvasp.aopts.flag("AFLOWIN_FLAG::MPI_BIN")) bin = xvasp.aopts.getattachedscheme("AFLOWIN_FLAG::MPI_BIN");
  ...
  if(!xvasp.aopts.flag("FLAG::AVASP_APL=OFF")) { //CO20180214 - I interpret this flag to refer to WRITING APL options, not if they are on
    ...
    for (uint i = 0; i < vkeys.size(); i++) {
      ...
      key = xvaspflag;
      aurostd::StringSubst(key, "AFLOWIN_FLAG::APL_", string(""));
      if (!scheme.empty()) {
  ...
  if(!xvasp.aopts.flag("FLAG::AVASP_AAPL=OFF")) {
    ...
    for (uint i = 0; i < vkeys.size(); i++) {
      ...
      key = xvaspflag;
      aurostd::StringSubst(key, "AFLOWIN_FLAG::AAPL_", string(""));
      if (!scheme.empty()) {
        aflowin << aurostd::PaddedPOST(_ASTROPT_+key+"="+scheme,_AFLOWINPAD_) << " // README_AFLOW_APL.TXT" << endl;
      }
    }
  ...
  if(1 && !xvasp.aopts.flag("FLAG::AVASP_AGL=OFF")) {  //CO20181226 - cormac will fix
  ...
  if(1 && !xvasp.aopts.flag("FLAG::AVASP_AEL=OFF")) { //CO20181226 - cormac will fix
  ...
  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " " << "[12.3]" << endl;

  // RELAX WRITING
  string relax_count=aurostd::utype2string(DEFAULT_VASP_FORCE_OPTION_RELAX_COUNT);
  if(xvasp.aopts.flag("AFLOWIN_FLAG::RELAX_COUNT")){relax_count=xvasp.aopts.getattachedscheme("AFLOWIN_FLAG::RELAX_COUNT");}
  if(LDEBUG) {cerr << __AFLOW_FUNC__ << " relax_count=" << relax_count << endl;}
  if(xvasp.AVASP_flag_RUN_RELAX_STATIC_BANDS) aflowin << aurostd::PaddedPOST("[VASP_RUN]RELAX_STATIC_BANDS="+relax_count,_AFLOWINPAD_); //CO20181226 - must be else if
  else if(xvasp.AVASP_flag_RUN_RELAX_STATIC) aflowin << aurostd::PaddedPOST("[VASP_RUN]RELAX_STATIC="+relax_count,_AFLOWINPAD_);  //CO20181226 - must be else if
  else if(xvasp.AVASP_flag_RUN_RELAX) aflowin << aurostd::PaddedPOST("[VASP_RUN]RELAX="+relax_count,_AFLOWINPAD_);  //CO20181226 - must be else if
  ...
  else if(xvasp.AVASP_potential==DEFAULT_VASP_POTCAR_DIR_POT_GGA) aus_PP="pot_GGA";
  else if(xvasp.AVASP_potential==DEFAULT_VASP_POTCAR_DIR_POT_PBE) aus_PP="pot_PBE";
  else if(xvasp.AVASP_potential==DEFAULT_VASP_POTCAR_DIR_POTPAW_LDA) aus_PP="potpaw_LDA";
  else if(xvasp.AVASP_potential==DEFAULT_VASP_POTCAR_DIR_POTPAW_GGA) aus_PP="potpaw_GGA";
  else if(xvasp.AVASP_potential==DEFAULT_VASP_POTCAR_DIR_POTPAW_PBE) aus_PP="potpaw_PBE";
  else if(xvasp.AVASP_potential==DEFAULT_VASP_POTCAR_DIR_POTPAW_LDA_KIN) aus_PP="potpaw_LDA_KIN"; //CO20190204 - must come AFTER potpaw_LDA in else if() structure
  else if(xvasp.AVASP_potential==DEFAULT_VASP_POTCAR_DIR_POTPAW_PBE_KIN) aus_PP="potpaw_PBE_KIN"; //CO20190204 - must come AFTER potpaw_PBE in else if() structure
  ...
  if(xvasp.aopts.flag("FLAG::AVASP_AUTO_PSEUDOPOTENTIALS") && !aus_PP.empty()) {
    ...
    if(aus_PP.empty()){aus_PP=DEFAULT_VASP_PSEUDOPOTENTIAL_TYPE;}  //CO20190126 - some sort of default
  ...
  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " " << "[12.4]" << endl;
  ...
  if(AFLOWIN_NEW) { // NEW
    ...
    if(xvasp.aopts.flag("FLAG::AVASP_SPIN") && xvasp.aopts.flag("FLAG::AVASP_RECYCLE_SPIN")) vstr.push_back("RECYCLE_SPIN");  //CO20230826
    if(vstr.size()>0) {
      for(uint i=0;i<vstr.size();i++) tstr+=vstr.at(i)+(i!=vstr.size()-1 ? "," : " ");
      aflowin << aurostd::PaddedPOST("[VASP_FORCE_OPTION]SPIN="+tstr,_AFLOWINPAD_) << " // (ON | OFF  (default: DEFAULT_VASP_FORCE_OPTION_SPIN in .aflow.rc)), REMOVE_RELAX_1 | _2 (default: DEFAULT_VASP_FORCE_OPTION_SPIN_REMOVE_RELAX_1 _2 in .aflow.rc), RECYCLE_SPIN (default DEFAULT_VASP_FORCE_OPTION_RECYCLE_SPIN in .aflow.rc)" << endl;
    }
  }
  ...
  if(xvasp.aopts.flag("FLAG::PRECISION_SET") || xvasp.aopts.flag("AFLOWIN_FLAG::PRECISION")) {
    if(AFLOWIN_OLD) { // OLD
      if(PRECISION.at(0)=='L' || PRECISION.at(0)=='l')
        aflowin << aurostd::PaddedPOST("[VASP_FORCE_OPTION]PREC=LOW",_AFLOWINPAD_) << " // (LOW | MEDIUM | NORMAL | HIGH | ACCURATE | PHONONS), PRESERVED (default: DEFAULT_VASP_FORCE_OPTION_PREC_SCHEME in .aflow.rc" << endl;
      if(PRECISION.at(0)=='M' || PRECISION.at(0)=='m')
        aflowin << aurostd::PaddedPOST("[VASP_FORCE_OPTION]PREC=MEDIUM",_AFLOWINPAD_) << " // (LOW | MEDIUM | NORMAL | HIGH | ACCURATE | PHONONS), PRESERVED (default: DEFAULT_VASP_FORCE_OPTION_PREC_SCHEME in .aflow.rc" << endl;
      if(PRECISION.at(0)=='N' || PRECISION.at(0)=='n')
        aflowin << aurostd::PaddedPOST("[VASP_FORCE_OPTION]PREC=NORMAL",_AFLOWINPAD_) << " // (LOW | MEDIUM | NORMAL | HIGH | ACCURATE | PHONONS), PRESERVED (default: DEFAULT_VASP_FORCE_OPTION_PREC_SCHEME in .aflow.rc" << endl;
      if(PRECISION.at(0)=='H' || PRECISION.at(0)=='h')
        aflowin << aurostd::PaddedPOST("[VASP_FORCE_OPTION]PREC=HIGH",_AFLOWINPAD_) << " // (LOW | MEDIUM | NORMAL | HIGH | ACCURATE | PHONONS), PRESERVED (default: DEFAULT_VASP_FORCE_OPTION_PREC_SCHEME in .aflow.rc" << endl;
      if(PRECISION.at(0)=='A' || PRECISION.at(0)=='a')
        aflowin << aurostd::PaddedPOST("[VASP_FORCE_OPTION]PREC=ACCURATE",_AFLOWINPAD_) << " // (LOW | MEDIUM | NORMAL | HIGH | ACCURATE | PHONONS), PRESERVED (default: DEFAULT_VASP_FORCE_OPTION_PREC_SCHEME in .aflow.rc" << endl;
      //ME20181022
      if(PRECISION.at(0)=='P' || PRECISION.at(0)=='p')
        aflowin << aurostd::PaddedPOST("[VASP_FORCE_OPTION]PREC=PHONONS",_AFLOWINPAD_) << " // (LOW | MEDIUM | NORMAL | HIGH | ACCURATE | PHONONS), PRESERVED (default: DEFAULT_VASP_FORCE_OPTION_PREC_SCHEME in .aflow.rc" << endl;
    ...
    if(AFLOWIN_NEW) { // NEW
      ...
      if(vstr.size()>0) {
        ...
        aflowin << aurostd::PaddedPOST("[VASP_FORCE_OPTION]PREC="+tstr,_AFLOWINPAD_) << " // (LOW | MEDIUM | NORMAL | HIGH | ACCURATE | PHONONS), PRESERVED (default: DEFAULT_VASP_FORCE_OPTION_PREC_SCHEME in .aflow.rc)" << endl;
      }
      if(vstr.size()==0) {
        aflowin << aurostd::PaddedPOST("#[VASP_FORCE_OPTION]PREC="+DEFAULT_VASP_FORCE_OPTION_PREC_SCHEME,_AFLOWINPAD_) << " // (LOW | MEDIUM | NORMAL | HIGH | ACCURATE | PHONONS), PRESERVED (default: DEFAULT_VASP_FORCE_OPTION_PREC_SCHEME in .aflow.rc)" << endl;
      }
    }
  }
  ...
  if(xvasp.aopts.flag("FLAG::ALGO_SET") || xvasp.aopts.flag("AFLOWIN_FLAG::ALGORITHM")) {
    ...
    if(AFLOWIN_NEW) { // NEW
      ...
      if(vstr.size()==0) {
        aflowin << aurostd::PaddedPOST("#[VASP_FORCE_OPTION]ALGO="+DEFAULT_VASP_FORCE_OPTION_ALGO_SCHEME,_AFLOWINPAD_) << " // (NORMAL | VERYFAST | FAST | ALL | DAMPED), PRESERVED (default: DEFAULT_VASP_FORCE_OPTION_ALGO_SCHEME in .aflow.rc)" << endl;
      }
    }
  }
  ...
  if(xvasp.aopts.flag("FLAG::ABMIX_SET")) { //  unspecified | [AUTO | US | PAW | #AMIX,#BMIX[,#AMIX_MAG,#BMIX_MAG]]
    ...
    if(vstr.size()==0) {
      aflowin << aurostd::PaddedPOST("#[VASP_FORCE_OPTION]ABMIX=AUTO",_AFLOWINPAD_) << " // unspecified | [AUTO | US | PAW | (exp) #AMIX,#BMIX[,#AMIX_MAG,#BMIX_MAG]] (default=unspecified " << DEFAULT_VASP_FORCE_OPTION_ABMIX_SCHEME<< ")" << endl;
    }
  }

  //CO20181226 - this is a bit strange, volume_preserved seems to be associated with += or *= VOLUME inflation before relaxation
  //but here, it also dictates ISIF (RELAX_ALL==isif=3)
  //these are independent
  //I am interpreting this as: if not volume_preserved, then you probably want RELAX_ALL
  //[CO20181226 - melding with above]// RELAX WRITING
  //[CO20181226 - melding with above]if(xvasp.aopts.flag("FLAG::VOLUME_PRESERVED")==TRUE || xvasp.AVASP_flag_RUN_STATIC==TRUE || xvasp.AVASP_flag_RUN_STATIC_BANDS==TRUE) {
  //[CO20181226 - melding with above]} else {
  //[CO20181226 - melding with above]  if(!xvasp.aopts.flag("AFLOWIN_FLAG::RELAX_TYPE")) aflowin << "[VASP_FORCE_OPTION]RELAX_ALL " << endl; //CO20180214
  //[CO20181226 - melding with above]}
  ...
  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " " << "[12.6]" << endl;
  ...
  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " " << "[12.7]" << endl;
  if(AFLOWIN_NEW) {
    vector<string> vstr;string tstr;
    vstr.clear();tstr="";
    ...
    if(xvasp.aopts.flag("AFLOWIN_FLAG::CONVERT_UNIT_CELL")) {
      ...
      for(uint i=0;i<vCONVERT_UNIT_CELL.size();i++) {
        if(vCONVERT_UNIT_CELL.at(i)=="SPRIM") vstr.push_back("SPRIM"); //vstr.push_back("STANDARD_PRIMITIVE"); //CO20181226 - not sure why we swap e.g. SPRIM for STANDARD_PRIMITIVE, just keep consistent with aflow.in
        if(vCONVERT_UNIT_CELL.at(i)=="STD_PRIM") vstr.push_back("SPRIM"); //vstr.push_back("STANDARD_PRIMITIVE");  //CO20181226 - not sure why we swap e.g. SPRIM for STANDARD_PRIMITIVE, just keep consistent with aflow.in
        if(vCONVERT_UNIT_CELL.at(i)=="STANDARD_PRIMITIVE") vstr.push_back("SPRIM"); //vstr.push_back("STANDARD_PRIMITIVE");  //CO20181226 - not sure why we swap e.g. SPRIM for STANDARD_PRIMITIVE, just keep consistent with aflow.in
        if(vCONVERT_UNIT_CELL.at(i)=="SCONV") vstr.push_back("SCONV"); //vstr.push_back("STANDARD_CONVENTIONAL");  //CO20181226 - not sure why we swap e.g. SPRIM for STANDARD_PRIMITIVE, just keep consistent with aflow.in
        if(vCONVERT_UNIT_CELL.at(i)=="STD_CONV") vstr.push_back("SCONV"); //vstr.push_back("STANDARD_CONVENTIONAL"); //CO20181226 - not sure why we swap e.g. SPRIM for STANDARD_PRIMITIVE, just keep consistent with aflow.in
        if(vCONVERT_UNIT_CELL.at(i)=="STANDARD_CONVENTIONAL") vstr.push_back("SCONV"); //vstr.push_back("STANDARD_CONVENTIONAL");  //CO20181226 - not sure why we swap e.g. SPRIM for STANDARD_PRIMITIVE, just keep consistent with aflow.in
        if(vCONVERT_UNIT_CELL.at(i)=="NIGGLI") vstr.push_back("NIGGLI"); //vstr.push_back("NIGGLI");  //CO20181226 - not sure why we swap e.g. SPRIM for STANDARD_PRIMITIVE, just keep consistent with aflow.in
        if(vCONVERT_UNIT_CELL.at(i)=="MINK") vstr.push_back("MINK"); //vstr.push_back("MINKOWSKI"); //CO20181226 - not sure why we swap e.g. SPRIM for STANDARD_PRIMITIVE, just keep consistent with aflow.in
        if(vCONVERT_UNIT_CELL.at(i)=="MINKOWSKI") vstr.push_back("MINK"); //vstr.push_back("MINKOWSKI");  //CO20181226 - not sure why we swap e.g. SPRIM for STANDARD_PRIMITIVE, just keep consistent with aflow.in
        if(vCONVERT_UNIT_CELL.at(i)=="INCELL") vstr.push_back("INCELL"); //vstr.push_back("INCELL");  //CO20181226 - not sure why we swap e.g. SPRIM for STANDARD_PRIMITIVE, just keep consistent with aflow.in
        if(vCONVERT_UNIT_CELL.at(i)=="COMPACT") vstr.push_back("COMPACT"); //vstr.push_back("COMPACT");  //CO20181226 - not sure why we swap e.g. SPRIM for STANDARD_PRIMITIVE, just keep consistent with aflow.in
        if(vCONVERT_UNIT_CELL.at(i)=="INCOMPACT") vstr.push_back("COMPACT"); //vstr.push_back("COMPACT");  //CO20181226 - not sure why we swap e.g. SPRIM for STANDARD_PRIMITIVE, just keep consistent with aflow.in
        if(vCONVERT_UNIT_CELL.at(i)=="INWIGNERSEITZ") vstr.push_back("WS"); //vstr.push_back("WIGNERSEITZ");  //CO20181226 - not sure why we swap e.g. SPRIM for STANDARD_PRIMITIVE, just keep consistent with aflow.in
        if(vCONVERT_UNIT_CELL.at(i)=="WS") vstr.push_back("WS"); //vstr.push_back("WIGNERSEITZ"); //CO20181226 - not sure why we swap e.g. SPRIM for STANDARD_PRIMITIVE, just keep consistent with aflow.in
        if(vCONVERT_UNIT_CELL.at(i)=="WIGNERSEITZ") vstr.push_back("WS"); //vstr.push_back("WIGNERSEITZ");  //CO20181226 - not sure why we swap e.g. SPRIM for STANDARD_PRIMITIVE, just keep consistent with aflow.in
        if(vCONVERT_UNIT_CELL.at(i)=="C") vstr.push_back("CART"); //vstr.push_back("CARTESIAN");  //CO20181226 - not sure why we swap e.g. SPRIM for STANDARD_PRIMITIVE, just keep consistent with aflow.in
        if(vCONVERT_UNIT_CELL.at(i)=="CART") vstr.push_back("CART"); //vstr.push_back("CARTESIAN"); //CO20181226 - not sure why we swap e.g. SPRIM for STANDARD_PRIMITIVE, just keep consistent with aflow.in
        if(vCONVERT_UNIT_CELL.at(i)=="CARTESIAN") vstr.push_back("CART"); //vstr.push_back("CARTESIAN");  //CO20181226 - not sure why we swap e.g. SPRIM for STANDARD_PRIMITIVE, just keep consistent with aflow.in
        if(vCONVERT_UNIT_CELL.at(i)=="F") vstr.push_back("FRAC"); //vstr.push_back("FRACTIONAL"); //CO20181226 - not sure why we swap e.g. SPRIM for STANDARD_PRIMITIVE, just keep consistent with aflow.in
        if(vCONVERT_UNIT_CELL.at(i)=="FRAC") vstr.push_back("FRAC"); //vstr.push_back("FRACTIONAL");  //CO20181226 - not sure why we swap e.g. SPRIM for STANDARD_PRIMITIVE, just keep consistent with aflow.in
        if(vCONVERT_UNIT_CELL.at(i)=="FRACTIONAL") vstr.push_back("FRAC"); //vstr.push_back("FRACTIONAL");  //CO20181226 - not sure why we swap e.g. SPRIM for STANDARD_PRIMITIVE, just keep consistent with aflow.in
        if(vCONVERT_UNIT_CELL.at(i)=="D") vstr.push_back("FRAC"); //vstr.push_back("DIRECT"); //CO20181226 - not sure why we swap e.g. SPRIM for STANDARD_PRIMITIVE, just keep consistent with aflow.in
        if(vCONVERT_UNIT_CELL.at(i)=="DIR") vstr.push_back("FRAC"); //vstr.push_back("DIRECT"); //CO20181226 - not sure why we swap e.g. SPRIM for STANDARD_PRIMITIVE, just keep consistent with aflow.in
        if(vCONVERT_UNIT_CELL.at(i)=="DIRECT") vstr.push_back("FRAC"); //vstr.push_back("DIRECT");  //CO20181226 - not sure why we swap e.g. SPRIM for STANDARD_PRIMITIVE, just keep consistent with aflow.in
        if(vCONVERT_UNIT_CELL.at(i)=="PRE") vstr.push_back("PRES"); //vstr.push_back("PRESERVE"); //CO20181226 - not sure why we swap e.g. SPRIM for STANDARD_PRIMITIVE, just keep consistent with aflow.in
        if(vCONVERT_UNIT_CELL.at(i)=="PRES") vstr.push_back("PRES"); //vstr.push_back("PRESERVE");  //CO20181226 - not sure why we swap e.g. SPRIM for STANDARD_PRIMITIVE, just keep consistent with aflow.in
        if(vCONVERT_UNIT_CELL.at(i)=="PRESERVE") vstr.push_back("PRES"); //vstr.push_back("PRESERVE");  //CO20181226 - not sure why we swap e.g. SPRIM for STANDARD_PRIMITIVE, just keep consistent with aflow.in
      }
    } else {
    ...
    if(vstr.size()>0) {
      std::sort(vstr.begin(),vstr.end());vstr.erase( std::unique( vstr.begin(), vstr.end() ), vstr.end() ); //remove duplicates
  ...
  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " " << "[12.8]" << endl;
  ...
  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " " << "[12.9]" << endl;
  ...
  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " " << "[12.10]" << endl;
  ...
  if (xvasp.aopts.flag("FLAG::INCAR_MODE_MODE_IMPLICIT")) {aflowin << "[VASP_INCAR_MODE_IMPLICIT]" << endl;}
  else if (xvasp.aopts.flag("FLAG::INCAR_MODE_EXPLICIT") && xvasp.aopts.flag("FLAG::INCAR_KEYWORD")) {aflowin << "[VASP_INCAR_MODE_EXPLICIT]" << endl;}
  else if (xvasp.aopts.flag("FLAG::INCAR_MODE_EXTERNAL")) {aflowin << "[VASP_INCAR_MODE_EXTERNAL]" << endl;}
  if (xvasp.aopts.flag("FLAG::INCAR_KEYWORD")) {
    for (uint i = 0; i < xvasp.AVASP_INCAR_KEYWORD.size(); i++) {  // Last vector element is empty  //CO20181226 - better way
  ...
  if (xvasp.aopts.flag("FLAG::INCAR_EXPLICIT_START_STOP") || !xvasp.aopts.flag("FLAG::INCAR_KEYWORD")) {
    ...
    if (xvasp.aopts.flag("FLAG::INCAR_EXPLICIT_START_STOP")) {  //ME20181128
      //[CO20181226 OBSOLETE - need to remove system]aflowin << xvasp.AVASP_INCAR_EXPLICIT_START_STOP.str();
      //CO20181226 START
      vector<string> vlines;
      aurostd::stream2vectorstring(xvasp.AVASP_INCAR_EXPLICIT_START_STOP, vlines);
      for(uint i=0;i<vlines.size();i++){
        if(aurostd::substring2bool(vlines[i],"SYSTEM=")){continue;} //CO20181226
  ...
  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " " << "[12.11]" << endl;
  ...
  if (!skip_implicit) {
    ...
    if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " " << "[12.12]" << endl;
    ...
    // } else {
    //[ME20181216]  aflowin << "[VASP_KPOINTS_FILE]KPPRA=" << xvasp.AVASP_value_KPPRA << endl; ME20181023 Unnecessary for only static runs
    //  }

    if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " " << "[12.13]" << endl;

    //  OBSOLETE - ME20181023, will be taken care of later
    //  if(xvasp.AVASP_prototype_mode==LIBRARY_MODE_ICSD) {
    ...
    if(pocc){
      if(!xvasp.aopts.flag("AFLOWIN_FLAG::KSCHEME")) xvasp.AVASP_KSCHEME="G";
      if(!xvasp.aopts.flag("AFLOWIN_FLAG::KSCHEME_STATIC")) xvasp.AVASP_STATIC_KSCHEME="G";
    }
    ...
    //if (!xvasp.AVASP_flag_RUN_RELAX || write_all) //CO20181226 - ME, this needs to be more explicit, breaks pocc
    if (xvasp.AVASP_flag_RUN_STATIC || xvasp.AVASP_flag_RUN_RELAX_STATIC || xvasp.AVASP_flag_RUN_RELAX_STATIC_BANDS || xvasp.AVASP_flag_RUN_STATIC_BANDS || write_all)  //CO20181226
    { //CO20200106 - patching for auto-indenting
      aflowin << "[VASP_KPOINTS_FILE]STATIC_KSCHEME=" << xvasp.AVASP_STATIC_KSCHEME << endl;
      aflowin << "[VASP_KPOINTS_FILE]STATIC_KPPRA=" << xvasp.AVASP_value_KPPRA_STATIC << endl;
    ...
    if (xvasp.AVASP_flag_RUN_RELAX_STATIC_BANDS || xvasp.AVASP_flag_RUN_STATIC_BANDS || write_all) {
      aflowin << "[VASP_KPOINTS_FILE]BANDS_LATTICE=" << xvasp.AVASP_path_BANDS << endl;
      aflowin << "[VASP_KPOINTS_FILE]BANDS_GRID=" << xvasp.AVASP_value_BANDS_GRID << endl;
    }
  }  // !skip_implicit

  if (xvasp.aopts.flag("FLAG::KPOINTS_EXTERNAL")) {aflowin << "[VASP_KPOINTS_MODE_EXTERNAL]" << endl;}
  else if (xvasp.aopts.flag("FLAG::KPOINTS_EXPLICIT") && xvasp.aopts.flag("FLAG::KPOINTS_KEYWORD")) {aflowin << "[VASP_KPOINTS_MODE_EXPLICIT]" << endl;}
  if (xvasp.aopts.flag("FLAG::KPOINTS_KEYWORD") && skip_implicit) { //CO20181226 - ME check!!!!!!
    for (uint i = 0; i < xvasp.AVASP_KPOINTS_KEYWORD.size(); i++) {  // Last vector element is empty  //CO20181226 - better way
  ...
  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " " << "[12.14]" << endl;
  ...
  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " " << "[12.15]" << endl;
  ...
  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " " << "[12.16]" << endl;
  // STRUCTURE ABINIT
  ...
  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " " << "[12.17]" << endl;
  // STRUCTURE AIMS
  ...
  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " " << "[12.18]" << endl;
  // STRUCTURE CIF
  ...
  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " " << "[12.19]" << endl;
  // STRUCTURE ABCCAR
  ...
  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " " << "[12.20]" << endl;

  // POTENTIAL
  aflowin << AFLOWIN_SEPARATION_LINE << endl; // [AFLOW] **************************************************
  if(LDEBUG) cerr << "DEBUG - AVASP_MakeSingleAFLOWIN [13a]" << endl;

  if (xvasp.aopts.flag("FLAG::POTCAR_MODE_IMPLICIT")) {aflowin << "[VASP_POTCAR_MODE_IMPLICIT]" << endl;}
  else if (xvasp.aopts.flag("FLAG::POTCAR_EXPLICIT") && xvasp.aopts.flag("FLAG::POTCAR_KEYWORD")) {aflowin << "[VASP_POTCAR_MODE_EXPLICIT]" << endl;}
  else if (xvasp.aopts.flag("FLAG::POTCAR_EXTERNAL")) {aflowin << "[VASP_POTCAR_MODE_EXTERNAL]" << endl;}

  if(xvasp.aopts.flag("FLAG::POTCAR_KEYWORD")){
    for (uint i = 0; i < xvasp.AVASP_POTCAR_KEYWORD.size(); i++) {  // Last vector element is empty  //CO20181226 - better way
    ...
    for(uint i=0;i<xvasp.str.species.size();i++) {
      if(xvasp.aopts.flag("FLAG::AVASP_AUTO_PSEUDOPOTENTIALS")==FALSE) {
        if(xvasp.str.species.at(i)!="" && xvasp.str.species.at(i)!="X") {// need because some times we have the "" around
          ...
          if(LDEBUG) cerr << __AFLOW_FUNC__ << " AUTO_PSEUDOPOTENTIALS=FALSE - " << xvasp.AVASP_potential << "/" << xvasp.str.species_pp.at(i) << endl;
        }
      } else {
        if(xvasp.str.species.at(i)!="" && xvasp.str.species.at(i)!="X") // need because some times we have the "" around
  ...
  if(1) {
    ...
    for(uint i=0;i<xvasp.str.species_pp.size();i++)
      aflowin << xvasp.str.species_pp.at(i) << aurostd::utype2string(xvasp.str.comp_each_type.at(i),_AVASP_DOUBLE2STRING_PRECISION_) << "|"; //[CO20181226 - weird output with pocc]xvasp.str.num_each_type.at(i) << "|";
    aflowin << endl;
    aflowin << "[AFLOW] COMPOSITION=|"; // COMPOSITION
    for(uint i=0;i<xvasp.str.species_pp.size();i++) 
      aflowin << KBIN::VASP_PseudoPotential_CleanName(xvasp.str.species.at(i)) << aurostd::utype2string(xvasp.str.comp_each_type.at(i),_AVASP_DOUBLE2STRING_PRECISION_) << "|"; //[CO20181226 - weird output with pocc]xvasp.str.num_each_type.at(i) << "|";
    aflowin << endl;
  ...
  if(!print_directory){
    //attempt 1 to fix
    //[CO20191112 - OBSOLETE]aurostd::StringSubst(directory_to_print,aurostd::execute2string("pwd"),"./");
  ...
  if(!print_directory){
    ...
    //[CO20191112 - OBSOLETE]vector<string> pwdtokens;aurostd::string2tokens(aurostd::execute2string("pwd"),pwdtokens,"/");
    ...
    if(pwdtokens.size()>0){
      ...
      for(uint i=0;i<dirtokens.size();i++){
  ...
  if(!print_directory){
    ...
    aurostd::string2tokens(directory,dirtokens,"/");
    bool save_tokens=false;
    string token_to_find="AFLOWDATA";
    for(uint i=0;i<dirtokens.size();i++){
      if(dirtokens[i]==token_to_find){
        dirtokens_save.clear(); //if multiple AFLOWDATA in path, only keep last
        save_tokens=true;
      }
      if(save_tokens){dirtokens_save.push_back(dirtokens[i]);}
    }
    if(dirtokens_save.size()>0){
      directory_to_print="./"+aurostd::joinWDelimiter(dirtokens_save,"/");
      print_directory=(!directory_to_print.empty());
  ...
  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " " << "[14]" << endl;
  ...
  if(flag_WRITE==FALSE&&flag_PRINT==TRUE) {
    ...
    cout << aflowin.str();cout.flush();
  }

  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " " << "[16]" << endl;
...
#ifndef COMPILE_SLIM
//[OBSOLETE]bool AVASP_MakeSingleAFLOWIN_20180101(_xvasp& xvasp_in,stringstream &_aflowin,bool flag_WRITE,int pthread,bool flag_PRINT) {
//[OBSOLETE]  //  if(flag_WRITE==FALSE) DEBUG=TRUE;
//[OBSOLETE]  bool LDEBUG=(FALSE || XHOST.DEBUG);
//[OBSOLETE]  stringstream message;
//[OBSOLETE]
//[OBSOLETE]  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " " << "[0]" << endl;
//[OBSOLETE]  if(LDEBUG && xvasp_in.AVASP_prototype_mode==LIBRARY_MODE_HTQC)       cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp_in.AVASP_prototype_mode==LIBRARY_MODE_HTQC" << endl;
//[OBSOLETE]  if(LDEBUG && xvasp_in.AVASP_prototype_mode==LIBRARY_MODE_ICSD)       cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp_in.AVASP_prototype_mode==LIBRARY_MODE_ICSD" << endl;
//[OBSOLETE]  if(LDEBUG && xvasp_in.AVASP_prototype_mode==LIBRARY_MODE_HTQC_ICSD)  cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp_in.AVASP_prototype_mode==LIBRARY_MODE_HTQC_ICSD" << endl;
//[OBSOLETE]  if(LDEBUG && xvasp_in.AVASP_prototype_mode==LIBRARY_MODE_LIB3)       cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp_in.AVASP_prototype_mode==LIBRARY_MODE_LIB3" << endl;
//[OBSOLETE]  if(LDEBUG && xvasp_in.AVASP_prototype_mode==LIBRARY_MODE_PROTOTYPE)  cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp_in.AVASP_prototype_mode==LIBRARY_MODE_PROTOTYPE" << endl;
//[OBSOLETE]  if(LDEBUG && xvasp_in.AVASP_prototype_mode==LIBRARY_MODE_XSTRUCTURE) cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp_in.AVASP_prototype_mode==LIBRARY_MODE_XSTRUCTURE" << endl;
//[OBSOLETE]
//[OBSOLETE]  _xvasp xvasp=xvasp_in; // copy
//[OBSOLETE]
//[OBSOLETE]  // xvasp.aopts.flag("AFLOWIN_FLAG::PSTRESS",TRUE);
//[OBSOLETE]  //  if(xvasp.aopts.flag("AFLOWIN_FLAG::PSTRESS",TRUE)) xvasp.aopts.push_attached("AFLOWIN_FLAG::PSTRESS","7.65");
//[OBSOLETE]  // xvasp.AVASP_value_PSTRESS=7.65;
//[OBSOLETE]
//[OBSOLETE]  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"AFLOWIN_FLAG::VASP\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::VASP") << endl;
//[OBSOLETE]  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"FLAG::AVASP_FORCE_NOLDAU\")=" << xvasp.aopts.flag("FLAG::AVASP_FORCE_NOLDAU") << endl;
//[OBSOLETE]  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"FLAG::AVASP_FORCE_NOLDAU\")=" << xvasp.aopts.flag("FLAG::AVASP_FORCE_NOLDAU") << endl;
//[OBSOLETE]  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"AFLOWIN_FLAG::PSTRESS\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::PSTRESS") << endl;
//[OBSOLETE]  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp.aopts.getattachedscheme(\"AFLOWIN_FLAG::PSTRESS\")=" << xvasp.aopts.getattachedscheme("AFLOWIN_FLAG::PSTRESS") << endl;
//[OBSOLETE]  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"AFLOWIN_FLAG::MODULE\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::MODULE") << endl;  //CO20180214
//[OBSOLETE]  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp.aopts.getattachedscheme(\"AFLOWIN_FLAG::MODULE\")=" << xvasp.aopts.getattachedscheme("AFLOWIN_FLAG::MODULE") << endl;  //CO20180214
//[OBSOLETE]  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"AFLOWIN_FLAG::APL_SUPERCELL\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::APL_SUPERCELL") << endl;  //CO20180214
//[OBSOLETE]  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp.aopts.getattachedscheme(\"AFLOWIN_FLAG::APL_SUPERCELL\")=" << xvasp.aopts.getattachedscheme("AFLOWIN_FLAG::APL_SUPERCELL") << endl;  //CO20180214
//[OBSOLETE]  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"AFLOWIN_FLAG::EDIFFG\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::EDIFFG") << endl;
//[OBSOLETE]  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp.aopts.getattachedscheme(\"AFLOWIN_FLAG::EDIFFG\")=" << xvasp.aopts.getattachedscheme("AFLOWIN_FLAG::EDIFFG") << endl;
//[OBSOLETE]  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"AFLOWIN_FLAG::POTIM\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::POTIM") << endl;
//[OBSOLETE]  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp.aopts.getattachedscheme(\"AFLOWIN_FLAG::POTIM\")=" << xvasp.aopts.getattachedscheme("AFLOWIN_FLAG::POTIM") << endl;
//[OBSOLETE]  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"AFLOWIN_FLAG::PRECISION\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::PRECISION") << endl;
//[OBSOLETE]  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp.aopts.getattachedscheme(\"AFLOWIN_FLAG::PRECISION\")=" << xvasp.aopts.getattachedscheme("AFLOWIN_FLAG::PRECISION") << endl;
//[OBSOLETE]  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"AFLOWIN_FLAG::ALGORITHM\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::ALGORITHM") << endl;
//[OBSOLETE]  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp.aopts.getattachedscheme(\"AFLOWIN_FLAG::ALGORITHM\")=" << xvasp.aopts.getattachedscheme("AFLOWIN_FLAG::ALGORITHM") << endl;
//[OBSOLETE]  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"AFLOWIN_FLAG::METAGGA\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::METAGGA") << endl;
//[OBSOLETE]  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp.aopts.getattachedscheme(\"AFLOWIN_FLAG::METAGGA\")=" << xvasp.aopts.getattachedscheme("AFLOWIN_FLAG::METAGGA") << endl;
//[OBSOLETE]  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"AFLOWIN_FLAG::IVDW\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::IVDW") << endl;
//[OBSOLETE]  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp.aopts.getattachedscheme(\"AFLOWIN_FLAG::IVDW\")=" << xvasp.aopts.getattachedscheme("AFLOWIN_FLAG::IVDW") << endl;
//[OBSOLETE]  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"AFLOWIN_FLAG::RELAX_TYPE\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::RELAX_TYPE") << endl;  //CO20180214
//[OBSOLETE]  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp.aopts.getattachedscheme(\"AFLOWIN_FLAG::RELAX_TYPE\")=" << xvasp.aopts.getattachedscheme("AFLOWIN_FLAG::RELAX_TYPE") << endl;  //CO20180214
//[OBSOLETE]  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"AFLOWIN_FLAG::RELAX_MODE\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::RELAX_MODE") << endl;
//[OBSOLETE]  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp.aopts.getattachedscheme(\"AFLOWIN_FLAG::RELAX_MODE\")=" << xvasp.aopts.getattachedscheme("AFLOWIN_FLAG::RELAX_MODE") << endl;
//[OBSOLETE]  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"AFLOWIN_FLAG::TYPE\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::TYPE") << endl;
//[OBSOLETE]  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp.aopts.getattachedscheme(\"AFLOWIN_FLAG::TYPE\")=" << xvasp.aopts.getattachedscheme("AFLOWIN_FLAG::TYPE") << endl;
//[OBSOLETE]  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"AFLOWIN_FLAG::CONVERT_UNIT_CELL\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::CONVERT_UNIT_CELL") << endl;
//[OBSOLETE]  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp.aopts.getattachedscheme(\"AFLOWIN_FLAG::CONVERT_UNIT_CELL\")=" << xvasp.aopts.getattachedscheme("AFLOWIN_FLAG::CONVERT_UNIT_CELL") << endl;
//[OBSOLETE]  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"AFLOWIN_FLAG::VOLUME_PLUS_EQUAL\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::VOLUME_PLUS_EQUAL") << endl;
//[OBSOLETE]  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp.aopts.getattachedscheme(\"AFLOWIN_FLAG::VOLUME_PLUS_EQUAL\")=" << xvasp.aopts.getattachedscheme("AFLOWIN_FLAG::VOLUME_PLUS_EQUAL") << endl;
//[OBSOLETE]  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"AFLOWIN_FLAG::VOLUME_MULTIPLY_EQUAL\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::VOLUME_MULTIPLY_EQUAL") << endl;
//[OBSOLETE]  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp.aopts.getattachedscheme(\"AFLOWIN_FLAG::VOLUME_MULTIPLY_EQUAL\")=" << xvasp.aopts.getattachedscheme("AFLOWIN_FLAG::VOLUME_MULTIPLY_EQUAL") << endl;
//[OBSOLETE]  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"AFLOWIN_FLAG::NO_VOLUME_ADJUSTMENT\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::NO_VOLUME_ADJUSTMENT") << endl;  //CO20180214
//[OBSOLETE]
//[OBSOLETE]  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"AFLOWIN_FLAG::KPPRA\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::KPPRA") << endl;
//[OBSOLETE]  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp.aopts.getattachedscheme(\"AFLOWIN_FLAG::KPPRA\")=" << xvasp.aopts.getattachedscheme("AFLOWIN_FLAG::KPPRA") << endl;
//[OBSOLETE]  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"AFLOWIN_FLAG::KPPRA_STATIC\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::KPPRA_STATIC") << endl;
//[OBSOLETE]  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp.aopts.getattachedscheme(\"AFLOWIN_FLAG::KPPRA_STATIC\")=" << xvasp.aopts.getattachedscheme("AFLOWIN_FLAG::KPPRA_STATIC") << endl;
//[OBSOLETE]  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"AFLOWIN_FLAG::BANDS_GRID\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::BANDS_GRID") << endl;
//[OBSOLETE]  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp.aopts.getattachedscheme(\"AFLOWIN_FLAG::BANDS_GRID\")=" << xvasp.aopts.getattachedscheme("AFLOWIN_FLAG::BANDS_GRID") << endl;
//[OBSOLETE]
//[OBSOLETE]  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp.aopts.flag(\"AFLOWIN_FLAG::ENMAX_MULTYPLY\")=" << xvasp.aopts.flag("AFLOWIN_FLAG::ENMAX_MULTYPLY") << endl;
//[OBSOLETE]  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp.aopts.getattachedscheme(\"AFLOWIN_FLAG::ENMAX_MULTYPLY\")=" << xvasp.aopts.getattachedscheme("AFLOWIN_FLAG::ENMAX_MULTYPLY") << endl;
//[OBSOLETE]
//[OBSOLETE]  //  cerr << aurostd::vectorstring2string(xvasp.str.species) << "/" << xvasp.AVASP_label << endl;
//[OBSOLETE]  // checks if everything is different
//[OBSOLETE]  ofstream oaus;
//[OBSOLETE]  //  xstructure str;
//[OBSOLETE]  string directory,system,formula,label_MIX,label_NOMIX,label_SKIP,label_ALREADY;
//[OBSOLETE]  bool Krun=TRUE; //,swapspeciesAB=FALSE,swapspeciesBC=FALSE,swapspeciesCA=FALSE;
//[OBSOLETE]  stringstream aflowin;aflowin.clear();aflowin.str(std::string());
//[OBSOLETE]  stringstream aflowin_qe; aflowin_qe.clear();aflowin_qe.str(std::string());
//[OBSOLETE]  stringstream aflowin_abinit; aflowin_abinit.clear();aflowin_abinit.str(std::string());
//[OBSOLETE]  stringstream aflowin_aims; aflowin_aims.clear();aflowin_aims.str(std::string());
//[OBSOLETE]  stringstream aflowin_cif; aflowin_cif.clear();aflowin_cif.str(std::string()); //DX20190123 - add CIF
//[OBSOLETE]  stringstream aflowin_abccar; aflowin_abccar.clear();aflowin_abccar.str(std::string()); //DX20190123 - add ABCCAR
//[OBSOLETE]  // for HTQC
//[OBSOLETE]  // xstructure str1[100];_xvasp xvsp[100];
//[OBSOLETE]
//[OBSOLETE]  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " " << "[1]" << endl;
//[OBSOLETE]  //clean up name
//[OBSOLETE]  xvasp.AVASP_label=aurostd::RemoveSubString(xvasp.AVASP_label,"/");
//[OBSOLETE]  xvasp.AVASP_label=aurostd::RemoveSubString(xvasp.AVASP_label," ");
//[OBSOLETE]  // loading BUGS
//[OBSOLETE]  vector<string> vstr;
//[OBSOLETE]  aurostd::string2tokens(string(CONVENTIONAL_FORCE),vstr,",");
//[OBSOLETE]  bool fixed_lattice_vasp=FALSE;
//[OBSOLETE]  for(uint istr=0;istr<vstr.size()&&!fixed_lattice_vasp;istr++) {
//[OBSOLETE]    if(vstr.at(istr)==xvasp.AVASP_label) {
//[OBSOLETE]      //   cerr << vstr.at(istr) << endl;
//[OBSOLETE]      fixed_lattice_vasp=TRUE;
//[OBSOLETE]      if(xvasp.aopts.flag("AVASP_flag_CONVERT_UNIT_CELL_STANDARD_PRIMITIVE")) {
//[OBSOLETE]        xvasp.aopts.flag("AVASP_flag_CONVERT_UNIT_CELL_STANDARD_PRIMITIVE",FALSE);
//[OBSOLETE]        xvasp.aopts.flag("AVASP_flag_CONVERT_UNIT_CELL_STANDARD_CONVENTIONAL",TRUE);
//[OBSOLETE]      }
//[OBSOLETE]    }
//[OBSOLETE]  }
//[OBSOLETE]
//[OBSOLETE]  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " " << "[2]" << endl;
//[OBSOLETE]
//[OBSOLETE]  if(LDEBUG) {
//[OBSOLETE]    cerr << "xvasp.str.species.size()=" << xvasp.str.species.size() << endl;
//[OBSOLETE]    cerr << "xvasp.str.species_pp.size()=" << xvasp.str.species_pp.size() << "   ";
//[OBSOLETE]    for(uint i=0;i<xvasp.str.species_pp.size();i++) cerr << xvasp.str.species_pp.at(i) << " "; 
//[OBSOLETE]    cerr  << endl;
//[OBSOLETE]    cerr << "xvasp.str.species_pp_type.size()=" << xvasp.str.species_pp_type.size() << "   ";
//[OBSOLETE]    for(uint i=0;i<xvasp.str.species_pp_type.size();i++) cerr << xvasp.str.species_pp_type.at(i) << " "; 
//[OBSOLETE]    cerr  << endl;
//[OBSOLETE]    cerr << "xvasp.str.species_pp_version.size()=" << xvasp.str.species_pp_version.size() << "   ";
//[OBSOLETE]    for(uint i=0;i<xvasp.str.species_pp_version.size();i++) cerr << xvasp.str.species_pp_version.at(i) << " "; 
//[OBSOLETE]    cerr  << endl;
//[OBSOLETE]    cerr << "xvasp.str.species_pp_ZVAL.size()=" << xvasp.str.species_pp_ZVAL.size() << "   ";
//[OBSOLETE]    for(uint i=0;i<xvasp.str.species_pp_ZVAL.size();i++) cerr << xvasp.str.species_pp_ZVAL.at(i) << " "; 
//[OBSOLETE]    cerr  << endl;
//[OBSOLETE]    cerr << "xvasp.str.species_pp_vLDAU.size()=" << xvasp.str.species_pp_vLDAU.size() << "   ";
//[OBSOLETE]    for(uint i=0;i<xvasp.str.species_pp_vLDAU.size();i++) cerr << xvasp.str.species_pp_vLDAU.at(i).size() << " "; 
//[OBSOLETE]    cerr  << endl;
//[OBSOLETE]    cerr << "xvasp.str.num_each_type.size()=" << xvasp.str.num_each_type.size() << endl;
//[OBSOLETE]    cerr << "xvasp.str.comp_each_type.size()=" << xvasp.str.comp_each_type.size() << endl;
//[OBSOLETE]    cerr << "xvasp.str.species_volume.size()=" << xvasp.str.species_volume.size() << "   "; //CO20181128
//[OBSOLETE]    for(uint i=0;i<xvasp.str.species_volume.size();i++) cerr << xvasp.str.species_volume.at(i) << " "; //CO20181128
//[OBSOLETE]    cerr << endl; //CO20181128
//[OBSOLETE]    cerr << "xvasp.str.species_mass.size()=" << xvasp.str.species_mass.size() << "   "; //CO20181128
//[OBSOLETE]    for(uint i=0;i<xvasp.str.species_mass.size();i++) cerr << xvasp.str.species_mass.at(i) << " "; //CO20181128
//[OBSOLETE]    cerr << endl; //CO20181128
//[OBSOLETE]  }
//[OBSOLETE]  if(xvasp.str.num_each_type.size()!=xvasp.str.species.size()) {
//[OBSOLETE]    if(LDEBUG) cerr << __AFLOW_FUNC__ << " WARNING 1 (fixing)" << endl;
//[OBSOLETE]    xvasp.str.num_each_type.clear(); 
//[OBSOLETE]    for(uint i=0;i<xvasp.str.species.size();i++) xvasp.str.num_each_type.push_back(0);
//[OBSOLETE]    xvasp.str.comp_each_type.clear(); 
//[OBSOLETE]    for(uint i=0;i<xvasp.str.species.size();i++) xvasp.str.comp_each_type.push_back(0);
//[OBSOLETE]  }
//[OBSOLETE]  if(xvasp.str.species_pp.size()!=xvasp.str.species.size()) {
//[OBSOLETE]    if(LDEBUG) cerr <<"" << __AFLOW_FUNC__ << " WARNING 2 (fixing)" << endl;
//[OBSOLETE]    xvasp.str.species_pp=xvasp.str.species; // so we have the same dimension !
//[OBSOLETE]  }
//[OBSOLETE]  if(xvasp.str.species_volume.size()!=xvasp.str.species.size()) {
//[OBSOLETE]    if(LDEBUG) cerr <<"" << __AFLOW_FUNC__ << " WARNING 3 (fixing)" << endl;
//[OBSOLETE]    xvasp.str.species_volume.clear(); 
//[OBSOLETE]    for(uint i=0;i<xvasp.str.species.size();i++) xvasp.str.species_volume.push_back(0);
//[OBSOLETE]  }
//[OBSOLETE]  if(xvasp.str.species_mass.size()!=xvasp.str.species.size()) {
//[OBSOLETE]    if(LDEBUG) cerr <<"" << __AFLOW_FUNC__ << " WARNING 4 (fixing)" << endl;
//[OBSOLETE]    xvasp.str.species_mass.clear(); 
//[OBSOLETE]    for(uint i=0;i<xvasp.str.species.size();i++) xvasp.str.species_mass.push_back(0);
//[OBSOLETE]  }
//[OBSOLETE]  deque<double> vmass(xvasp.str.species_mass); // BACKUP
//[OBSOLETE]  //  for(uint i=0;i<xvasp.str.species.size();i++) cerr << "xvasp.str.species_mass=" << xvasp.str.species_mass.at(i) << endl;
//[OBSOLETE]
//[OBSOLETE]  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " " << "[3]" << endl;
//[OBSOLETE]
//[OBSOLETE]  // DEBUG for XBANDS put 1
//[OBSOLETE]  if(0) { // DEBUG XBANDS
//[OBSOLETE]    xvasp.aopts.flag("FLAG::AVASP_AUTO_PSEUDOPOTENTIALS",FALSE);
//[OBSOLETE]    if(xvasp.aopts.flag("FLAG::AVASP_AUTO_PSEUDOPOTENTIALS")==FALSE) {
//[OBSOLETE]      for(uint isp=0;isp<xvasp.str.species.size();isp++) {
//[OBSOLETE]        xvasp.str.species_pp.at(isp)=xvasp.str.species.at(isp);
//[OBSOLETE]      }
//[OBSOLETE]    }
//[OBSOLETE]  }
//[OBSOLETE]
//[OBSOLETE]  // FIX THE SPECIES IF AUTO_PSEUDOPOTENTIALS
//[OBSOLETE]  if(xvasp.aopts.flag("FLAG::AVASP_AUTO_PSEUDOPOTENTIALS")) {
//[OBSOLETE]    if(1 && xvasp.str.species.size()==2) // AlMg potpaw_GGA
//[OBSOLETE]      if((KBIN::VASP_PseudoPotential_CleanName(xvasp.str.species.at(0))=="Ga" && KBIN::VASP_PseudoPotential_CleanName(xvasp.str.species.at(1))=="Mg") ||
//[OBSOLETE]          (KBIN::VASP_PseudoPotential_CleanName(xvasp.str.species.at(0))=="Ge" && KBIN::VASP_PseudoPotential_CleanName(xvasp.str.species.at(1))=="Mg") ||
//[OBSOLETE]          (KBIN::VASP_PseudoPotential_CleanName(xvasp.str.species.at(0))=="Al" && KBIN::VASP_PseudoPotential_CleanName(xvasp.str.species.at(1))=="Mg") ||
//[OBSOLETE]          (KBIN::VASP_PseudoPotential_CleanName(xvasp.str.species.at(0))=="Mg" && KBIN::VASP_PseudoPotential_CleanName(xvasp.str.species.at(1))=="Si")) {
//[OBSOLETE]        cout << __AFLOW_FUNC__ << " Pseudopotential exception: " << xvasp.str.species_pp.at(0) << xvasp.str.species_pp.at(1) << " -> potpaw_GGA " << endl;
//[OBSOLETE]        xvasp.AVASP_potential="potpaw_GGA";
//[OBSOLETE]      }
//[OBSOLETE]    // FIX THE SPECIES IF AUTO_PSEUDOPOTENTIALS && LIBRARY_MODE_HTQC
//[OBSOLETE]    if(xvasp.aopts.flag("FLAG::AVASP_AUTO_PSEUDOPOTENTIALS") && (xvasp.AVASP_prototype_mode==LIBRARY_MODE_HTQC || xvasp.AVASP_prototype_mode==LIBRARY_MODE_HTQC_ICSD)) {
//[OBSOLETE]      // patches for potpaw_GGA
//[OBSOLETE]      if(xvasp.AVASP_potential==DEFAULT_VASP_POTCAR_DIR_POTPAW_GGA) {
//[OBSOLETE]        for(uint isp=0;isp<xvasp.str.species.size();isp++)
//[OBSOLETE]          xvasp.str.species_pp.at(isp)=AVASP_Get_PseudoPotential_PAW_GGA(KBIN::VASP_PseudoPotential_CleanName(xvasp.str.species.at(isp)));
//[OBSOLETE]        if(xvasp.str.species.size()==2) {
//[OBSOLETE]          // check for EXCEPTION GaMg
//[OBSOLETE]          if(KBIN::VASP_PseudoPotential_CleanName(xvasp.str.species.at(0))=="Ga" && KBIN::VASP_PseudoPotential_CleanName(xvasp.str.species.at(1))=="Mg") {
//[OBSOLETE]            cout << __AFLOW_FUNC__ << " Pseudopotential exception: " << xvasp.str.species_pp.at(0) << xvasp.str.species_pp.at(1) << " -> ";
//[OBSOLETE]            xvasp.str.species_pp.at(0)="Ga";xvasp.str.species_pp.at(1)="Mg_pv";cout << xvasp.str.species_pp.at(0) << xvasp.str.species_pp.at(1) << endl;
//[OBSOLETE]          }
//[OBSOLETE]          // check for EXCEPTION GeMg
//[OBSOLETE]          if(KBIN::VASP_PseudoPotential_CleanName(xvasp.str.species.at(0))=="Ge" && KBIN::VASP_PseudoPotential_CleanName(xvasp.str.species.at(1))=="Mg") {
//[OBSOLETE]            cout << __AFLOW_FUNC__ << " Pseudopotential exception: " << xvasp.str.species_pp.at(0) << xvasp.str.species_pp.at(1) << " -> ";
//[OBSOLETE]            xvasp.str.species_pp.at(0)="Ge";xvasp.str.species_pp.at(1)="Mg_pv";cout << xvasp.str.species_pp.at(0) << xvasp.str.species_pp.at(1) << endl;
//[OBSOLETE]          }
//[OBSOLETE]          if(KBIN::VASP_PseudoPotential_CleanName(xvasp.str.species.at(0))=="Mg" && KBIN::VASP_PseudoPotential_CleanName(xvasp.str.species.at(1))=="Si") {
//[OBSOLETE]            cout << __AFLOW_FUNC__ << " Pseudopotential exception: " << xvasp.str.species_pp.at(0) << xvasp.str.species_pp.at(1) << " -> ";
//[OBSOLETE]            xvasp.str.species_pp.at(0)="Mg_pv";xvasp.str.species_pp.at(1)="Si";cout << xvasp.str.species_pp.at(0) << xvasp.str.species_pp.at(1) << endl;
//[OBSOLETE]          }
//[OBSOLETE]        }
//[OBSOLETE]      }
//[OBSOLETE]      // patches for potpaw_PBE
//[OBSOLETE]      if(xvasp.AVASP_potential==DEFAULT_VASP_POTCAR_DIR_POTPAW_PBE) {
//[OBSOLETE]        for(uint isp=0;isp<xvasp.str.species.size();isp++){
//[OBSOLETE]          xvasp.str.species_pp.at(isp)=AVASP_Get_PseudoPotential_PAW_PBE(KBIN::VASP_PseudoPotential_CleanName(xvasp.str.species.at(isp)));
//[OBSOLETE]          if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.str.species_pp.at(" << isp << ")=" << xvasp.str.species_pp.at(isp) << endl;}  //CO20180705
//[OBSOLETE]        }
//[OBSOLETE]        if(xvasp.str.species.size()==2) {
//[OBSOLETE]          // check for EXCEPTION BHf
//[OBSOLETE]          if(KBIN::VASP_PseudoPotential_CleanName(xvasp.str.species.at(0))=="B" && KBIN::VASP_PseudoPotential_CleanName(xvasp.str.species.at(1))=="Hf") {
//[OBSOLETE]            cout << __AFLOW_FUNC__ << " Pseudopotential exception: " << xvasp.str.species_pp.at(0) << xvasp.str.species_pp.at(1) << " -> ";
//[OBSOLETE]            xvasp.str.species_pp.at(0)="B_s";xvasp.str.species_pp.at(1)="Hf_pv";cout << xvasp.str.species_pp.at(0) << xvasp.str.species_pp.at(1) << endl;
//[OBSOLETE]          }
//[OBSOLETE]          // check for EXCEPTION BeHf
//[OBSOLETE]          if(KBIN::VASP_PseudoPotential_CleanName(xvasp.str.species.at(0))=="Be" && KBIN::VASP_PseudoPotential_CleanName(xvasp.str.species.at(1))=="Hf") {
//[OBSOLETE]            cout << __AFLOW_FUNC__ << " Pseudopotential exception: " << xvasp.str.species_pp.at(0) << xvasp.str.species_pp.at(1) << " -> ";
//[OBSOLETE]            xvasp.str.species_pp.at(0)="Be";xvasp.str.species_pp.at(1)="Hf_pv";cout << xvasp.str.species_pp.at(0) << xvasp.str.species_pp.at(1) << endl;
//[OBSOLETE]          }
//[OBSOLETE]          // check for EXCEPTION HfK
//[OBSOLETE]          if(KBIN::VASP_PseudoPotential_CleanName(xvasp.str.species.at(0))=="Hf" && KBIN::VASP_PseudoPotential_CleanName(xvasp.str.species.at(1))=="K") {
//[OBSOLETE]            cout << __AFLOW_FUNC__ << " Pseudopotential exception: " << xvasp.str.species_pp.at(0) << xvasp.str.species_pp.at(1) << " -> ";
//[OBSOLETE]            xvasp.str.species_pp.at(0)="Hf_pv";xvasp.str.species_pp.at(1)="K_pv";cout << xvasp.str.species_pp.at(0) << xvasp.str.species_pp.at(1) << endl;
//[OBSOLETE]          }
//[OBSOLETE]          // check for EXCEPTION HfSn
//[OBSOLETE]          if(KBIN::VASP_PseudoPotential_CleanName(xvasp.str.species.at(0))=="Hf" && KBIN::VASP_PseudoPotential_CleanName(xvasp.str.species.at(1))=="Sn") {
//[OBSOLETE]            cout << __AFLOW_FUNC__ << " Pseudopotential exception: " << xvasp.str.species_pp.at(0) << xvasp.str.species_pp.at(1) << " -> ";
//[OBSOLETE]            xvasp.str.species_pp.at(0)="Hf_pv";xvasp.str.species_pp.at(1)="Sn_d";cout << xvasp.str.species_pp.at(0) << xvasp.str.species_pp.at(1) << endl;
//[OBSOLETE]          }
//[OBSOLETE]          // check for EXCEPTION BSm
//[OBSOLETE]          if(KBIN::VASP_PseudoPotential_CleanName(xvasp.str.species.at(0))=="B" && KBIN::VASP_PseudoPotential_CleanName(xvasp.str.species.at(1))=="Sm") {
//[OBSOLETE]            cout << __AFLOW_FUNC__ << " Pseudopotential exception: " << xvasp.str.species_pp.at(0) << xvasp.str.species_pp.at(1) << " -> ";
//[OBSOLETE]            xvasp.str.species_pp.at(0)="B_h";xvasp.str.species_pp.at(1)="Sm_3";cout << xvasp.str.species_pp.at(0) << xvasp.str.species_pp.at(1) << endl;
//[OBSOLETE]            aurostd::StringSubst(xvasp.AVASP_potential,"potpaw_PBE","potpaw_GGA");
//[OBSOLETE]            cout << __AFLOW_FUNC__ << " Pseudopotential exception: \"potpaw_PBE\"=>\"potpaw_GGA\"" << endl;
//[OBSOLETE]            xvasp.aopts.flag("FLAG::AVASP_AUTO_PSEUDOPOTENTIALS",FALSE);
//[OBSOLETE]            cout << __AFLOW_FUNC__ << " turning OFF pseudopotential" << endl;	    
//[OBSOLETE]          }
//[OBSOLETE]        }
//[OBSOLETE]      }
//[OBSOLETE]      // patches for potpaw_PBE_KIN
//[OBSOLETE]      if(xvasp.AVASP_potential==DEFAULT_VASP_POTCAR_DIR_POTPAW_PBE_KIN) {
//[OBSOLETE]        for(uint isp=0;isp<xvasp.str.species.size();isp++)
//[OBSOLETE]          xvasp.str.species_pp.at(isp)=AVASP_Get_PseudoPotential_PAW_PBE_KIN(KBIN::VASP_PseudoPotential_CleanName(xvasp.str.species.at(isp)));
//[OBSOLETE]        // no exceptions yet
//[OBSOLETE]      }
//[OBSOLETE]      // patches for potpaw_LDA_KIN
//[OBSOLETE]      if(xvasp.AVASP_potential==DEFAULT_VASP_POTCAR_DIR_POTPAW_LDA_KIN) {
//[OBSOLETE]        for(uint isp=0;isp<xvasp.str.species.size();isp++)
//[OBSOLETE]          xvasp.str.species_pp.at(isp)=AVASP_Get_PseudoPotential_PAW_LDA_KIN(KBIN::VASP_PseudoPotential_CleanName(xvasp.str.species.at(isp)));
//[OBSOLETE]        // no exceptions yet
//[OBSOLETE]      }
//[OBSOLETE]      // patches for potpaw_LDA pot_GGA pot_LDA
//[OBSOLETE]      for(uint isp=0;isp<xvasp.str.species.size();isp++)  {
//[OBSOLETE]        //	if(aurostd::substring2bool(xvasp.AVASP_potential,"potpaw_GGA"))
//[OBSOLETE]        //	  xvasp.str.species_pp.at(isp)=AVASP_Get_PseudoPotential_PAW_GGA(KBIN::VASP_PseudoPotential_CleanName(xvasp.str.species.at(isp)));
//[OBSOLETE]        if(xvasp.AVASP_potential==DEFAULT_VASP_POTCAR_DIR_POTPAW_LDA)
//[OBSOLETE]          xvasp.str.species_pp.at(isp)=AVASP_Get_PseudoPotential_PAW_LDA(KBIN::VASP_PseudoPotential_CleanName(xvasp.str.species.at(isp)));
//[OBSOLETE]        if(xvasp.AVASP_potential==DEFAULT_VASP_POTCAR_DIR_POT_GGA)
//[OBSOLETE]          xvasp.str.species_pp.at(isp)=AVASP_Get_PseudoPotential_GGA(KBIN::VASP_PseudoPotential_CleanName(xvasp.str.species.at(isp)));
//[OBSOLETE]        if(xvasp.AVASP_potential==DEFAULT_VASP_POTCAR_DIR_POT_LDA)
//[OBSOLETE]          xvasp.str.species_pp.at(isp)=AVASP_Get_PseudoPotential_LDA(KBIN::VASP_PseudoPotential_CleanName(xvasp.str.species.at(isp)));
//[OBSOLETE]      }
//[OBSOLETE]    }
//[OBSOLETE]    // FIX THE SPECIES IF   AUTO_PSEUDOPOTENTIALS && (LIBRARY_MODE_ICSD ||LIBRARY_MODE_LIB3)
//[OBSOLETE]    if(xvasp.aopts.flag("FLAG::AVASP_AUTO_PSEUDOPOTENTIALS") && (xvasp.AVASP_prototype_mode==LIBRARY_MODE_ICSD || xvasp.AVASP_prototype_mode==LIBRARY_MODE_LIB3)) {
//[OBSOLETE]      for(uint isp=0;isp<xvasp.str.species.size();isp++) {
//[OBSOLETE]        if(xvasp.AVASP_potential==DEFAULT_VASP_POTCAR_DIR_POTPAW_PBE_KIN)
//[OBSOLETE]          xvasp.str.species_pp.at(isp)=AVASP_Get_PseudoPotential_PAW_PBE_KIN(KBIN::VASP_PseudoPotential_CleanName(xvasp.str.species.at(isp)));
//[OBSOLETE]        if(xvasp.AVASP_potential==DEFAULT_VASP_POTCAR_DIR_POTPAW_LDA_KIN)
...
//[OBSOLETE]    }
//[OBSOLETE]
//[OBSOLETE]    // type and version fixed
//[OBSOLETE]    xvasp.str.species_pp_type.clear();for(uint isp=0;isp<xvasp.str.species.size();isp++) xvasp.str.species_pp_type.push_back(xvasp.AVASP_potential);
//[OBSOLETE]    xvasp.str.species_pp_version.clear();for(uint isp=0;isp<xvasp.str.species.size();isp++) xvasp.str.species_pp_version.push_back("");
//[OBSOLETE]    xvasp.str.species_pp_ZVAL.clear();for(uint isp=0;isp<xvasp.str.species.size();isp++) xvasp.str.species_pp_ZVAL.push_back(0.0);
//[OBSOLETE]    xvasp.str.species_pp_vLDAU.clear();for(uint isp=0;isp<xvasp.str.species.size();isp++) xvasp.str.species_pp_vLDAU.push_back(deque<double>());
//[OBSOLETE]
//[OBSOLETE]  } // NAMES FIXED !
//[OBSOLETE]
//[OBSOLETE]  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " " << "[4]" << endl;
//[OBSOLETE]
//[OBSOLETE]  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " [5] xvasp.str.species.size()=" << xvasp.str.species.size() << endl;
//[OBSOLETE]
//[OBSOLETE]  // START THE HTQC STUFF
//[OBSOLETE]  if((xvasp.AVASP_prototype_mode==LIBRARY_MODE_HTQC || xvasp.AVASP_prototype_mode==LIBRARY_MODE_HTQC_ICSD || xvasp.AVASP_prototype_mode==LIBRARY_MODE_LIB3)) {
//[OBSOLETE]    // check for EXCEPTION Gd and Ce metals PUT LDAU
//[OBSOLETE]    if(aurostd::substring2bool(xvasp.str.species,"Gd")) {xvasp.aopts.flag("FLAG::AVASP_LDAU1",FALSE);xvasp.aopts.flag("FLAG::AVASP_LDAU2",TRUE);}
//[OBSOLETE]    if(aurostd::substring2bool(xvasp.str.species,"Ce")) {xvasp.aopts.flag("FLAG::AVASP_LDAU1",FALSE);xvasp.aopts.flag("FLAG::AVASP_LDAU2",TRUE);}
//[OBSOLETE]    if(LDEBUG)   cerr << "xvasp.aopts.flag(\"FLAG::AVASP_FORCE_NOLDAU\")=" << xvasp.aopts.flag("FLAG::AVASP_FORCE_NOLDAU") << endl;
//[OBSOLETE]    if(xvasp.aopts.flag("FLAG::AVASP_FORCE_NOLDAU"))  {xvasp.aopts.flag("FLAG::AVASP_LDAU1",FALSE);xvasp.aopts.flag("FLAG::AVASP_LDAU2",FALSE);}
//[OBSOLETE]
//[OBSOLETE]    if(xvasp.AVASP_directory_from_library_) {
//[OBSOLETE]      for(uint isp1=0;isp1<xvasp.str.species.size();isp1++)
//[OBSOLETE]        for(uint isp2=isp1+1;isp2<xvasp.str.species.size();isp2++)
//[OBSOLETE]          if(KBIN::VASP_PseudoPotential_CleanName(xvasp.str.species.at(isp1))==KBIN::VASP_PseudoPotential_CleanName(xvasp.str.species.at(isp2))) {
//[OBSOLETE]            ostringstream aus;
//[OBSOLETE]            if(LDEBUG) aus << "EEEEE  PROTO_Generation_Binary_Aflowin error xvasp.str.species.at(isp1)==xvasp.str.species.at(isp2) " << xvasp.str.species.at(isp1) << endl;
//[OBSOLETE]            if(LDEBUG) aurostd::PrintErrorStream(oaus,aus,XHOST.QUIET);
//[OBSOLETE]            Krun=FALSE;
//[OBSOLETE]            return Krun; // empty
//[OBSOLETE]          }
//[OBSOLETE]    }
//[OBSOLETE]    //  cerr << xvasp.AVASP_volumeC; // keep it bisy
//[OBSOLETE]    if(xvasp.AVASP_alpha_fix==TRUE) {
//[OBSOLETE]      xvasp.str.SpeciesPutAlphabetic(); // should put alphabetic also the PSEUDOPOTENTIALS
//[OBSOLETE]    }
//[OBSOLETE]    //    xvasp.str.SpeciesPutAlphabetic();
//[OBSOLETE]
//[OBSOLETE]    if(xvasp.AVASP_prototype_from_library_) {
//[OBSOLETE]      if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " [5a.1]" << endl;
//[OBSOLETE]      string label_AFLOWLIB_LIB0,label_AFLOWLIB_LIB1,label_AFLOWLIB_LIB2,label_AFLOWLIB_LIB3,label_AFLOWLIB_LIB4,label_AFLOWLIB_LIB5,label_AFLOWLIB_LIB6,label_AFLOWLIB_LIB7,label_AFLOWLIB_LIB8,label_AFLOWLIB_LIB9;
//[OBSOLETE]      directory=xvasp.AVASP_dirbase+"/";
//[OBSOLETE]      for(uint i=0;i<xvasp.str.species_pp.size();i++) {
//[OBSOLETE]        directory+=xvasp.str.species_pp.at(i);
//[OBSOLETE]        if(xvasp.POTCAR_TYPE_DATE_PRINT_flag) { // add potential type and date
//[OBSOLETE]          if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " [5a.2]" << endl;
//[OBSOLETE]          string FilePotcar,DataPotcar,AUIDPotcar;
//[OBSOLETE]          if(!KBIN::VASP_Find_FILE_POTCAR(xvasp.AVASP_potential+"/"+xvasp.str.species_pp.at(i),FilePotcar,DataPotcar,AUIDPotcar)) {
//[OBSOLETE]            cerr << "EEEEE  POTCAR [" << xvasp.AVASP_potential+"/"+xvasp.str.species_pp.at(i) << "] not found! " << Message(__AFLOW_FILE__) << endl;
//[OBSOLETE]            return FALSE; // dont die
//[OBSOLETE]          } else {
//[OBSOLETE]            if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << "  POTCAR [" << xvasp.AVASP_potential+"/"+xvasp.str.species_pp.at(i) << "] = " << FilePotcar << endl;
//[OBSOLETE]            vector<string> tokens;
//[OBSOLETE]            string pottype="",date="",sgrep=aurostd::execute2string("cat "+FilePotcar+" | grep TITEL");
//[OBSOLETE]            aurostd::string2tokens(sgrep,tokens," ");
//[OBSOLETE]            if(tokens.size()!=4 && tokens.size()!=5) {
//[OBSOLETE]              cerr << "EEEEE  POTCAR [" << xvasp.AVASP_potential+"/"+xvasp.str.species_pp.at(i) << "] = " << FilePotcar << "  wrong TITEL: " << sgrep << endl; 
//[OBSOLETE]              return FALSE; // dont die
//[OBSOLETE]            }
//[OBSOLETE]            if(tokens.size()==4) { // no indications of time
//[OBSOLETE]              if(tokens.at(2)=="US" && aurostd::substring2bool(FilePotcar,"LDA","lda")) {pottype="LDA";date=DEFAULT_VASP_POTCAR_DATE_POT_LDA;}
//[OBSOLETE]              if(tokens.at(2)=="US" && aurostd::substring2bool(FilePotcar,"GGA","gga")) {pottype="GGA";date=DEFAULT_VASP_POTCAR_DATE_POT_GGA;}
//[OBSOLETE]            }
//[OBSOLETE]            if(tokens.size()==5) {
//[OBSOLETE]              if(tokens.at(2)=="PAW") {pottype="PAW_LDA";date=tokens.at(4);}
//[OBSOLETE]              if(tokens.at(2)=="PAW_GGA") {pottype="PAW_GGA";date=tokens.at(4);}
//[OBSOLETE]              if(tokens.at(2)=="PAW_RPBE") {pottype="PAW_RPBE";date=tokens.at(4);}  // potpaw_GGA/DEFAULT_VASP_POTCAR_DATE/Ge_h
//[OBSOLETE]              if(tokens.at(2)=="PAW_PBE") {pottype="PAW_PBE";date=tokens.at(4);}
//[OBSOLETE]              if(tokens.at(2)=="PAW_PBE") {pottype="PAW_PBE_KIN";date=tokens.at(4);} // FIX CO+SC PBE_KIN CHECK PRESENCE OF "mkinetic energy-density pseudized"
//[OBSOLETE]              if(tokens.at(2)=="PAW_LDA") {pottype="PAW_LDA_KIN";date=tokens.at(4);} // FIX CO+SC LDA_KIN CHECK PRESENCE OF "mkinetic energy-density pseudized"
//[OBSOLETE]              // SEE https://www.vasp.at/wiki/index.php/METAGGA
//[OBSOLETE]            }
//[OBSOLETE]            if(pottype.empty()) {
//[OBSOLETE]              cerr << "EEEEE  POTCAR [" << xvasp.AVASP_potential+"/"+xvasp.str.species_pp.at(i) << "] = " << FilePotcar << "  wrong pottype:" << sgrep << endl; 
//[OBSOLETE]              return FALSE; // dont die
//[OBSOLETE]            }
//[OBSOLETE]            if(date.empty()) {
//[OBSOLETE]              cerr << "EEEEE  POTCAR [" << xvasp.AVASP_potential+"/"+xvasp.str.species_pp.at(i) << "] = " << FilePotcar << "  wrong date:" << sgrep << endl;
//[OBSOLETE]              return FALSE; // dont die
//[OBSOLETE]            }
//[OBSOLETE]            directory+=":"+pottype+":"+date;
//[OBSOLETE]            if(i<xvasp.str.species_pp.size()-1) directory+=":";
//[OBSOLETE]          }
//[OBSOLETE]          if(LDEBUG) cerr << xvasp.AVASP_potential << "/" << xvasp.str.species_pp.at(i) << endl;	
//[OBSOLETE]        }
//[OBSOLETE]      }
//[OBSOLETE]      if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " [5a.3]" << endl;
//[OBSOLETE]      directory+="/"+xvasp.AVASP_label;
//[OBSOLETE]      //  cerr << "DEBUG - " << __AFLOW_FUNC__ << " xvasp.AVASP_prototype_from_library_ directory(1)=" << directory << endl;    
//[OBSOLETE]      system=""+aurostd::vectorstring2string(xvasp.str.species_pp)+"."+xvasp.AVASP_label;
//[OBSOLETE]      // label_text0 - MIX
//[OBSOLETE]      label_MIX=xvasp.AVASP_libbase+"/"+aurostd::vectorstring2string(xvasp.str.species_pp)+"/"+xvasp.AVASP_label+"/"+_AFLOWIN_;
//[OBSOLETE]      if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " [5a.4]" << endl;
//[OBSOLETE]      if(XHOST.hostname==XHOST.AFLOW_MATERIALS_SERVER || XHOST.hostname==XHOST.AFLOW_WEB_SERVER) {
//[OBSOLETE]        if(xvasp.AVASP_libbase.size()==0) {
//[OBSOLETE]          if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " [5a.5]" << endl;
//[OBSOLETE]          if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " [5a.6] XHOST_LIBRARY_LIB2=" << XHOST_LIBRARY_LIB2 << endl;
//[OBSOLETE]          if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " [5a.7] vAFLOW_PROJECTS_DIRECTORIES.size()=" << vAFLOW_PROJECTS_DIRECTORIES.size() << endl;
//[OBSOLETE]          label_AFLOWLIB_LIB0=init::AFLOW_Projects_Directories("LIB0")+"/RAW"+label_MIX;
//[OBSOLETE]          label_AFLOWLIB_LIB1=init::AFLOW_Projects_Directories("LIB1")+"/RAW"+label_MIX;
//[OBSOLETE]          label_AFLOWLIB_LIB2=init::AFLOW_Projects_Directories("LIB2")+"/RAW"+label_MIX;
//[OBSOLETE]          label_AFLOWLIB_LIB4=init::AFLOW_Projects_Directories("LIB4")+"/RAW"+label_MIX;
//[OBSOLETE]          label_AFLOWLIB_LIB5=init::AFLOW_Projects_Directories("LIB5")+"/RAW"+label_MIX;
//[OBSOLETE]          label_AFLOWLIB_LIB6=init::AFLOW_Projects_Directories("LIB6")+"/RAW"+label_MIX;
//[OBSOLETE]          label_AFLOWLIB_LIB7=init::AFLOW_Projects_Directories("LIB7")+"/RAW"+label_MIX;
//[OBSOLETE]          label_AFLOWLIB_LIB8=init::AFLOW_Projects_Directories("LIB8")+"/RAW"+label_MIX;
//[OBSOLETE]          label_AFLOWLIB_LIB9=init::AFLOW_Projects_Directories("LIB9")+"/RAW"+label_MIX;
//[OBSOLETE]          if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " [5a.6] label_AFLOWLIB_LIB2=" << label_AFLOWLIB_LIB2 << endl;
//[OBSOLETE]          if(XHOST_LIBRARY_LIB3!=LIBRARY_NOTHING)  {label_AFLOWLIB_LIB3=init::AFLOW_Projects_Directories("LIB3")+"/LIB"+label_MIX;} else {label_AFLOWLIB_LIB3="./LIB"+label_MIX;}
//[OBSOLETE]        } else {
//[OBSOLETE]          if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " [5d.02] else CHECK THESE BY HAND" << endl;
//[OBSOLETE]          label_AFLOWLIB_LIB2=label_MIX;aurostd::StringSubst(label_AFLOWLIB_LIB2,init::AFLOW_Projects_Directories("LIB3"),init::AFLOW_Projects_Directories("LIB2"));  // why this swap ?
//[OBSOLETE]          label_AFLOWLIB_LIB3=label_MIX;aurostd::StringSubst(label_AFLOWLIB_LIB3,init::AFLOW_Projects_Directories("LIB2"),init::AFLOW_Projects_Directories("LIB3"));  // why this swap ?
//[OBSOLETE]          aurostd::StringSubst(label_AFLOWLIB_LIB3,"LIB2U","");
//[OBSOLETE]          aurostd::StringSubst(label_AFLOWLIB_LIB2,"//","/");
//[OBSOLETE]          aurostd::StringSubst(label_AFLOWLIB_LIB3,"//","/");
//[OBSOLETE]          if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " [5d.02] label_AFLOWLIB_LIB0=" << label_AFLOWLIB_LIB0 << endl;
//[OBSOLETE]          if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " [5d.02] label_AFLOWLIB_LIB1=" << label_AFLOWLIB_LIB1 << endl;
//[OBSOLETE]          if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " [5d.02] label_AFLOWLIB_LIB2=" << label_AFLOWLIB_LIB2 << endl;
//[OBSOLETE]          if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " [5d.02] label_AFLOWLIB_LIB3=" << label_AFLOWLIB_LIB3 << endl;	
//[OBSOLETE]          if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " [5d.02] label_AFLOWLIB_LIB4=" << label_AFLOWLIB_LIB4 << endl;
//[OBSOLETE]          if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " [5d.02] label_AFLOWLIB_LIB5=" << label_AFLOWLIB_LIB5 << endl;
//[OBSOLETE]          if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " [5d.02] label_AFLOWLIB_LIB6=" << label_AFLOWLIB_LIB6 << endl;
//[OBSOLETE]          if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " [5d.02] label_AFLOWLIB_LIB7=" << label_AFLOWLIB_LIB7 << endl;
//[OBSOLETE]          if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " [5d.02] label_AFLOWLIB_LIB8=" << label_AFLOWLIB_LIB8 << endl;
//[OBSOLETE]          if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " [5d.02] label_AFLOWLIB_LIB9=" << label_AFLOWLIB_LIB9 << endl;
//[OBSOLETE]        }
//[OBSOLETE]        if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " [5d.1]" << endl;
//[OBSOLETE]        //     if(xvasp.AVASP_libbase.size()==0) label_MIX=init::AFLOW_Projects_Directories("LIB2")+"/LIB"+label_MIX;
//[OBSOLETE]        if(xvasp.AVASP_libbase.size()==0 && xvasp.AVASP_prototype_mode==LIBRARY_MODE_HTQC) label_MIX=init::AFLOW_Projects_Directories("LIB2")+"/RAW"+label_MIX;
//[OBSOLETE]        if(xvasp.AVASP_libbase.size()==0 && xvasp.AVASP_prototype_mode==LIBRARY_MODE_HTQC_ICSD) label_MIX=init::AFLOW_Projects_Directories("LIB2")+"/RAW"+label_MIX;
//[OBSOLETE]        if(xvasp.AVASP_libbase.size()==0 && xvasp.AVASP_prototype_mode==LIBRARY_MODE_LIB3) label_MIX=init::AFLOW_Projects_Directories("LIB3")+"/LIB"+label_MIX;
//[OBSOLETE]        //  cerr << "LIB2=" << label_AFLOWLIB_LIB2 << endl;
//[OBSOLETE]        //  cerr << "LIB3=" << label_AFLOWLIB_LIB3 << endl;
//[OBSOLETE]      } else {
//[OBSOLETE]        if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " [5d.03] no check for MIX in non aflowlib servers " << endl;
//[OBSOLETE]      }	
//[OBSOLETE]
//[OBSOLETE]      if(LDEBUG) cerr << "DEBUG - AVASP_MakeSingleAFLOWIN [label_MIX] " << label_MIX << endl;
//[OBSOLETE]      if(xvasp.AVASP_aflowin_only_if_missing==TRUE) if(aurostd::FileExist(label_MIX)) {if(LDEBUG) cerr << label_MIX << endl; return TRUE;}  // ALREADY WRITTEN
//[OBSOLETE]      if(xvasp.AVASP_aflowin_only_if_missing==TRUE) if(aurostd::FileExist(label_AFLOWLIB_LIB0)) {if(LDEBUG) cerr << label_AFLOWLIB_LIB0 << endl; return TRUE;}  // IN AFLOWLIB
//[OBSOLETE]      if(xvasp.AVASP_aflowin_only_if_missing==TRUE) if(aurostd::FileExist(label_AFLOWLIB_LIB1)) {if(LDEBUG) cerr << label_AFLOWLIB_LIB1 << endl; return TRUE;}  // IN AFLOWLIB
//[OBSOLETE]      if(xvasp.AVASP_aflowin_only_if_missing==TRUE) if(aurostd::FileExist(label_AFLOWLIB_LIB2)) {if(LDEBUG) cerr << label_AFLOWLIB_LIB2 << endl; return TRUE;}  // IN AFLOWLIB
//[OBSOLETE]      if(xvasp.AVASP_aflowin_only_if_missing==TRUE) if(aurostd::FileExist(label_AFLOWLIB_LIB3)) {if(LDEBUG) cerr << label_AFLOWLIB_LIB3 << endl; return TRUE;}  // IN AFLOWLIB
//[OBSOLETE]      if(xvasp.AVASP_aflowin_only_if_missing==TRUE) if(aurostd::FileExist(label_AFLOWLIB_LIB4)) {if(LDEBUG) cerr << label_AFLOWLIB_LIB4 << endl; return TRUE;}  // IN AFLOWLIB
//[OBSOLETE]      if(xvasp.AVASP_aflowin_only_if_missing==TRUE) if(aurostd::FileExist(label_AFLOWLIB_LIB5)) {if(LDEBUG) cerr << label_AFLOWLIB_LIB5 << endl; return TRUE;}  // IN AFLOWLIB
//[OBSOLETE]      if(xvasp.AVASP_aflowin_only_if_missing==TRUE) if(aurostd::FileExist(label_AFLOWLIB_LIB6)) {if(LDEBUG) cerr << label_AFLOWLIB_LIB6 << endl; return TRUE;}  // IN AFLOWLIB
//[OBSOLETE]      if(xvasp.AVASP_aflowin_only_if_missing==TRUE) if(aurostd::FileExist(label_AFLOWLIB_LIB7)) {if(LDEBUG) cerr << label_AFLOWLIB_LIB7 << endl; return TRUE;}  // IN AFLOWLIB
//[OBSOLETE]      if(xvasp.AVASP_aflowin_only_if_missing==TRUE) if(aurostd::FileExist(label_AFLOWLIB_LIB8)) {if(LDEBUG) cerr << label_AFLOWLIB_LIB8 << endl; return TRUE;}  // IN AFLOWLIB
//[OBSOLETE]      if(xvasp.AVASP_aflowin_only_if_missing==TRUE) if(aurostd::FileExist(label_AFLOWLIB_LIB9)) {if(LDEBUG) cerr << label_AFLOWLIB_LIB9 << endl; return TRUE;}  // IN AFLOWLIB
//[OBSOLETE]
//[OBSOLETE]      if(xvasp.AVASP_aflowin_only_if_missing==TRUE) if(aurostd::FileExist("/common/BANDS/LIB/"+aurostd::vectorstring2string(xvasp.str.species_pp)+"/"+xvasp.AVASP_label+"/"+_AFLOWIN_)) {if(LDEBUG) cerr << "BANDS" << endl; return TRUE;}
//[OBSOLETE]      if(xvasp.AVASP_aflowin_only_if_missing==TRUE) if(aurostd::FileExist("/common/BANDS/RAW/"+aurostd::vectorstring2string(xvasp.str.species_pp)+"/"+xvasp.AVASP_label+"/"+_AFLOWIN_)) {if(LDEBUG) cerr << "BANDS" << endl; return TRUE;}
//[OBSOLETE]      // label_NOMIX - NOMIX
//[OBSOLETE]      label_NOMIX=label_MIX;aurostd::StringSubst(label_NOMIX,"LIB2","LIB2/NOMIX");
//[OBSOLETE]      if(LDEBUG) cerr << "DEBUG - AVASP_MakeSingleAFLOWIN [label_NOMIX] " << label_NOMIX << endl;
//[OBSOLETE]      if(xvasp.AVASP_aflowin_only_if_missing==TRUE) if(aurostd::FileExist(label_NOMIX)) {if(LDEBUG) cerr << label_NOMIX << endl; return TRUE;}
//[OBSOLETE]      // label_SKIP - SKIP
//[OBSOLETE]      label_SKIP=label_MIX;aurostd::StringSubst(label_SKIP,"LIB2","LIB2/SKIP");
//[OBSOLETE]      if(LDEBUG) cerr << "DEBUG - AVASP_MakeSingleAFLOWIN [label_SKIP] " << label_SKIP << endl;
//[OBSOLETE]      if(xvasp.AVASP_aflowin_only_if_missing==TRUE) if(aurostd::FileExist(label_SKIP)) {if(LDEBUG) cerr << label_SKIP << endl; return TRUE;}
//[OBSOLETE]      // label_ALREADY - ALREADY
//[OBSOLETE]      label_ALREADY=directory+"/"+_AFLOWIN_;
//[OBSOLETE]      if(LDEBUG) cerr << "DEBUG - AVASP_MakeSingleAFLOWIN [label_ALREADY] " << label_ALREADY << endl;
//[OBSOLETE]      if(xvasp.AVASP_aflowin_only_if_missing==TRUE) if(aurostd::FileExist(label_ALREADY)) {if(LDEBUG) cerr << label_ALREADY << endl; return TRUE;}
//[OBSOLETE]      // done generate
//[OBSOLETE]      if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " [6] xvasp.str.species.size()=" << xvasp.str.species.size() << endl;
//[OBSOLETE]
//[OBSOLETE]      if(xvasp.str.species.size()==1) { // because specie 1 is part of the binary stuff
//[OBSOLETE]        if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " [6a] xvasp.str.species.size()=" << xvasp.str.species.size() << endl;	
//[OBSOLETE]        //DX [OBSOLETE] - Not sure why we add 2 of each; breaks ANRL unaries: deque<string> species_pp;      species_pp.push_back(xvasp.str.species_pp.at(0));species_pp.push_back(xvasp.str.species_pp.at(0));
//[OBSOLETE]        //DX [OBSOLETE] - Not sure why we add 2 of each; breaks ANRL unaries: deque<string> species_pp_backup; species_pp_backup.push_back(xvasp.str.species_pp.at(0));species_pp_backup.push_back(xvasp.str.species_pp.at(0));  // to prevent mess up of species
//[OBSOLETE]        //DX [OBSOLETE] - Not sure why we add 2 of each; breaks ANRL unaries: deque<double> species_volume;  species_volume.push_back(xvasp.str.species_volume.at(0));species_volume.push_back(xvasp.str.species_volume.at(0));
//[OBSOLETE]        //DX [OBSOLETE] - Not sure why we add 2 of each; breaks ANRL unaries: deque<double> species_mass;    species_mass.push_back(xvasp.str.species_mass.at(0));species_mass.push_back(xvasp.str.species_mass.at(0));
//[OBSOLETE]        deque<string> species_pp;      species_pp.push_back(xvasp.str.species_pp.at(0)); //DX20180118 - instead of adding 2 (see above)
//[OBSOLETE]        deque<string> species_pp_backup; species_pp_backup.push_back(xvasp.str.species_pp.at(0)); //DX20180118 - instead of adding 2 (see above)
//[OBSOLETE]        deque<double> species_volume;  species_volume.push_back(xvasp.str.species_volume.at(0)); //DX20180118 - instead of adding 2 (see above)
//[OBSOLETE]        deque<double> species_mass;    species_mass.push_back(xvasp.str.species_mass.at(0)); //DX20180118 - instead of adding 2 (see above)
//[OBSOLETE]        //	xvasp.str=aflowlib::PrototypeLibraries(oaus,xvasp.AVASP_label,xvasp.AVASP_parameters,species_pp,species_volume,xvasp.AVASP_volume_in); // FOR HTQC
//[OBSOLETE]        xvasp.str=aflowlib::PrototypeLibraries(oaus,xvasp.AVASP_label,xvasp.AVASP_parameters,species_pp,species_volume,xvasp.AVASP_volume_in,xvasp_in.AVASP_prototype_mode); 
//[OBSOLETE]        for(uint i=0;i<xvasp.str.species_pp.size()&&i<species_pp_backup.size();i++) xvasp.str.species_pp.at(i)=species_pp_backup.at(i); // to restore mess up of species
//[OBSOLETE]        // xvasp.str=PrototypeBinary(oaus,xvasp.AVASP_label,xvasp.str.species_pp.at(0),xvasp.str.species_volume.at(0),xvasp.str.species_pp.at(0),xvasp.str.species_volume.at(0),xvasp.AVASP_volume_in); // OLD WAY
//[OBSOLETE]        xvasp.str.species_mass=vmass;
//[OBSOLETE]      }
//[OBSOLETE]
//[OBSOLETE]      if(xvasp.str.species.size()>=2) {
//[OBSOLETE]        if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " [7]  xvasp.str.species.size()>=2" << endl;
//[OBSOLETE]        for(uint i=0;i<xvasp.str.species_pp.size();i++) if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " [7.0a]: xvasp.str.species_pp.at(i) " << xvasp.str.species_pp.at(i) << endl;
//[OBSOLETE]        for(uint i=0;i<xvasp.str.species_pp_type.size();i++) if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " [7.0b]: xvasp.str.species_pp_type.at(i) " << xvasp.str.species_pp_type.at(i) << endl;
//[OBSOLETE]        for(uint i=0;i<xvasp.str.species_pp_version.size();i++) if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " [7.0c]: xvasp.str.species_pp_version.at(i) " << xvasp.str.species_pp_version.at(i) << endl;
//[OBSOLETE]        for(uint i=0;i<xvasp.str.species_pp_ZVAL.size();i++) if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " [7.0c]: xvasp.str.species_pp_ZVAL.at(i) " << xvasp.str.species_pp_ZVAL.at(i) << endl;
//[OBSOLETE]        for(uint i=0;i<xvasp.str.species_pp_vLDAU.size();i++) if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " [7.0c]: xvasp.str.species_pp_vLDAU.at(i) " << xvasp.str.species_pp_vLDAU.at(i).size() << endl;
//[OBSOLETE]        for(uint i=0;i<xvasp.str.species_volume.size();i++) if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " [7.0d]: xvasp.str.species_volume.at(i) " << xvasp.str.species_volume.at(i) << endl;
//[OBSOLETE]        for(uint i=0;i<xvasp.str.species_mass.size();i++) if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " [7.0e]: xvasp.str.species_mass.at(i) " << xvasp.str.species_mass.at(i) << endl;
//[OBSOLETE]        if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " [7.1a1]: xvasp.AVASP_volume_in=" << xvasp.AVASP_volume_in << endl;
//[OBSOLETE]        if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " [7.1a2]: xvasp.AVASP_label=" << xvasp.AVASP_label << endl;
//[OBSOLETE]        if(LDEBUG) {cerr << "DEBUG - " << __AFLOW_FUNC__ << " [7.1a3]: xvasp.str.species_pp.size()=" << xvasp.str.species_pp.size() << ": "; for(uint i=0;i<xvasp.str.species_pp.size();i++) cerr << " " << xvasp.str.species_pp.at(i); cerr << endl;}
//[OBSOLETE]        if(LDEBUG) {cerr << "DEBUG - " << __AFLOW_FUNC__ << " [7.1a3]: xvasp.str.species_volume.size()=" << xvasp.str.species_volume.size() << ": "; for(uint i=0;i<xvasp.str.species_volume.size();i++) cerr << " " << xvasp.str.species_volume.at(i); cerr << endl;}
//[OBSOLETE]        xstructure a;
//[OBSOLETE]        //	xvasp.str=aflowlib::PrototypeLibraries(oaus,xvasp.AVASP_label,xvasp.AVASP_parameters,xvasp.str.species_pp,xvasp.str.species_volume,xvasp.AVASP_volume_in);   // FOR HTQC
//[OBSOLETE]        xvasp.str=aflowlib::PrototypeLibraries(oaus,xvasp.AVASP_label,xvasp.AVASP_parameters,xvasp.str.species_pp,xvasp.str.species_volume,xvasp.AVASP_volume_in,xvasp_in.AVASP_prototype_mode); 
//[OBSOLETE]
//[OBSOLETE]        if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " [7.1b]  xvasp.str.species.size()>=2" << endl;
//[OBSOLETE]        if(LDEBUG) cerr << xvasp.str << endl;
//[OBSOLETE]        if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " [7.1c]  xvasp.str.species.size()>=2" << endl;
//[OBSOLETE]        // xvasp.str=PrototypeBinary(oaus,xvasp.AVASP_label,xvasp.str.species_pp.at(0),xvasp.str.species_volume.at(0),xvasp.str.species_pp.at(1),xvasp.str.species_volume.at(1),xvasp.AVASP_volume_in); // OLD WAY
//[OBSOLETE]        xvasp.str.species_mass=vmass;
//[OBSOLETE]      }
//[OBSOLETE]      if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " [8] xvasp.str.species.size()=" << xvasp.str.species.size() << endl;
//[OBSOLETE]      //   cerr << "[7]" << xvasp.str.species_pp.at(0) << " " << xvasp.str.species_pp.at(1) << endl;
//[OBSOLETE]    } else {
//[OBSOLETE]      directory=xvasp.AVASP_dirbase+"/"+aurostd::vectorstring2string(xvasp.str.species_pp)+"/"+xvasp.AVASP_label;
//[OBSOLETE]      // cerr << "DEBUG - " << __AFLOW_FUNC__ << " directory(2)=" << directory << endl;
//[OBSOLETE]      system=aurostd::vectorstring2string(xvasp.str.species_pp)+"."+xvasp.AVASP_label;
//[OBSOLETE]      label_MIX=xvasp.AVASP_libbase+"/"+aurostd::vectorstring2string(xvasp.str.species_pp)+"/"+xvasp.AVASP_label+"/"+_AFLOWIN_;
//[OBSOLETE]    }
//[OBSOLETE]    if(xvasp.AVASP_directory_from_library_==FALSE) {
//[OBSOLETE]      directory=xvasp.AVASP_dirbase+"/"+xvasp.AVASP_label;
//[OBSOLETE]      //   cerr << "DEBUG - " << __AFLOW_FUNC__ << " directory(3)=" << directory << endl;
//[OBSOLETE]      system=xvasp.AVASP_label;
//[OBSOLETE]    }
//[OBSOLETE]    if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " [9]" << endl;
//[OBSOLETE]
//[OBSOLETE]    // MAKE Directory
//[OBSOLETE]    //  Krun=aurostd::DirectoryMake(directory); // do later
//[OBSOLETE]    // if(Krun==FALSE) return Krun;             // do later
//[OBSOLETE]    // UNDERSTAND SPECIES !
//[OBSOLETE]    //  cerr << str.num_each_type.size() << endl;
//[OBSOLETE]    //  cerr << str.comp_each_type.size() << endl;
//[OBSOLETE]    if(xvasp.str.SpeciesGetAlphabetic()==FALSE) xvasp.str.SpeciesPutAlphabetic();
//[OBSOLETE]  }
//[OBSOLETE]
//[OBSOLETE]  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " " << "[10]" << endl;
//[OBSOLETE]
//[OBSOLETE]  // for ICSD
//[OBSOLETE]  if(xvasp.AVASP_prototype_mode==LIBRARY_MODE_ICSD) {
//[OBSOLETE]    if(LDEBUG) cerr << "DEBUG: xvasp.AVASP_prototype_mode==LIBRARY_MODE_ICSD" << endl;
//[OBSOLETE]    // xvasp.AVASP_dirbase=_ICSD_DIRBASE_;
//[OBSOLETE]    // xvasp.AVASP_libbase=init::AFLOW_Projects_Directories("ICSD");
//[OBSOLETE]    // directory=xvasp.AVASP_dirbase+"/"+xvasp.AVASP_label;
//[OBSOLETE]    system=xvasp.AVASP_label;
//[OBSOLETE]    //    if(xvasp.str.spacegroupnumber!=0) {
//[OBSOLETE]    //       cerr << "DEBUG: calling LATTICE::Lattice_SpaceGroup from AVASP_MakeSingleAFLOWIN" << endl;
//[OBSOLETE]    //       directory=xvasp.AVASP_dirbase+"/"+LATTICE::Lattice_SpaceGroup(xvasp.str.spacegroupnumber)+"/"+xvasp.AVASP_label;}
//[OBSOLETE]    //     else
//[OBSOLETE]    directory=xvasp.AVASP_dirbase+"/"+xvasp.str.bravais_lattice_type+"/"+xvasp.AVASP_label;
//[OBSOLETE]    //  cerr << "DEBUG - " << __AFLOW_FUNC__ << " directory(4)=" << directory << endl;
//[OBSOLETE]    //    cerr << directory << endl;
//[OBSOLETE]  }
//[OBSOLETE]
//[OBSOLETE]  // for ICSD
//[OBSOLETE]  if(xvasp.AVASP_prototype_mode==LIBRARY_MODE_PROTOTYPE || xvasp.AVASP_prototype_mode==LIBRARY_MODE_XSTRUCTURE) {
//[OBSOLETE]    system="";
//[OBSOLETE]    formula="";
//[OBSOLETE]    directory=xvasp.Directory;
//[OBSOLETE]    for(uint i=0;i<xvasp.str.species_pp.size();i++) {
//[OBSOLETE]      system+=xvasp.str.species_pp.at(i);
//[OBSOLETE]      formula+=xvasp.str.species_pp.at(i)+aurostd::utype2string(xvasp.str.num_each_type.at(i));
//[OBSOLETE]    }
//[OBSOLETE]    //if(xvasp.AVASP_prototype_mode==LIBRARY_MODE_PROTOTYPE) directory=xvasp.Directory;
//[OBSOLETE]    if(xvasp.AVASP_prototype_mode==LIBRARY_MODE_XSTRUCTURE) system+="/"+xvasp.Directory;
//[OBSOLETE]    aurostd::StringSubst(system,"/./","/");aurostd::StringSubst(system,"//","/");
//[OBSOLETE]  }
//[OBSOLETE]
//[OBSOLETE]  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " " << "[11]" << endl;
//[OBSOLETE]
//[OBSOLETE]  bool AFLOWIN_OLD=FALSE;
//[OBSOLETE]  bool AFLOWIN_NEW=TRUE;
//[OBSOLETE]
//[OBSOLETE]  //DX20180123 - Add ANRL parameters to label - START
//[OBSOLETE]  // check for ANRL
//[OBSOLETE]  if(xvasp.aopts.flag("AFLOWIN_FLAG::PARAMS")==TRUE) {
//[OBSOLETE]    string anrl_add_on=":ANRL="+xvasp.AVASP_parameters;
//[OBSOLETE]    system+=anrl_add_on;directory+=anrl_add_on;xvasp.AVASP_label+=anrl_add_on;
//[OBSOLETE]  }
//[OBSOLETE]  //DX20180123 - Add ANRL parameters to label - END
//[OBSOLETE]
//[OBSOLETE]  // check for PSTRESS/PRESSURE   //  if(xvasp.aopts.flag("AFLOWIN_FLAG::PSTRESS",TRUE)) xvasp.aopts.push_attached("AFLOWIN_FLAG::PSTRESS","7.65");
//[OBSOLETE]  if(xvasp.aopts.flag("AFLOWIN_FLAG::PSTRESS")==TRUE) {
//[OBSOLETE]    double PSTRESS=aurostd::string2utype<double>(xvasp.aopts.getattachedscheme("AFLOWIN_FLAG::PSTRESS"));
//[OBSOLETE]    if(abs(PSTRESS)>0.00001) {
//[OBSOLETE]      if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " with pressure " << "[12p]" << endl;
//[OBSOLETE]      string pressure_add_on=":P="+aurostd::utype2string(PSTRESS,_AVASP_DOUBLE2STRING_PRECISION_)+"kB";
//[OBSOLETE]      if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " with pressure " << "[12p2] pressure_add_on="  << pressure_add_on << endl;
//[OBSOLETE]      system+=pressure_add_on;directory+=pressure_add_on;xvasp.AVASP_label+=pressure_add_on;
//[OBSOLETE]    }
//[OBSOLETE]  }
//[OBSOLETE]
//[OBSOLETE]  // check for LDAU1
//[OBSOLETE]  if(0 && xvasp.aopts.flag("FLAG::AVASP_LDAU1") && !aurostd::substring2bool(system,"_ICSD")) {
//[OBSOLETE]    if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " with LDAU1 " << "[12p3]" << endl;
//[OBSOLETE]    string ldau1_add_on=":LDAU1";
//[OBSOLETE]    system+=ldau1_add_on;directory+=ldau1_add_on;xvasp.AVASP_label+=ldau1_add_on;
//[OBSOLETE]  }
//[OBSOLETE]  // check for LDAU2
//[OBSOLETE]  if((xvasp.aopts.flag("FLAG::AVASP_LDAU1") || xvasp.aopts.flag("FLAG::AVASP_LDAU2") ) && !aurostd::substring2bool(system,"_ICSD")) {
//[OBSOLETE]    if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " with LDAU2 " << "[12p4]" << endl;
//[OBSOLETE]    string ldau2_add_on=":LDAU2";
//[OBSOLETE]    system+=ldau2_add_on;directory+=ldau2_add_on;xvasp.AVASP_label+=ldau2_add_on;
//[OBSOLETE]  }
//[OBSOLETE]
//[OBSOLETE]  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " " << "[12.2]" << endl;
//[OBSOLETE]
//[OBSOLETE]  // skipped if necessary
//[OBSOLETE]  // PREAMBLE
//[OBSOLETE]  aflowin << AFLOWIN_SEPARATION_LINE << endl; // [AFLOW] **************************************************
//[OBSOLETE]  aflowin << "[AFLOW]                                                                                     " << endl;
//[OBSOLETE]  aflowin << "[AFLOW]                     .o.        .o88o. oooo                                          " << endl;
//[OBSOLETE]  aflowin << "[AFLOW]                    .888.       888 `` `888                                          " << endl;
//[OBSOLETE]  aflowin << "[AFLOW]                   .8'888.     o888oo   888   .ooooo.  oooo oooo    ooo              " << endl;
//[OBSOLETE]  aflowin << "[AFLOW]                  .8' `888.     888     888  d88' `88b  `88. `88.  .8'               " << endl;
//[OBSOLETE]  aflowin << "[AFLOW]                 .88ooo8888.    888     888  888   888   `88..]88..8'                " << endl;
//[OBSOLETE]  aflowin << "[AFLOW]                .8'     `888.   888     888  888   888    `888'`888'                 " << endl;
//[OBSOLETE]  aflowin << "[AFLOW]               o88o     o8888o o888o   o888o `Y8bod8P'     `8'  `8'  .in             " << endl;
//[OBSOLETE]  aflowin << "[AFLOW]                                                                                     " << endl;
//[OBSOLETE]  aflowin << AFLOWIN_SEPARATION_LINE << endl; // [AFLOW]  **************************************************
//[OBSOLETE]  aflowin << "[AFLOW] * Stefano Curtarolo - (AFLOW V" << string(AFLOW_VERSION) << ") " << endl;
//[OBSOLETE]  aflowin << "[AFLOW] * D. Morgan, W. Setyawan, G. Hart, M. Jahnatek, S. Wang, O. Levy, K. Yang, J. Xue,  " << endl;
//[OBSOLETE]  aflowin << "[AFLOW] * R. Taylor, C. Calderon, C. Toher, C. Oses, J. J. Plata, D. Hicks, M. Esters,      " << endl;
//[OBSOLETE]  aflowin << "[AFLOW] * P. Nath, F. Rose, E. Gossett, E. Perim, R. Chepulskyy, K. Rasch, M. Fornari,      " << endl;
//[OBSOLETE]  aflowin << "[AFLOW] * M. Buongiorno Nardelli " << endl;
//[OBSOLETE]  aflowin << AFLOWIN_SEPARATION_LINE << endl; // [AFLOW] **************************************************
//[OBSOLETE]  aflowin << "[AFLOW] Aflow automatically generated (aflow_avasp.cpp) " << endl;
//[OBSOLETE]  aflowin << "[AFLOW] GENERATOR = " << XHOST.user << " " << endl;  //CO20180622
//[OBSOLETE]  aflowin << AFLOWIN_SEPARATION_LINE << endl; // [AFLOW] **************************************************
//[OBSOLETE]  aflowin << AFLOWIN_SEPARATION_LINE << endl; // [AFLOW] **************************************************
//[OBSOLETE]  aflowin << "[AFLOW]SYSTEM=" << system << endl;
//[OBSOLETE]  if(xvasp.AVASP_prototype_mode==LIBRARY_MODE_PROTOTYPE || xvasp.AVASP_prototype_mode==LIBRARY_MODE_XSTRUCTURE)
//[OBSOLETE]    aflowin << "[AFLOW]FORMULA=" << formula << endl;
//[OBSOLETE]  if(xvasp.str.species.size()==1)
//[OBSOLETE]    aflowin << "#[AFLOW] single element calculation" << endl;
//[OBSOLETE]  aflowin << AFLOWIN_SEPARATION_LINE << endl; // [AFLOW] **************************************************
//[OBSOLETE]  aflowin << "[AFLOW] input file for aflow " << endl;
//[OBSOLETE]  aflowin << "[AFLOW_MODE=VASP] " << endl;
//[OBSOLETE]  aflowin << AFLOWIN_SEPARATION_LINE << endl; // [AFLOW] **************************************************
//[OBSOLETE]  aflowin << "[AFLOW_MODE_ZIP="+DEFAULT_KZIP_BIN+"] " << endl;
//[OBSOLETE]  aflowin << "[AFLOW_MODE_BINARY=" << DEFAULT_VASP_BIN << "] " << endl;
//[OBSOLETE]  aflowin << AFLOWIN_SEPARATION_LINE << endl; // [AFLOW] **************************************************
//[OBSOLETE]  aflowin << AFLOWIN_SEPARATION_LINE << endl; // [AFLOW] **************************************************
//[OBSOLETE]  if(xvasp.AVASP_flag_MPI || XHOST.MPI) {
//[OBSOLETE]    aflowin << "[AFLOW_MODE_MPI]" << endl;
//[OBSOLETE]  } else {
//[OBSOLETE]    aflowin << "#[AFLOW_MODE_MPI]" << endl;
//[OBSOLETE]  }
//[OBSOLETE]  string NCPUS_VAL="MAX";
//[OBSOLETE]  if(XHOST.vflag_control.flag("XPLUG_NUM_THREADS")) NCPUS_VAL=XHOST.vflag_control.getattachedscheme("XPLUG_NUM_THREADS");
//[OBSOLETE]  aflowin << "[AFLOW_MODE_MPI_MODE]NCPUS=" << NCPUS_VAL << " " << endl;
//[OBSOLETE]#ifdef MPI_LAM
//[OBSOLETE]  aflowin << "[AFLOW_MODE_MPI_MODE]START=\"lamboot\" " << endl;
//[OBSOLETE]  aflowin << "[AFLOW_MODE_MPI_MODE]STOP=\"lamhalt\" " << endl;
//[OBSOLETE]#endif
//[OBSOLETE]  aflowin << "[AFLOW_MODE_MPI_MODE]COMMAND =\"" << MPI_COMMAND_DEFAULT << "\" " << endl;
//[OBSOLETE]  aflowin << "[AFLOW_MODE_MPI_MODE]AUTOTUNE " << endl;
//[OBSOLETE]  aflowin << "[AFLOW_MODE_MPI_MODE]BINARY=\"" << DEFAULT_VASP_MPI_BIN << "\" " << endl;
//[OBSOLETE]  aflowin << AFLOWIN_SEPARATION_LINE << endl; // [AFLOW] **************************************************
//[OBSOLETE]  // SYMMETRY WRITE
//[OBSOLETE]  if(!xvasp.aopts.flag("FLAGS::AVASP_SYMMETRY=OFF")) {
//[OBSOLETE]    aflowin << aurostd::PaddedPOST("[AFLOW_SYMMETRY]CALC ",_AFLOWINPAD_) << " // README_AFLOW_SYM.TXT" << endl; //CO20180214
//[OBSOLETE]    aflowin << aurostd::PaddedPOST("#[AFLOW_SYMMETRY]SGROUP_WRITE ",_AFLOWINPAD_) << " // README_AFLOW_SYM.TXT" << endl; //CO20180214
//[OBSOLETE]    aflowin << aurostd::PaddedPOST("#[AFLOW_SYMMETRY]SGROUP_RADIUS=7.77 ",_AFLOWINPAD_) << " // README_AFLOW_SYM.TXT" << endl; //CO20180214
//[OBSOLETE]    //aflowin << "[AFLOW_SYMMETRY]CALC " << endl;
//[OBSOLETE]    //aflowin << "#[AFLOW_SYMMETRY]SGROUP_WRITE " << endl;
//[OBSOLETE]    //aflowin << "#[AFLOW_SYMMETRY]SGROUP_RADIUS=7.77 " << endl;
//[OBSOLETE]    aflowin << AFLOWIN_SEPARATION_LINE << endl; // [AFLOW] **************************************************
//[OBSOLETE]  }
//[OBSOLETE]  // NEIGHBORS WRITE
//[OBSOLETE]  //DX20210122 [OBSOLETE] if(!xvasp.aopts.flag("FLAGS::AVASP_NEIGHBORS=OFF")) {
//[OBSOLETE]  //DX20210122 [OBSOLETE]   aflowin << aurostd::PaddedPOST("#[AFLOW_NEIGHBOURS]CALC ",_AFLOWINPAD_) << " // README_AFLOW.TXT" << endl; //CO20180214
//[OBSOLETE]  //DX20210122 [OBSOLETE]   aflowin << aurostd::PaddedPOST("[AFLOW_NEIGHBOURS]RADIUS=7.7 ",_AFLOWINPAD_) << " // README_AFLOW.TXT" << endl; //CO20180214
//[OBSOLETE]  //DX20210122 [OBSOLETE]   aflowin << aurostd::PaddedPOST("[AFLOW_NEIGHBOURS]DRADIUS=0.1 ",_AFLOWINPAD_) << " // README_AFLOW.TXT" << endl; //CO20180214
//[OBSOLETE]  //DX20210122 [OBSOLETE]   //aflowin << "#[AFLOW_NEIGHBOURS]CALC " << endl;
//[OBSOLETE]  //DX20210122 [OBSOLETE]   //aflowin << "[AFLOW_NEIGHBOURS]RADIUS=7.7 " << endl;
//[OBSOLETE]  //DX20210122 [OBSOLETE]   //aflowin << "[AFLOW_NEIGHBOURS]DRADIUS=0.1 " << endl;
//[OBSOLETE]  //DX20210122 [OBSOLETE]   aflowin << AFLOWIN_SEPARATION_LINE << endl; // [AFLOW] **************************************************
//[OBSOLETE]  //DX20210122 [OBSOLETE] }
//[OBSOLETE]  string MODULE = aurostd::toupper(xvasp.aopts.getattachedscheme("AFLOWIN_FLAG::MODULE"));
//[OBSOLETE]  // APL WRITING
//[OBSOLETE]  if(!xvasp.aopts.flag("FLAGS::AVASP_APL=OFF")) { //CO20180214 - I interpret this flag to refer to WRITING APL options, not if they are on
//[OBSOLETE]    aflowin << aurostd::PaddedPOST((MODULE=="APL"?string(""):string("#"))+"[AFLOW_APL]CALC ",_AFLOWINPAD_) << " // README_AFLOW_APL.TXT" << endl; //CO20180214
//[OBSOLETE]    aflowin << aurostd::PaddedPOST("[AFLOW_APL]ENGINE=DM",_AFLOWINPAD_) << " // README_AFLOW_APL.TXT" << endl;
//[OBSOLETE]    aflowin << aurostd::PaddedPOST("[AFLOW_APL]DMAG=0.015",_AFLOWINPAD_) << " // README_AFLOW_APL.TXT" << endl;
//[OBSOLETE]    //DX+CO START
//[OBSOLETE]    aflowin << aurostd::PaddedPOST((xvasp.aopts.flag("AFLOWIN_FLAG::APL_SUPERCELL")?string("#"):string(""))+"[AFLOW_APL]MINATOMS=100",_AFLOWINPAD_) << " // README_AFLOW_APL.TXT" << endl;
//[OBSOLETE]    aflowin << aurostd::PaddedPOST((xvasp.aopts.flag("AFLOWIN_FLAG::APL_SUPERCELL")?string(""):string("#"))+"[AFLOW_APL]SUPERCELL="+
//[OBSOLETE]        (xvasp.aopts.flag("AFLOWIN_FLAG::APL_SUPERCELL")?xvasp.aopts.getattachedscheme("AFLOWIN_FLAG::APL_SUPERCELL"):"3x3x3"),_AFLOWINPAD_) << " // README_AFLOW_APL.TXT" << endl;  //CO20180214
//[OBSOLETE]    aflowin << aurostd::PaddedPOST("[AFLOW_APL]DC=y",_AFLOWINPAD_) << " // README_AFLOW_APL.TXT" << endl;
//[OBSOLETE]    aflowin << aurostd::PaddedPOST("[AFLOW_APL]DPM=y",_AFLOWINPAD_) << " // README_AFLOW_APL.TXT" << endl;
//[OBSOLETE]    aflowin << aurostd::PaddedPOST("[AFLOW_APL]ZEROSTATE=y",_AFLOWINPAD_) << " // README_AFLOW_APL.TXT" << endl;
//[OBSOLETE]    //DX+CO END
//[OBSOLETE]    aflowin << aurostd::PaddedPOST("[AFLOW_APL]DOS=y",_AFLOWINPAD_) << " // README_AFLOW_APL.TXT" << endl;
//[OBSOLETE]    aflowin << aurostd::PaddedPOST("[AFLOW_APL]TP=y",_AFLOWINPAD_) << " // README_AFLOW_APL.TXT" << endl;
//[OBSOLETE]    aflowin << aurostd::PaddedPOST("[AFLOW_APL]TPT=0:2000:10",_AFLOWINPAD_) << " // README_AFLOW_APL.TXT" << endl;
//[OBSOLETE]    aflowin << AFLOWIN_SEPARATION_LINE << endl; // [AFLOW] **************************************************
//[OBSOLETE]  }
//[OBSOLETE]  if(!xvasp.aopts.flag("FLAGS::AVASP_QHA=OFF")) {
//[OBSOLETE]    aflowin << aurostd::PaddedPOST((MODULE=="QHA"?string(""):string("#"))+"[AFLOW_QHA]CALC ",_AFLOWINPAD_) << " // README_AFLOW_APL.TXT" << endl;
//[OBSOLETE]    aflowin << aurostd::PaddedPOST("[AFLOW_QHA]MODE=QHA3P",_AFLOWINPAD_) << " // README_AFLOW_APL.TXT" << endl;
//[OBSOLETE]    aflowin << aurostd::PaddedPOST("[AFLOW_QHA]EOS=y",_AFLOWINPAD_) << " // README_AFLOW_APL.TXT" << endl;
//[OBSOLETE]    //[OBSOLETE PN20180717]aflowin << aurostd::PaddedPOST("[AFLOW_QHA]SCQHA=y",_AFLOWINPAD_) << " // README_AFLOW_QHA_SCQHA_QHA3P.TXT" << endl;
//[OBSOLETE]    //[OBSOLETE PN20180717]aflowin << aurostd::PaddedPOST("[AFLOW_QHA]GP_DISTORTION=0.03",_AFLOWINPAD_) << " // README_AFLOW_QHA_SCQHA_QHA3P.TXT" << endl;
//[OBSOLETE]    //[OBSOLETE PN20180717]aflowin << aurostd::PaddedPOST("[AFLOW_QHA]SCQHA_DISTORTION=3",_AFLOWINPAD_) << " // README_AFLOW_QHA_SCQHA_QHA3P.TXT" << endl;
//[OBSOLETE]    //[OBSOLETE PN20180717]aflowin << aurostd::PaddedPOST("[AFLOW_QHA]EOS_DISTORTION_RANGE=-3:6:1",_AFLOWINPAD_) << " // README_AFLOW_QHA_SCQHA_QHA3P.TXT" << endl;
//[OBSOLETE]    //[OBSOLETE PN20180717]aflowin << aurostd::PaddedPOST("[AFLOW_QHA]SCQHA_PDIS_T=50,100,200",_AFLOWINPAD_) << " // README_AFLOW_QHA_SCQHA_QHA3P.TXT" << endl;
//[OBSOLETE]    //[OBSOLETE CO20180705]aflowin << aurostd::PaddedPOST("[AFLOW_QHA]GP_VOL_DISTORTION_PERCENTAGE=0.03",_AFLOWINPAD_) << " // README_AFLOW_APL.TXT" << endl;
//[OBSOLETE]    //[OBSOLETE CO20180705]aflowin << aurostd::PaddedPOST("[AFLOW_QHA]DISPLACEMENTS=y",_AFLOWINPAD_) << " // README_AFLOW_APL.TXT" << endl;
//[OBSOLETE]    //[OBSOLETE CO20180705]aflowin << aurostd::PaddedPOST("[AFLOW_QHA]PROJECTION_DIR=1:1:1",_AFLOWINPAD_) << " // README_AFLOW_APL.TXT" << endl;
//[OBSOLETE]    //[OBSOLETE CO20180705]aflowin << aurostd::PaddedPOST("[AFLOW_QHA]EOS=n",_AFLOWINPAD_) << " // README_AFLOW_APL.TXT" << endl;
//[OBSOLETE]    //[OBSOLETE CO20180705]aflowin << aurostd::PaddedPOST("[AFLOW_QHA]EOS_VOLRANGE_DIST=-2:4:0.5",_AFLOWINPAD_) << " // README_AFLOW_APL.TXT" << endl;
//[OBSOLETE]    //[OBSOLETE CO20180705]aflowin << aurostd::PaddedPOST("[AFLOW_QHA]EOS_KPOINTS_MODE=32768:10000:20:100000",_AFLOWINPAD_) << " // README_AFLOW_APL.TXT" << endl;
//[OBSOLETE]    aflowin << AFLOWIN_SEPARATION_LINE << endl; // [AFLOW] **************************************************
//[OBSOLETE]  }
//[OBSOLETE]  if(!xvasp.aopts.flag("FLAGS::AVASP_AAPL=OFF")) {
//[OBSOLETE]    aflowin << aurostd::PaddedPOST((MODULE=="AAPL"?string(""):string("#"))+"[AFLOW_AAPL]CALC ",_AFLOWINPAD_) << " // README_AFLOW_APL.TXT" << endl;
//[OBSOLETE]    aflowin << aurostd::PaddedPOST("[AFLOW_AAPL]TDMAG=0.015",_AFLOWINPAD_) << " // README_AFLOW_APL.TXT" << endl;
//[OBSOLETE]    aflowin << aurostd::PaddedPOST("[AFLOW_AAPL]CUT_SHELL=4",_AFLOWINPAD_) << " // README_AFLOW_APL.TXT" << endl;
//[OBSOLETE]    aflowin << aurostd::PaddedPOST("[AFLOW_AAPL]CUT_RAD=4.5",_AFLOWINPAD_) << " // README_AFLOW_APL.TXT" << endl;
//[OBSOLETE]    aflowin << aurostd::PaddedPOST("[AFLOW_AAPL]SUMRULE=1E-5",_AFLOWINPAD_) << " // README_AFLOW_APL.TXT" << endl;
//[OBSOLETE]    aflowin << aurostd::PaddedPOST("[AFLOW_AAPL]BTE=FULL",_AFLOWINPAD_) << " // README_AFLOW_APL.TXT" << endl;
//[OBSOLETE]    aflowin << aurostd::PaddedPOST("[AFLOW_AAPL]THERMALGRID=21x21x21",_AFLOWINPAD_) << " // README_AFLOW_APL.TXT" << endl;
//[OBSOLETE]    aflowin << aurostd::PaddedPOST("[AFLOW_AAPL]ISOTOPE=y",_AFLOWINPAD_) << " // README_AFLOW_APL.TXT" << endl;
//[OBSOLETE]    aflowin << aurostd::PaddedPOST("[AFLOW_AAPL]CUMULATIVEK=y",_AFLOWINPAD_) << " // README_AFLOW_APL.TXT" << endl;
//[OBSOLETE]    aflowin << aurostd::PaddedPOST("[AFLOW_AAPL]BOUNDARY=n",_AFLOWINPAD_) << " // README_AFLOW_APL.TXT" << endl;
//[OBSOLETE]    aflowin << aurostd::PaddedPOST("[AFLOW_AAPL]NANO_SIZE=100",_AFLOWINPAD_) << " // README_AFLOW_APL.TXT" << endl;
//[OBSOLETE]    aflowin << aurostd::PaddedPOST("[AFLOW_AAPL]TCT=200:700:20",_AFLOWINPAD_) << " // README_AFLOW_APL.TXT" << endl;
//[OBSOLETE]    aflowin << AFLOWIN_SEPARATION_LINE << endl; // [AFLOW] **************************************************
//[OBSOLETE]  }
//[OBSOLETE]  if(0) {
//[OBSOLETE]    if(xvasp.str.species.size()==1 || xvasp.AVASP_prototype_mode==LIBRARY_MODE_HTQC || xvasp.AVASP_prototype_mode==LIBRARY_MODE_HTQC_ICSD) {
//[OBSOLETE]      xvasp.AVASP_flag_RUN_RELAX=FALSE;
//[OBSOLETE]      xvasp.AVASP_flag_RUN_RELAX_STATIC_BANDS=TRUE;
//[OBSOLETE]    }
//[OBSOLETE]  }
//[OBSOLETE]
//[OBSOLETE]  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " " << "[12.3]" << endl;
//[OBSOLETE]
//[OBSOLETE]  // RELAX WRITING
//[OBSOLETE]  if(xvasp.AVASP_flag_RUN_RELAX) aflowin << aurostd::PaddedPOST("[VASP_RUN]RELAX=2",_AFLOWINPAD_);
//[OBSOLETE]  if(xvasp.AVASP_flag_RUN_RELAX_STATIC) aflowin << aurostd::PaddedPOST("[VASP_RUN]RELAX_STATIC=2",_AFLOWINPAD_);
//[OBSOLETE]  if(xvasp.AVASP_flag_RUN_RELAX_STATIC_BANDS) aflowin << aurostd::PaddedPOST("[VASP_RUN]RELAX_STATIC_BANDS=2",_AFLOWINPAD_);
//[OBSOLETE]  if(xvasp.AVASP_flag_RUN_STATIC_BANDS) aflowin << aurostd::PaddedPOST("[VASP_RUN]STATIC_BANDS",_AFLOWINPAD_);
//[OBSOLETE]  if(xvasp.AVASP_flag_RUN_STATIC) aflowin << aurostd::PaddedPOST("[VASP_RUN]STATIC",_AFLOWINPAD_);
//[OBSOLETE]  if(xvasp.AVASP_flag_GENERATE) aflowin << aurostd::PaddedPOST("[VASP_RUN]GENERATE",_AFLOWINPAD_);
//[OBSOLETE]  aflowin << " // GENERATE | STATIC | RELAX=N | RELAX_STATIC=N | STATIC_BANDS | RELAX_STATIC_BANDS=N | REPEAT_STATIC | REPEAT_STATIC_BANDS | REPEAT_BANDS [,DS[,DD[,DSCF]]] " << endl;
//[OBSOLETE]
//[OBSOLETE]  if(xvasp.AVASP_flag_RUN_RELAX_STATIC ||
//[OBSOLETE]      xvasp.AVASP_flag_RUN_RELAX_STATIC_BANDS ||
//[OBSOLETE]      xvasp.AVASP_flag_RUN_STATIC_BANDS ||
//[OBSOLETE]      xvasp.AVASP_flag_RUN_STATIC) {
//[OBSOLETE]    if(aurostd::substring2bool(xvasp.AVASP_potential,"pot_LDA")) aflowin << "[VASP_FORCE_OPTION]RWIGS_STATIC" << endl; // dont need for paw
//[OBSOLETE]    if(aurostd::substring2bool(xvasp.AVASP_potential,"pot_GGA")) aflowin << "[VASP_FORCE_OPTION]RWIGS_STATIC" << endl; // dont need for paw
//[OBSOLETE]  }
//[OBSOLETE]
//[OBSOLETE]  // KPOINTS WRITING
//[OBSOLETE]  if(xvasp.AVASP_value_NSW>0) {
//[OBSOLETE]    aflowin << "[VASP_FORCE_OPTION]NSW=101 " << endl;
//[OBSOLETE]  }
//[OBSOLETE]
//[OBSOLETE]  // NOMIX WRITING
//[OBSOLETE]  if(xvasp.aopts.flag("FLAG::AVASP_SKIP_NOMIX")) {
//[OBSOLETE]    aflowin << "[VASP_FORCE_OPTION]NEGLECT_NOMIX " << endl;
//[OBSOLETE]  } else {
//[OBSOLETE]    aflowin << "#[VASP_FORCE_OPTION]NEGLECT_NOMIX " << endl;
//[OBSOLETE]  }
//[OBSOLETE]
//[OBSOLETE]  // WAVECAR WRITING
//[OBSOLETE]  if(xvasp.aopts.flag("FLAG::AVASP_WAVECAR")) {
//[OBSOLETE]    aflowin << aurostd::PaddedPOST("[VASP_FORCE_OPTION]WAVECAR=ON",_AFLOWINPAD_) << " // ON | OFF (default OFF)" << endl;
//[OBSOLETE]  } else {
//[OBSOLETE]    //aflowin << aurostd::PaddedPOST("[VASP_FORCE_OPTION]WAVECAR=OFF",_AFLOWINPAD_) << " // ON | OFF (default OFF)" << endl;
//[OBSOLETE]  }
//[OBSOLETE]
//[OBSOLETE]  // CHGCAR WRITING
//[OBSOLETE]  // CO+ME20220311 - Always write CHGCAR settings. While this may increase the size of the aflow.in, some
//[OBSOLETE]  // settings are necessary to ensure portability of the aflow.in file. In this case, relying on the
//[OBSOLETE]  // default can result in GBs of potentially unwanted data when moving aflow.in files between systems
//[OBSOLETE]  if(xvasp.aopts.flag("FLAG::AVASP_CHGCAR")) {
//[OBSOLETE]    aflowin << aurostd::PaddedPOST("[VASP_FORCE_OPTION]CHGCAR=ON",_AFLOWINPAD_) << " // ON | OFF (default ON)" << endl;
//[OBSOLETE]  } else {
//[OBSOLETE]    aflowin << aurostd::PaddedPOST("[VASP_FORCE_OPTION]CHGCAR=OFF",_AFLOWINPAD_) << " // ON | OFF (default ON)" << endl;
//[OBSOLETE]  }
//[OBSOLETE]
//[OBSOLETE]  // KPOINTS WRITING
//[OBSOLETE]  aflowin << aurostd::PaddedPOST("#[VASP_FORCE_OPTION]KPOINTS=keyword[,keyword]",_AFLOWINPAD_) << " // EVEN | ODD | KSHIFT_GAMMA_EVEN | KSHIFT_GAMMA_ODD | KSCHEME_MONKHORST_PACK | KSCHEME_GAMMA | GAMMA | KEEPK | IBZKPT" << endl;
//[OBSOLETE]
//[OBSOLETE]  aflowin << aurostd::PaddedPOST("[VASP_FORCE_OPTION]SYM=ON",_AFLOWINPAD_) << " // ON | OFF  (default ON)" << endl;
//[OBSOLETE]
//[OBSOLETE]  string aus_PP="";
//[OBSOLETE]  if(xvasp.AVASP_potential==DEFAULT_VASP_POTCAR_DIR_POT_LDA) aus_PP="pot_LDA";
//[OBSOLETE]  if(xvasp.AVASP_potential==DEFAULT_VASP_POTCAR_DIR_POT_GGA) aus_PP="pot_GGA";
//[OBSOLETE]  if(xvasp.AVASP_potential==DEFAULT_VASP_POTCAR_DIR_POT_PBE) aus_PP="pot_PBE";
//[OBSOLETE]  if(xvasp.AVASP_potential==DEFAULT_VASP_POTCAR_DIR_POTPAW_LDA) aus_PP="potpaw_LDA";
//[OBSOLETE]  if(xvasp.AVASP_potential==DEFAULT_VASP_POTCAR_DIR_POTPAW_GGA) aus_PP="potpaw_GGA";
//[OBSOLETE]  if(xvasp.AVASP_potential==DEFAULT_VASP_POTCAR_DIR_POTPAW_PBE) aus_PP="potpaw_PBE";
//[OBSOLETE]  if(xvasp.AVASP_potential==DEFAULT_VASP_POTCAR_DIR_POTPAW_LDA_KIN) aus_PP="potpaw_LDA_KIN";
//[OBSOLETE]  if(xvasp.AVASP_potential==DEFAULT_VASP_POTCAR_DIR_POTPAW_PBE_KIN) aus_PP="potpaw_PBE_KIN";
//[OBSOLETE]
//[OBSOLETE]  if(xvasp.aopts.flag("FLAG::AVASP_AUTO_PSEUDOPOTENTIALS")) {
//[OBSOLETE]    aflowin << aurostd::PaddedPOST("[VASP_FORCE_OPTION]AUTO_PSEUDOPOTENTIALS="+aus_PP,_AFLOWINPAD_) << " // pot_LDA | pot_GGA | potpaw_LDA | potpaw_GGA | potpaw_PBE | potpaw_LDA_KIN | potpaw_PBE_KIN  " << endl;
//[OBSOLETE]
//[OBSOLETE]  } else {
//[OBSOLETE]    //   cerr << __AFLOW_FUNC__ << " AUTO_PSEUDOPOTENTIALS=FALSE" << endl;
//[OBSOLETE]    aflowin << aurostd::PaddedPOST("#[VASP_FORCE_OPTION]AUTO_PSEUDOPOTENTIALS="+aus_PP,_AFLOWINPAD_) << " // pot_LDA | pot_GGA | potpaw_LDA | potpaw_GGA | potpaw_PBE | potpaw_LDA_KIN | potpaw_PBE_KIN  " << endl;
//[OBSOLETE]  }
//[OBSOLETE]
//[OBSOLETE]  // NBANDS WRITING
//[OBSOLETE]  if(xvasp.aopts.flag("AFLOWIN_FLAG::NBANDS")) {
//[OBSOLETE]    aflowin << aurostd::PaddedPOST("[VASP_FORCE_OPTION]NBANDS",_AFLOWINPAD_) << " // Estimate Bands (better than VASP)" << endl;
//[OBSOLETE]  } else {
//[OBSOLETE]    //  aflowin << aurostd::PaddedPOST("#[VASP_FORCE_OPTION]NBANDS",_AFLOWINPAD_) << " // Estimate Bands (better than VASP)" << endl;
//[OBSOLETE]  }
//[OBSOLETE]
//[OBSOLETE]  // PSTRESS WRITING
//[OBSOLETE]  if(xvasp.aopts.flag("AFLOWIN_FLAG::PSTRESS")) {
//[OBSOLETE]    double PSTRESS=aurostd::string2utype<double>(xvasp.aopts.getattachedscheme("AFLOWIN_FLAG::PSTRESS"));
//[OBSOLETE]    aflowin << aurostd::PaddedPOST("[VASP_FORCE_OPTION]PSTRESS="+aurostd::utype2string(PSTRESS,_AVASP_DOUBLE2STRING_PRECISION_),_AFLOWINPAD_) << " // Pressure in kBar (1kB=0.1GPa)" << endl;
//[OBSOLETE]  } else {
//[OBSOLETE]    aflowin << aurostd::PaddedPOST("#[VASP_FORCE_OPTION]PSTRESS=0.0",_AFLOWINPAD_) << " // Pressure in kBar (1kB=0.1GPa)" << endl;
//[OBSOLETE]  }
//[OBSOLETE]
//[OBSOLETE]  // EDIFFG WRITING
//[OBSOLETE]  if(xvasp.aopts.flag("AFLOWIN_FLAG::EDIFFG")) {
//[OBSOLETE]    double EDIFFG=aurostd::string2utype<double>(xvasp.aopts.getattachedscheme("AFLOWIN_FLAG::EDIFFG"));
//[OBSOLETE]    aflowin << aurostd::PaddedPOST("[VASP_FORCE_OPTION]EDIFFG="+aurostd::utype2string(EDIFFG,_AVASP_DOUBLE2STRING_PRECISION_),_AFLOWINPAD_) << " // EDIFFG for relaxed forces" << endl;
//[OBSOLETE]  } else {
//[OBSOLETE]    aflowin << aurostd::PaddedPOST("#[VASP_FORCE_OPTION]EDIFFG="+aurostd::utype2string(DEFAULT_VASP_PREC_EDIFFG,_AVASP_DOUBLE2STRING_PRECISION_),_AFLOWINPAD_) << " // EDIFFG for relaxed forces" << endl;
//[OBSOLETE]  }
//[OBSOLETE]
//[OBSOLETE]  // ENMAX_MULTIPLY WRITING
//[OBSOLETE]  if(xvasp.aopts.flag("AFLOWIN_FLAG::ENMAX_MULTIPLY")) {
//[OBSOLETE]    double ENMAX_MULTIPLY=aurostd::string2utype<double>(xvasp.aopts.getattachedscheme("AFLOWIN_FLAG::ENMAX_MULTIPLY"));
//[OBSOLETE]    aflowin << aurostd::PaddedPOST("[VASP_FORCE_OPTION]ENMAX_MULTIPLY="+aurostd::utype2string(ENMAX_MULTIPLY,_AVASP_DOUBLE2STRING_PRECISION_),_AFLOWINPAD_) << " // extra multiplication" << endl;
//[OBSOLETE]  } else {
//[OBSOLETE]    aflowin << aurostd::PaddedPOST("#[VASP_FORCE_OPTION]ENMAX_MULTIPLY="+aurostd::utype2string(DEFAULT_VASP_PREC_ENMAX_HIGH,4),_AFLOWINPAD_) << " // Multiplication of the max(pseudopotential_cutoffs)" << endl;
//[OBSOLETE]  }
//[OBSOLETE]
//[OBSOLETE]  // POTIM WRITING
//[OBSOLETE]  if(xvasp.aopts.flag("AFLOWIN_FLAG::POTIM")) {
//[OBSOLETE]    double POTIM=aurostd::string2utype<double>(xvasp.aopts.getattachedscheme("AFLOWIN_FLAG::POTIM"));
//[OBSOLETE]    aflowin << aurostd::PaddedPOST("[VASP_FORCE_OPTION]POTIM="+aurostd::utype2string(POTIM,_AVASP_DOUBLE2STRING_PRECISION_),_AFLOWINPAD_) << " // for ionic time-step" << endl;
//[OBSOLETE]  } else {
//[OBSOLETE]    aflowin << aurostd::PaddedPOST("#[VASP_FORCE_OPTION]POTIM="+aurostd::utype2string(DEFAULT_VASP_PREC_POTIM,_AVASP_DOUBLE2STRING_PRECISION_),_AFLOWINPAD_) << " // ionic time-step" << endl;
//[OBSOLETE]  }
//[OBSOLETE]
//[OBSOLETE]  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " " << "[12.4]" << endl;
//[OBSOLETE]
//[OBSOLETE]  // SPIN WRITING
//[OBSOLETE]  if(AFLOWIN_OLD) { // OLD
//[OBSOLETE]    if(xvasp.aopts.flag("FLAG::AVASP_SPIN")) {
//[OBSOLETE]      aflowin << aurostd::PaddedPOST("[VASP_FORCE_OPTION]SPIN=ON",_AFLOWINPAD_) << " // ON | OFF  (default NEGLECT)" << endl;
//[OBSOLETE]      aflowin << "[VASP_FORCE_OPTION]SPIN_REMOVE_RELAX_1 " << endl;
//[OBSOLETE]    } else {
//[OBSOLETE]      aflowin << aurostd::PaddedPOST("[VASP_FORCE_OPTION]SPIN=OFF",_AFLOWINPAD_) << " // ON | OFF  (default NEGLECT)" << endl;
//[OBSOLETE]    }
//[OBSOLETE]  }
//[OBSOLETE]  if(AFLOWIN_NEW) { // NEW
//[OBSOLETE]    vector<string> vstr;string tstr;
//[OBSOLETE]    vstr.clear();tstr="";
//[OBSOLETE]    if(xvasp.aopts.flag("FLAG::AVASP_SPIN"))  vstr.push_back("ON");
//[OBSOLETE]    if(!xvasp.aopts.flag("FLAG::AVASP_SPIN")) vstr.push_back("OFF");
//[OBSOLETE]    if(xvasp.aopts.flag("FLAG::AVASP_SPIN") && xvasp.aopts.flag("FLAG::AVASP_SPIN_REMOVE_RELAX_1")) vstr.push_back("REMOVE_RELAX_1");
//[OBSOLETE]    if(xvasp.aopts.flag("FLAG::AVASP_SPIN") && xvasp.aopts.flag("FLAG::AVASP_SPIN_REMOVE_RELAX_2")) vstr.push_back("REMOVE_RELAX_2");
//[OBSOLETE]    if(vstr.size()>0) {
//[OBSOLETE]      for(uint i=0;i<vstr.size();i++) tstr+=vstr.at(i)+(i!=vstr.size()-1 ? "," : " ");
//[OBSOLETE]      aflowin << aurostd::PaddedPOST("[VASP_FORCE_OPTION]SPIN="+tstr,_AFLOWINPAD_) << " // (ON | OFF  (default DEFAULT_VASP_FORCE_OPTION_SPIN in .aflow.rc)), REMOVE_RELAX_1 | _2 (default: DEFAULT_VASP_FORCE_OPTION_SPIN_REMOVE_RELAX_1 _2 in .aflow.rc)" << endl;
//[OBSOLETE]    }
//[OBSOLETE]  }
//[OBSOLETE]
//[OBSOLETE]  // BADER WRITING
//[OBSOLETE]  // CO+ME20220311 - Always write Bader settings. While this may increase the size of the aflow.in, some
//[OBSOLETE]  // settings are necessary to ensure portability of the aflow.in file. In this case, relying on the
//[OBSOLETE]  // default can result in GBs of potentially unwanted data when moving aflow.in files between systems
//[OBSOLETE]  if(xvasp.aopts.flag("FLAG::AVASP_BADER")) {
//[OBSOLETE]    aflowin << aurostd::PaddedPOST("[VASP_FORCE_OPTION]BADER=ON",_AFLOWINPAD_) << " // ON | OFF (default OFF)" << endl;
//[OBSOLETE]  } else {
//[OBSOLETE]    aflowin << aurostd::PaddedPOST("[VASP_FORCE_OPTION]BADER=OFF",_AFLOWINPAD_) << " // ON | OFF (default OFF)" << endl;
//[OBSOLETE]  }
//[OBSOLETE]  // ELF WRITING
//[OBSOLETE]  if(xvasp.aopts.flag("FLAG::AVASP_ELF")) {
//[OBSOLETE]    aflowin << aurostd::PaddedPOST("[VASP_FORCE_OPTION]ELF=ON",_AFLOWINPAD_) << " // ON | OFF (default OFF)" << endl;
//[OBSOLETE]  } else {
//[OBSOLETE]    //    aflowin << aurostd::PaddedPOST("[VASP_FORCE_OPTION]ELF=OFF",_AFLOWINPAD_) << " // ON | OFF (default OFF)" << endl;
//[OBSOLETE]  }
//[OBSOLETE]
//[OBSOLETE]  // LSCOUPLING WRITING
//[OBSOLETE]  if(xvasp.aopts.flag("FLAG::AVASP_LSCOUPLING")) {
//[OBSOLETE]    aflowin << aurostd::PaddedPOST("[VASP_FORCE_OPTION]LSCOUPLING=ON",_AFLOWINPAD_) << " // ON | OFF (default OFF)" << endl;
//[OBSOLETE]  } else {
//[OBSOLETE]    // aflowin << aurostd::PaddedPOST("[VASP_FORCE_OPTION]LSCOUPLING=OFF",_AFLOWINPAD_) << " // ON | OFF (default OFF)" << endl;
//[OBSOLETE]  }
//[OBSOLETE]
//[OBSOLETE]  // MAGMOM WRITING
//[OBSOLETE]  if(xvasp.aopts.flag("FLAG::AVASP_AUTO_MAGMOM")) {
//[OBSOLETE]    aflowin << aurostd::PaddedPOST("[VASP_FORCE_OPTION]AUTO_MAGMOM=ON",_AFLOWINPAD_) << " // ON | OFF (default OFF)" << endl;
//[OBSOLETE]  } else {
//[OBSOLETE]    aflowin << aurostd::PaddedPOST("#[VASP_FORCE_OPTION]AUTO_MAGMOM=ON",_AFLOWINPAD_) << " // ON | OFF (default OFF)" << endl;
//[OBSOLETE]  }
//[OBSOLETE]
//[OBSOLETE]  // RELAX_TYPE
//[OBSOLETE]  if(xvasp.aopts.flag("AFLOWIN_FLAG::RELAX_TYPE")){  //CO20180214
//[OBSOLETE]    aflowin << aurostd::PaddedPOST("[VASP_FORCE_OPTION]RELAX_"+xvasp.aopts.getattachedscheme("AFLOWIN_FLAG::RELAX_TYPE"),_AFLOWINPAD_);
//[OBSOLETE]    aflowin << " // ALL | IONS | CELL_SHAPE | CELL_VOLUME | IONS_CELL_VOLUME | IONS_CELL_SHAPE " << endl;
//[OBSOLETE]  } else {
//[OBSOLETE]    // RELAX_MODE
//[OBSOLETE]    if(xvasp.aopts.flag("AFLOWIN_FLAG::RELAX_MODE")) {
//[OBSOLETE]      string RELAX_MODE=xvasp.aopts.getattachedscheme("AFLOWIN_FLAG::RELAX_MODE");
//[OBSOLETE]      //   if(RELAX_MODE.at(0)=='E' || RELAX_MODE.at(0)=='e')
//[OBSOLETE]      aflowin << aurostd::PaddedPOST("[VASP_FORCE_OPTION]RELAX_MODE="+RELAX_MODE,_AFLOWINPAD_) << " // (ENERGY | FORCES | ENERGY_FORCES | FORCES_ENERGY) (default: DEFAULT_VASP_FORCE_OPTION_RELAX_MODE_SCHEME in .aflow.rc) " << endl;
//[OBSOLETE]    } else {
//[OBSOLETE]      if(xvasp.aopts.flag("FLAG::AVASP_RELAX_FORCES")) {
//[OBSOLETE]        aflowin << aurostd::PaddedPOST("[VASP_FORCE_OPTION]RELAX_MODE=FORCES",_AFLOWINPAD_) << " // (ENERGY | FORCES | ENERGY_FORCES | FORCES_ENERGY) (default: DEFAULT_VASP_FORCE_OPTION_RELAX_MODE_SCHEME in .aflow.rc) " << endl;
//[OBSOLETE]      } else {
//[OBSOLETE]        aflowin << aurostd::PaddedPOST("[VASP_FORCE_OPTION]RELAX_MODE=ENERGY",_AFLOWINPAD_) << " // (ENERGY | FORCES | ENERGY_FORCES | FORCES_ENERGY) (default: DEFAULT_VASP_FORCE_OPTION_RELAX_MODE_SCHEME in .aflow.rc) " << endl;
//[OBSOLETE]      }
//[OBSOLETE]    }
//[OBSOLETE]  }
//[OBSOLETE]
//[OBSOLETE]  // PRECISION WRITING
//[OBSOLETE]  string PRECISION=xvasp.AVASP_flag_PRECISION_scheme;
//[OBSOLETE]  if(xvasp.str.species.size()==1) PRECISION="A";
//[OBSOLETE]  if(xvasp.aopts.flag("AFLOWIN_FLAG::PRECISION"))
//[OBSOLETE]    PRECISION=xvasp.aopts.getattachedscheme("AFLOWIN_FLAG::PRECISION");
//[OBSOLETE]  if(xvasp.aopts.flag("FLAG::PRECISION_SET") || xvasp.aopts.flag("AFLOWIN_FLAG::PRECISION")) {
//[OBSOLETE]    if(AFLOWIN_OLD) { // OLD
//[OBSOLETE]      if(PRECISION.at(0)=='L' || PRECISION.at(0)=='l')
//[OBSOLETE]        aflowin << aurostd::PaddedPOST("[VASP_FORCE_OPTION]PREC=LOW",_AFLOWINPAD_) << " // (LOW | MEDIUM | NORMAL | HIGH | ACCURATE), PRESERVED (default: DEFAULT_VASP_FORCE_OPTION_PREC_SCHEME in .aflow.rc" << endl;
//[OBSOLETE]      if(PRECISION.at(0)=='M' || PRECISION.at(0)=='m')
//[OBSOLETE]        aflowin << aurostd::PaddedPOST("[VASP_FORCE_OPTION]PREC=MEDIUM",_AFLOWINPAD_) << " // (LOW | MEDIUM | NORMAL | HIGH | ACCURATE), PRESERVED (default: DEFAULT_VASP_FORCE_OPTION_PREC_SCHEME in .aflow.rc" << endl;
//[OBSOLETE]      if(PRECISION.at(0)=='N' || PRECISION.at(0)=='n')
//[OBSOLETE]        aflowin << aurostd::PaddedPOST("[VASP_FORCE_OPTION]PREC=NORMAL",_AFLOWINPAD_) << " // (LOW | MEDIUM | NORMAL | HIGH | ACCURATE), PRESERVED (default: DEFAULT_VASP_FORCE_OPTION_PREC_SCHEME in .aflow.rc" << endl;
//[OBSOLETE]      if(PRECISION.at(0)=='H' || PRECISION.at(0)=='h')
//[OBSOLETE]        aflowin << aurostd::PaddedPOST("[VASP_FORCE_OPTION]PREC=HIGH",_AFLOWINPAD_) << " // (LOW | MEDIUM | NORMAL | HIGH | ACCURATE), PRESERVED (default: DEFAULT_VASP_FORCE_OPTION_PREC_SCHEME in .aflow.rc" << endl;
//[OBSOLETE]      if(PRECISION.at(0)=='A' || PRECISION.at(0)=='a')
//[OBSOLETE]        aflowin << aurostd::PaddedPOST("[VASP_FORCE_OPTION]PREC=ACCURATE",_AFLOWINPAD_) << " // (LOW | MEDIUM | NORMAL | HIGH | ACCURATE), PRESERVED (default: DEFAULT_VASP_FORCE_OPTION_PREC_SCHEME in .aflow.rc" << endl;
//[OBSOLETE]      aflowin << "#[VASP_FORCE_OPTION]PREC_preserved " << endl;
//[OBSOLETE]    }
//[OBSOLETE]    if(AFLOWIN_NEW) { // NEW
//[OBSOLETE]      vector<string> vstr;string tstr;
//[OBSOLETE]      vstr.clear();tstr="";
//[OBSOLETE]      if(PRECISION.at(0)=='L' || PRECISION.at(0)=='l')
//[OBSOLETE]        vstr.push_back("LOW");
//[OBSOLETE]      if(PRECISION.at(0)=='M' || PRECISION.at(0)=='m')
//[OBSOLETE]        vstr.push_back("MEDIUM");
//[OBSOLETE]      if(PRECISION.at(0)=='N' || PRECISION.at(0)=='n')
//[OBSOLETE]        vstr.push_back("NORMAL");
//[OBSOLETE]      if(PRECISION.at(0)=='H' || PRECISION.at(0)=='h')
//[OBSOLETE]        vstr.push_back("HIGH");
//[OBSOLETE]      if(PRECISION.at(0)=='A' || PRECISION.at(0)=='a')
//[OBSOLETE]        vstr.push_back("ACCURATE");
//[OBSOLETE]      if(xvasp.aopts.flag("FLAG::PRECISION_PRESERVED")) vstr.push_back("PRESERVED");
//[OBSOLETE]      if(vstr.size()>0) {
//[OBSOLETE]        for(uint i=0;i<vstr.size();i++)
//[OBSOLETE]          tstr+=vstr.at(i)+(i!=vstr.size()-1 ? "," : " ");
//[OBSOLETE]        aflowin << aurostd::PaddedPOST("[VASP_FORCE_OPTION]PREC="+tstr,_AFLOWINPAD_) << " // (LOW | MEDIUM | NORMAL | HIGH | ACCURATE), PRESERVED (default: DEFAULT_VASP_FORCE_OPTION_PREC_SCHEME in .aflow.rc)" << endl;
//[OBSOLETE]      }
//[OBSOLETE]      if(vstr.size()==0) {
//[OBSOLETE]        aflowin << aurostd::PaddedPOST("#[VASP_FORCE_OPTION]PREC=something",_AFLOWINPAD_) << " // (LOW | MEDIUM | NORMAL | HIGH | ACCURATE), PRESERVED (default: DEFAULT_VASP_FORCE_OPTION_PREC_SCHEME in .aflow.rc)" << endl;
//[OBSOLETE]      }
//[OBSOLETE]    }
//[OBSOLETE]  }
//[OBSOLETE]
//[OBSOLETE]  // ALGO WRITING
//[OBSOLETE]  string ALGORITHM=xvasp.AVASP_flag_ALGO_scheme;
//[OBSOLETE]  if(xvasp.str.species.size()==1) ALGORITHM="N";
//[OBSOLETE]  if(xvasp.aopts.flag("AFLOWIN_FLAG::ALGORITHM"))
//[OBSOLETE]    ALGORITHM=xvasp.aopts.getattachedscheme("AFLOWIN_FLAG::ALGORITHM");
//[OBSOLETE]  if(xvasp.aopts.flag("FLAG::ALGO_SET") || xvasp.aopts.flag("AFLOWIN_FLAG::ALGORITHM")) {
//[OBSOLETE]    if(AFLOWIN_OLD) { // OLD
//[OBSOLETE]      if(ALGORITHM.at(0)=='N' || ALGORITHM.at(0)=='n')
//[OBSOLETE]        aflowin << aurostd::PaddedPOST("[VASP_FORCE_OPTION]ALGO=NORMAL",_AFLOWINPAD_) << " // (NORMAL | VERYFAST | FAST | ALL | DAMPED), PRESERVED (default: DEFAULT_VASP_FORCE_OPTION_ALGO_SCHEME in .aflow.rc)" << endl;
//[OBSOLETE]      if(ALGORITHM.at(0)=='V' || ALGORITHM.at(0)=='v')
//[OBSOLETE]        aflowin << aurostd::PaddedPOST("[VASP_FORCE_OPTION]ALGO=VERYFAST",_AFLOWINPAD_) << " // (NORMAL | VERYFAST | FAST | ALL | DAMPED), PRESERVED (default: DEFAULT_VASP_FORCE_OPTION_ALGO_SCHEME in .aflow.rc)" << endl;
//[OBSOLETE]      if(ALGORITHM.at(0)=='F' || ALGORITHM.at(0)=='f')
//[OBSOLETE]        aflowin << aurostd::PaddedPOST("[VASP_FORCE_OPTION]ALGO=FAST",_AFLOWINPAD_) << " // (NORMAL | VERYFAST | FAST | ALL | DAMPED), PRESERVED (default: DEFAULT_VASP_FORCE_OPTION_ALGO_SCHEME in .aflow.rc)" << endl;
//[OBSOLETE]      if(ALGORITHM.at(0)=='A' || ALGORITHM.at(0)=='a')
//[OBSOLETE]        aflowin << aurostd::PaddedPOST("[VASP_FORCE_OPTION]ALGO=ALL",_AFLOWINPAD_) << " // (NORMAL | VERYFAST | FAST | ALL | DAMPED), PRESERVED (default: DEFAULT_VASP_FORCE_OPTION_ALGO_SCHEME in .aflow.rc)" << endl;
//[OBSOLETE]      if(ALGORITHM.at(0)=='D' || ALGORITHM.at(0)=='d')
//[OBSOLETE]        aflowin << aurostd::PaddedPOST("[VASP_FORCE_OPTION]ALGO=DAMPED",_AFLOWINPAD_) << " // (NORMAL | VERYFAST | FAST | ALL | DAMPED), PRESERVED (default: DEFAULT_VASP_FORCE_OPTION_ALGO_SCHEME in .aflow.rc)" << endl;
//[OBSOLETE]      aflowin << "#[VASP_FORCE_OPTION]ALGO_PRESERVED " << endl;
//[OBSOLETE]    }
//[OBSOLETE]    if(AFLOWIN_NEW) { // NEW
//[OBSOLETE]      vector<string> vstr;string tstr;
//[OBSOLETE]      vstr.clear();tstr="";
...
//[OBSOLETE]        vstr.push_back("NORMAL");
//[OBSOLETE]      if(ALGORITHM.at(0)=='V' || ALGORITHM.at(0)=='v')
//[OBSOLETE]        vstr.push_back("VERYFAST");
//[OBSOLETE]      if(ALGORITHM.at(0)=='F' || ALGORITHM.at(0)=='f')
//[OBSOLETE]        vstr.push_back("FAST");
//[OBSOLETE]      if(ALGORITHM.at(0)=='A' || ALGORITHM.at(0)=='a')
//[OBSOLETE]        vstr.push_back("ALL");
//[OBSOLETE]      if(ALGORITHM.at(0)=='D' || ALGORITHM.at(0)=='d')
//[OBSOLETE]        vstr.push_back("DAMPED");
//[OBSOLETE]      if(xvasp.aopts.flag("FLAG::ALGO_PRESERVED")) vstr.push_back("PRESERVED");
//[OBSOLETE]      if(vstr.size()>0) {
//[OBSOLETE]        for(uint i=0;i<vstr.size();i++) tstr+=vstr.at(i)+(i!=vstr.size()-1 ? "," : " ");
//[OBSOLETE]        aflowin << aurostd::PaddedPOST("[VASP_FORCE_OPTION]ALGO="+tstr,_AFLOWINPAD_) << " // (NORMAL | VERYFAST | FAST | ALL | DAMPED), PRESERVED (default: DEFAULT_VASP_FORCE_OPTION_ALGO_SCHEME in .aflow.rc)" << endl;
//[OBSOLETE]      }
//[OBSOLETE]      if(vstr.size()==0) {
//[OBSOLETE]        aflowin << aurostd::PaddedPOST("#[VASP_FORCE_OPTION]ALGO=something",_AFLOWINPAD_) << " // (NORMAL | VERYFAST | FAST | ALL | DAMPED), PRESERVED (default: DEFAULT_VASP_FORCE_OPTION_ALGO_SCHEME in .aflow.rc)" << endl;
//[OBSOLETE]      }
//[OBSOLETE]    }
//[OBSOLETE]  }
//[OBSOLETE]
//[OBSOLETE]
//[OBSOLETE]  // METAGGA WRITING
//[OBSOLETE]  string METAGGA=DEFAULT_VASP_FORCE_OPTION_METAGGA_SCHEME; // default
//[OBSOLETE]
//[OBSOLETE]  if(xvasp.aopts.flag("AFLOWIN_FLAG::METAGGA"))
//[OBSOLETE]    METAGGA=xvasp.aopts.getattachedscheme("AFLOWIN_FLAG::METAGGA");
//[OBSOLETE]
//[OBSOLETE]  if(xvasp.aopts.flag("AFLOWIN_FLAG::METAGGA")) {
//[OBSOLETE]    vector<string> vstr;string tstr;
//[OBSOLETE]    vstr.clear();tstr="";
//[OBSOLETE]    if(aurostd::toupper(METAGGA)=="TPSS") { vstr.push_back("TPSS"); }
//[OBSOLETE]    if(aurostd::toupper(METAGGA)=="RTPSS") { vstr.push_back("RTPSS"); }
//[OBSOLETE]    if(aurostd::toupper(METAGGA)=="M06L") { vstr.push_back("M06L"); }
//[OBSOLETE]    if(aurostd::toupper(METAGGA)=="MBJL") { vstr.push_back("MBJL"); }
//[OBSOLETE]    if(aurostd::toupper(METAGGA)=="SCAN") { vstr.push_back("SCAN"); }
//[OBSOLETE]    if(aurostd::toupper(METAGGA)=="MS0") { vstr.push_back("MS0"); }
//[OBSOLETE]    if(aurostd::toupper(METAGGA)=="MS1") { vstr.push_back("MS1"); }
//[OBSOLETE]    if(aurostd::toupper(METAGGA)=="MS2") { vstr.push_back("MS2"); }
//[OBSOLETE]    if(aurostd::toupper(METAGGA)=="NONE" || aurostd::toupper(METAGGA)=="" || aurostd::toupper(METAGGA)=="OFF" || aurostd::toupper(METAGGA)=="0") { }
//[OBSOLETE]    if(vstr.size()>0) {
//[OBSOLETE]      for(uint i=0;i<vstr.size();i++)
//[OBSOLETE]        tstr+=vstr.at(i)+(i!=vstr.size()-1 ? "," : " ");
//[OBSOLETE]      aflowin << aurostd::PaddedPOST("[VASP_FORCE_OPTION]METAGGA="+tstr,_AFLOWINPAD_) << " // (TPSS | RTPSS | M06L | MBJL | SCAN | MS0 | MS1 | MS2 | NONE) (default: DEFAULT_VASP_FORCE_OPTION_METAGGA_SCHEME in .aflow.rc)" << endl;
//[OBSOLETE]    }
//[OBSOLETE]    if(vstr.size()==0) {
//[OBSOLETE]      aflowin << aurostd::PaddedPOST("#[VASP_FORCE_OPTION]METAGGA=NONE",_AFLOWINPAD_) << " // (TPSS | RTPSS | M06L | MBJL | SCAN | MS0 | MS1 | MS2 | NONE) (default: DEFAULT_VASP_FORCE_OPTION_METAGGA_SCHEME in .aflow.rc)" << endl;
//[OBSOLETE]    }
//[OBSOLETE]  } else {
//[OBSOLETE]    aflowin << aurostd::PaddedPOST("#[VASP_FORCE_OPTION]METAGGA=NONE",_AFLOWINPAD_) << " // (TPSS | RTPSS | M06L | MBJL | SCAN | MS0 | MS1 | MS2 | NONE) (default: DEFAULT_VASP_FORCE_OPTION_METAGGA_SCHEME in .aflow.rc)" << endl;
//[OBSOLETE]  }
//[OBSOLETE]
//[OBSOLETE]  // IVDW WRITING
//[OBSOLETE]  string IVDW=DEFAULT_VASP_FORCE_OPTION_IVDW_SCHEME; // default
//[OBSOLETE]
//[OBSOLETE]  if(xvasp.aopts.flag("AFLOWIN_FLAG::IVDW"))
//[OBSOLETE]    IVDW=xvasp.aopts.getattachedscheme("AFLOWIN_FLAG::IVDW");
//[OBSOLETE]
//[OBSOLETE]  if(xvasp.aopts.flag("FLAG::IVDW_SET") || xvasp.aopts.flag("AFLOWIN_FLAG::IVDW")) {
//[OBSOLETE]    vector<string> vstr;string tstr;
//[OBSOLETE]    vstr.clear();tstr="";
//[OBSOLETE]    if(aurostd::toupper(IVDW)=="OFF" || aurostd::toupper(IVDW)=="NONE" || aurostd::toupper(IVDW)=="0" || aurostd::toupper(IVDW)=="") { ; // nothing
//[OBSOLETE]    } else {
//[OBSOLETE]      vstr.push_back(aurostd::toupper(IVDW));
//[OBSOLETE]    }
//[OBSOLETE]    if(vstr.size()>0) {
//[OBSOLETE]      for(uint i=0;i<vstr.size();i++)
//[OBSOLETE]        tstr+=vstr.at(i)+(i!=vstr.size()-1 ? "," : " ");
//[OBSOLETE]      aflowin << aurostd::PaddedPOST("[VASP_FORCE_OPTION]IVDW="+tstr,_AFLOWINPAD_) << " // (number_for_VASP_see_manual_for_IVDW | 0) (default: DEFAULT_VASP_FORCE_OPTION_IVDW_SCHEME in .aflow.rc)" << endl;
//[OBSOLETE]    }
//[OBSOLETE]    if(vstr.size()==0) {
//[OBSOLETE]      aflowin << aurostd::PaddedPOST("#[VASP_FORCE_OPTION]IVDW=0",_AFLOWINPAD_) << " // (number_for_VASP_see_manual_for_IVDW | 0) (default: DEFAULT_VASP_FORCE_OPTION_IVDW_SCHEME in .aflow.rc)" << endl;
//[OBSOLETE]    }
//[OBSOLETE]  } else {
//[OBSOLETE]    aflowin << aurostd::PaddedPOST("#[VASP_FORCE_OPTION]IVDW=0",_AFLOWINPAD_) << " // (number_for_VASP_see_manual_for_IVDW | 0) (default: DEFAULT_VASP_FORCE_OPTION_IVDW_SCHEME in .aflow.rc)" << endl;
//[OBSOLETE]  }
//[OBSOLETE]
//[OBSOLETE]  // ABMIX WRITING
//[OBSOLETE]  if(xvasp.str.species.size()==1) xvasp.AVASP_flag_ABMIX_scheme="N";
//[OBSOLETE]  if(xvasp.aopts.flag("FLAG::ABMIX_SET")) { //  unspecified | [AUTO | US | PAW | #AMIX,#BMIX[,#AMIX_MAG,#BMIX_MAG]]
//[OBSOLETE]    vector<string> vstr;string tstr;
//[OBSOLETE]    vstr.clear();tstr="";
//[OBSOLETE]    if(xvasp.AVASP_flag_ABMIX_scheme.at(0)=='A' || xvasp.AVASP_flag_ABMIX_scheme.at(0)=='a')
//[OBSOLETE]      vstr.push_back("AUTO");
//[OBSOLETE]    if(xvasp.AVASP_flag_ABMIX_scheme.at(0)=='U' || xvasp.AVASP_flag_ABMIX_scheme.at(0)=='u')
//[OBSOLETE]      vstr.push_back("US");
//[OBSOLETE]    if(xvasp.AVASP_flag_ABMIX_scheme.at(0)=='P' || xvasp.AVASP_flag_ABMIX_scheme.at(0)=='p')
//[OBSOLETE]      vstr.push_back("PAW");
//[OBSOLETE]    if(vstr.size()>0) {
//[OBSOLETE]      for(uint i=0;i<vstr.size();i++)
//[OBSOLETE]        tstr+=vstr.at(i)+(i!=vstr.size()-1 ? "," : " ");
//[OBSOLETE]      aflowin << aurostd::PaddedPOST("[VASP_FORCE_OPTION]ABMIX="+tstr,_AFLOWINPAD_) << " // unspecified | [AUTO | US | PAW | (exp) #AMIX,#BMIX[,#AMIX_MAG,#BMIX_MAG]] (default=unspecified " << DEFAULT_VASP_FORCE_OPTION_ABMIX_SCHEME<< ")" << endl;
//[OBSOLETE]    }
//[OBSOLETE]    if(vstr.size()==0) {
//[OBSOLETE]      aflowin << aurostd::PaddedPOST("#[VASP_FORCE_OPTION]#ABMIX=...",_AFLOWINPAD_) << " // unspecified | [AUTO | US | PAW | (exp) #AMIX,#BMIX[,#AMIX_MAG,#BMIX_MAG]] (default=unspecified " << DEFAULT_VASP_FORCE_OPTION_ABMIX_SCHEME<< ")" << endl;
//[OBSOLETE]    }
//[OBSOLETE]  }
//[OBSOLETE]
//[OBSOLETE]  // RELAX WRITING
//[OBSOLETE]  if(xvasp.aopts.flag("FLAG::VOLUME_PRESERVED")==TRUE || xvasp.AVASP_flag_RUN_STATIC==TRUE || xvasp.AVASP_flag_RUN_STATIC_BANDS==TRUE) {
//[OBSOLETE]  } else {
//[OBSOLETE]    if(!xvasp.aopts.flag("AFLOWIN_FLAG::RELAX_TYPE")) aflowin << "[VASP_FORCE_OPTION]RELAX_ALL " << endl; //CO20180214
//[OBSOLETE]  }
//[OBSOLETE]
//[OBSOLETE]  // NOTUNE WRITING
//[OBSOLETE]  aflowin << "#[VASP_FORCE_OPTION]NOTUNE " << endl;
//[OBSOLETE]
//[OBSOLETE]  // TYPE WRITING
//[OBSOLETE]  string TYPE=xvasp.AVASP_flag_TYPE.xscheme;
//[OBSOLETE]  if(xvasp.aopts.flag("AFLOWIN_FLAG::TYPE")) 
//[OBSOLETE]    TYPE=xvasp.aopts.getattachedscheme("AFLOWIN_FLAG::TYPE");
//[OBSOLETE]  if(TYPE.at(0)!='M' && TYPE.at(0)!='I' && TYPE.at(0)!='S' && TYPE.at(0)!='m' && TYPE.at(0)!='i' && TYPE.at(0)!='s')
//[OBSOLETE]    aflowin << aurostd::PaddedPOST("[VASP_FORCE_OPTION]TYPE=DEFAULT",_AFLOWINPAD_) << " // (METAL | INSULATOR | SEMICONDUCTOR | DEFAULT) (default " << DEFAULT_VASP_FORCE_OPTION_TYPE_SCHEME<< ") " << endl;
//[OBSOLETE]  if(TYPE.at(0)=='M' || TYPE.at(0)=='m')
//[OBSOLETE]    aflowin << aurostd::PaddedPOST("[VASP_FORCE_OPTION]TYPE=METAL",_AFLOWINPAD_) << " // (METAL | INSULATOR | SEMICONDUCTOR | DEFAULT) (default " << DEFAULT_VASP_FORCE_OPTION_TYPE_SCHEME<< ") " << endl;
//[OBSOLETE]  if(TYPE.at(0)=='I' || TYPE.at(0)=='i')
//[OBSOLETE]    aflowin << aurostd::PaddedPOST("[VASP_FORCE_OPTION]TYPE=INSULATOR",_AFLOWINPAD_) << " // (METAL | INSULATOR | SEMICONDUCTOR | DEFAULT) (default " << DEFAULT_VASP_FORCE_OPTION_TYPE_SCHEME<< ") " << endl;
//[OBSOLETE]  if(TYPE.at(0)=='S' || TYPE.at(0)=='s')
//[OBSOLETE]    aflowin << aurostd::PaddedPOST("[VASP_FORCE_OPTION]TYPE=SEMICONDUCTOR",_AFLOWINPAD_) << " // (METAL | INSULATOR | SEMICONDUCTOR | DEFAULT) (default " << DEFAULT_VASP_FORCE_OPTION_TYPE_SCHEME<< ") " << endl;
//[OBSOLETE]
//[OBSOLETE]  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " " << "[12.5]" << endl;
//[OBSOLETE]
//[OBSOLETE]  if(AFLOWIN_OLD) { // OLD STYLE
//[OBSOLETE]    if(xvasp.aopts.flag("FLAG::AVASP_LDAU1")) aflowin << "[VASP_FORCE_OPTION]LDAU1=ON" << endl;
//[OBSOLETE]    if(xvasp.aopts.flag("FLAG::AVASP_LDAU2")) aflowin << "[VASP_FORCE_OPTION]LDAU2=ON" << endl;
//[OBSOLETE]    if(xvasp.aopts.flag("FLAG::AVASP_LDAU1") || xvasp.aopts.flag("FLAG::AVASP_LDAU2")) {
//[OBSOLETE]      stringstream aus;
//[OBSOLETE]      aus << "[VASP_FORCE_OPTION]LDAU_SPECIES=";
//[OBSOLETE]      for(uint i=0;i<xvasp.str.species.size();i++) aus << KBIN::VASP_PseudoPotential_CleanName(xvasp.str.species.at(i)) << " ";
//[OBSOLETE]      aflowin << aurostd::PaddedPOST(aus.str(),_AFLOWINPAD_) << " // LDAU SPECIES separated by spaces" << endl;
//[OBSOLETE]    }
//[OBSOLETE]  }
//[OBSOLETE]  if(AFLOWIN_NEW) { // NEW STYLE
//[OBSOLETE]    if(xvasp.aopts.flag("FLAG::AVASP_LDAU_ADIABATIC")==FALSE && xvasp.aopts.flag("FLAG::AVASP_LDAU_CUTOFF")==FALSE) {
//[OBSOLETE]      if(xvasp.aopts.flag("FLAG::AVASP_LDAU1") && !xvasp.aopts.flag("FLAG::AVASP_LDAU2")) aflowin << aurostd::PaddedPOST("[VASP_FORCE_OPTION]LDAU1=ON",_AFLOWINPAD_) << " // ON | OFF | ADIABATIC | CUTOFF  " << endl;
//[OBSOLETE]      if(xvasp.aopts.flag("FLAG::AVASP_LDAU2") && !xvasp.aopts.flag("FLAG::AVASP_LDAU1")) aflowin << aurostd::PaddedPOST("[VASP_FORCE_OPTION]LDAU2=ON",_AFLOWINPAD_) << " // ON | OFF | ADIABATIC | CUTOFF  " << endl;
//[OBSOLETE]      if(xvasp.aopts.flag("FLAG::AVASP_LDAU2") && xvasp.aopts.flag("FLAG::AVASP_LDAU1"))  aflowin << aurostd::PaddedPOST("[VASP_FORCE_OPTION]LDAU2=ON",_AFLOWINPAD_) << " // ON | OFF | ADIABATIC | CUTOFF  " << endl;
//[OBSOLETE]    }
//[OBSOLETE]    if(xvasp.aopts.flag("FLAG::AVASP_LDAU_ADIABATIC")==TRUE && xvasp.aopts.flag("FLAG::AVASP_LDAU_CUTOFF")==FALSE) {
//[OBSOLETE]      if(xvasp.aopts.flag("FLAG::AVASP_LDAU1") && !xvasp.aopts.flag("FLAG::AVASP_LDAU2")) aflowin << aurostd::PaddedPOST("[VASP_FORCE_OPTION]LDAU1=ADIABATIC",_AFLOWINPAD_) << " // ON | OFF | ADIABATIC | CUTOFF  " << endl;
//[OBSOLETE]      if(xvasp.aopts.flag("FLAG::AVASP_LDAU2") && !xvasp.aopts.flag("FLAG::AVASP_LDAU1")) aflowin << aurostd::PaddedPOST("[VASP_FORCE_OPTION]LDAU2=ADIABATIC",_AFLOWINPAD_) << " // ON | OFF | ADIABATIC | CUTOFF  " << endl;
//[OBSOLETE]      if(xvasp.aopts.flag("FLAG::AVASP_LDAU2") && xvasp.aopts.flag("FLAG::AVASP_LDAU1"))  aflowin << aurostd::PaddedPOST("[VASP_FORCE_OPTION]LDAU2=ADIABATIC",_AFLOWINPAD_) << " // ON | OFF | ADIABATIC | CUTOFF  " << endl;
//[OBSOLETE]    }
//[OBSOLETE]    if(xvasp.aopts.flag("FLAG::AVASP_LDAU_ADIABATIC")==FALSE && xvasp.aopts.flag("FLAG::AVASP_LDAU_CUTOFF")==TRUE) {
//[OBSOLETE]      if(xvasp.aopts.flag("FLAG::AVASP_LDAU1") && !xvasp.aopts.flag("FLAG::AVASP_LDAU2")) aflowin << aurostd::PaddedPOST("[VASP_FORCE_OPTION]LDAU1=CUTOFF",_AFLOWINPAD_) << " // ON | OFF | ADIABATIC | CUTOFF  " << endl;
//[OBSOLETE]      if(xvasp.aopts.flag("FLAG::AVASP_LDAU2") && !xvasp.aopts.flag("FLAG::AVASP_LDAU1")) aflowin << aurostd::PaddedPOST("[VASP_FORCE_OPTION]LDAU2=CUTOFF",_AFLOWINPAD_) << " // ON | OFF | ADIABATIC | CUTOFF  " << endl;
//[OBSOLETE]      if(xvasp.aopts.flag("FLAG::AVASP_LDAU2") && xvasp.aopts.flag("FLAG::AVASP_LDAU1"))  aflowin << aurostd::PaddedPOST("[VASP_FORCE_OPTION]LDAU2=CUTOFF",_AFLOWINPAD_) << " // ON | OFF | ADIABATIC | CUTOFF  " << endl;
//[OBSOLETE]    }
//[OBSOLETE]    if(xvasp.aopts.flag("FLAG::AVASP_LDAU1") || xvasp.aopts.flag("FLAG::AVASP_LDAU2")) aflowin << aurostd::PaddedPOST("[VASP_FORCE_OPTION]LDAU_PARAMETERS="+xvasp.AVASP_LDAU_PARAMETERS_STRING,_AFLOWINPAD_) << " // species;Ls;Us;Js " << endl;
//[OBSOLETE]  }
//[OBSOLETE]
//[OBSOLETE]  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " " << "[12.6]" << endl;
//[OBSOLETE]
//[OBSOLETE]  // CONVERT_UNIT_CELL
//[OBSOLETE]  // gus check
//[OBSOLETE]  {
//[OBSOLETE]    vector<string> tokens;aurostd::string2tokens(system,tokens,".");
//[OBSOLETE]    if(tokens.size()>1) {
//[OBSOLETE]      if(tokens.at(1).at(0)=='f') xvasp.aopts.flag("AVASP_flag_CONVERT_UNIT_CELL_STANDARD_PRIMITIVE",FALSE);
//[OBSOLETE]      if(tokens.at(1).at(0)=='b') xvasp.aopts.flag("AVASP_flag_CONVERT_UNIT_CELL_STANDARD_PRIMITIVE",FALSE);
//[OBSOLETE]      if(tokens.at(1).at(0)=='s') xvasp.aopts.flag("AVASP_flag_CONVERT_UNIT_CELL_STANDARD_PRIMITIVE",FALSE);
//[OBSOLETE]    }
//[OBSOLETE]  }
//[OBSOLETE]
//[OBSOLETE]  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " " << "[12.7]" << endl;
//[OBSOLETE]  if(AFLOWIN_NEW) {
//[OBSOLETE]    vector<string> vstr;string tstr;
//[OBSOLETE]    vstr.clear();tstr="";
//[OBSOLETE]
//[OBSOLETE]    if(xvasp.aopts.flag("AFLOWIN_FLAG::CONVERT_UNIT_CELL")) {
//[OBSOLETE]      vector<string>  vCONVERT_UNIT_CELL;
//[OBSOLETE]      aurostd::string2tokens(aurostd::toupper(xvasp.aopts.getattachedscheme("AFLOWIN_FLAG::CONVERT_UNIT_CELL")),vCONVERT_UNIT_CELL,",");
//[OBSOLETE]      for(uint i=0;i<vCONVERT_UNIT_CELL.size();i++) {
//[OBSOLETE]        if(vCONVERT_UNIT_CELL.at(i)=="SPRIM") vstr.push_back("STANDARD_PRIMITIVE");
//[OBSOLETE]        if(vCONVERT_UNIT_CELL.at(i)=="STD_PRIM") vstr.push_back("STANDARD_PRIMITIVE");
//[OBSOLETE]        if(vCONVERT_UNIT_CELL.at(i)=="STANDARD_PRIMITIVE") vstr.push_back("STANDARD_PRIMITIVE");
//[OBSOLETE]        if(vCONVERT_UNIT_CELL.at(i)=="SCONV") vstr.push_back("STANDARD_CONVENTIONAL");
//[OBSOLETE]        if(vCONVERT_UNIT_CELL.at(i)=="STD_CONV") vstr.push_back("STANDARD_CONVENTIONAL");
//[OBSOLETE]        if(vCONVERT_UNIT_CELL.at(i)=="STANDARD_CONVENTIONAL") vstr.push_back("STANDARD_CONVENTIONAL");
//[OBSOLETE]        if(vCONVERT_UNIT_CELL.at(i)=="NIGGLI") vstr.push_back("NIGGLI");
//[OBSOLETE]        if(vCONVERT_UNIT_CELL.at(i)=="MINK") vstr.push_back("MINKOWSKI");
//[OBSOLETE]        if(vCONVERT_UNIT_CELL.at(i)=="MINKOWSKI") vstr.push_back("MINKOWSKI");
//[OBSOLETE]        if(vCONVERT_UNIT_CELL.at(i)=="INCELL") vstr.push_back("INCELL");
//[OBSOLETE]        if(vCONVERT_UNIT_CELL.at(i)=="COMPACT") vstr.push_back("COMPACT");
//[OBSOLETE]        if(vCONVERT_UNIT_CELL.at(i)=="INCOMPACT") vstr.push_back("COMPACT");
//[OBSOLETE]        if(vCONVERT_UNIT_CELL.at(i)=="INWIGNERSEITZ") vstr.push_back("WIGNERSEITZ");
//[OBSOLETE]        if(vCONVERT_UNIT_CELL.at(i)=="WS") vstr.push_back("WIGNERSEITZ");
//[OBSOLETE]        if(vCONVERT_UNIT_CELL.at(i)=="WIGNERSEITZ") vstr.push_back("WIGNERSEITZ");
//[OBSOLETE]        if(vCONVERT_UNIT_CELL.at(i)=="C") vstr.push_back("CARTESIAN");
//[OBSOLETE]        if(vCONVERT_UNIT_CELL.at(i)=="CART") vstr.push_back("CARTESIAN");
//[OBSOLETE]        if(vCONVERT_UNIT_CELL.at(i)=="CARTESIAN") vstr.push_back("CARTESIAN");
//[OBSOLETE]        if(vCONVERT_UNIT_CELL.at(i)=="F") vstr.push_back("FRACTIONAL");
//[OBSOLETE]        if(vCONVERT_UNIT_CELL.at(i)=="FRAC") vstr.push_back("FRACTIONAL");
//[OBSOLETE]        if(vCONVERT_UNIT_CELL.at(i)=="FRACTIONAL") vstr.push_back("FRACTIONAL");
//[OBSOLETE]        if(vCONVERT_UNIT_CELL.at(i)=="D") vstr.push_back("DIRECT");
//[OBSOLETE]        if(vCONVERT_UNIT_CELL.at(i)=="DIR") vstr.push_back("DIRECT");
//[OBSOLETE]        if(vCONVERT_UNIT_CELL.at(i)=="DIRECT") vstr.push_back("DIRECT");
//[OBSOLETE]        if(vCONVERT_UNIT_CELL.at(i)=="PRE") vstr.push_back("PRESERVE");
//[OBSOLETE]        if(vCONVERT_UNIT_CELL.at(i)=="PRES") vstr.push_back("PRESERVE");
//[OBSOLETE]        if(vCONVERT_UNIT_CELL.at(i)=="PRESERVE") vstr.push_back("PRESERVE");
//[OBSOLETE]      }
//[OBSOLETE]    } else {
//[OBSOLETE]      if(xvasp.aopts.flag("AVASP_flag_CONVERT_UNIT_CELL_STANDARD_PRIMITIVE")) vstr.push_back("SPRIM");
//[OBSOLETE]      //if(xvasp.aopts.flag("AVASP_flag_CONVERT_UNIT_CELL_STANDARD_PRIMITIVE")) vstr.push_back("STANDARD_PRIMITIVE");
//[OBSOLETE]      if(xvasp.aopts.flag("AVASP_flag_CONVERT_UNIT_CELL_STANDARD_CONVENTIONAL")) vstr.push_back("SCONV");
//[OBSOLETE]      //if(xvasp.aopts.flag("AVASP_flag_CONVERT_UNIT_CELL_STANDARD_CONVENTIONAL")) vstr.push_back("STANDARD_CONVENTIONAL");
//[OBSOLETE]      if(xvasp.aopts.flag("AVASP_flag_CONVERT_UNIT_CELL_NIGGLI")) vstr.push_back("NIGGLI");
//[OBSOLETE]      if(xvasp.aopts.flag("AVASP_flag_CONVERT_UNIT_CELL_MINKOWSKI")) vstr.push_back("MINK");
//[OBSOLETE]      //if(xvasp.aopts.flag("AVASP_flag_CONVERT_UNIT_CELL_MINKOWSKI")) vstr.push_back("MINKOWSKI");
//[OBSOLETE]      if(xvasp.aopts.flag("AVASP_flag_CONVERT_UNIT_CELL_INCELL")) vstr.push_back("INCELL");
//[OBSOLETE]      if(xvasp.aopts.flag("AVASP_flag_CONVERT_UNIT_CELL_INCOMPACT")) vstr.push_back("COMPACT");
//[OBSOLETE]      if(xvasp.aopts.flag("AVASP_flag_CONVERT_UNIT_CELL_COMPACT")) vstr.push_back("COMPACT");
//[OBSOLETE]      if(xvasp.aopts.flag("AVASP_flag_CONVERT_UNIT_CELL_CARTESIAN")) vstr.push_back("CART");
//[OBSOLETE]      //if(xvasp.aopts.flag("AVASP_flag_CONVERT_UNIT_CELL_CARTESIAN")) vstr.push_back("CARTESIAN");
//[OBSOLETE]      if(xvasp.aopts.flag("AVASP_flag_CONVERT_UNIT_CELL_FRACTIONAL")) vstr.push_back("FRAC");
//[OBSOLETE]      //if(xvasp.aopts.flag("AVASP_flag_CONVERT_UNIT_CELL_FRACTIONAL")) vstr.push_back("FRACTIONAL");
//[OBSOLETE]      if(xvasp.aopts.flag("AVASP_flag_CONVERT_UNIT_CELL_WIGNERSEITZ")) vstr.push_back("WS");
//[OBSOLETE]      //if(xvasp.aopts.flag("AVASP_flag_CONVERT_UNIT_CELL_WIGNERSEITZ")) vstr.push_back("WIGNERSEITZ");
//[OBSOLETE]      if(xvasp.aopts.flag("AVASP_flag_CONVERT_UNIT_CELL_PRESERVE")) vstr.push_back("PRES");
//[OBSOLETE]      //if(xvasp.aopts.flag("AVASP_flag_CONVERT_UNIT_CELL_PRESERVE")) vstr.push_back("PRESERVE");
//[OBSOLETE]    }
//[OBSOLETE]    if(vstr.size()>0) {
//[OBSOLETE]      for(uint i=0;i<vstr.size();i++) tstr+=vstr.at(i)+(i!=vstr.size()-1 ? "," : " ");
//[OBSOLETE]      aflowin << aurostd::PaddedPOST("[VASP_FORCE_OPTION]CONVERT_UNIT_CELL="+tstr,_AFLOWINPAD_) << " // (SPRIM, SCONV, NIGGLI, MINK, INCELL, COMPACT, WS, CART, FRAC, PRES) " << endl;
//[OBSOLETE]    }
//[OBSOLETE]    if(vstr.size()==0) {
//[OBSOLETE]      aflowin << aurostd::PaddedPOST("#[VASP_FORCE_OPTION]CONVERT_UNIT_CELL=something",_AFLOWINPAD_) << " // (SPRIM, SCONV, NIGGLI, MINK, INCELL, COMPACT, WS, CART, FRAC, PRES)" << endl;
//[OBSOLETE]    }
//[OBSOLETE]  }
//[OBSOLETE]
//[OBSOLETE]  // VOLUME_PLUS_EQUAL
//[OBSOLETE]  if(xvasp.aopts.flag("AFLOWIN_FLAG::VOLUME_PLUS_EQUAL") && !xvasp.aopts.flag("AFLOWIN_FLAG::NO_VOLUME_ADJUSTMENT")) {
//[OBSOLETE]    aflowin << "[VASP_FORCE_OPTION]VOLUME+=" << xvasp.aopts.getattachedscheme("AFLOWIN_FLAG::VOLUME_PLUS_EQUAL") << " " << endl;
//[OBSOLETE]    xvasp.aopts.pop_attached("AFLOWIN_FLAG::VOLUME_MULTIPLY_EQUAL");
//[OBSOLETE]  } else {
//[OBSOLETE]    aflowin << "#[VASP_FORCE_OPTION]VOLUME+=10.0 " << endl;
//[OBSOLETE]  }
//[OBSOLETE]
//[OBSOLETE]  // VOLUME_MULTIPLY_EQUAL
//[OBSOLETE]  if(xvasp.aopts.flag("AFLOWIN_FLAG::VOLUME_MULTIPLY_EQUAL") && !xvasp.aopts.flag("AFLOWIN_FLAG::NO_VOLUME_ADJUSTMENT")) {
//[OBSOLETE]    aflowin << "[VASP_FORCE_OPTION]VOLUME*=" << xvasp.aopts.getattachedscheme("AFLOWIN_FLAG::VOLUME_MULTIPLY_EQUAL") << " " << endl;
//[OBSOLETE]    xvasp.aopts.pop_attached("AFLOWIN_FLAG::VOLUME_PLUS_EQUAL");
//[OBSOLETE]  } else {
//[OBSOLETE]    if(xvasp.aopts.flag("FLAG::VOLUME_PRESERVED")==TRUE || xvasp.AVASP_flag_RUN_STATIC==TRUE || xvasp.AVASP_flag_RUN_STATIC_BANDS==TRUE || xvasp.aopts.flag("AFLOWIN_FLAG::NO_VOLUME_ADJUSTMENT")) {
//[OBSOLETE]      aflowin << "#[VASP_FORCE_OPTION]VOLUME*=1.05 " << endl;
//[OBSOLETE]    } else {
//[OBSOLETE]      if(!xvasp.aopts.flag("AFLOWIN_FLAG::VOLUME_PLUS_EQUAL")) {aflowin << "[VASP_FORCE_OPTION]VOLUME*=1.05 " << endl;} else {aflowin << "#[VASP_FORCE_OPTION]VOLUME*=1.05 " << endl;}
//[OBSOLETE]    }
//[OBSOLETE]  }
//[OBSOLETE]
//[OBSOLETE]  if(0) { // write the AFIX
//[OBSOLETE]    aflowin << AFLOWIN_SEPARATION_LINE << endl; // [AFLOW] **************************************************
//[OBSOLETE]    aflowin << "[AFLOW] # Do not uncomment the AFIX unless you know what  you are doing. " << endl;
//[OBSOLETE]    aflowin <<  aurostd::PaddedPOST("[VASP_FORCE_OPTION]IGNORE_AFIX=NONE",_AFLOWINPAD_) << " // ROTMAT, SGRCON, IBZKPT, SYMPREC, INVGRP, EDDRMM, LREAL, BRMIX, DAV, EDDDAV, EFIELD_PEAD, ZPOTRF, EXCCOR, NATOMS, NBANDS, MEMORY, PSMAXN, NPAR" << endl;
//[OBSOLETE]  }
//[OBSOLETE]  aflowin << AFLOWIN_SEPARATION_LINE << endl; // [AFLOW] **************************************************
//[OBSOLETE]  aflowin << AFLOWIN_SEPARATION_LINE << endl; // [AFLOW] **************************************************
//[OBSOLETE]  aflowin << "[VASP_INCAR_MODE_EXPLICIT]START " << endl;
//[OBSOLETE]  aflowin << "SYSTEM=" << system << endl;
//[OBSOLETE]  //aflowin << " " << endl;
//[OBSOLETE]  if(xvasp.aopts.flag("FLAG::EXTRA_INCAR")==TRUE) {
//[OBSOLETE]    aflowin << xvasp.AVASP_EXTRA_INCAR.str(); // << endl;
//[OBSOLETE]  }
//[OBSOLETE]  aflowin << aurostd::PaddedPOST("#PSTRESS=000     # Pressure in kBar (1kB=0.1GPa) ",_AFLOWINPAD_) << " # for hand modification" << endl;
//[OBSOLETE]  aflowin << aurostd::PaddedPOST("#EDIFFG="+aurostd::utype2string(DEFAULT_VASP_PREC_EDIFFG,_AVASP_DOUBLE2STRING_PRECISION_)+"     # For relaxed forces ",_AFLOWINPAD_) << " # for hand modification" << endl;
//[OBSOLETE]  aflowin << aurostd::PaddedPOST("#POTIM="+aurostd::utype2string(DEFAULT_VASP_PREC_EDIFFG,_AVASP_DOUBLE2STRING_PRECISION_)+"      # default ",_AFLOWINPAD_) << " # for hand modification" << endl;
//[OBSOLETE]  aflowin << aurostd::PaddedPOST("#NBANDS=XX  ",_AFLOWINPAD_) << " # for hand modification" << endl;
//[OBSOLETE]  aflowin << aurostd::PaddedPOST("#IALGO=48   ",_AFLOWINPAD_) << " # for hand modification" << endl;
//[OBSOLETE]  aflowin << "[VASP_INCAR_MODE_EXPLICIT]STOP " << endl;
//[OBSOLETE]  aflowin << AFLOWIN_SEPARATION_LINE << endl; // [AFLOW] **************************************************
//[OBSOLETE]  aflowin << "[VASP_KPOINTS_MODE_IMPLICIT] " << endl;
//[OBSOLETE]  aflowin << "[VASP_KPOINTS_FILE]KSCHEME=" << xvasp.AVASP_KSCHEME << " " << endl;
//[OBSOLETE]
//[OBSOLETE]  // MODIFIERS
//[OBSOLETE]  if(xvasp.aopts.flag("AFLOWIN_FLAG::KPPRA")) xvasp.AVASP_value_KPPRA=aurostd::string2utype<int>(xvasp.aopts.getattachedscheme("AFLOWIN_FLAG::KPPRA"));    // KPPRA
//[OBSOLETE]  if(xvasp.aopts.flag("AFLOWIN_FLAG::KPPRA_STATIC")) xvasp.AVASP_value_KPPRA_STATIC=aurostd::string2utype<int>(xvasp.aopts.getattachedscheme("AFLOWIN_FLAG::KPPRA_STATIC")); // KPPRA_STATIC
//[OBSOLETE]  if(xvasp.aopts.flag("AFLOWIN_FLAG::BANDS_GRID")) xvasp.AVASP_value_BANDS_GRID=aurostd::string2utype<uint>(xvasp.aopts.getattachedscheme("AFLOWIN_FLAG::BANDS_GRID")); // BANDS_GRID
//[OBSOLETE]
//[OBSOLETE]  if(xvasp.str.species.size()==1) if(!xvasp.aopts.flag("AFLOWIN_FLAG::KPPRA")) xvasp.AVASP_value_KPPRA=DEFAULT_UNARY_KPPRA; // DEFAULT KPPRA
//[OBSOLETE]  // if(xvasp.aopts.flag("FLAG::AVASP_KPPRA") && PARAMS->vkppra.size()>0) {
//[OBSOLETE]  //   aflowin << "[VASP_KPOINTS_FILE]KPPRA=" << PARAMS->vkppra.front() << endl;
//[OBSOLETE]  //   PARAMS->vkppra.pop_front();
//[OBSOLETE]  // } else {
//[OBSOLETE]  aflowin << "[VASP_KPOINTS_FILE]KPPRA=" << xvasp.AVASP_value_KPPRA << endl;
//[OBSOLETE]  //  }
//[OBSOLETE]  if(xvasp.AVASP_prototype_mode==LIBRARY_MODE_ICSD) {
//[OBSOLETE]    if(xvasp.AVASP_flag_RUN_RELAX_STATIC || xvasp.AVASP_flag_RUN_RELAX_STATIC_BANDS) {
//[OBSOLETE]      aflowin << "[VASP_KPOINTS_FILE]STATIC_KSCHEME=" << xvasp.AVASP_STATIC_KSCHEME << " " << endl;
//[OBSOLETE]      aflowin << "[VASP_KPOINTS_FILE]STATIC_KPPRA=" << xvasp.AVASP_value_KPPRA_STATIC << endl;
//[OBSOLETE]      if(xvasp.AVASP_flag_RUN_RELAX_STATIC_BANDS) {
//[OBSOLETE]        aflowin << "[VASP_KPOINTS_FILE]BANDS_LATTICE=" << xvasp.AVASP_path_BANDS << endl;
//[OBSOLETE]        aflowin << "[VASP_KPOINTS_FILE]BANDS_GRID=" << xvasp.AVASP_value_BANDS_GRID << endl;
//[OBSOLETE]      }
//[OBSOLETE]    }
//[OBSOLETE]  }
//[OBSOLETE]  // HTQC do AUTO
//[OBSOLETE]  if(xvasp.AVASP_prototype_mode==LIBRARY_MODE_HTQC || xvasp.AVASP_prototype_mode==LIBRARY_MODE_HTQC_ICSD || xvasp.AVASP_prototype_mode==LIBRARY_MODE_LIB3) {
//[OBSOLETE]    if(!xvasp.aopts.flag("AFLOWIN_FLAG::KPPRA_STATIC")) xvasp.AVASP_value_KPPRA_STATIC=DEFAULT_KPPRA_STATIC; 
//[OBSOLETE]    xvasp.AVASP_STATIC_KSCHEME=DEFAULT_STATIC_KSCHEME;
//[OBSOLETE]    xvasp.AVASP_path_BANDS=DEFAULT_BANDS_LATTICE;
//[OBSOLETE]    if(!xvasp.aopts.flag("AFLOWIN_FLAG::BANDS_GRID")) xvasp.AVASP_value_BANDS_GRID=DEFAULT_BANDS_GRID;
//[OBSOLETE]    if(xvasp.str.species.size()==1) if(!xvasp.aopts.flag("AFLOWIN_FLAG::KPPRA_STATIC")) xvasp.AVASP_value_KPPRA_STATIC=DEFAULT_UNARY_KPPRA_STATIC;
//[OBSOLETE]    if(xvasp.str.species.size()==1) if(!xvasp.aopts.flag("AFLOWIN_FLAG::BANDS_GRID")) xvasp.AVASP_value_BANDS_GRID=DEFAULT_UNARY_BANDS_GRID;
//[OBSOLETE]    aflowin << "[VASP_KPOINTS_FILE]STATIC_KSCHEME=" << xvasp.AVASP_STATIC_KSCHEME << " " << endl;
//[OBSOLETE]    aflowin << "[VASP_KPOINTS_FILE]STATIC_KPPRA=" << xvasp.AVASP_value_KPPRA_STATIC << endl;
//[OBSOLETE]    aflowin << "[VASP_KPOINTS_FILE]BANDS_LATTICE=" << xvasp.AVASP_path_BANDS << endl;
//[OBSOLETE]    aflowin << "[VASP_KPOINTS_FILE]BANDS_GRID=" << xvasp.AVASP_value_BANDS_GRID << endl;
//[OBSOLETE]  }
//[OBSOLETE]  // PROTOTYPE check the stuff out
//[OBSOLETE]  if(xvasp.AVASP_prototype_mode==LIBRARY_MODE_PROTOTYPE) {
//[OBSOLETE]    cerr << "DEBUG - AVASP calculating parameters for bands" << endl;
//[OBSOLETE]    if(!xvasp.aopts.flag("AFLOWIN_FLAG::KPPRA_STATIC")) xvasp.AVASP_value_KPPRA_STATIC=DEFAULT_KPPRA_STATIC;                           
//[OBSOLETE]    xvasp.AVASP_STATIC_KSCHEME=DEFAULT_STATIC_KSCHEME;
//[OBSOLETE]    // kpoints for the brillouin zone
//[OBSOLETE]    xvasp.str.GetLatticeType(); // takes care of everything
//[OBSOLETE]    xvasp.AVASP_path_BANDS=xvasp.str.bravais_lattice_variation_type;  // ICSD BASTARDS
//[OBSOLETE]    cerr << "DEBUG - AVASP xvasp.AVASP_path_BANDS=" << xvasp.AVASP_path_BANDS << endl;
//[OBSOLETE]    if(!xvasp.aopts.flag("AFLOWIN_FLAG::BANDS_GRID")) xvasp.AVASP_value_BANDS_GRID=DEFAULT_BANDS_GRID;                               
//[OBSOLETE]    if(xvasp.AVASP_path_BANDS=="HEX" || xvasp.AVASP_path_BANDS=="FCC") {
//[OBSOLETE]      xvasp.AVASP_KSCHEME="G";           // HEXAGONAL/FCC SYSTEMS GET GAMMA KPOINTS GRID
//[OBSOLETE]      xvasp.AVASP_STATIC_KSCHEME="G";    // HEXAGONAL/FCC SYSTEMS GET GAMMA KPOINTS GRID
//[OBSOLETE]    }
//[OBSOLETE]    if(xvasp.AVASP_flag_RUN_RELAX_STATIC || xvasp.AVASP_flag_RUN_RELAX_STATIC_BANDS || xvasp.AVASP_prototype_mode==LIBRARY_MODE_PROTOTYPE) {
//[OBSOLETE]      aflowin << "[VASP_KPOINTS_FILE]STATIC_KSCHEME=" << xvasp.AVASP_STATIC_KSCHEME << " " << endl;
//[OBSOLETE]      aflowin << "[VASP_KPOINTS_FILE]STATIC_KPPRA=" << xvasp.AVASP_value_KPPRA_STATIC << endl;
//[OBSOLETE]      if(xvasp.AVASP_flag_RUN_RELAX_STATIC_BANDS || xvasp.AVASP_prototype_mode==LIBRARY_MODE_PROTOTYPE) {
//[OBSOLETE]        aflowin << "[VASP_KPOINTS_FILE]BANDS_LATTICE=" << xvasp.AVASP_path_BANDS << endl;
//[OBSOLETE]        aflowin << "[VASP_KPOINTS_FILE]BANDS_GRID=" << xvasp.AVASP_value_BANDS_GRID << endl;
//[OBSOLETE]      }
//[OBSOLETE]    }
...
//[OBSOLETE]
//[OBSOLETE]  aflowin << AFLOWIN_SEPARATION_LINE << endl; // [AFLOW] **************************************************
//[OBSOLETE]  // STRUCTURE VASP
//[OBSOLETE]  if(xvasp.aopts.flag("AFLOWIN_FLAG::VASP")) {
//[OBSOLETE]    aflowin << AFLOWIN_SEPARATION_LINE << endl; // [AFLOW] **************************************************
//[OBSOLETE]    aflowin << "[VASP_POSCAR_MODE_EXPLICIT]START " << endl;
//[OBSOLETE]    aflowin << xvasp.str;
//[OBSOLETE]    aflowin << "[VASP_POSCAR_MODE_EXPLICIT]STOP " << endl;
//[OBSOLETE]  }
//[OBSOLETE]  // STRUCTURE QUANTUM ESPRESSO
//[OBSOLETE]  //  xvasp.aopts.flag("AFLOWIN_FLAG::QE",FALSE); // APL patch
//[OBSOLETE]  if(xvasp.aopts.flag("AFLOWIN_FLAG::QE")) {
//[OBSOLETE]    aflowin_qe << AFLOWIN_SEPARATION_LINE << endl; // [AFLOW] **************************************************
//[OBSOLETE]    aflowin_qe << "[QE_GEOM_MODE_EXPLICIT]START " << endl;
//[OBSOLETE]    xstructure _str(xvasp.str);_str.xstructure2qe();
//[OBSOLETE]    aflowin_qe << _str;
//[OBSOLETE]    aflowin_qe << "[QE_GEOM_MODE_EXPLICIT]STOP " << endl;
//[OBSOLETE]    //   aflowin_qe << AFLOWIN_SEPARATION_LINE << endl; // [AFLOW] **************************************************
//[OBSOLETE]  }
//[OBSOLETE]  // STRUCTURE ABINIT
//[OBSOLETE]  //  xvasp.aopts.flag("AFLOWIN_FLAG::ABINIT",FALSE); // APL patch
//[OBSOLETE]  if(xvasp.aopts.flag("AFLOWIN_FLAG::ABINIT")) {
//[OBSOLETE]    aflowin_abinit << AFLOWIN_SEPARATION_LINE << endl; // [AFLOW] **************************************************
//[OBSOLETE]    aflowin_abinit << "[ABINIT_GEOM_MODE_EXPLICIT]START " << endl;
//[OBSOLETE]    xstructure _str(xvasp.str);_str.xstructure2abinit();
//[OBSOLETE]    aflowin_abinit << _str;
//[OBSOLETE]    aflowin_abinit << "[ABINIT_GEOM_MODE_EXPLICIT]STOP " << endl;
//[OBSOLETE]    //   aflowin_abinit << AFLOWIN_SEPARATION_LINE << endl; // [AFLOW] **************************************************
//[OBSOLETE]  }
//[OBSOLETE]  // STRUCTURE AIMS
//[OBSOLETE]  //  xvasp.aopts.flag("AFLOWIN_FLAG::AIMS",FALSE); // APL patch
//[OBSOLETE]  if(xvasp.aopts.flag("AFLOWIN_FLAG::AIMS")) {
//[OBSOLETE]    aflowin_aims << AFLOWIN_SEPARATION_LINE << endl; // [AFLOW] **************************************************
//[OBSOLETE]    aflowin_aims << "[AIMS_GEOM_MODE_EXPLICIT]START " << endl;
//[OBSOLETE]    xstructure _str(xvasp.str);_str.xstructure2aims();
//[OBSOLETE]    aflowin_aims << _str;
//[OBSOLETE]    aflowin_aims << "[AIMS_GEOM_MODE_EXPLICIT]STOP " << endl;
//[OBSOLETE]    //   aflowin_aims << AFLOWIN_SEPARATION_LINE << endl; // [AFLOW] **************************************************
//[OBSOLETE]  }
//[OBSOLETE]  //DX20190123 - add CIF - START
//[OBSOLETE]  // STRUCTURE CIF
//[OBSOLETE]  //  xvasp.aopts.flag("AFLOWIN_FLAG::CIF",FALSE); // APL patch
//[OBSOLETE]  if(xvasp.aopts.flag("AFLOWIN_FLAG::CIF")) {
//[OBSOLETE]    aflowin_cif << AFLOWIN_SEPARATION_LINE << endl; // [AFLOW] **************************************************
//[OBSOLETE]    aflowin_cif << "[CIF_GEOM_MODE_EXPLICIT]START " << endl;
//[OBSOLETE]    xstructure _str(xvasp.str);_str.xstructure2cif();
//[OBSOLETE]    aflowin_cif << _str;
//[OBSOLETE]    aflowin_cif << "[CIF_GEOM_MODE_EXPLICIT]STOP " << endl;
//[OBSOLETE]    //   aflowin_cif << AFLOWIN_SEPARATION_LINE << endl; // [AFLOW] **************************************************
//[OBSOLETE]  }
//[OBSOLETE]  //DX20190123 - add CIF - END
//[OBSOLETE]  //DX20190123 - add ABCCAr - START
//[OBSOLETE]  // STRUCTURE ABCCAR
//[OBSOLETE]  //  xvasp.aopts.flag("AFLOWIN_FLAG::ABCCAR",FALSE); // APL patch
//[OBSOLETE]  if(xvasp.aopts.flag("AFLOWIN_FLAG::ABCCAR")) {
//[OBSOLETE]    aflowin_abccar << AFLOWIN_SEPARATION_LINE << endl; // [AFLOW] **************************************************
//[OBSOLETE]    aflowin_abccar << "[ABCCAR_GEOM_MODE_EXPLICIT]START " << endl;
//[OBSOLETE]    xstructure _str(xvasp.str);_str.xstructure2abccar();
//[OBSOLETE]    aflowin_abccar << _str;
//[OBSOLETE]    aflowin_abccar << "[ABCCAR_GEOM_MODE_EXPLICIT]STOP " << endl;
//[OBSOLETE]    //   aflowin_abccar << AFLOWIN_SEPARATION_LINE << endl; // [AFLOW] **************************************************
//[OBSOLETE]  }
//[OBSOLETE]  //DX20190123 - add ABCCAR - END
//[OBSOLETE]  // POTENTIAL
//[OBSOLETE]  aflowin << AFLOWIN_SEPARATION_LINE << endl; // [AFLOW] **************************************************
//[OBSOLETE]  aflowin << "[VASP_POTCAR_MODE_IMPLICIT] " << endl;
//[OBSOLETE]  if(LDEBUG) cerr << "DEBUG - AVASP_MakeSingleAFLOWIN [13a]" << endl;
//[OBSOLETE]  for(uint i=0;i<xvasp.str.species.size();i++) {
//[OBSOLETE]    if(xvasp.aopts.flag("FLAG::AVASP_AUTO_PSEUDOPOTENTIALS")==FALSE) {
//[OBSOLETE]      if(xvasp.str.species.at(i)!="" && xvasp.str.species.at(i)!="X") {// need because some times we have the "" around
//[OBSOLETE]        aflowin << "[VASP_POTCAR_FILE]" << xvasp.AVASP_potential << "/" << xvasp.str.species_pp.at(i) << endl;
//[OBSOLETE]        if(LDEBUG) cerr << __AFLOW_FUNC__ << " AUTO_PSEUDOPOTENTIALS=FALSE - " << xvasp.AVASP_potential << "/" << xvasp.str.species_pp.at(i) << endl;
//[OBSOLETE]      }
//[OBSOLETE]    } else {
//[OBSOLETE]      if(xvasp.str.species.at(i)!="" && xvasp.str.species.at(i)!="X") // need because some times we have the "" around
//[OBSOLETE]        aflowin << "[VASP_POTCAR_FILE]" << KBIN::VASP_PseudoPotential_CleanName(xvasp.str.species.at(i)) << endl;
//[OBSOLETE]    }
//[OBSOLETE]  }
//[OBSOLETE]  if(LDEBUG) cerr << "DEBUG - AVASP_MakeSingleAFLOWIN [13b]" << endl;
//[OBSOLETE]  if(xvasp.aopts.flag("FLAG::AVASP_AUTO_PSEUDOPOTENTIALS")==TRUE) {
//[OBSOLETE]    aflowin << "[AFLOW] " << xvasp.AVASP_potential << ": ";
//[OBSOLETE]    for(uint i=0;i<xvasp.str.species_pp.size();i++) aflowin << xvasp.str.species_pp.at(i) << " ";
//[OBSOLETE]    aflowin << endl;
//[OBSOLETE]  }
//[OBSOLETE]  if(1) {
//[OBSOLETE]    aflowin << "[AFLOW] COMPOSITION_PP=|";  // COMPOSITION_PP
//[OBSOLETE]    for(uint i=0;i<xvasp.str.species_pp.size();i++)
//[OBSOLETE]      aflowin << xvasp.str.species_pp.at(i) << xvasp.str.num_each_type.at(i) << "|";
//[OBSOLETE]    aflowin << endl;
//[OBSOLETE]    aflowin << "[AFLOW] COMPOSITION=|"; // COMPOSITION
//[OBSOLETE]    for(uint i=0;i<xvasp.str.species_pp.size();i++) 
//[OBSOLETE]      aflowin << KBIN::VASP_PseudoPotential_CleanName(xvasp.str.species.at(i)) << xvasp.str.num_each_type.at(i) << "|";
//[OBSOLETE]    aflowin << endl;
//[OBSOLETE]    aflowin << "[AFLOW] VOLUME(A^3)=|"; // VOLUME
//[OBSOLETE]    for(uint i=0;i<xvasp.str.species_pp.size();i++)
//[OBSOLETE]      aflowin << aurostd::utype2string<double>(xvasp.str.species_volume.at(i),9) << "|";
//[OBSOLETE]    aflowin << endl;
//[OBSOLETE]    aflowin << "[AFLOW] MASS(amu)=|"; // MASS
//[OBSOLETE]    for(uint i=0;i<xvasp.str.species_pp.size();i++)
//[OBSOLETE]      aflowin << aurostd::utype2string<double>(xvasp.str.species_mass.at(i)/AMU2KILOGRAM,9) << "|";
//[OBSOLETE]    aflowin << endl;
//[OBSOLETE]  }
//[OBSOLETE]  if(LDEBUG) cerr << "DEBUG - AVASP_MakeSingleAFLOWIN [13c]" << endl;
//[OBSOLETE]
//[OBSOLETE]  // add quantum espresso LOGICS (if any)
//[OBSOLETE]  if(xvasp.aopts.flag("AFLOWIN_FLAG::QE")) {
//[OBSOLETE]    aflowin << AFLOWIN_SEPARATION_LINE << endl; // [AFLOW] **************************************************
//[OBSOLETE]    aflowin << "[AFLOW] Quantum Espresso information (experimental)" << endl;
//[OBSOLETE]    //    aflowin << AFLOWIN_SEPARATION_LINE << endl; // [AFLOW] **************************************************
//[OBSOLETE]    aflowin << aflowin_qe.str();
//[OBSOLETE]  }
//[OBSOLETE]  // add abinit LOGICS (if any)
//[OBSOLETE]  if(xvasp.aopts.flag("AFLOWIN_FLAG::ABINIT")) {
//[OBSOLETE]    aflowin << AFLOWIN_SEPARATION_LINE << endl; // [AFLOW] **************************************************
//[OBSOLETE]    aflowin << "[AFLOW] Abinit information (experimental)" << endl;
//[OBSOLETE]    //    aflowin << AFLOWIN_SEPARATION_LINE << endl; // [AFLOW] **************************************************
//[OBSOLETE]    aflowin << aflowin_abinit.str();
//[OBSOLETE]  }
//[OBSOLETE]  // add aims LOGICS (if any)
//[OBSOLETE]  if(xvasp.aopts.flag("AFLOWIN_FLAG::AIMS")) {
//[OBSOLETE]    aflowin << AFLOWIN_SEPARATION_LINE << endl; // [AFLOW] **************************************************
//[OBSOLETE]    aflowin << "[AFLOW] Aims information (experimental)" << endl;
//[OBSOLETE]    //    aflowin << AFLOWIN_SEPARATION_LINE << endl; // [AFLOW] **************************************************
//[OBSOLETE]    aflowin << aflowin_aims.str();
//[OBSOLETE]  }
//[OBSOLETE]  //DX20190123 - add CIF - START
//[OBSOLETE]  // add cif LOGICS (if any)
//[OBSOLETE]  if(xvasp.aopts.flag("AFLOWIN_FLAG::CIF")) {
//[OBSOLETE]    aflowin << AFLOWIN_SEPARATION_LINE << endl; // [AFLOW] **************************************************
//[OBSOLETE]    aflowin << "[AFLOW] CIF information (experimental)" << endl;
//[OBSOLETE]    //    aflowin << AFLOWIN_SEPARATION_LINE << endl; // [AFLOW] **************************************************
//[OBSOLETE]    aflowin << aflowin_cif.str();
//[OBSOLETE]  }
//[OBSOLETE]  //DX20190123 - add CIF - END
//[OBSOLETE]  //DX20190123 - add ABCCAR - START
//[OBSOLETE]  // add cif LOGICS (if any)
//[OBSOLETE]  if(xvasp.aopts.flag("AFLOWIN_FLAG::ABCCAr")) {
//[OBSOLETE]    aflowin << AFLOWIN_SEPARATION_LINE << endl; // [AFLOW] **************************************************
//[OBSOLETE]    aflowin << "[AFLOW] ABCCAR information (experimental)" << endl;
//[OBSOLETE]    //    aflowin << AFLOWIN_SEPARATION_LINE << endl; // [AFLOW] **************************************************
//[OBSOLETE]    aflowin << aflowin_abccar.str();
//[OBSOLETE]  }
//[OBSOLETE]  //DX20190123 - add CIF - END
//[OBSOLETE]  // now close
//[OBSOLETE]  aflowin << AFLOWIN_SEPARATION_LINE << endl; // [AFLOW] **************************************************
//[OBSOLETE]  aflowin << "[AFLOW] Aflow automatically generated (aflow_avasp.cpp) " << endl;
//[OBSOLETE]  aflowin << AFLOWIN_SEPARATION_LINE << endl; // [AFLOW] **************************************************
//[OBSOLETE]  aflowin << "[AFLOW] AFLOW V(" << string(AFLOW_VERSION) << ") in " << directory << endl;
//[OBSOLETE]  aflowin << AFLOWIN_SEPARATION_LINE << endl; // [AFLOW] **************************************************
//[OBSOLETE]
//[OBSOLETE]  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " " << "[14]" << endl;
//[OBSOLETE]
//[OBSOLETE]  string msg;
//[OBSOLETE]  if(xvasp.AVASP_prototype_mode==LIBRARY_MODE_LIB3)
//[OBSOLETE]    flag_WRITE=AVASP_CheckHeuslersSanvito(xvasp,msg);
//[OBSOLETE]
//[OBSOLETE]  // NO WRITE
//[OBSOLETE]  if(flag_WRITE==FALSE && 0) {
//[OBSOLETE]    cout << "AFLOW V(" << string(AFLOW_VERSION) << ") skipping " << directory;
//[OBSOLETE]    cout << " [" << msg << "] *************** ";
//[OBSOLETE]    cout << endl;cout.flush();
//[OBSOLETE]  }
//[OBSOLETE]
//[OBSOLETE]  // YES WRITE
//[OBSOLETE]  if(flag_WRITE==TRUE) {
//[OBSOLETE]    // DONE and write
//[OBSOLETE]    if(1) {
//[OBSOLETE]      if(directory.empty()) {
//[OBSOLETE]        string message = "empty directory";
//[OBSOLETE]        throw aurostd::xerror(__AFLOW_FILE__, __AFLOW_FUNC__, message, _FILE_NOT_FOUND_);
//[OBSOLETE]      }
//[OBSOLETE]      if(pthread>=0)  pthread_mutex_lock(&mutex_AVASP);
//[OBSOLETE]      cout << "AFLOW V(" << string(AFLOW_VERSION) << ") creating " << directory;
//[OBSOLETE]      if(xvasp.aopts.flag("FLAG::AVASP_LDAU1")) cout << " [LDAU1]";
//[OBSOLETE]      if(xvasp.aopts.flag("FLAG::AVASP_LDAU2")) cout << " [LDAU2]";
//[OBSOLETE]      if(fixed_lattice_vasp) cout << " [fixed_lattice_vasp=" << xvasp.AVASP_label << "]";
//[OBSOLETE]      if(pthread>=0) cout << "   - pthread=" << pthread;
//[OBSOLETE]      cout << endl;cout.flush();
//[OBSOLETE]      if(pthread>=0)  pthread_mutex_unlock(&mutex_AVASP);
//[OBSOLETE]    }
//[OBSOLETE]    // MAKE Directory and WRITE _AFLOWIN_
//[OBSOLETE]    Krun=aurostd::DirectoryMake(directory);
//[OBSOLETE]    if(Krun==FALSE) return Krun;
//[OBSOLETE]    // CHMOD Directory 777
//[OBSOLETE]    Krun=aurostd::DirectoryChmod("777",directory);
//[OBSOLETE]    if(Krun==FALSE) return Krun;
//[OBSOLETE]    // Write _AFLOWIN_
//[OBSOLETE]    Krun=aurostd::stringstream2file(aflowin,string(directory+"/"+_AFLOWIN_));
//[OBSOLETE]    if(Krun==FALSE) return Krun;
//[OBSOLETE]    // CHMOD a+w _AFLOWIN_
//[OBSOLETE]    Krun=aurostd::ChmodFile("a+w",string(directory+"/"+_AFLOWIN_));
//[OBSOLETE]    if(Krun==FALSE) return Krun;
//[OBSOLETE]    //  cout << str;
//[OBSOLETE]    if(LDEBUG) cerr << "DEBUG - AVASP_MakeSingleAFLOWIN [15]" << endl;
//[OBSOLETE]  }
//[OBSOLETE]  if(flag_WRITE==FALSE&&flag_PRINT==TRUE) {
//[OBSOLETE]    cout << aflowin.str() << endl;cout.flush();
//[OBSOLETE]  }
//[OBSOLETE]
//[OBSOLETE]  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " " << "[16]" << endl;
//[OBSOLETE]
//[OBSOLETE]  // make _aflowin
//[OBSOLETE]  _aflowin.clear();_aflowin.str(std::string());
//[OBSOLETE]  _aflowin << aflowin.str();
//[OBSOLETE]
//[OBSOLETE]
...
bool AVASP_MakePrototype_AFLOWIN_20181226(_AVASP_PROTO *PARAMS) {
  ...
  xvasp.AVASP_flag_RUN_RELAX_STATIC=PARAMS->vparams.flag("AFLOWIN_FLAG::RUN_RELAX_STATIC");
  xvasp.AVASP_flag_RUN_RELAX_STATIC_BANDS=PARAMS->vparams.flag("AFLOWIN_FLAG::RUN_RELAX_STATIC_BANDS");
  xvasp.AVASP_flag_RUN_STATIC=PARAMS->vparams.flag("AFLOWIN_FLAG::RUN_STATIC"); //CO20190219
  xvasp.AVASP_flag_RUN_STATIC_BANDS=PARAMS->vparams.flag("AFLOWIN_FLAG::RUN_STATIC_BANDS"); //CO20190219
  //NO GENERATE YET
  //CO20190215 - the order is VERY important, as args2addattachedscheme in aconvasp finds RUN_RELAX RUN_RELAX_STATIC and RUN_RELAX_STATIC_BANDS for --run_relax_static_bands
  //so we proceed in order of longest flag name and with else if's
  if(xvasp.AVASP_flag_RUN_RELAX_STATIC_BANDS){
    if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.AVASP_flag_RUN_RELAX_STATIC_BANDS ON" << endl;}
    xvasp.AVASP_flag_RUN_RELAX=FALSE;
    xvasp.AVASP_flag_RUN_RELAX_STATIC=FALSE;
    xvasp.AVASP_flag_RUN_RELAX_STATIC_BANDS=TRUE;
    xvasp.AVASP_flag_RUN_STATIC=FALSE;
    ...
    if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.AVASP_flag_RUN_RELAX_STATIC ON" << endl;}
    xvasp.AVASP_flag_RUN_RELAX=FALSE;
    xvasp.AVASP_flag_RUN_RELAX_STATIC=TRUE;
    xvasp.AVASP_flag_RUN_RELAX_STATIC_BANDS=FALSE;
    xvasp.AVASP_flag_RUN_STATIC=FALSE;
    ...
    if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.AVASP_flag_RUN_STATIC_BANDS ON" << endl;}
    xvasp.AVASP_flag_RUN_RELAX=FALSE;
    xvasp.AVASP_flag_RUN_RELAX_STATIC=FALSE;
    xvasp.AVASP_flag_RUN_RELAX_STATIC_BANDS=FALSE;
    xvasp.AVASP_flag_RUN_STATIC=FALSE;
    ...
    if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.AVASP_flag_RUN_STATIC ON" << endl;}
    xvasp.AVASP_flag_RUN_RELAX=FALSE;
    xvasp.AVASP_flag_RUN_RELAX_STATIC=FALSE;
    xvasp.AVASP_flag_RUN_RELAX_STATIC_BANDS=FALSE;
    xvasp.AVASP_flag_RUN_STATIC=TRUE;
    ...
    if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xvasp.AVASP_flag_RUN_RELAX ON" << endl;}
    xvasp.AVASP_flag_RUN_RELAX=TRUE;
    xvasp.AVASP_flag_RUN_RELAX_STATIC=FALSE;
    xvasp.AVASP_flag_RUN_RELAX_STATIC_BANDS=FALSE;
    xvasp.AVASP_flag_RUN_STATIC=FALSE;
  ...
  string pocc_parameters_raw=PARAMS->vparams.getattachedscheme("AFLOWIN_FLAG::POCC_PARAMS");
  string pocc_tol_raw=PARAMS->vparams.getattachedscheme("AFLOWIN_FLAG::POCC_TOL");
  if(LDEBUG) cerr << __AFLOW_FUNC__ << " pocc_parameters_raw=" << pocc_parameters_raw << endl;
  bool pocc=(!pocc_parameters_raw.empty());
  vector<string> pocc_parameters_sets,pocc_tol_sets;
  if(!pocc_parameters_raw.empty()){aurostd::string2tokens(pocc_parameters_raw,pocc_parameters_sets,",");}
  else {pocc_parameters_sets.push_back("");} //so that it enters the for loop later just once
  ...
  //[CO20181226 - OBSOLETE PROTO_AFLOW::RUN_RELAX_STATIC_BANDS]if(PARAMS->vparams.flag("AFLOWIN_FLAG::BANDS")) {xvasp.AVASP_flag_RUN_RELAX_STATIC_BANDS=TRUE;xvasp.AVASP_flag_RUN_RELAX=FALSE;}
  ...
  for(uint i=0;i<PARAMS->ucell.size();i++){params_ucell_input.push_back(PARAMS->ucell[i]);}
  ...
  for(uint i=0;i<orig_labels.size();i++){
    if(aurostd::string2tokens(orig_labels[i],anrl_tokens,"_")>=4) {
      if(aurostd::string2tokens(orig_labels[i],perm_tokens,".")==1) {
        ...
        if(LDEBUG) cerr << __AFLOW_FUNC__ << " added default permutation designation to ANRL label; label=" << new_labels[new_labels.size()-1] << endl;
      }
  ...
  uint nspeciesHTQC=aflowlib::PrototypeLibrariesSpeciesNumber(label_raw),nspecies=nspeciesHTQC; //PARAMS->ucell.at(0)); //CO20181226

  //decide alphabetic
  bool alphabetic=TRUE;
  if(!PARAMS->vparams.flag("AFLOWIN_FLAG::HTQC_ICSD")) alphabetic=RequestedAlphabeticLabeling(label_raw); //PARAMS->ucell.at(0));
  ...
  if(!pocc){  //will patch for pocc after we parse input
    ...
    if(PARAMS->ucell.size()==1) { //this must be OLD as _ICSD_ passes through the AVASP_MakePrototypeICSD_AFLOWIN() not here, probably obsolete, but we keep for history
      ...
      for(uint i=0;i<austokens2.size();i++){params_ucell_input.push_back(austokens2[i]);} //now we can treat as label:species:species
      reverse=false;  //label comes first
      //[CO20181226 - OBSOLETE]specieX.clear();volumeX.clear();massX.clear();
      //[CO20181226 - OBSOLETE]for(uint ispecies=0;ispecies<nspecies;ispecies++) {
      //[CO20181226 - OBSOLETE]  specieX.push_back(vector<string>(0));
      //[CO20181226 - OBSOLETE]  volumeX.push_back(vector<double>(0));
      //[CO20181226 - OBSOLETE]  massX.push_back(vector<double>(0));
      //[CO20181226 - OBSOLETE]  //  cerr << specieX_raw.at(ispecies) << endl;
      //[CO20181226 - OBSOLETE]  specieX.push_back(*(new vector<string>(0))); specieX.at(specieX.size()-1).clear();
      //[CO20181226 - OBSOLETE]  volumeX.push_back(*(new vector<double>(0))); volumeX.at(volumeX.size()-1).clear();
      //[CO20181226 - OBSOLETE]  massX.push_back(*(new vector<double>(0))); massX.at(massX.size()-1).clear();
      //[CO20181226 - OBSOLETE]}
    }
  }

  //make some decisions based on nspeciesHTQC
  //[CO20181226 - moved down and qualified]if(nspeciesHTQC==3) {xvasp.AVASP_flag_RUN_RELAX_STATIC_BANDS=TRUE;xvasp.AVASP_flag_RUN_RELAX=FALSE;} // force bands for ternary
  //[CO20181226 - moved down and qualified]if(nspeciesHTQC==4) {xvasp.AVASP_flag_RUN_RELAX_STATIC_BANDS=TRUE;xvasp.AVASP_flag_RUN_RELAX=FALSE;} // force bands for quaternary
  ...
  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " labels=" << label_raw << endl; //PARAMS->ucell.at(0) << endl;
  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " pocc=" << pocc << endl;
  ...
  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " 1+nspeciesHTQC=" << 1+nspeciesHTQC << endl; //CO20191110 - nspeciesHTQC makes sense here
  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " 1+nspeciesHTQC+1=" << 1+nspeciesHTQC+1 << endl; //CO20191110 - nspeciesHTQC makes sense here
  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " 2+nspeciesHTQC=" << 2+nspeciesHTQC << endl; //CO20191110 - nspeciesHTQC makes sense here
  ...
  //[CO20181226 - OBSOLETE]    specieX.push_back(vector<string>(0));
  //[CO20181226 - OBSOLETE]    specieX.push_back(*(new vector<string>(0))); specieX.at(specieX.size()-1).clear();
  //[CO20181226 - OBSOLETE]    specieX_raw.push_back("");
  //[CO20181226 - OBSOLETE]    volumeX.push_back(vector<double>(0));
  //[CO20181226 - OBSOLETE]    massX.push_back(vector<double>(0));
  //[CO20181226 - OBSOLETE]    volumeX.push_back(*(new vector<double>(0))); volumeX.at(volumeX.size()-1).clear();
  //[CO20181226 - OBSOLETE]    massX.push_back(*(new vector<double>(0))); massX.at(massX.size()-1).clear();
  //[CO20181226 - OBSOLETE]  }
  //[CO20181226 - OBSOLETE]  if(PARAMS->vparams.flag("AFLOWIN_FLAG::REVERSE")==FALSE) {
  //[CO20181226 - OBSOLETE]    label_raw=PARAMS->ucell.at(0);
  //[CO20181226 - OBSOLETE]    for(uint isp=1;isp<=nspecies;isp++)
  //[CO20181226 - OBSOLETE]      if(nspecies>=isp) specieX_raw.at(isp-1)=PARAMS->ucell.at(0+isp);
  //[CO20181226 - OBSOLETE]  }
  //[CO20181226 - OBSOLETE]  if(PARAMS->vparams.flag("AFLOWIN_FLAG::REVERSE")==TRUE) {
  //[CO20181226 - OBSOLETE]    specieX_raw.at(0)=PARAMS->ucell.at(0);
  //[CO20181226 - OBSOLETE]    if(nspecies==1) {label_raw=PARAMS->ucell.at(1);}
  //[CO20181226 - OBSOLETE]    if(nspecies>=2) {specieX_raw.at(1)=PARAMS->ucell.at(1);label_raw=PARAMS->ucell.at(2);}  // for backward compatibility
  //[CO20181226 - OBSOLETE]  }
  //[CO20181226 - OBSOLETE]}
  ...
  //patch LIB lables
  // SEARCH FOR SPECIES
  //[CO20181226 OBSOLETE]if(PARAMS->ucell.size()==1+nspecies){  //volumes are not really practical unless you know how big the LIB strings are  //forget it, just patch anyway
  ...
  for(uint isp=0;isp<specieX_raw.size();isp++) {
    present_here=aurostd::substring2bool(specieX_raw.at(isp),"LIB4");
    if(present_here) aurostd::StringSubst(specieX_raw.at(isp),"LIB4",SPECIE_RAW_LIB4);
  ...
  for(uint i=0;i<specieX_raw.size();i++){
    //  cerr << "specieX_raw.at(i)=" << specieX_raw.at(i) << endl;
    specieX.push_back(vector<string>(0));
  ...
  if(nspecies>=2){  //CO20191110
    for(uint i=0;i<specieX.size();i++){ //CO20191110
      if(specieX[i].size()>1){xvasp.AVASP_alpha_fix=TRUE;}  //CO20191110
    } //CO20191110
  } //CO20191110
  //[CO20191110 OBSOLETE]if(nspecies>=2) if(specieX.at(0).size()>1 || specieX.at(1).size()>1) HTQC=TRUE;
  //[CO20191110 OBSOLETE]if(HTQC) xvasp.AVASP_alpha_fix=TRUE;
  ...
  if(vvnum.size()==0){  //automatic volumes
    if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " [x3b] - USE AUTOMATIC VOLUMES" << endl;
    for(uint i=0;i<specieX.size();i++){
      volumeX.push_back(vector<double>(0));
      for(uint j=0;j<specieX[i].size();j++){
  ...
  //patch masses
  for(uint i=0;i<specieX.size();i++){
    massX.push_back(vector<double>(0));
    for(uint j=0;j<specieX[i].size();j++){
      massX.back().push_back(GetAtomMass(specieX[i][j]));
    }
  }

  //[CO20181226 OBSOLETE]// get the xvasp.AVASP_potential
  //[CO20181226 OBSOLETE]if(PARAMS->ucell.size()==1+nspecies) {  // USE AUTOMATIC VOLUMES
  //[CO20181226 OBSOLETE]  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " [x3b] - USE AUTOMATIC VOLUMES" << endl;
  //[CO20181226 OBSOLETE]  for(uint ispecies=0;ispecies<nspecies;ispecies++)
  //[CO20181226 OBSOLETE]    for(uint i=0;i<specieX.at(ispecies).size();i++) {
  //[CO20181226 OBSOLETE]      volumeX.at(ispecies).push_back(GetAtomVolume(specieX.at(ispecies).at(i))); //CO20181129
  //[CO20181226 OBSOLETE]      massX.at(ispecies).push_back(GetAtomMass(specieX.at(ispecies).at(i))); //CO20181129
  //[CO20181226 OBSOLETE]      //	cerr << 1.0e25*GetAtomMass(specieX.at(ispecies).at(i)) << endl; //CO20181129
  //[CO20181226 OBSOLETE]    }
  //[CO20181226 OBSOLETE]}

  //[CO20181226 OBSOLETE]double vol; //CO20180705
  //[CO20181226 OBSOLETE]if(PARAMS->ucell.size()==1+nspecies+1) {  // USE ONE VOLUME FITS ALL
  //[CO20181226 OBSOLETE]  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " [x3d] - USE ONE VOLUME FITS ALL" << endl;
  //[CO20181226 OBSOLETE]  for(uint ispecies=0;ispecies<nspecies;ispecies++) {
  //[CO20181226 OBSOLETE]    vector<string> tokens;tokens.clear();
  //[CO20181226 OBSOLETE]    aurostd::string2tokens(PARAMS->ucell.at(1+nspecies+1-1),tokens,",");
  //[CO20181226 OBSOLETE]    for(uint i=0;i<specieX.at(ispecies).size();i++) {
  ...
  //[CO20181226 OBSOLETE]if(PARAMS->ucell.size()==1+nspecies*2) {
  //[CO20181226 OBSOLETE]  if(LDEBUG) cerr << "DEBUG - " << __AFLOW_FUNC__ << " [x3e] - EXTRACT VOLUMES FROM STRING" << endl;
  //[CO20181226 OBSOLETE]  for(uint ispecies=0;ispecies<nspecies;ispecies++) {
  //[CO20181226 OBSOLETE]    vector<string> tokens;tokens.clear();
  //[CO20181226 OBSOLETE]    aurostd::string2tokens(PARAMS->ucell.at(1+nspecies+ispecies),tokens,",");
  ...
  //[CO20181226 OBSOLETE]  }
  //[CO20181226 OBSOLETE]  for(uint ispecies=0;ispecies<nspecies;ispecies++) {
  //[CO20181226 OBSOLETE]    if(specieX.at(ispecies).size() != volumeX.at(ispecies).size()) {
  //[CO20181226 OBSOLETE]      aus << "EEEEE  PROTO_Generation_Binary_Aflowin error \"specieX.at(" << ispecies << ").size()!=volumeX.at(" << ispecies << ").size()\" " << specieX.at(ispecies).size() << "," << volumeX.at(ispecies).size() << endl;
  //[CO20181226 OBSOLETE]      aurostd::PrintErrorStream(cerr,aus,XHOST.QUIET);
  //[CO20181226 OBSOLETE]      return FALSE;
  //[CO20181226 OBSOLETE]    }
  //[CO20181226 OBSOLETE]    if(specieX.at(ispecies).size() != massX.at(ispecies).size()) {
  //[CO20181226 OBSOLETE]      aus << "EEEEE  PROTO_Generation_Binary_Aflowin error \"specieX.at(" << ispecies << ").size()!=massX.at(" << ispecies << ").size()\" " << specieX.at(ispecies).size() << "," << massX.at(ispecies).size() << endl;
  //[CO20181226 OBSOLETE]      aurostd::PrintErrorStream(cerr,aus,XHOST.QUIET);
  //[CO20181226 OBSOLETE]      return FALSE;
  //[CO20181226 OBSOLETE]    }
  //[CO20181226 OBSOLETE]  }
  ...
  while(xc.increment()){
    ...
    if(aurostd::StringsAlphabetic(species_tmp,false)){
      for(uint k=0;k<label.size();k++) {
        for(uint ipocc=0;ipocc<pocc_parameters_sets.size();ipocc++){
          for(uint ipocctol=0;ipocctol<pocc_tol_sets.size();ipocctol++){
            for(uint ip=0;ip<PARAMS->vpressure.size();ip++) {
              ...
              if(LDEBUG) cerr << __AFLOW_FUNC__ << " xaus.AVASP_pocc_parameters=" << xaus.AVASP_pocc_parameters << endl;
              ...
              if(LDEBUG) {cerr << __AFLOW_FUNC__ << " xaus.str.species=" << aurostd::joinWDelimiter(xaus.str.species,",") << endl;}
              for(uint i=0;i<xaus.str.species.size();i++){xaus.str.species_pp.push_back(xaus.str.species[i]);}
              for(uint i=0;i<xaus.str.species.size();i++){xaus.str.species_pp_type.push_back(xaus.AVASP_potential);}
              ...
              if(!PARAMS->vparams.flag("AFLOWIN_FLAG::LIST")) {
                ...
                if(xaus.aopts.flag("AFLOWIN_FLAG::PSTRESS")==FALSE) {
                  ...
                  for(uint i=0;i<xaus.str.species.size();i++) cout << ":" << KBIN::VASP_PseudoPotential_CleanName(xaus.str.species.at(i));	
                  cout << endl;
                } else {
      ...
      if(0||(flag_LIB2U==FALSE && flag_LIB2==FALSE && flag_LIB3==FALSE && flag_LIB4==FALSE)) {
  ...
  // ***************************************************************************
  //[CO20181226 OBSOLETE]// 1 SPECIES
  //[CO20181226 OBSOLETE]if(nspecies==1) {
  //[CO20181226 OBSOLETE]  if(LDEBUG) cerr <<"DEBUG - " << __AFLOW_FUNC__ << " [5] 1species" << endl;
  //[CO20181226 OBSOLETE]  uint ii[nspecies];
  //[CO20181226 OBSOLETE]  for(ii[0]=0;ii[0]<specieX.at(0).size();ii[0]++) {
  //[CO20181226 OBSOLETE]    for(uint k=0;k<label.size();k++) {
  //[CO20181226 OBSOLETE]      for(uint ip=0;ip<PARAMS->vpressure.size();ip++) {
  //[CO20181226 OBSOLETE]        _xvasp xaus(xvasp);
  //[CO20181226 OBSOLETE]        xaus.AVASP_label=label.at(k);
  //[CO20181226 OBSOLETE]        xaus.str.species.clear();xaus.str.species_pp.clear();xaus.str.species_pp_type.clear();xaus.str.species_pp_version.clear();xaus.str.species_pp_ZVAL.clear();xaus.str.species_pp_vLDAU.clear();xaus.str.species_volume.clear();xaus.str.species_mass.clear();
  //[CO20181226 OBSOLETE]        for(uint i=0;i<nspecies;i++) {xaus.str.species.push_back(specieX.at(i).at(ii[i]));xaus.str.species_volume.push_back(volumeX.at(i).at(ii[i]));xaus.str.species_mass.push_back(massX.at(i).at(ii[i]));}
  //[CO20181226 OBSOLETE]        xaus.str.species_pp=xaus.str.species;
  //[CO20181226 OBSOLETE]        for(uint i=0;i<nspecies;i++) xaus.str.species_pp_type.push_back(xaus.AVASP_potential);
  //[CO20181226 OBSOLETE]        for(uint i=0;i<nspecies;i++) xaus.str.species_pp_version.push_back("");
  //[CO20181226 OBSOLETE]        for(uint i=0;i<nspecies;i++) xaus.str.species_pp_ZVAL.push_back(0.0);
  //[CO20181226 OBSOLETE]        for(uint i=0;i<nspecies;i++) xaus.str.species_pp_vLDAU.push_back(deque<double>());
  //[CO20181226 OBSOLETE]        if(!aurostd::substring2bool(string_POTENTIAL,_AVASP_PSEUDOPOTENTIAL_AUTO_)) xaus.aopts.flag("FLAG::AVASP_AUTO_PSEUDOPOTENTIALS",FALSE);
  //[CO20181226 OBSOLETE]        if(xaus.aopts.flag("FLAG::AVASP_FORCE_LDAU")) AVASP_ADD_LDAU(xaus);
  //[CO20181226 OBSOLETE]        if(xaus.aopts.flag("FLAG::AVASP_FORCE_NOLDAU")) AVASP_REMOVE_LDAU(xaus);	
  //[CO20181226 OBSOLETE]        xaus.aopts.push_attached("AFLOWIN_FLAG::PSTRESS",aurostd::utype2string(PARAMS->vpressure.at(ip)));
  //[CO20181226 OBSOLETE]        if(PARAMS->vpressure.size()==1 && abs(aurostd::string2utype<double>(xaus.aopts.getattachedscheme("AFLOWIN_FLAG::PSTRESS")))<0.00001) {
  //[CO20181226 OBSOLETE]          xaus.aopts.flag("AFLOWIN_FLAG::PSTRESS",FALSE);xaus.aopts.push_attached("AFLOWIN_FLAG::PSTRESS","0.0");};
  //[CO20181226 OBSOLETE]        if(!PARAMS->vparams.flag("AFLOWIN_FLAG::LIST")) {
  //[CO20181226 OBSOLETE]          if(!MULTITHREAD) AVASP_MakeSingleAFLOWIN(xaus,!PARAMS->vparams.flag("AFLOWIN_FLAG::STDOUT"));   // SINGLE_THREAD
  //[CO20181226 OBSOLETE]          if(MULTITHREAD) {dxvasp.push_back(xaus);if(dxvasp.size()==AVASP_AFLOWIN_MAX_JOBS) AVASP_MakePrototype_AFLOWIN_LOOP(dxvasp,!PARAMS->vparams.flag("AFLOWIN_FLAG::STDOUT"));}
  //[CO20181226 OBSOLETE]        } else {
  //[CO20181226 OBSOLETE]          if(xaus.aopts.flag("AFLOWIN_FLAG::PSTRESS")==FALSE) {
  //[CO20181226 OBSOLETE]            cout << "aflow " << PARAMS->vparams.getattachedscheme("AFLOWIN_FLAG::LIST_VCMD") << "--aflow_proto=" << xaus.AVASP_label; 
  //[CO20181226 OBSOLETE]            for(uint i=0;i<nspecies;i++) cout << ":" << KBIN::VASP_PseudoPotential_CleanName(xaus.str.species.at(i));	
  //[CO20181226 OBSOLETE]            cout << endl;
  //[CO20181226 OBSOLETE]          } else {
  //[CO20181226 OBSOLETE]            cout << "aflow " << PARAMS->vparams.getattachedscheme("AFLOWIN_FLAG::LIST_VCMD") << "--pressure=" << xaus.aopts.getattachedscheme("AFLOWIN_FLAG::PSTRESS") << " --aflow_proto=" << xaus.AVASP_label; 
  //[CO20181226 OBSOLETE]            for(uint i=0;i<nspecies;i++) cout << ":" << KBIN::VASP_PseudoPotential_CleanName(xaus.str.species.at(i)); 
  //[CO20181226 OBSOLETE]            cout << endl;
  //[CO20181226 OBSOLETE]          }
  //[CO20181226 OBSOLETE]        }
  ...
  //[CO20181226 OBSOLETE]    }
  //[CO20181226 OBSOLETE]  }
  //[CO20181226 OBSOLETE]  if(MULTITHREAD) AVASP_MakePrototype_AFLOWIN_LOOP(dxvasp,!PARAMS->vparams.flag("AFLOWIN_FLAG::STDOUT")); // FLUSH OUT
  //[CO20181226 OBSOLETE]}
  // ***************************************************************************
  // 2 SPECIES
  //[CO20181226 OBSOLETE]if(nspecies==2) {
  //[CO20181226 OBSOLETE]  if(LDEBUG) cerr <<"DEBUG - " << __AFLOW_FUNC__ << " [5] 2species" << endl;
  //[CO20181226 OBSOLETE]  uint ii[nspecies];
  //[CO20181226 OBSOLETE]  for(ii[0]=0;ii[0]<specieX.at(0).size();ii[0]++) {
  //[CO20181226 OBSOLETE]    if(LDEBUG) cerr <<"DEBUG - " << __AFLOW_FUNC__ << " [5a] specieX.at(0).size()=" << specieX.at(0).size() << "  -  specieX.at(0).at(ii[0])=" << specieX.at(0).at(ii[0]) << endl;
  //[CO20181226 OBSOLETE]    for(ii[1]=0;ii[1]<specieX.at(1).size();ii[1]++) {
  //[CO20181226 OBSOLETE]      if(LDEBUG) cerr <<"DEBUG - " << __AFLOW_FUNC__ << " [5b] specieX.at(1).size()=" << specieX.at(1).size() << "  -  specieX.at(1).at(ii[1])=" << specieX.at(1).at(ii[1]) << endl;
  //[CO20181226 OBSOLETE]      if(specieX.at(0).at(ii[0])<specieX.at(1).at(ii[1])) {
  //[CO20181226 OBSOLETE]        // 	if((flag_LIB2U==FALSE && flag_LIB2==FALSE && flag_LIB3==FALSE && specieX.at(0).at(ii[0])!=specieX.at(1).at(ii[1])) ||
  //[CO20181226 OBSOLETE]        // 	   (flag_LIB2U==TRUE  && flag_LIB2==FALSE && flag_LIB3==FALSE && specieX.at(0).at(ii[0])<specieX.at(1).at(ii[1]))  ||
  //[CO20181226 OBSOLETE]        // 	   (flag_LIB2U==FALSE && flag_LIB2==TRUE  && flag_LIB3==FALSE && specieX.at(0).at(ii[0])<specieX.at(1).at(ii[1]))  ||
  //[CO20181226 OBSOLETE]        // 	   (flag_LIB2U==FALSE && flag_LIB2==FALSE && flag_LIB3==TRUE  && specieX.at(0).at(ii[0])<specieX.at(1).at(ii[1])) ) { // check if identical is done later //[CO20200106 - close bracket for indenting]}
  //[CO20181226 OBSOLETE]        for(uint k=0;k<label.size();k++) {
  //[CO20181226 OBSOLETE]          for(uint ip=0;ip<PARAMS->vpressure.size();ip++) {
  //[CO20181226 OBSOLETE]            _xvasp xaus(xvasp);
  //[CO20181226 OBSOLETE]            xaus.AVASP_label=label.at(k);
  ...
  //[CO20181226 OBSOLETE]            for(uint i=0;i<nspecies;i++) {xaus.str.species.push_back(specieX.at(i).at(ii[i]));xaus.str.species_volume.push_back(volumeX.at(i).at(ii[i]));xaus.str.species_mass.push_back(massX.at(i).at(ii[i]));}
  //[CO20181226 OBSOLETE]            xaus.str.species_pp=xaus.str.species;
  //[CO20181226 OBSOLETE]            //	      for(uint i=0;i<nspecies;i++) cerr << "xaus.str.species_pp=" << xaus.str.species_pp.at(i) << " " << "xaus.str.species_volume=" << xaus.str.species_volume.at(i) << " " << "xaus.str.species_mass=" << xaus.str.species_mass.at(i) << " " << endl;
  //[CO20181226 OBSOLETE]            for(uint i=0;i<nspecies;i++) xaus.str.species_pp_type.push_back(xaus.AVASP_potential);
  //[CO20181226 OBSOLETE]            for(uint i=0;i<nspecies;i++) xaus.str.species_pp_version.push_back("");
  //[CO20181226 OBSOLETE]            for(uint i=0;i<nspecies;i++) xaus.str.species_pp_ZVAL.push_back(0.0);
  //[CO20181226 OBSOLETE]            for(uint i=0;i<nspecies;i++) xaus.str.species_pp_vLDAU.push_back(deque<double>());
  ...
  //[CO20181226 OBSOLETE]                for(uint i=0;i<nspecies;i++) cout << ":" << KBIN::VASP_PseudoPotential_CleanName(xaus.str.species.at(i)); 
  //[CO20181226 OBSOLETE]                cout << endl;
  //[CO20181226 OBSOLETE]              } else {cout << "aflow " << PARAMS->vparams.getattachedscheme("AFLOWIN_FLAG::LIST_VCMD") << "--pressure=" << xaus.aopts.getattachedscheme("AFLOWIN_FLAG::PSTRESS") << " --aflow_proto=" << xaus.AVASP_label; 
  //[CO20181226 OBSOLETE]                for(uint i=0;i<nspecies;i++) cout << ":" << KBIN::VASP_PseudoPotential_CleanName(xaus.str.species.at(i)); 
  //[CO20181226 OBSOLETE]                cout << endl;
  //[CO20181226 OBSOLETE]              }
  //[CO20181226 OBSOLETE]            }
  //[CO20181226 OBSOLETE]          }
  //[CO20181226 OBSOLETE]        }
  //[CO20181226 OBSOLETE]      } else { // no alphabetic
  //[CO20181226 OBSOLETE]        if(flag_LIB2U==FALSE && flag_LIB2==FALSE && flag_LIB3==FALSE) {
  //[CO20181226 OBSOLETE]          for(uint i=0;i<nspecies-1;i++) {
  //[CO20181226 OBSOLETE]            if(specieX.at(i).at(ii[i])>specieX.at(i+1).at(ii[i+1])) {
  //[CO20181226 OBSOLETE]              cerr << __AFLOW_FUNC__ << " system ";
  //[CO20181226 OBSOLETE]              for(uint j=0;j<nspecies;j++) {
  ...
  // **********************************************************n*****************
  // 3 SPECIES
  //[CO20181226 OBSOLETE]if(nspecies==3) {
  //[CO20181226 OBSOLETE]  //   LDEBUG=TRUE;
  //[CO20181226 OBSOLETE]  if(LDEBUG) cerr <<"DEBUG - " << __AFLOW_FUNC__ << " [5] 3species" << endl;
  //[CO20181226 OBSOLETE]  uint ii[nspecies];
  //[CO20181226 OBSOLETE]  for(ii[0]=0;ii[0]<specieX.at(0).size();ii[0]++) {
  //[CO20181226 OBSOLETE]    for(ii[1]=0;ii[1]<specieX.at(1).size();ii[1]++) {
  //[CO20181226 OBSOLETE]      for(ii[2]=0;ii[2]<specieX.at(2).size();ii[2]++) {
  //[CO20181226 OBSOLETE]        if(LDEBUG) cerr <<"DEBUG - " << __AFLOW_FUNC__ << " [5.0.3] 3species specieX.at(2).at(ii[2])=" << specieX.at(2).at(ii[2]) <<  endl;
  //[CO20181226 OBSOLETE]        if(LDEBUG) { 
  //[CO20181226 OBSOLETE]          cerr << "DEBUG - " << __AFLOW_FUNC__ << " [5.0.3] 3species = " << specieX.at(0).at(ii[0]) << " " << specieX.at(1).at(ii[1]) << " " << specieX.at(2).at(ii[2]);
  //[CO20181226 OBSOLETE]          if(specieX.at(0).at(ii[0])<specieX.at(1).at(ii[1])) cerr << " 0<1 ";
  //[CO20181226 OBSOLETE]          if(specieX.at(1).at(ii[1])<specieX.at(2).at(ii[2])) cerr << " 1<2 ";
  //[CO20181226 OBSOLETE]          cerr << endl;
  //[CO20181226 OBSOLETE]        }
  //[CO20181226 OBSOLETE]        if(specieX.at(0).at(ii[0])<specieX.at(1).at(ii[1]) && specieX.at(1).at(ii[1])<specieX.at(2).at(ii[2])) { // check if identical is done later
  //[CO20181226 OBSOLETE]          if(LDEBUG) cerr <<"DEBUG - " << __AFLOW_FUNC__ << " [5.0.4] 3species " << specieX.at(0).at(ii[0]) << specieX.at(1).at(ii[1]) << specieX.at(2).at(ii[2]) <<  endl;
  //[CO20181226 OBSOLETE]          // 	  if((flag_LIB2U==FALSE && flag_LIB2==FALSE && flag_LIB3==FALSE && specieX.at(0).at(ii[0])!=specieX.at(1).at(ii[1]) && specieX.at(1).at(ii[1])!=specieX.at(2).at(ii[2])) ||
  //[CO20181226 OBSOLETE]          // 	     (flag_LIB2U==TRUE  && flag_LIB2==FALSE && flag_LIB3==FALSE && specieX.at(0).at(ii[0])<specieX.at(1).at(ii[1])  && specieX.at(1).at(ii[1])<specieX.at(2).at(ii[2]))  ||
  //[CO20181226 OBSOLETE]          // 	     (flag_LIB2U==FALSE && flag_LIB2==TRUE  && flag_LIB3==FALSE && specieX.at(0).at(ii[0])<specieX.at(1).at(ii[1])  && specieX.at(1).at(ii[1])<specieX.at(2).at(ii[2]))  ||
  //[CO20181226 OBSOLETE]          // 	     (flag_LIB2U==FALSE && flag_LIB2==FALSE && flag_LIB3==TRUE  && specieX.at(0).at(ii[0])<specieX.at(1).at(ii[1])  && specieX.at(1).at(ii[1])<specieX.at(2).at(ii[2]))) {  //[CO20200106 - close bracket for indenting]}
  //[CO20181226 OBSOLETE]          for(uint k=0;k<label.size();k++) {
  //[CO20181226 OBSOLETE]            if(LDEBUG) cerr <<"DEBUG - " << __AFLOW_FUNC__ << " [5.1] 3species label.at(" << k << ")=" << label.at(k) << endl;
  //[CO20181226 OBSOLETE]            for(uint ip=0;ip<PARAMS->vpressure.size();ip++) {
  //[CO20181226 OBSOLETE]              if(LDEBUG) cerr <<"DEBUG - " << __AFLOW_FUNC__ << " [5.1] 3species PARAMS->vpressure.at(" << ip << ")=" << PARAMS->vpressure.at(ip) << endl;
  //[CO20181226 OBSOLETE]              _xvasp xaus(xvasp);
  //[CO20181226 OBSOLETE]              xaus.AVASP_label=label.at(k);
  //[CO20181226 OBSOLETE]              xaus.str.species.clear();xaus.str.species_pp.clear();xaus.str.species_pp_type.clear();xaus.str.species_pp_version.clear();xaus.str.species_pp_ZVAL.clear();xaus.str.species_pp_vLDAU.clear();xaus.str.species_volume.clear();xaus.str.species_mass.clear();
  //[CO20181226 OBSOLETE]              for(uint i=0;i<nspecies;i++) {xaus.str.species.push_back(specieX.at(i).at(ii[i]));xaus.str.species_volume.push_back(volumeX.at(i).at(ii[i]));xaus.str.species_mass.push_back(massX.at(i).at(ii[i]));}
  ...
  //[CO20181226 OBSOLETE]              for(uint i=0;i<nspecies;i++) xaus.str.species_pp_ZVAL.push_back(0.0);
  //[CO20181226 OBSOLETE]              for(uint i=0;i<nspecies;i++) xaus.str.species_pp_vLDAU.push_back(deque<double>());
  //[CO20181226 OBSOLETE]              //	if(flag_LIB3==FALSE) {  //[CO20200106 - close bracket for indenting]}
  //[CO20181226 OBSOLETE]              if(!aurostd::substring2bool(string_POTENTIAL,_AVASP_PSEUDOPOTENTIAL_AUTO_)) xaus.aopts.flag("FLAG::AVASP_AUTO_PSEUDOPOTENTIALS",FALSE);
  //[CO20181226 OBSOLETE]              if(xaus.aopts.flag("FLAG::AVASP_FORCE_LDAU")) AVASP_ADD_LDAU(xaus);
  //[CO20181226 OBSOLETE]              if(xaus.aopts.flag("FLAG::AVASP_FORCE_NOLDAU")) AVASP_REMOVE_LDAU(xaus);
  //[CO20181226 OBSOLETE]              xaus.aopts.push_attached("AFLOWIN_FLAG::PSTRESS",aurostd::utype2string(PARAMS->vpressure.at(ip)));
  ...
  // ***************************************************************************
  // 4 SPECIES
  //[CO20181226 OBSOLETE]if(nspecies==4) {
  //[CO20181226 OBSOLETE]  if(LDEBUG) cerr <<"DEBUG - " << __AFLOW_FUNC__ << " [5] 4species" << endl;
  //[CO20181226 OBSOLETE]  uint ii[nspecies];
  //[CO20181226 OBSOLETE]  for(ii[0]=0;ii[0]<specieX.at(0).size();ii[0]++) {
  //[CO20181226 OBSOLETE]    for(ii[1]=0;ii[1]<specieX.at(1).size();ii[1]++) {
  //[CO20181226 OBSOLETE]      for(ii[2]=0;ii[2]<specieX.at(2).size();ii[2]++) {
  //[CO20181226 OBSOLETE]        for(ii[3]=0;ii[3]<specieX.at(3).size();ii[3]++) {
  //[CO20181226 OBSOLETE]          // 	    if((flag_LIB2U==FALSE && flag_LIB2==FALSE && flag_LIB3==FALSE && specieX.at(0).at(ii[0])!=specieX.at(1).at(ii[1]) && specieX.at(1).at(ii[1])!=specieX.at(2).at(ii[2]) && specieX.at(2).at(ii[2])!=specieX.at(3).at(ii[3])) ||
  //[CO20181226 OBSOLETE]          // 	       (flag_LIB2U==TRUE  && flag_LIB2==FALSE && flag_LIB3==FALSE && specieX.at(0).at(ii[0])<specieX.at(1).at(ii[1])  && specieX.at(1).at(ii[1])<specieX.at(2).at(ii[2])  && specieX.at(2).at(ii[2])<specieX.at(3).at(ii[3]))  ||
  //[CO20181226 OBSOLETE]          // 	       (flag_LIB2U==FALSE && flag_LIB2==TRUE  && flag_LIB3==FALSE && specieX.at(0).at(ii[0])<specieX.at(1).at(ii[1])  && specieX.at(1).at(ii[1])<specieX.at(2).at(ii[2])  && specieX.at(2).at(ii[2])<specieX.at(3).at(ii[3]))  ||
  //[CO20181226 OBSOLETE]          // 	       (flag_LIB2U==FALSE && flag_LIB2==FALSE && flag_LIB3==TRUE  && specieX.at(0).at(ii[0])<specieX.at(1).at(ii[1])  && specieX.at(1).at(ii[1])<specieX.at(2).at(ii[2])  && specieX.at(2).at(ii[2])<specieX.at(3).at(ii[3]))) {  //[CO20200106 - close bracket for indenting]}
  //[CO20181226 OBSOLETE]          if(specieX.at(0).at(ii[0])<specieX.at(1).at(ii[1])  && specieX.at(1).at(ii[1])<specieX.at(2).at(ii[2])  && specieX.at(2).at(ii[2])<specieX.at(3).at(ii[3])) { // check if identical is done later
  //[CO20181226 OBSOLETE]            for(uint k=0;k<label.size();k++) {
  //[CO20181226 OBSOLETE]              for(uint ip=0;ip<PARAMS->vpressure.size();ip++) {
  //[CO20181226 OBSOLETE]                _xvasp xaus(xvasp);
  //[CO20181226 OBSOLETE]                xaus.AVASP_label=label.at(k);
  ...
  //[CO20181226 OBSOLETE]                for(uint i=0;i<nspecies;i++) xaus.str.species_pp_ZVAL.push_back(0.0);
  //[CO20181226 OBSOLETE]                for(uint i=0;i<nspecies;i++) xaus.str.species_pp_vLDAU.push_back(deque<double>());
  //[CO20181226 OBSOLETE]                // check alpha
  //[CO20181226 OBSOLETE]                if(alphabetic==TRUE) AlphabetizePrototypeLabelSpecies(xaus.str.species,xaus.str.species_pp,xaus.str.species_volume,xaus.str.species_mass,xaus.AVASP_label);
  //[CO20181226 OBSOLETE]                if(!aurostd::substring2bool(string_POTENTIAL,_AVASP_PSEUDOPOTENTIAL_AUTO_)) xaus.aopts.flag("FLAG::AVASP_AUTO_PSEUDOPOTENTIALS",FALSE);
  //[CO20181226 OBSOLETE]                if(1) { // workaround elpasolites
  //[CO20181226 OBSOLETE]                  // LDAU
  //[CO20181226 OBSOLETE]                  // bool CHECK_LDAU=TRUE;
  //[CO20181226 OBSOLETE]                  xaus.aopts.flag("FLAG::AVASP_SKIP_NOMIX",FALSE);
  //[CO20181226 OBSOLETE]                  // xaus.AVASP_flag_TYPE.xscheme.at(0)=='M'=FALSE;
  //[CO20181226 OBSOLETE]                  // xaus.AVASP_flag_TYPE.xscheme.at(0)=='I'=TRUE;
  //[CO20181226 OBSOLETE]                  xaus.aopts.flag("FLAG::VOLUME_PRESERVED",TRUE);
  //[CO20181226 OBSOLETE]                  // if(xaus.aopts.flag("FLAG::AVASP_FORCE_LDAU")) AVASP_ADD_LDAU(xaus);
  //[CO20181226 OBSOLETE]                  if(1) AVASP_ADD_LDAU(xaus);
  //[CO20181226 OBSOLETE]                  if(xaus.aopts.flag("FLAG::AVASP_FORCE_NOLDAU")) AVASP_REMOVE_LDAU(xaus);
  //[CO20181226 OBSOLETE]                }
  //[CO20181226 OBSOLETE]                //  if(flag_LIB3==FALSE) { //[CO20200106 - close bracket for indenting]}
  //[CO20181226 OBSOLETE]                xaus.aopts.push_attached("AFLOWIN_FLAG::PSTRESS",aurostd::utype2string(PARAMS->vpressure.at(ip)));
...
bool AVASP_MakePrototypeICSD_AFLOWIN(_AVASP_PROTO *PARAMS,bool flag_AFLOW_IN_ONLY_IF_MISSING) { //CO20200106 - patching for auto-indenting
  ...
  bool LDEBUG=(FALSE || XHOST.DEBUG);
  if(LDEBUG) cerr << __AFLOW_FUNC__ << " 0a" << endl;
  _xvasp xvasp;
  ...
  if(LDEBUG) cerr << __AFLOW_FUNC__ << " 0c" << endl;
  ...
  if(LDEBUG) cerr << __AFLOW_FUNC__ << " 0d" << endl;
  ...
  if(LDEBUG) cerr << __AFLOW_FUNC__ << " 0d-1" << endl;
  xvasp.str=aflowlib::PrototypeLibraries(cerr,label,parameters,LIBRARY_MODE_ICSD);
  if(LDEBUG) cerr << __AFLOW_FUNC__ << " 0d-2" << endl;
  if(LDEBUG) cerr << __AFLOW_FUNC__ << " DEBUG: xvasp.str.bravais_lattice_type=" << xvasp.str.bravais_lattice_type << endl;
  if(LDEBUG) cerr << __AFLOW_FUNC__ << " DEBUG: xvasp.str.bravais_lattice_variation_type=" << xvasp.str.bravais_lattice_variation_type << endl;
  if(LDEBUG) cerr << __AFLOW_FUNC__ << " 0d-3" << endl;
  ...
  if(LDEBUG) cerr << __AFLOW_FUNC__ << " DEBUG: label=" << label << endl;
  ...
  if(LDEBUG) cerr << __AFLOW_FUNC__ << " DEBUG: potential=" << xvasp.AVASP_potential << endl;
  ...
  // Parameters
  if(LDEBUG) cerr << __AFLOW_FUNC__ << " 1a" << endl;
  ...
  if(LDEBUG) cerr << __AFLOW_FUNC__ << " 2a" << endl;
  if(LDEBUG) cerr << xvasp.str << endl;
  if(LDEBUG) cerr << __AFLOW_FUNC__ << " Running AVASP_MakeSingleAFLOWIN" << endl;
  AVASP_MakeSingleAFLOWIN(xvasp,!PARAMS->vparams.flag("AFLOWIN_FLAG::STDOUT"));
  if(LDEBUG) cerr << __AFLOW_FUNC__ << " 3a" << endl;
