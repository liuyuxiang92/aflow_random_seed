...
namespace pflow {
  ...
  void CalculateGFA(aurostd::xoption& vpflow, const string& alloy, const string& AE_file_read, double fe_cut){
    ...
    ostream& oss=cout;
    vector<string> species=aurostd::stringElements2VectorElements(alloy,true,true,pp_string,false,oss);  //clean and sort, do not keep_pp //[CO20190712 - OBSOLETE]getAlphabeticVectorString(alloy);
