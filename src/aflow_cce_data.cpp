...
namespace cce {
  ...
  //CCE_get_electronegativities_ox_nums////////////////////////////////////////////////////////
  // function to get Allen electronegativities and preferred as well as (all) known oxidation numbers of the elements
  // Allen electronegativities are chosen since the IUPAC definition of oxidation states seems to use Allen electronegativities and since they also seem to give the best results
  // https://en.wikipedia.org/wiki/Oxidation_state#Determination
  // https://pubs.acs.org/doi/abs/10.1021/ja00207a003
  // https://pubs.acs.org/doi/10.1021/ja992866e
  // https://pubs.acs.org/doi/10.1021/ja9928677
  // preferred and all oxidation states of the elements listed according to the periodic table of the elements from Wiley-VCH, 5th edition (2012) with some modifications (e. g. for Cr, Cu, Fe, Ti)
  // if there is a most preferred oxidation number for an element with multiple preferred ones, it is listed first
  ...
  if (element=="K")   {return "0.734  1          1        +1         +1";}
  if (element=="Rb")  {return "0.706  1          1        +1         +1";}
  if (element=="Cs")  {return "0.659  1          1        +1         +1";}
  if (element=="Fr")  {return "0.67   1          1        +1         +1";}
  if (element=="Be")  {return "1.576  1          1        +2         +2";}
  if (element=="Mg")  {return "1.293  1          1        +2         +2";}
  if (element=="Ca")  {return "1.034  1          1        +2         +2";}
  if (element=="Sr")  {return "0.963  1          1        +2         +2";}
  if (element=="Ba")  {return "0.881  1          1        +2         +2";}
  if (element=="Ra")  {return "0.89   1          1        +2         +2";}
  if (element=="Sc")  {return "1.19   1          1        +3         +3";}
  if (element=="Y")   {return "1.12   1          1        +3         +3";}
  if (element=="La")  {return "1.09   1          1        +3         +3";}
  if (element=="Lu")  {return "1.09   1          1        +3         +3";}
  if (element=="Ti")  {return "1.38   1          3        +4         +4,+3,+2";}
  if (element=="Zr")  {return "1.32   1          2        +4         +4,+3";}
  if (element=="Hf")  {return "1.16   1          2        +4         +4,+3";}
  if (element=="V")   {return "1.53   1          5        +5         +5,+4,+3,+2,0";}
  if (element=="Nb")  {return "1.41   1          3        +5         +5,+3,+2";}
  if (element=="Ta")  {return "1.34   1          2        +5         +5,+3";}
  if (element=="Cr")  {return "1.65   2          4        +3,+6      +6,+3,+2,0";} // Cr+3 most preferred oxidation number
  if (element=="Mo")  {return "1.47   1          6        +6         +6,+5,+4,+3,+2,0";}
  if (element=="W")   {return "1.47   1          6        +6         +6,+5,+4,+3,+2,0";}
  if (element=="Mn")  {return "1.75   1          7        +2         +7,+6,+4,+3,+2,0,-1";}
  if (element=="Tc")  {return "1.51   1          1        +7         +7";}
  if (element=="Re")  {return "1.60   1          5        +7         +7,+6,+4,+2,-1";}
  if (element=="Fe")  {return "1.80   2          5        +3,+2      +6,+3,+2,0,-2";} // Fe+3 most preferred oxidation number
  if (element=="Ru")  {return "1.54   2          7        +4,+3      +8,+6,+4,+3,+2,0,-2";}
  if (element=="Os")  {return "1.65   1          7        +4         +8,+6,+4,+3,+2,0,-2";}
  if (element=="Co")  {return "1.84   1          4        +2         +3,+2,0,-1";}
  if (element=="Rh")  {return "1.56   2          6        +3,+1      +5,+4,+3,+2,+1,0";}
  if (element=="Ir")  {return "1.68   2          7        +4,+1      +6,+4,+3,+2,+1,0,-1";}
  if (element=="Ni")  {return "1.88   1          3        +2         +3,+2,0";}
  if (element=="Pd")  {return "1.58   1          3        +2         +4,+2,0";}
  if (element=="Pt")  {return "1.72   2          3        +4,+2      +4,+2,0";}
  if (element=="Cu")  {return "1.85   2          2        +2,+1      +2,+1";} // Cu+2 most preferred oxidation number
  if (element=="Ag")  {return "1.87   1          2        +1         +2,+1";}
  if (element=="Au")  {return "1.92   1          3        +3         +3,+1";}
  if (element=="Zn")  {return "1.59   1          1        +2         +2";}
  if (element=="Cd")  {return "1.52   1          1        +2         +2";}
  if (element=="Hg")  {return "1.76   1          2        +2         +2,+1";}
  if (element=="B")   {return "2.051  1          1        +3         +3";}
  if (element=="Al")  {return "1.613  1          1        +3         +3";}
  if (element=="Ga")  {return "1.756  1          1        +3         +3";}
  if (element=="In")  {return "1.656  1          1        +3         +3";}
  if (element=="Tl")  {return "1.789  1          2        +1         +3,+1";}
  if (element=="C")   {return "2.544  2          3        +4,-4      +4,+2,-4";}
  if (element=="Si")  {return "1.916  1          2        +4         +4,-4";}
  if (element=="Ge")  {return "1.994  1          1        +4         +4";}
  if (element=="Sn")  {return "1.824  2          2        +4,+2      +4,+2";}
  if (element=="Pb")  {return "1.854  1          2        +2         +4,+2";}
  if (element=="N")   {return "3.066  1          5        -3         +5,+4,+3,+2,-3";}
  if (element=="P")   {return "2.253  1          3        +5         +5,+3,-3";}
  if (element=="As")  {return "2.211  1          3        +3         +5,+3,-3";}
  if (element=="Sb")  {return "1.984  1          3        +3         +5,+3,-3";}
  if (element=="Bi")  {return "2.01   1          2        +3         +5,+3";}
  if (element=="O")   {return "3.610  1          3        -2         -0.5,-1,-2";}
  if (element=="S")   {return "2.589  1          4        +6         +6,+4,+2,-2";}
  if (element=="Se")  {return "2.424  1          3        +4         +6,+4,-2";}
  if (element=="Te")  {return "2.158  1          3        +4         +6,+4,-2";}
  if (element=="Po")  {return "2.19   1          3        +4         +6,+4,+2";}
  if (element=="F")   {return "4.193  1          1        -1         -1";}
  if (element=="Cl")  {return "2.869  1          5        -1         +7,+5,+3,+1,-1";}
  if (element=="Br")  {return "2.685  1          5        -1         +7,+5,+3,+1,-1";}
  if (element=="I")   {return "2.359  1          4        -1         +7,+5,+1,-1";}
  if (element=="At")  {return "2.39   1          5        -1         +7,+5,+3,+1,-1";}
  if (element=="He")  {return "4.160  0          0";}
  if (element=="Ne")  {return "4.787  0          0";}
  if (element=="Ar")  {return "3.242  0          0";}
  if (element=="Kr")  {return "2.966  1          1        +2         +2";}
  if (element=="Xe")  {return "2.582  0          4        -          +8,+6,+4,+2";}
  if (element=="Rn")  {return "2.60   1          1        +2         +2";}
  else {return "";}                                                                                                      
  }
