...
namespace compare{
  ...
  //DX20191122 [MOVED TO XATOM] xvector<double> centroid_with_PBC(vector<xvector<double> >& coordinates, const xmatrix<double>& lattice);
  //DX20191122 [MOVED TO XATOM] xvector<double> centroid_with_PBC(vector<xvector<double> >& coordinates, vector<double>& weights,
  //DX20191122 [MOVED TO XATOM]    const xmatrix<double>& lattice);
  //DX20191122 [MOVED TO XATOM] xvector<double> centroid(const xstructure& xstr); //DX20200715
  //DX20191122 [MOVED TO XATOM] xvector<double> centroid(const deque<_atom>& atoms); //DX20200715
  //DX20191122 [MOVED TO XATOM] xvector<double> centroid(const vector<xvector<double> >& coordinates); //DX20200715
  //DX20191122 [MOVED TO XATOM] xvector<double> centroid(const vector<xvector<double> >& coordinates, const vector<double>& weights); //DX20200715
