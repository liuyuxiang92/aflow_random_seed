...
namespace cce {
  ...
  void CCE_print_usage(ostream& oss) {
    ...
    oss << "--functionals=              Provide a comma separated list with the functionals in the same sequence" << endl; 
    oss << "                            as the DFT formation energies they correspond to. These can be:" << endl; 
    ...
    oss << endl;
    oss << "aflow --cce=POSCAR --dft_formation_energies=-5.434,-6.220,-6.249 --functionals=PBE,LDA,SCAN --oxidation_numbers=2,-2" << endl;
    oss << "This will give you the CCE corrections and CCE formation enthalpies for PBE, LDA and SCAN for MgO." << endl;
    oss << endl;
    oss << "aflow --cce=POSCAR --dft_formation_energies=-6.220 --functionals=LDA --oxidation_numbers=2,-2" << endl;
    oss << "This gives you only the CCE corrections and CCE formation enthalpies for LDA." << endl;
    oss << endl;
    oss << "aflow --cce=POSCAR --dft_formation_energies=-5.434 --oxidation_numbers=2,-2" << endl;
    ...
    oss << "This gives you only the CCE corrections for PBE, LDA and SCAN." << endl;
    oss << endl;
    oss << "aflow --cce=POSCAR" << endl;
    oss << "This gives you the CCE corrections for PBE, LDA and SCAN if an aflow.in and a Bader charges file" << endl; 
    oss << "in AFLOW format are present and the oxidation numbers can be determined from them." << endl;
    oss << endl;
  }
